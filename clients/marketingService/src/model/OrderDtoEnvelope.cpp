...
OrderDtoEnvelope::OrderDtoEnvelope()
{
    m_IsSuccess = false;
...
void OrderDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OrderDtoEnvelope::toJson() const
{
...
bool OrderDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OrderDto> refVal_setResult;
...
void OrderDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OrderDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OrderDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OrderDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OrderDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OrderDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OrderDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OrderDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OrderDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OrderDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OrderDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OrderDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OrderDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OrderDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OrderDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OrderDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OrderDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OrderDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OrderDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OrderDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OrderDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OrderDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OrderDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OrderDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OrderDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OrderDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OrderDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OrderDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OrderDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OrderDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OrderDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OrderDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OrderDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<OrderDto> OrderDtoEnvelope::getResult() const
{
    return m_Result;
}

void OrderDtoEnvelope::setResult(const std::shared_ptr<OrderDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OrderDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
