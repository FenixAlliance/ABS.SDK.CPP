...
NewsletterDtoEnvelope::NewsletterDtoEnvelope()
{
    m_IsSuccess = false;
...
void NewsletterDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value NewsletterDtoEnvelope::toJson() const
{
...
bool NewsletterDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NewsletterDto> refVal_setResult;
...
void NewsletterDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NewsletterDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool NewsletterDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void NewsletterDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool NewsletterDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void NewsletterDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t NewsletterDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void NewsletterDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool NewsletterDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void NewsletterDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t NewsletterDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void NewsletterDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool NewsletterDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void NewsletterDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime NewsletterDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void NewsletterDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool NewsletterDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void NewsletterDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t NewsletterDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void NewsletterDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool NewsletterDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void NewsletterDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t NewsletterDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void NewsletterDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool NewsletterDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void NewsletterDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& NewsletterDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void NewsletterDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool NewsletterDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void NewsletterDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t NewsletterDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void NewsletterDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool NewsletterDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void NewsletterDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<NewsletterDto> NewsletterDtoEnvelope::getResult() const
{
    return m_Result;
}

void NewsletterDtoEnvelope::setResult(const std::shared_ptr<NewsletterDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool NewsletterDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void NewsletterDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
