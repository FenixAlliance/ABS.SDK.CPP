...
EmailGroupDtoEnvelope::EmailGroupDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmailGroupDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmailGroupDtoEnvelope::toJson() const
{
...
bool EmailGroupDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmailGroupDto> refVal_setResult;
...
void EmailGroupDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailGroupDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmailGroupDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmailGroupDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmailGroupDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmailGroupDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmailGroupDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmailGroupDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmailGroupDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmailGroupDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmailGroupDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmailGroupDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmailGroupDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmailGroupDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmailGroupDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmailGroupDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmailGroupDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmailGroupDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmailGroupDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmailGroupDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmailGroupDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmailGroupDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmailGroupDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmailGroupDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmailGroupDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmailGroupDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmailGroupDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmailGroupDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmailGroupDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmailGroupDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmailGroupDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmailGroupDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmailGroupDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmailGroupDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmailGroupDto> EmailGroupDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmailGroupDtoEnvelope::setResult(const std::shared_ptr<EmailGroupDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmailGroupDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmailGroupDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
