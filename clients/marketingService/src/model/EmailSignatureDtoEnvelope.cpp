...
EmailSignatureDtoEnvelope::EmailSignatureDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmailSignatureDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmailSignatureDtoEnvelope::toJson() const
{
...
bool EmailSignatureDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmailSignatureDto> refVal_setResult;
...
void EmailSignatureDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailSignatureDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmailSignatureDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmailSignatureDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmailSignatureDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmailSignatureDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmailSignatureDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmailSignatureDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmailSignatureDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmailSignatureDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmailSignatureDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmailSignatureDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmailSignatureDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmailSignatureDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmailSignatureDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmailSignatureDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmailSignatureDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmailSignatureDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmailSignatureDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmailSignatureDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmailSignatureDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmailSignatureDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmailSignatureDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmailSignatureDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmailSignatureDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmailSignatureDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmailSignatureDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmailSignatureDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmailSignatureDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmailSignatureDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmailSignatureDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmailSignatureDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmailSignatureDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmailSignatureDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmailSignatureDto> EmailSignatureDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmailSignatureDtoEnvelope::setResult(const std::shared_ptr<EmailSignatureDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmailSignatureDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmailSignatureDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
