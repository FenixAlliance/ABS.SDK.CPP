...
EmailGroupDtoListEnvelope::EmailGroupDtoListEnvelope()
{
    m_IsSuccess = false;
...
void EmailGroupDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmailGroupDtoListEnvelope::toJson() const
{
...
bool EmailGroupDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<EmailGroupDto>> refVal_setResult;
...
void EmailGroupDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailGroupDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmailGroupDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmailGroupDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmailGroupDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmailGroupDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmailGroupDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmailGroupDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmailGroupDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmailGroupDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmailGroupDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmailGroupDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmailGroupDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmailGroupDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmailGroupDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmailGroupDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmailGroupDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmailGroupDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmailGroupDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmailGroupDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmailGroupDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmailGroupDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmailGroupDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmailGroupDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmailGroupDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmailGroupDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmailGroupDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmailGroupDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmailGroupDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmailGroupDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmailGroupDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmailGroupDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmailGroupDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmailGroupDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<EmailGroupDto>>& EmailGroupDtoListEnvelope::getResult()
{
    return m_Result;
}

void EmailGroupDtoListEnvelope::setResult(const std::vector<std::shared_ptr<EmailGroupDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmailGroupDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmailGroupDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
