...
EmailTemplateDtoEnvelope::EmailTemplateDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmailTemplateDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmailTemplateDtoEnvelope::toJson() const
{
...
bool EmailTemplateDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmailTemplateDto> refVal_setResult;
...
void EmailTemplateDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailTemplateDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmailTemplateDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmailTemplateDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmailTemplateDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmailTemplateDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmailTemplateDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmailTemplateDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmailTemplateDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmailTemplateDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmailTemplateDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmailTemplateDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmailTemplateDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmailTemplateDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmailTemplateDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmailTemplateDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmailTemplateDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmailTemplateDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmailTemplateDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmailTemplateDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmailTemplateDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmailTemplateDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmailTemplateDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmailTemplateDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmailTemplateDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmailTemplateDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmailTemplateDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmailTemplateDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmailTemplateDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmailTemplateDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmailTemplateDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmailTemplateDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmailTemplateDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmailTemplateDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmailTemplateDto> EmailTemplateDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmailTemplateDtoEnvelope::setResult(const std::shared_ptr<EmailTemplateDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmailTemplateDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmailTemplateDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
