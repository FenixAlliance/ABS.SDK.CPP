...
SocialMediaPostDtoEnvelope::SocialMediaPostDtoEnvelope()
{
    m_IsSuccess = false;
...
void SocialMediaPostDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialMediaPostDtoEnvelope::toJson() const
{
...
bool SocialMediaPostDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SocialMediaPostDto> refVal_setResult;
...
void SocialMediaPostDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialMediaPostDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialMediaPostDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialMediaPostDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialMediaPostDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialMediaPostDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialMediaPostDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialMediaPostDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialMediaPostDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialMediaPostDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialMediaPostDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialMediaPostDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialMediaPostDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialMediaPostDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialMediaPostDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialMediaPostDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialMediaPostDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialMediaPostDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialMediaPostDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialMediaPostDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialMediaPostDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialMediaPostDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialMediaPostDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialMediaPostDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialMediaPostDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialMediaPostDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialMediaPostDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialMediaPostDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialMediaPostDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialMediaPostDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialMediaPostDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialMediaPostDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialMediaPostDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialMediaPostDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SocialMediaPostDto> SocialMediaPostDtoEnvelope::getResult() const
{
    return m_Result;
}

void SocialMediaPostDtoEnvelope::setResult(const std::shared_ptr<SocialMediaPostDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialMediaPostDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialMediaPostDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
