...
utility::string_t NewsletterUpdateDto::getTenantId() const
{
    return m_TenantId;
}

void NewsletterUpdateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool NewsletterUpdateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void NewsletterUpdateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t NewsletterUpdateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void NewsletterUpdateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool NewsletterUpdateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void NewsletterUpdateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
