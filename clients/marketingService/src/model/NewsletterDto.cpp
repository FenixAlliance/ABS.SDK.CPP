...
#include "CppRestOpenAPIClient/model/NewsletterDto.h"
...
void NewsletterDto::validate()
{
    // TODO: implement validation
}

web::json::value NewsletterDto::toJson() const
{
...
bool NewsletterDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NewsletterDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NewsletterDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t NewsletterDto::getId() const
{
    return m_Id;
}

void NewsletterDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool NewsletterDto::idIsSet() const
{
    return m_IdIsSet;
}

void NewsletterDto::unsetId()
{
    m_IdIsSet = false;
}
utility::datetime NewsletterDto::getTimestamp() const
{
    return m_Timestamp;
}

void NewsletterDto::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool NewsletterDto::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void NewsletterDto::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t NewsletterDto::getName() const
{
    return m_Name;
}

void NewsletterDto::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool NewsletterDto::nameIsSet() const
{
    return m_NameIsSet;
}

void NewsletterDto::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t NewsletterDto::getCode() const
{
    return m_Code;
}

void NewsletterDto::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool NewsletterDto::codeIsSet() const
{
    return m_CodeIsSet;
}

void NewsletterDto::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t NewsletterDto::getTitle() const
{
    return m_Title;
}

void NewsletterDto::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool NewsletterDto::titleIsSet() const
{
    return m_TitleIsSet;
}

void NewsletterDto::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t NewsletterDto::getTenantId() const
{
    return m_TenantId;
}

void NewsletterDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool NewsletterDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void NewsletterDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t NewsletterDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void NewsletterDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool NewsletterDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void NewsletterDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
