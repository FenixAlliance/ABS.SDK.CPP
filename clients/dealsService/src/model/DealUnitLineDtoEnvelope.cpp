...
DealUnitLineDtoEnvelope::DealUnitLineDtoEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitLineDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitLineDtoEnvelope::toJson() const
{
...
bool DealUnitLineDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DealUnitLineDto> refVal_setResult;
...
void DealUnitLineDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitLineDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitLineDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitLineDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitLineDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitLineDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitLineDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitLineDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitLineDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitLineDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitLineDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitLineDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitLineDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitLineDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitLineDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitLineDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitLineDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitLineDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitLineDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitLineDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitLineDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitLineDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitLineDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitLineDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitLineDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitLineDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitLineDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitLineDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitLineDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitLineDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitLineDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitLineDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitLineDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitLineDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DealUnitLineDto> DealUnitLineDtoEnvelope::getResult() const
{
    return m_Result;
}

void DealUnitLineDtoEnvelope::setResult(const std::shared_ptr<DealUnitLineDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitLineDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitLineDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
