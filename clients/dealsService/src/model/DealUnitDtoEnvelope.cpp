...
DealUnitDtoEnvelope::DealUnitDtoEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitDtoEnvelope::toJson() const
{
...
bool DealUnitDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DealUnitDto> refVal_setResult;
...
void DealUnitDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DealUnitDto> DealUnitDtoEnvelope::getResult() const
{
    return m_Result;
}

void DealUnitDtoEnvelope::setResult(const std::shared_ptr<DealUnitDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
