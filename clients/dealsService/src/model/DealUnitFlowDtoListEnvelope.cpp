...
DealUnitFlowDtoListEnvelope::DealUnitFlowDtoListEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitFlowDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitFlowDtoListEnvelope::toJson() const
{
...
bool DealUnitFlowDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DealUnitFlowDto>> refVal_setResult;
...
void DealUnitFlowDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitFlowDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitFlowDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitFlowDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitFlowDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitFlowDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitFlowDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitFlowDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitFlowDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitFlowDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitFlowDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitFlowDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitFlowDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitFlowDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitFlowDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitFlowDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitFlowDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitFlowDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<DealUnitFlowDto>>& DealUnitFlowDtoListEnvelope::getResult()
{
    return m_Result;
}

void DealUnitFlowDtoListEnvelope::setResult(const std::vector<std::shared_ptr<DealUnitFlowDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitFlowDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitFlowDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
