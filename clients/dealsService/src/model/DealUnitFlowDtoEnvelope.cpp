...
DealUnitFlowDtoEnvelope::DealUnitFlowDtoEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitFlowDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitFlowDtoEnvelope::toJson() const
{
...
bool DealUnitFlowDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DealUnitFlowDto> refVal_setResult;
...
void DealUnitFlowDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitFlowDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitFlowDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitFlowDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitFlowDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitFlowDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitFlowDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitFlowDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitFlowDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitFlowDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitFlowDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitFlowDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitFlowDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitFlowDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitFlowDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitFlowDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitFlowDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitFlowDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitFlowDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitFlowDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitFlowDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitFlowDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitFlowDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitFlowDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitFlowDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitFlowDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitFlowDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitFlowDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitFlowDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitFlowDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitFlowDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitFlowDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitFlowDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitFlowDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DealUnitFlowDto> DealUnitFlowDtoEnvelope::getResult() const
{
    return m_Result;
}

void DealUnitFlowDtoEnvelope::setResult(const std::shared_ptr<DealUnitFlowDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitFlowDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitFlowDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
