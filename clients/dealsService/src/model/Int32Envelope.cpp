...
void Int32Envelope::validate()
{
    // TODO: implement validation
}

web::json::value Int32Envelope::toJson() const
{
...
bool Int32Envelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Int32Envelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Int32Envelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool Int32Envelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void Int32Envelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool Int32Envelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void Int32Envelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t Int32Envelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void Int32Envelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool Int32Envelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void Int32Envelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t Int32Envelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void Int32Envelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool Int32Envelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void Int32Envelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime Int32Envelope::getTimestamp() const
{
    return m_Timestamp;
}

void Int32Envelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool Int32Envelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void Int32Envelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t Int32Envelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void Int32Envelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool Int32Envelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void Int32Envelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t Int32Envelope::getErrorCode() const
{
    return m_ErrorCode;
}

void Int32Envelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool Int32Envelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void Int32Envelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& Int32Envelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void Int32Envelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool Int32Envelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void Int32Envelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t Int32Envelope::getActivityId() const
{
    return m_ActivityId;
}

void Int32Envelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool Int32Envelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void Int32Envelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
int32_t Int32Envelope::getResult() const
{
    return m_Result;
}

void Int32Envelope::setResult(int32_t value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Int32Envelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void Int32Envelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
