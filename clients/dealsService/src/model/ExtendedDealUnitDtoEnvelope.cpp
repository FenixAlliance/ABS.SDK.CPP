...
ExtendedDealUnitDtoEnvelope::ExtendedDealUnitDtoEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedDealUnitDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedDealUnitDtoEnvelope::toJson() const
{
...
bool ExtendedDealUnitDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExtendedDealUnitDto> refVal_setResult;
...
void ExtendedDealUnitDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedDealUnitDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedDealUnitDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedDealUnitDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedDealUnitDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedDealUnitDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedDealUnitDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedDealUnitDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedDealUnitDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedDealUnitDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedDealUnitDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedDealUnitDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedDealUnitDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedDealUnitDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedDealUnitDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedDealUnitDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedDealUnitDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedDealUnitDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExtendedDealUnitDto> ExtendedDealUnitDtoEnvelope::getResult() const
{
    return m_Result;
}

void ExtendedDealUnitDtoEnvelope::setResult(const std::shared_ptr<ExtendedDealUnitDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedDealUnitDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedDealUnitDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
