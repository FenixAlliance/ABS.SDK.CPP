...
DealUnitFlowStageDtoEnvelope::DealUnitFlowStageDtoEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitFlowStageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitFlowStageDtoEnvelope::toJson() const
{
...
bool DealUnitFlowStageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DealUnitFlowStageDto> refVal_setResult;
...
void DealUnitFlowStageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitFlowStageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitFlowStageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitFlowStageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitFlowStageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitFlowStageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitFlowStageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitFlowStageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitFlowStageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitFlowStageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitFlowStageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitFlowStageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitFlowStageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitFlowStageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitFlowStageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitFlowStageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitFlowStageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitFlowStageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DealUnitFlowStageDto> DealUnitFlowStageDtoEnvelope::getResult() const
{
    return m_Result;
}

void DealUnitFlowStageDtoEnvelope::setResult(const std::shared_ptr<DealUnitFlowStageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitFlowStageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitFlowStageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
