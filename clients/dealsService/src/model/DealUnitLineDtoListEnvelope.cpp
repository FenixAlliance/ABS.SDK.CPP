...
DealUnitLineDtoListEnvelope::DealUnitLineDtoListEnvelope()
{
    m_IsSuccess = false;
...
void DealUnitLineDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DealUnitLineDtoListEnvelope::toJson() const
{
...
bool DealUnitLineDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DealUnitLineDto>> refVal_setResult;
...
void DealUnitLineDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DealUnitLineDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DealUnitLineDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DealUnitLineDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DealUnitLineDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DealUnitLineDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DealUnitLineDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DealUnitLineDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DealUnitLineDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DealUnitLineDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DealUnitLineDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DealUnitLineDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DealUnitLineDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DealUnitLineDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DealUnitLineDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DealUnitLineDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DealUnitLineDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DealUnitLineDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DealUnitLineDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitLineDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitLineDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitLineDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitLineDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitLineDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitLineDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitLineDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitLineDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitLineDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitLineDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitLineDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DealUnitLineDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DealUnitLineDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DealUnitLineDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DealUnitLineDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<DealUnitLineDto>>& DealUnitLineDtoListEnvelope::getResult()
{
    return m_Result;
}

void DealUnitLineDtoListEnvelope::setResult(const std::vector<std::shared_ptr<DealUnitLineDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DealUnitLineDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DealUnitLineDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
