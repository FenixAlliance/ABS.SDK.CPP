...
int32_t DealUnitDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DealUnitDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DealUnitDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DealUnitDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DealUnitDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DealUnitDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DealUnitDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DealUnitDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DealUnitDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DealUnitDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DealUnitDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DealUnitDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
