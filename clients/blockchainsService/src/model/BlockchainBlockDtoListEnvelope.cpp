...
BlockchainBlockDtoListEnvelope::BlockchainBlockDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BlockchainBlockDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlockchainBlockDtoListEnvelope::toJson() const
{
...
bool BlockchainBlockDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BlockchainBlockDto>> refVal_setResult;
...
void BlockchainBlockDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlockchainBlockDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlockchainBlockDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlockchainBlockDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlockchainBlockDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlockchainBlockDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlockchainBlockDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlockchainBlockDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlockchainBlockDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlockchainBlockDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlockchainBlockDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlockchainBlockDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlockchainBlockDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlockchainBlockDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlockchainBlockDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlockchainBlockDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlockchainBlockDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlockchainBlockDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BlockchainBlockDto>>& BlockchainBlockDtoListEnvelope::getResult()
{
    return m_Result;
}

void BlockchainBlockDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BlockchainBlockDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlockchainBlockDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlockchainBlockDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
