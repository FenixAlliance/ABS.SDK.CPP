...
SocialFeedPostDtoListEnvelope::SocialFeedPostDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SocialFeedPostDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialFeedPostDtoListEnvelope::toJson() const
{
...
bool SocialFeedPostDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SocialFeedPostDto>> refVal_setResult;
...
void SocialFeedPostDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialFeedPostDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialFeedPostDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialFeedPostDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialFeedPostDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialFeedPostDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialFeedPostDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialFeedPostDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialFeedPostDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialFeedPostDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialFeedPostDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialFeedPostDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialFeedPostDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialFeedPostDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialFeedPostDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialFeedPostDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialFeedPostDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialFeedPostDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SocialFeedPostDto>>& SocialFeedPostDtoListEnvelope::getResult()
{
    return m_Result;
}

void SocialFeedPostDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SocialFeedPostDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialFeedPostDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialFeedPostDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
