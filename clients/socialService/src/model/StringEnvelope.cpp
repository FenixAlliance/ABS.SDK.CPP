...
void StringEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value StringEnvelope::toJson() const
{
...
bool StringEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void StringEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StringEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool StringEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void StringEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool StringEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void StringEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t StringEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void StringEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool StringEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void StringEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t StringEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void StringEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool StringEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void StringEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime StringEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void StringEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool StringEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void StringEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t StringEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void StringEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool StringEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void StringEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t StringEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void StringEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool StringEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void StringEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& StringEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void StringEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool StringEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void StringEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t StringEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void StringEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool StringEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void StringEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
utility::string_t StringEnvelope::getResult() const
{
    return m_Result;
}

void StringEnvelope::setResult(const utility::string_t& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StringEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void StringEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
