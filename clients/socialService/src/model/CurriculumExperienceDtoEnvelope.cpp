...
CurriculumExperienceDtoEnvelope::CurriculumExperienceDtoEnvelope()
{
    m_IsSuccess = false;
...
void CurriculumExperienceDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CurriculumExperienceDtoEnvelope::toJson() const
{
...
bool CurriculumExperienceDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CurriculumExperienceDto> refVal_setResult;
...
void CurriculumExperienceDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CurriculumExperienceDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CurriculumExperienceDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CurriculumExperienceDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CurriculumExperienceDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CurriculumExperienceDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CurriculumExperienceDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CurriculumExperienceDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CurriculumExperienceDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CurriculumExperienceDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CurriculumExperienceDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CurriculumExperienceDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CurriculumExperienceDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CurriculumExperienceDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CurriculumExperienceDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CurriculumExperienceDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CurriculumExperienceDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CurriculumExperienceDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CurriculumExperienceDto> CurriculumExperienceDtoEnvelope::getResult() const
{
    return m_Result;
}

void CurriculumExperienceDtoEnvelope::setResult(const std::shared_ptr<CurriculumExperienceDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CurriculumExperienceDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CurriculumExperienceDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
