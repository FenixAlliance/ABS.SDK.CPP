...
CurriculumDtoListEnvelope::CurriculumDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CurriculumDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CurriculumDtoListEnvelope::toJson() const
{
...
bool CurriculumDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CurriculumDto>> refVal_setResult;
...
void CurriculumDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CurriculumDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CurriculumDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CurriculumDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CurriculumDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CurriculumDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CurriculumDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CurriculumDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CurriculumDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CurriculumDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CurriculumDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CurriculumDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CurriculumDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CurriculumDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CurriculumDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CurriculumDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CurriculumDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CurriculumDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CurriculumDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CurriculumDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CurriculumDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CurriculumDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CurriculumDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CurriculumDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CurriculumDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CurriculumDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CurriculumDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CurriculumDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CurriculumDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CurriculumDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CurriculumDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CurriculumDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CurriculumDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CurriculumDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CurriculumDto>>& CurriculumDtoListEnvelope::getResult()
{
    return m_Result;
}

void CurriculumDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CurriculumDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CurriculumDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CurriculumDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
