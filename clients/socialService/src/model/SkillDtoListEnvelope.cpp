...
SkillDtoListEnvelope::SkillDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SkillDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SkillDtoListEnvelope::toJson() const
{
...
bool SkillDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SkillDto>> refVal_setResult;
...
void SkillDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SkillDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SkillDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SkillDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SkillDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SkillDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SkillDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SkillDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SkillDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SkillDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SkillDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SkillDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SkillDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SkillDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SkillDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SkillDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SkillDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SkillDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SkillDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SkillDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SkillDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SkillDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SkillDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SkillDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SkillDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SkillDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SkillDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SkillDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SkillDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SkillDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SkillDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SkillDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SkillDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SkillDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SkillDto>>& SkillDtoListEnvelope::getResult()
{
    return m_Result;
}

void SkillDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SkillDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SkillDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SkillDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
