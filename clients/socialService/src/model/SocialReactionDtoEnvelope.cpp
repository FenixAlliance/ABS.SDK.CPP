...
SocialReactionDtoEnvelope::SocialReactionDtoEnvelope()
{
    m_IsSuccess = false;
...
void SocialReactionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialReactionDtoEnvelope::toJson() const
{
...
bool SocialReactionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SocialReactionDto> refVal_setResult;
...
void SocialReactionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialReactionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialReactionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialReactionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialReactionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialReactionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialReactionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialReactionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialReactionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialReactionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialReactionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialReactionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialReactionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialReactionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialReactionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialReactionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialReactionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialReactionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialReactionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialReactionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialReactionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialReactionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialReactionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialReactionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialReactionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialReactionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialReactionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialReactionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialReactionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialReactionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialReactionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialReactionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialReactionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialReactionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SocialReactionDto> SocialReactionDtoEnvelope::getResult() const
{
    return m_Result;
}

void SocialReactionDtoEnvelope::setResult(const std::shared_ptr<SocialReactionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialReactionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialReactionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
