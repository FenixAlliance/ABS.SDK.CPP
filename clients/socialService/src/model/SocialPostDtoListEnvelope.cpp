...
int32_t SocialPostDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialPostDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialPostDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialPostDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialPostDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialPostDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialPostDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialPostDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialPostDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialPostDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialPostDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialPostDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
