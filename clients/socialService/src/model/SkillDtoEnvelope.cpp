...
SkillDtoEnvelope::SkillDtoEnvelope()
{
    m_IsSuccess = false;
...
void SkillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SkillDtoEnvelope::toJson() const
{
...
bool SkillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SkillDto> refVal_setResult;
...
void SkillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SkillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SkillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SkillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SkillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SkillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SkillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SkillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SkillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SkillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SkillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SkillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SkillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SkillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SkillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SkillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SkillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SkillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SkillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SkillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SkillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SkillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SkillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SkillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SkillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SkillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SkillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SkillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SkillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SkillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SkillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SkillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SkillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SkillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SkillDto> SkillDtoEnvelope::getResult() const
{
    return m_Result;
}

void SkillDtoEnvelope::setResult(const std::shared_ptr<SkillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SkillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SkillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
