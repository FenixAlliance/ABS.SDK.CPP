...
PrivateMessageDtoListEnvelope::PrivateMessageDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PrivateMessageDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PrivateMessageDtoListEnvelope::toJson() const
{
...
bool PrivateMessageDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PrivateMessageDto>> refVal_setResult;
...
void PrivateMessageDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PrivateMessageDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PrivateMessageDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PrivateMessageDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PrivateMessageDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PrivateMessageDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PrivateMessageDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PrivateMessageDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PrivateMessageDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PrivateMessageDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PrivateMessageDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PrivateMessageDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PrivateMessageDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PrivateMessageDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PrivateMessageDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PrivateMessageDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PrivateMessageDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PrivateMessageDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PrivateMessageDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PrivateMessageDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PrivateMessageDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PrivateMessageDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PrivateMessageDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PrivateMessageDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PrivateMessageDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PrivateMessageDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PrivateMessageDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PrivateMessageDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PrivateMessageDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PrivateMessageDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PrivateMessageDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PrivateMessageDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PrivateMessageDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PrivateMessageDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PrivateMessageDto>>& PrivateMessageDtoListEnvelope::getResult()
{
    return m_Result;
}

void PrivateMessageDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PrivateMessageDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PrivateMessageDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PrivateMessageDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
