...
SocialFeedDtoEnvelope::SocialFeedDtoEnvelope()
{
    m_IsSuccess = false;
...
void SocialFeedDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialFeedDtoEnvelope::toJson() const
{
...
bool SocialFeedDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SocialFeedDto> refVal_setResult;
...
void SocialFeedDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialFeedDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialFeedDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialFeedDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialFeedDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialFeedDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialFeedDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialFeedDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialFeedDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialFeedDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialFeedDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialFeedDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialFeedDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialFeedDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialFeedDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialFeedDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialFeedDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialFeedDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialFeedDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialFeedDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialFeedDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialFeedDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialFeedDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialFeedDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialFeedDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialFeedDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialFeedDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialFeedDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialFeedDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialFeedDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialFeedDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialFeedDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialFeedDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialFeedDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SocialFeedDto> SocialFeedDtoEnvelope::getResult() const
{
    return m_Result;
}

void SocialFeedDtoEnvelope::setResult(const std::shared_ptr<SocialFeedDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialFeedDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialFeedDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
