...
SocialPostDtoEnvelope::SocialPostDtoEnvelope()
{
    m_IsSuccess = false;
...
void SocialPostDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialPostDtoEnvelope::toJson() const
{
...
bool SocialPostDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SocialPostDto> refVal_setResult;
...
void SocialPostDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialPostDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialPostDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialPostDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialPostDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialPostDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialPostDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialPostDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialPostDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialPostDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialPostDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialPostDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialPostDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialPostDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialPostDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialPostDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialPostDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialPostDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialPostDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialPostDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialPostDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialPostDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialPostDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialPostDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialPostDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialPostDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialPostDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialPostDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialPostDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialPostDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialPostDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialPostDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialPostDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialPostDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SocialPostDto> SocialPostDtoEnvelope::getResult() const
{
    return m_Result;
}

void SocialPostDtoEnvelope::setResult(const std::shared_ptr<SocialPostDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialPostDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialPostDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
