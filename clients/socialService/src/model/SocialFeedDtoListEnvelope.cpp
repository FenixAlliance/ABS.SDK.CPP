...
SocialFeedDtoListEnvelope::SocialFeedDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SocialFeedDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialFeedDtoListEnvelope::toJson() const
{
...
bool SocialFeedDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SocialFeedDto>> refVal_setResult;
...
void SocialFeedDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialFeedDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialFeedDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialFeedDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialFeedDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialFeedDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialFeedDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialFeedDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialFeedDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialFeedDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialFeedDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialFeedDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialFeedDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialFeedDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialFeedDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialFeedDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialFeedDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialFeedDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialFeedDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialFeedDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialFeedDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialFeedDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialFeedDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialFeedDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialFeedDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialFeedDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialFeedDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialFeedDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialFeedDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialFeedDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialFeedDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialFeedDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialFeedDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialFeedDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SocialFeedDto>>& SocialFeedDtoListEnvelope::getResult()
{
    return m_Result;
}

void SocialFeedDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SocialFeedDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialFeedDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialFeedDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
