...
SocialGroupDtoListEnvelope::SocialGroupDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SocialGroupDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialGroupDtoListEnvelope::toJson() const
{
...
bool SocialGroupDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SocialGroupDto>> refVal_setResult;
...
void SocialGroupDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialGroupDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialGroupDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialGroupDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialGroupDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialGroupDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialGroupDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialGroupDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialGroupDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialGroupDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialGroupDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialGroupDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialGroupDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialGroupDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialGroupDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialGroupDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialGroupDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialGroupDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialGroupDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialGroupDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialGroupDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialGroupDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialGroupDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialGroupDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialGroupDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialGroupDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialGroupDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialGroupDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialGroupDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialGroupDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialGroupDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialGroupDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialGroupDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialGroupDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SocialGroupDto>>& SocialGroupDtoListEnvelope::getResult()
{
    return m_Result;
}

void SocialGroupDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SocialGroupDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialGroupDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialGroupDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
