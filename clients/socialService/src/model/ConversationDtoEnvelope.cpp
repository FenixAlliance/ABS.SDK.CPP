...
ConversationDtoEnvelope::ConversationDtoEnvelope()
{
    m_IsSuccess = false;
...
void ConversationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ConversationDtoEnvelope::toJson() const
{
...
bool ConversationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ConversationDto> refVal_setResult;
...
void ConversationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ConversationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ConversationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ConversationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ConversationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ConversationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ConversationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ConversationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ConversationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ConversationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ConversationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ConversationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ConversationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ConversationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ConversationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ConversationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ConversationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ConversationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ConversationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ConversationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ConversationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ConversationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ConversationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ConversationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ConversationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ConversationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ConversationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ConversationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ConversationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ConversationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ConversationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ConversationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ConversationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ConversationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ConversationDto> ConversationDtoEnvelope::getResult() const
{
    return m_Result;
}

void ConversationDtoEnvelope::setResult(const std::shared_ptr<ConversationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ConversationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ConversationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
