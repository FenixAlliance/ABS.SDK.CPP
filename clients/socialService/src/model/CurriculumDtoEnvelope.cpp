...
CurriculumDtoEnvelope::CurriculumDtoEnvelope()
{
    m_IsSuccess = false;
...
void CurriculumDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CurriculumDtoEnvelope::toJson() const
{
...
bool CurriculumDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CurriculumDto> refVal_setResult;
...
void CurriculumDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CurriculumDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CurriculumDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CurriculumDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CurriculumDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CurriculumDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CurriculumDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CurriculumDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CurriculumDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CurriculumDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CurriculumDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CurriculumDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CurriculumDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CurriculumDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CurriculumDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CurriculumDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CurriculumDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CurriculumDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CurriculumDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CurriculumDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CurriculumDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CurriculumDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CurriculumDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CurriculumDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CurriculumDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CurriculumDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CurriculumDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CurriculumDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CurriculumDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CurriculumDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CurriculumDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CurriculumDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CurriculumDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CurriculumDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CurriculumDto> CurriculumDtoEnvelope::getResult() const
{
    return m_Result;
}

void CurriculumDtoEnvelope::setResult(const std::shared_ptr<CurriculumDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CurriculumDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CurriculumDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
