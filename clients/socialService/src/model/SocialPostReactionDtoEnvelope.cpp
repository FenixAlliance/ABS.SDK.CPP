...
SocialPostReactionDtoEnvelope::SocialPostReactionDtoEnvelope()
{
    m_IsSuccess = false;
...
void SocialPostReactionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SocialPostReactionDtoEnvelope::toJson() const
{
...
bool SocialPostReactionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SocialPostReactionDto> refVal_setResult;
...
void SocialPostReactionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SocialPostReactionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SocialPostReactionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SocialPostReactionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SocialPostReactionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SocialPostReactionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SocialPostReactionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SocialPostReactionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SocialPostReactionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SocialPostReactionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SocialPostReactionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SocialPostReactionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SocialPostReactionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SocialPostReactionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SocialPostReactionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SocialPostReactionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SocialPostReactionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SocialPostReactionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SocialPostReactionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SocialPostReactionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SocialPostReactionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SocialPostReactionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SocialPostReactionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SocialPostReactionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SocialPostReactionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SocialPostReactionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SocialPostReactionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SocialPostReactionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SocialPostReactionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SocialPostReactionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SocialPostReactionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SocialPostReactionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SocialPostReactionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SocialPostReactionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SocialPostReactionDto> SocialPostReactionDtoEnvelope::getResult() const
{
    return m_Result;
}

void SocialPostReactionDtoEnvelope::setResult(const std::shared_ptr<SocialPostReactionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SocialPostReactionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SocialPostReactionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
