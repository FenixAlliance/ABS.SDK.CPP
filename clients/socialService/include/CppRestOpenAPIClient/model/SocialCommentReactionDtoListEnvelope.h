...
/*
 * SocialCommentReactionDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SocialCommentReactionDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SocialCommentReactionDtoListEnvelope_H_
...
public:
    ...
    virtual ~SocialCommentReactionDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// SocialCommentReactionDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SocialCommentReactionDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<SocialCommentReactionDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SocialCommentReactionDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SocialCommentReactionDtoListEnvelope_H_ */
