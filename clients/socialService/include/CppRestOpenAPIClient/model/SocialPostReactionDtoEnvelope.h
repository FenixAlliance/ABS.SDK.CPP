...
/*
 * SocialPostReactionDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SocialPostReactionDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SocialPostReactionDtoEnvelope_H_
...
public:
    ...
    virtual ~SocialPostReactionDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// SocialPostReactionDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<SocialPostReactionDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<SocialPostReactionDto>& value);
...
protected:
    ...
    std::shared_ptr<SocialPostReactionDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SocialPostReactionDtoEnvelope_H_ */
