...
/*
 * CurriculumExperienceDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CurriculumExperienceDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CurriculumExperienceDtoListEnvelope_H_
...
public:
    ...
    virtual ~CurriculumExperienceDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CurriculumExperienceDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CurriculumExperienceDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CurriculumExperienceDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CurriculumExperienceDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CurriculumExperienceDtoListEnvelope_H_ */
