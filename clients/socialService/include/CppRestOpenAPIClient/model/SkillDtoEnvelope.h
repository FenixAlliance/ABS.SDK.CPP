...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SkillDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SkillDtoEnvelope_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<SkillDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<SkillDto>& value);
...
protected:
    ...
    std::shared_ptr<SkillDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SkillDtoEnvelope_H_ */
