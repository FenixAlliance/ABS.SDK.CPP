...
FileUploadDtoEnvelope::FileUploadDtoEnvelope()
{
    m_IsSuccess = false;
...
void FileUploadDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FileUploadDtoEnvelope::toJson() const
{
...
bool FileUploadDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FileUploadDto> refVal_setResult;
...
void FileUploadDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FileUploadDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FileUploadDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FileUploadDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FileUploadDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FileUploadDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FileUploadDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FileUploadDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FileUploadDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FileUploadDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FileUploadDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FileUploadDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FileUploadDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FileUploadDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FileUploadDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FileUploadDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FileUploadDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FileUploadDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FileUploadDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FileUploadDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FileUploadDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FileUploadDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FileUploadDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FileUploadDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FileUploadDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FileUploadDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FileUploadDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FileUploadDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FileUploadDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FileUploadDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FileUploadDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FileUploadDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FileUploadDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FileUploadDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<FileUploadDto> FileUploadDtoEnvelope::getResult() const
{
    return m_Result;
}

void FileUploadDtoEnvelope::setResult(const std::shared_ptr<FileUploadDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FileUploadDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FileUploadDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
