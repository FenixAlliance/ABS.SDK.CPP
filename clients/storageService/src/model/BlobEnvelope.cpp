...
void BlobEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlobEnvelope::toJson() const
{
...
bool BlobEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Blob> refVal_setResult;
...
void BlobEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlobEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlobEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlobEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlobEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlobEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlobEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlobEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlobEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlobEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlobEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlobEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlobEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlobEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlobEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlobEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlobEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlobEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlobEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlobEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlobEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlobEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlobEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlobEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlobEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlobEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlobEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlobEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlobEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlobEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlobEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlobEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlobEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlobEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<Blob> BlobEnvelope::getResult() const
{
    return m_Result;
}

void BlobEnvelope::setResult(const std::shared_ptr<Blob>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlobEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlobEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
