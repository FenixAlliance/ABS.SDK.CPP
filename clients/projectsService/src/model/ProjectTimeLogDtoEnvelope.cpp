...
ProjectTimeLogDtoEnvelope::ProjectTimeLogDtoEnvelope()
{
    m_IsSuccess = false;
...
void ProjectTimeLogDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProjectTimeLogDtoEnvelope::toJson() const
{
...
bool ProjectTimeLogDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ProjectTimeLogDto> refVal_setResult;
...
void ProjectTimeLogDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectTimeLogDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProjectTimeLogDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProjectTimeLogDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProjectTimeLogDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProjectTimeLogDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProjectTimeLogDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProjectTimeLogDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProjectTimeLogDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectTimeLogDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProjectTimeLogDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProjectTimeLogDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProjectTimeLogDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProjectTimeLogDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProjectTimeLogDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProjectTimeLogDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProjectTimeLogDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProjectTimeLogDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ProjectTimeLogDto> ProjectTimeLogDtoEnvelope::getResult() const
{
    return m_Result;
}

void ProjectTimeLogDtoEnvelope::setResult(const std::shared_ptr<ProjectTimeLogDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProjectTimeLogDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProjectTimeLogDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
