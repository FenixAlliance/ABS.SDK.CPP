...
ProjectTaskDtoListEnvelope::ProjectTaskDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ProjectTaskDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProjectTaskDtoListEnvelope::toJson() const
{
...
bool ProjectTaskDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ProjectTaskDto>> refVal_setResult;
...
void ProjectTaskDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectTaskDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProjectTaskDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProjectTaskDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProjectTaskDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProjectTaskDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProjectTaskDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProjectTaskDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProjectTaskDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProjectTaskDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProjectTaskDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProjectTaskDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProjectTaskDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProjectTaskDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProjectTaskDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectTaskDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectTaskDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectTaskDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProjectTaskDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProjectTaskDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProjectTaskDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProjectTaskDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProjectTaskDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProjectTaskDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProjectTaskDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProjectTaskDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProjectTaskDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProjectTaskDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProjectTaskDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProjectTaskDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProjectTaskDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProjectTaskDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProjectTaskDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProjectTaskDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ProjectTaskDto>>& ProjectTaskDtoListEnvelope::getResult()
{
    return m_Result;
}

void ProjectTaskDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ProjectTaskDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProjectTaskDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProjectTaskDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
