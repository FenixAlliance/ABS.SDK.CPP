...
ProjectTaskDtoEnvelope::ProjectTaskDtoEnvelope()
{
    m_IsSuccess = false;
...
void ProjectTaskDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProjectTaskDtoEnvelope::toJson() const
{
...
bool ProjectTaskDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ProjectTaskDto> refVal_setResult;
...
void ProjectTaskDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectTaskDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProjectTaskDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProjectTaskDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProjectTaskDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProjectTaskDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProjectTaskDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProjectTaskDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProjectTaskDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProjectTaskDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProjectTaskDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProjectTaskDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProjectTaskDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProjectTaskDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProjectTaskDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectTaskDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectTaskDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectTaskDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProjectTaskDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProjectTaskDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProjectTaskDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProjectTaskDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProjectTaskDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProjectTaskDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProjectTaskDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProjectTaskDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProjectTaskDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProjectTaskDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProjectTaskDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProjectTaskDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProjectTaskDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProjectTaskDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProjectTaskDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProjectTaskDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ProjectTaskDto> ProjectTaskDtoEnvelope::getResult() const
{
    return m_Result;
}

void ProjectTaskDtoEnvelope::setResult(const std::shared_ptr<ProjectTaskDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProjectTaskDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProjectTaskDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
