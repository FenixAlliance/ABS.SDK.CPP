...
ProjectDtoEnvelope::ProjectDtoEnvelope()
{
    m_IsSuccess = false;
...
void ProjectDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProjectDtoEnvelope::toJson() const
{
...
bool ProjectDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ProjectDto> refVal_setResult;
...
void ProjectDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProjectDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProjectDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProjectDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProjectDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProjectDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProjectDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProjectDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProjectDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProjectDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProjectDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProjectDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProjectDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProjectDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProjectDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProjectDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProjectDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProjectDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProjectDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProjectDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProjectDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProjectDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProjectDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProjectDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProjectDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProjectDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProjectDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProjectDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProjectDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProjectDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ProjectDto> ProjectDtoEnvelope::getResult() const
{
    return m_Result;
}

void ProjectDtoEnvelope::setResult(const std::shared_ptr<ProjectDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProjectDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProjectDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
