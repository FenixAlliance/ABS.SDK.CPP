...
ProjectPeriodDtoListEnvelope::ProjectPeriodDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ProjectPeriodDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProjectPeriodDtoListEnvelope::toJson() const
{
...
bool ProjectPeriodDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ProjectPeriodDto>> refVal_setResult;
...
void ProjectPeriodDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectPeriodDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProjectPeriodDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProjectPeriodDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProjectPeriodDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProjectPeriodDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProjectPeriodDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProjectPeriodDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProjectPeriodDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectPeriodDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProjectPeriodDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProjectPeriodDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProjectPeriodDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProjectPeriodDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProjectPeriodDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProjectPeriodDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProjectPeriodDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProjectPeriodDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ProjectPeriodDto>>& ProjectPeriodDtoListEnvelope::getResult()
{
    return m_Result;
}

void ProjectPeriodDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ProjectPeriodDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProjectPeriodDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProjectPeriodDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
