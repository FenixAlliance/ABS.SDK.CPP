...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_TimeLogsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TimeLogsApi_H_
...
public:
    ...
    explicit TimeLogsApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TimeLogsApi_H_ */
