...
/*
 * TaskCategoryDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TaskCategoryDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TaskCategoryDtoListEnvelope_H_
...
public:
    ...
    virtual ~TaskCategoryDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// TaskCategoryDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TaskCategoryDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<TaskCategoryDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<TaskCategoryDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TaskCategoryDtoListEnvelope_H_ */
