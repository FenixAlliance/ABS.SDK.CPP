...
/*
 * LicenseDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseDtoListEnvelope_H_
...
public:
    ...
    virtual ~LicenseDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// LicenseDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LicenseDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<LicenseDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<LicenseDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseDtoListEnvelope_H_ */
