...
/*
 * LicenseTypeDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseTypeDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseTypeDtoListEnvelope_H_
...
public:
    ...
    virtual ~LicenseTypeDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// LicenseTypeDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LicenseTypeDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<LicenseTypeDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<LicenseTypeDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseTypeDtoListEnvelope_H_ */
