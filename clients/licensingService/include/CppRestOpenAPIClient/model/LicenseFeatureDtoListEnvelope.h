...
/*
 * LicenseFeatureDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseFeatureDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseFeatureDtoListEnvelope_H_
...
public:
    ...
    virtual ~LicenseFeatureDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// LicenseFeatureDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LicenseFeatureDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<LicenseFeatureDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<LicenseFeatureDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LicenseFeatureDtoListEnvelope_H_ */
