...
LicenseTypeDtoListEnvelope::LicenseTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void LicenseTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LicenseTypeDtoListEnvelope::toJson() const
{
...
bool LicenseTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<LicenseTypeDto>> refVal_setResult;
...
void LicenseTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LicenseTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LicenseTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LicenseTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LicenseTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LicenseTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LicenseTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LicenseTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LicenseTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LicenseTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LicenseTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LicenseTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LicenseTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LicenseTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LicenseTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LicenseTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LicenseTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LicenseTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LicenseTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LicenseTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LicenseTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LicenseTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LicenseTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LicenseTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LicenseTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LicenseTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LicenseTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LicenseTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LicenseTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LicenseTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LicenseTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LicenseTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LicenseTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LicenseTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<LicenseTypeDto>>& LicenseTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void LicenseTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<LicenseTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LicenseTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LicenseTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
