...
void LicenseUpdateDto::validate()
{
    // TODO: implement validation
}

web::json::value LicenseUpdateDto::toJson() const
{
...
bool LicenseUpdateDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LicenseUpdateDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LicenseUpdateDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t LicenseUpdateDto::getTitle() const
{
    return m_Title;
}

void LicenseUpdateDto::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool LicenseUpdateDto::titleIsSet() const
{
    return m_TitleIsSet;
}

void LicenseUpdateDto::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t LicenseUpdateDto::getDescription() const
{
    return m_Description;
}

void LicenseUpdateDto::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool LicenseUpdateDto::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void LicenseUpdateDto::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t LicenseUpdateDto::getCode() const
{
    return m_Code;
}

void LicenseUpdateDto::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool LicenseUpdateDto::codeIsSet() const
{
    return m_CodeIsSet;
}

void LicenseUpdateDto::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t LicenseUpdateDto::getLicenseTypeId() const
{
    return m_LicenseTypeId;
}

void LicenseUpdateDto::setLicenseTypeId(const utility::string_t& value)
{
    m_LicenseTypeId = value;
    m_LicenseTypeIdIsSet = true;
}

bool LicenseUpdateDto::licenseTypeIdIsSet() const
{
    return m_LicenseTypeIdIsSet;
}

void LicenseUpdateDto::unsetLicenseTypeId()
{
    m_LicenseTypeIdIsSet = false;
}
}
