...
CurrencyDtoListEnvelope::CurrencyDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CurrencyDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CurrencyDtoListEnvelope::toJson() const
{
...
bool CurrencyDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CurrencyDto>> refVal_setResult;
...
void CurrencyDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CurrencyDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CurrencyDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CurrencyDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CurrencyDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CurrencyDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CurrencyDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CurrencyDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CurrencyDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CurrencyDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CurrencyDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CurrencyDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CurrencyDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CurrencyDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CurrencyDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CurrencyDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CurrencyDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CurrencyDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CurrencyDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CurrencyDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CurrencyDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CurrencyDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CurrencyDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CurrencyDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CurrencyDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CurrencyDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CurrencyDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CurrencyDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CurrencyDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CurrencyDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CurrencyDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CurrencyDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CurrencyDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CurrencyDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CurrencyDto>>& CurrencyDtoListEnvelope::getResult()
{
    return m_Result;
}

void CurrencyDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CurrencyDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CurrencyDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CurrencyDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
