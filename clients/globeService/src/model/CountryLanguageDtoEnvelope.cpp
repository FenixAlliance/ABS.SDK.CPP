...
CountryLanguageDtoEnvelope::CountryLanguageDtoEnvelope()
{
    m_IsSuccess = false;
...
void CountryLanguageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountryLanguageDtoEnvelope::toJson() const
{
...
bool CountryLanguageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CountryLanguageDto> refVal_setResult;
...
void CountryLanguageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountryLanguageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountryLanguageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountryLanguageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountryLanguageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountryLanguageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountryLanguageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountryLanguageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountryLanguageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountryLanguageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountryLanguageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountryLanguageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountryLanguageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountryLanguageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountryLanguageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountryLanguageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountryLanguageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountryLanguageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountryLanguageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountryLanguageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountryLanguageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountryLanguageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountryLanguageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountryLanguageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountryLanguageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountryLanguageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountryLanguageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountryLanguageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountryLanguageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountryLanguageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountryLanguageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountryLanguageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountryLanguageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountryLanguageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CountryLanguageDto> CountryLanguageDtoEnvelope::getResult() const
{
    return m_Result;
}

void CountryLanguageDtoEnvelope::setResult(const std::shared_ptr<CountryLanguageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountryLanguageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountryLanguageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
