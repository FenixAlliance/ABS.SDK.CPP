...
CountryStateDtoListEnvelope::CountryStateDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CountryStateDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountryStateDtoListEnvelope::toJson() const
{
...
bool CountryStateDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CountryStateDto>> refVal_setResult;
...
void CountryStateDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountryStateDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountryStateDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountryStateDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountryStateDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountryStateDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountryStateDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountryStateDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountryStateDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountryStateDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountryStateDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountryStateDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountryStateDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountryStateDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountryStateDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountryStateDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountryStateDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountryStateDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountryStateDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountryStateDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountryStateDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountryStateDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountryStateDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountryStateDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountryStateDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountryStateDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountryStateDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountryStateDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountryStateDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountryStateDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountryStateDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountryStateDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountryStateDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountryStateDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CountryStateDto>>& CountryStateDtoListEnvelope::getResult()
{
    return m_Result;
}

void CountryStateDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CountryStateDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountryStateDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountryStateDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
