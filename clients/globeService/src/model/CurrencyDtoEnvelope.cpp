...
CurrencyDtoEnvelope::CurrencyDtoEnvelope()
{
    m_IsSuccess = false;
...
void CurrencyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CurrencyDtoEnvelope::toJson() const
{
...
bool CurrencyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CurrencyDto> refVal_setResult;
...
void CurrencyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CurrencyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CurrencyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CurrencyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CurrencyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CurrencyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CurrencyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CurrencyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CurrencyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CurrencyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CurrencyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CurrencyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CurrencyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CurrencyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CurrencyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CurrencyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CurrencyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CurrencyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CurrencyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CurrencyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CurrencyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CurrencyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CurrencyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CurrencyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CurrencyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CurrencyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CurrencyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CurrencyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CurrencyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CurrencyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CurrencyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CurrencyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CurrencyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CurrencyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CurrencyDto> CurrencyDtoEnvelope::getResult() const
{
    return m_Result;
}

void CurrencyDtoEnvelope::setResult(const std::shared_ptr<CurrencyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CurrencyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CurrencyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
