...
CityDtoListEnvelope::CityDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CityDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CityDtoListEnvelope::toJson() const
{
...
bool CityDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CityDto>> refVal_setResult;
...
void CityDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CityDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CityDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CityDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CityDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CityDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CityDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CityDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CityDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CityDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CityDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CityDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CityDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CityDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CityDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CityDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CityDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CityDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CityDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CityDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CityDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CityDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CityDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CityDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CityDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CityDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CityDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CityDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CityDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CityDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CityDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CityDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CityDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CityDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CityDto>>& CityDtoListEnvelope::getResult()
{
    return m_Result;
}

void CityDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CityDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CityDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CityDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
