...
CountryStateDtoEnvelope::CountryStateDtoEnvelope()
{
    m_IsSuccess = false;
...
void CountryStateDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountryStateDtoEnvelope::toJson() const
{
...
bool CountryStateDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CountryStateDto> refVal_setResult;
...
void CountryStateDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountryStateDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountryStateDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountryStateDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountryStateDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountryStateDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountryStateDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountryStateDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountryStateDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountryStateDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountryStateDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountryStateDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountryStateDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountryStateDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountryStateDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountryStateDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountryStateDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountryStateDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountryStateDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountryStateDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountryStateDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountryStateDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountryStateDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountryStateDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountryStateDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountryStateDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountryStateDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountryStateDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountryStateDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountryStateDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountryStateDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountryStateDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountryStateDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountryStateDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CountryStateDto> CountryStateDtoEnvelope::getResult() const
{
    return m_Result;
}

void CountryStateDtoEnvelope::setResult(const std::shared_ptr<CountryStateDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountryStateDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountryStateDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
