...
CountryDtoListEnvelope::CountryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CountryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountryDtoListEnvelope::toJson() const
{
...
bool CountryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CountryDto>> refVal_setResult;
...
void CountryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CountryDto>>& CountryDtoListEnvelope::getResult()
{
    return m_Result;
}

void CountryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CountryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
