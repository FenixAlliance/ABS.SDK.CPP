...
TimezoneDtoEnvelope::TimezoneDtoEnvelope()
{
    m_IsSuccess = false;
...
void TimezoneDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TimezoneDtoEnvelope::toJson() const
{
...
bool TimezoneDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TimezoneDto> refVal_setResult;
...
void TimezoneDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TimezoneDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TimezoneDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TimezoneDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TimezoneDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TimezoneDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TimezoneDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TimezoneDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TimezoneDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TimezoneDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TimezoneDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TimezoneDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TimezoneDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TimezoneDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TimezoneDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TimezoneDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TimezoneDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TimezoneDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TimezoneDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TimezoneDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TimezoneDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TimezoneDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TimezoneDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TimezoneDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TimezoneDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TimezoneDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TimezoneDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TimezoneDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TimezoneDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TimezoneDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TimezoneDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TimezoneDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TimezoneDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TimezoneDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TimezoneDto> TimezoneDtoEnvelope::getResult() const
{
    return m_Result;
}

void TimezoneDtoEnvelope::setResult(const std::shared_ptr<TimezoneDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TimezoneDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TimezoneDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
