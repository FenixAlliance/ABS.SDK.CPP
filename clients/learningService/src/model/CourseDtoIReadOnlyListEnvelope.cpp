...
CourseDtoIReadOnlyListEnvelope::CourseDtoIReadOnlyListEnvelope()
{
    m_IsSuccess = false;
...
void CourseDtoIReadOnlyListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CourseDtoIReadOnlyListEnvelope::toJson() const
{
...
bool CourseDtoIReadOnlyListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CourseDto>> refVal_setResult;
...
void CourseDtoIReadOnlyListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CourseDtoIReadOnlyListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CourseDtoIReadOnlyListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CourseDtoIReadOnlyListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CourseDtoIReadOnlyListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CourseDtoIReadOnlyListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CourseDtoIReadOnlyListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CourseDtoIReadOnlyListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CourseDtoIReadOnlyListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CourseDtoIReadOnlyListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CourseDtoIReadOnlyListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CourseDtoIReadOnlyListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CourseDtoIReadOnlyListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CourseDtoIReadOnlyListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CourseDtoIReadOnlyListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CourseDtoIReadOnlyListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CourseDtoIReadOnlyListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CourseDtoIReadOnlyListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CourseDto>>& CourseDtoIReadOnlyListEnvelope::getResult()
{
    return m_Result;
}

void CourseDtoIReadOnlyListEnvelope::setResult(const std::vector<std::shared_ptr<CourseDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CourseDtoIReadOnlyListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CourseDtoIReadOnlyListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
