...
utility::string_t CourseNewsDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void CourseNewsDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool CourseNewsDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void CourseNewsDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
