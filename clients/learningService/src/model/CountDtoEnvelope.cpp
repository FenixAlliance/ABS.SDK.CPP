...
CountDtoEnvelope::CountDtoEnvelope()
{
    m_IsSuccess = false;
...
void CountDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountDtoEnvelope::toJson() const
{
...
bool CountDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CountDto> refVal_setResult;
...
void CountDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CountDto> CountDtoEnvelope::getResult() const
{
    return m_Result;
}

void CountDtoEnvelope::setResult(const std::shared_ptr<CountDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
