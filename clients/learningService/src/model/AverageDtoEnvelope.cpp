...
AverageDtoEnvelope::AverageDtoEnvelope()
{
    m_IsSuccess = false;
...
void AverageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AverageDtoEnvelope::toJson() const
{
...
bool AverageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AverageDto> refVal_setResult;
...
void AverageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AverageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AverageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AverageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AverageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AverageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AverageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AverageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AverageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AverageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AverageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AverageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AverageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AverageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AverageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AverageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AverageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AverageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AverageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AverageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AverageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AverageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AverageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AverageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AverageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AverageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AverageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AverageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AverageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AverageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AverageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AverageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AverageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AverageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AverageDto> AverageDtoEnvelope::getResult() const
{
    return m_Result;
}

void AverageDtoEnvelope::setResult(const std::shared_ptr<AverageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AverageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AverageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
