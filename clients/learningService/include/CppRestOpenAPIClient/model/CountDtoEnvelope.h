...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CountDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CountDtoEnvelope_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<CountDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<CountDto>& value);
...
protected:
    ...
    std::shared_ptr<CountDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CountDtoEnvelope_H_ */
