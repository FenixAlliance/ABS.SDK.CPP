...
WarehouseDtoEnvelope::WarehouseDtoEnvelope()
{
    m_IsSuccess = false;
...
void WarehouseDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WarehouseDtoEnvelope::toJson() const
{
...
bool WarehouseDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WarehouseDto> refVal_setResult;
...
void WarehouseDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WarehouseDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WarehouseDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WarehouseDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WarehouseDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WarehouseDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WarehouseDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WarehouseDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WarehouseDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WarehouseDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WarehouseDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WarehouseDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WarehouseDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WarehouseDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WarehouseDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WarehouseDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WarehouseDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WarehouseDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WarehouseDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WarehouseDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WarehouseDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WarehouseDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WarehouseDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WarehouseDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WarehouseDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WarehouseDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WarehouseDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WarehouseDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WarehouseDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WarehouseDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WarehouseDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WarehouseDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WarehouseDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WarehouseDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WarehouseDto> WarehouseDtoEnvelope::getResult() const
{
    return m_Result;
}

void WarehouseDtoEnvelope::setResult(const std::shared_ptr<WarehouseDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WarehouseDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WarehouseDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
