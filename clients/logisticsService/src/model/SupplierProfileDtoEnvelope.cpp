...
SupplierProfileDtoEnvelope::SupplierProfileDtoEnvelope()
{
    m_IsSuccess = false;
...
void SupplierProfileDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupplierProfileDtoEnvelope::toJson() const
{
...
bool SupplierProfileDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SupplierProfileDto> refVal_setResult;
...
void SupplierProfileDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupplierProfileDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupplierProfileDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupplierProfileDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupplierProfileDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupplierProfileDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupplierProfileDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupplierProfileDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupplierProfileDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupplierProfileDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupplierProfileDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupplierProfileDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupplierProfileDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupplierProfileDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupplierProfileDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupplierProfileDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupplierProfileDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupplierProfileDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupplierProfileDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupplierProfileDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupplierProfileDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupplierProfileDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupplierProfileDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupplierProfileDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupplierProfileDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupplierProfileDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupplierProfileDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupplierProfileDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupplierProfileDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupplierProfileDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupplierProfileDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupplierProfileDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupplierProfileDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupplierProfileDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SupplierProfileDto> SupplierProfileDtoEnvelope::getResult() const
{
    return m_Result;
}

void SupplierProfileDtoEnvelope::setResult(const std::shared_ptr<SupplierProfileDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupplierProfileDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupplierProfileDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
