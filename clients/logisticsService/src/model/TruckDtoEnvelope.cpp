...
TruckDtoEnvelope::TruckDtoEnvelope()
{
    m_IsSuccess = false;
...
void TruckDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TruckDtoEnvelope::toJson() const
{
...
bool TruckDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TruckDto> refVal_setResult;
...
void TruckDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TruckDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TruckDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TruckDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TruckDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TruckDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TruckDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TruckDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TruckDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TruckDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TruckDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TruckDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TruckDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TruckDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TruckDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TruckDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TruckDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TruckDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TruckDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TruckDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TruckDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TruckDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TruckDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TruckDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TruckDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TruckDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TruckDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TruckDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TruckDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TruckDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TruckDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TruckDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TruckDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TruckDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TruckDto> TruckDtoEnvelope::getResult() const
{
    return m_Result;
}

void TruckDtoEnvelope::setResult(const std::shared_ptr<TruckDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TruckDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TruckDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
