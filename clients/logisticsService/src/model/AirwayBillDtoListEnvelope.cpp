...
int32_t AirwayBillDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AirwayBillDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AirwayBillDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AirwayBillDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AirwayBillDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AirwayBillDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AirwayBillDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AirwayBillDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AirwayBillDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AirwayBillDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AirwayBillDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AirwayBillDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
