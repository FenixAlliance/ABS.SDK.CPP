...
TruckDtoListEnvelope::TruckDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TruckDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TruckDtoListEnvelope::toJson() const
{
...
bool TruckDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TruckDto>> refVal_setResult;
...
void TruckDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TruckDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TruckDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TruckDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TruckDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TruckDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TruckDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TruckDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TruckDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TruckDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TruckDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TruckDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TruckDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TruckDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TruckDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TruckDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TruckDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TruckDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TruckDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TruckDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TruckDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TruckDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TruckDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TruckDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TruckDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TruckDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TruckDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TruckDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TruckDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TruckDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TruckDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TruckDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TruckDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TruckDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TruckDto>>& TruckDtoListEnvelope::getResult()
{
    return m_Result;
}

void TruckDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TruckDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TruckDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TruckDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
