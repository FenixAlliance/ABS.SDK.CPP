...
VoyagePortCallDtoListEnvelope::VoyagePortCallDtoListEnvelope()
{
    m_IsSuccess = false;
...
void VoyagePortCallDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value VoyagePortCallDtoListEnvelope::toJson() const
{
...
bool VoyagePortCallDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<VoyagePortCallDto>> refVal_setResult;
...
void VoyagePortCallDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VoyagePortCallDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool VoyagePortCallDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void VoyagePortCallDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t VoyagePortCallDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void VoyagePortCallDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t VoyagePortCallDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void VoyagePortCallDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime VoyagePortCallDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void VoyagePortCallDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t VoyagePortCallDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void VoyagePortCallDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t VoyagePortCallDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void VoyagePortCallDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& VoyagePortCallDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void VoyagePortCallDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t VoyagePortCallDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void VoyagePortCallDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<VoyagePortCallDto>>& VoyagePortCallDtoListEnvelope::getResult()
{
    return m_Result;
}

void VoyagePortCallDtoListEnvelope::setResult(const std::vector<std::shared_ptr<VoyagePortCallDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool VoyagePortCallDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void VoyagePortCallDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
