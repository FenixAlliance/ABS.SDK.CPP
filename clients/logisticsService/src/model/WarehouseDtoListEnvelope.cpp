...
WarehouseDtoListEnvelope::WarehouseDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WarehouseDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WarehouseDtoListEnvelope::toJson() const
{
...
bool WarehouseDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WarehouseDto>> refVal_setResult;
...
void WarehouseDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WarehouseDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WarehouseDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WarehouseDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WarehouseDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WarehouseDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WarehouseDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WarehouseDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WarehouseDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WarehouseDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WarehouseDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WarehouseDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WarehouseDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WarehouseDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WarehouseDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WarehouseDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WarehouseDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WarehouseDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WarehouseDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WarehouseDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WarehouseDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WarehouseDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WarehouseDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WarehouseDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WarehouseDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WarehouseDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WarehouseDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WarehouseDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WarehouseDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WarehouseDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WarehouseDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WarehouseDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WarehouseDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WarehouseDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WarehouseDto>>& WarehouseDtoListEnvelope::getResult()
{
    return m_Result;
}

void WarehouseDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WarehouseDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WarehouseDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WarehouseDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
