...
DeliveryNoteDtoListEnvelope::DeliveryNoteDtoListEnvelope()
{
    m_IsSuccess = false;
...
void DeliveryNoteDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DeliveryNoteDtoListEnvelope::toJson() const
{
...
bool DeliveryNoteDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DeliveryNoteDto>> refVal_setResult;
...
void DeliveryNoteDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeliveryNoteDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DeliveryNoteDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DeliveryNoteDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DeliveryNoteDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DeliveryNoteDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DeliveryNoteDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DeliveryNoteDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DeliveryNoteDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DeliveryNoteDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DeliveryNoteDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DeliveryNoteDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DeliveryNoteDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DeliveryNoteDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DeliveryNoteDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DeliveryNoteDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DeliveryNoteDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DeliveryNoteDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<DeliveryNoteDto>>& DeliveryNoteDtoListEnvelope::getResult()
{
    return m_Result;
}

void DeliveryNoteDtoListEnvelope::setResult(const std::vector<std::shared_ptr<DeliveryNoteDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DeliveryNoteDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DeliveryNoteDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
