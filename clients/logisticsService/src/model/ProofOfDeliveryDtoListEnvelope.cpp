...
ProofOfDeliveryDtoListEnvelope::ProofOfDeliveryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ProofOfDeliveryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProofOfDeliveryDtoListEnvelope::toJson() const
{
...
bool ProofOfDeliveryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ProofOfDeliveryDto>> refVal_setResult;
...
void ProofOfDeliveryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProofOfDeliveryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProofOfDeliveryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProofOfDeliveryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProofOfDeliveryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProofOfDeliveryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProofOfDeliveryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProofOfDeliveryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProofOfDeliveryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProofOfDeliveryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProofOfDeliveryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProofOfDeliveryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProofOfDeliveryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProofOfDeliveryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProofOfDeliveryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProofOfDeliveryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProofOfDeliveryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProofOfDeliveryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ProofOfDeliveryDto>>& ProofOfDeliveryDtoListEnvelope::getResult()
{
    return m_Result;
}

void ProofOfDeliveryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ProofOfDeliveryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProofOfDeliveryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProofOfDeliveryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
