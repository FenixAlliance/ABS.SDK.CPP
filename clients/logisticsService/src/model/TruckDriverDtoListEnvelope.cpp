...
TruckDriverDtoListEnvelope::TruckDriverDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TruckDriverDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TruckDriverDtoListEnvelope::toJson() const
{
...
bool TruckDriverDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TruckDriverDto>> refVal_setResult;
...
void TruckDriverDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TruckDriverDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TruckDriverDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TruckDriverDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TruckDriverDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TruckDriverDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TruckDriverDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TruckDriverDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TruckDriverDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TruckDriverDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TruckDriverDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TruckDriverDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TruckDriverDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TruckDriverDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TruckDriverDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TruckDriverDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TruckDriverDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TruckDriverDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TruckDriverDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TruckDriverDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TruckDriverDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TruckDriverDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TruckDriverDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TruckDriverDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TruckDriverDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TruckDriverDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TruckDriverDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TruckDriverDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TruckDriverDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TruckDriverDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TruckDriverDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TruckDriverDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TruckDriverDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TruckDriverDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TruckDriverDto>>& TruckDriverDtoListEnvelope::getResult()
{
    return m_Result;
}

void TruckDriverDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TruckDriverDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TruckDriverDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TruckDriverDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
