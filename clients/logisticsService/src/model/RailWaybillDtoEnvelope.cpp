...
RailWaybillDtoEnvelope::RailWaybillDtoEnvelope()
{
    m_IsSuccess = false;
...
void RailWaybillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RailWaybillDtoEnvelope::toJson() const
{
...
bool RailWaybillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<RailWaybillDto> refVal_setResult;
...
void RailWaybillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RailWaybillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RailWaybillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RailWaybillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RailWaybillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RailWaybillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RailWaybillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RailWaybillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RailWaybillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RailWaybillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RailWaybillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RailWaybillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RailWaybillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RailWaybillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RailWaybillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RailWaybillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RailWaybillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RailWaybillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RailWaybillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RailWaybillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RailWaybillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RailWaybillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RailWaybillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RailWaybillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RailWaybillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RailWaybillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RailWaybillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RailWaybillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RailWaybillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RailWaybillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RailWaybillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RailWaybillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RailWaybillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RailWaybillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<RailWaybillDto> RailWaybillDtoEnvelope::getResult() const
{
    return m_Result;
}

void RailWaybillDtoEnvelope::setResult(const std::shared_ptr<RailWaybillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RailWaybillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RailWaybillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
