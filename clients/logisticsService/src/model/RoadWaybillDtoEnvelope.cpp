...
RoadWaybillDtoEnvelope::RoadWaybillDtoEnvelope()
{
    m_IsSuccess = false;
...
void RoadWaybillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RoadWaybillDtoEnvelope::toJson() const
{
...
bool RoadWaybillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<RoadWaybillDto> refVal_setResult;
...
void RoadWaybillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RoadWaybillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RoadWaybillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RoadWaybillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RoadWaybillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RoadWaybillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RoadWaybillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RoadWaybillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RoadWaybillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RoadWaybillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RoadWaybillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RoadWaybillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RoadWaybillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RoadWaybillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RoadWaybillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RoadWaybillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RoadWaybillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RoadWaybillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RoadWaybillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RoadWaybillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RoadWaybillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RoadWaybillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RoadWaybillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RoadWaybillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RoadWaybillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RoadWaybillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RoadWaybillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RoadWaybillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RoadWaybillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RoadWaybillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RoadWaybillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RoadWaybillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RoadWaybillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RoadWaybillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<RoadWaybillDto> RoadWaybillDtoEnvelope::getResult() const
{
    return m_Result;
}

void RoadWaybillDtoEnvelope::setResult(const std::shared_ptr<RoadWaybillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RoadWaybillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RoadWaybillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
