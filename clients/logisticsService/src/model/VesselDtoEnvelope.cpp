...
VesselDtoEnvelope::VesselDtoEnvelope()
{
    m_IsSuccess = false;
...
void VesselDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value VesselDtoEnvelope::toJson() const
{
...
bool VesselDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<VesselDto> refVal_setResult;
...
void VesselDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VesselDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool VesselDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void VesselDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool VesselDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void VesselDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t VesselDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void VesselDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool VesselDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void VesselDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t VesselDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void VesselDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool VesselDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void VesselDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime VesselDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void VesselDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool VesselDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void VesselDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t VesselDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void VesselDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool VesselDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void VesselDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t VesselDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void VesselDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool VesselDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void VesselDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& VesselDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void VesselDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool VesselDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void VesselDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t VesselDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void VesselDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool VesselDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void VesselDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<VesselDto> VesselDtoEnvelope::getResult() const
{
    return m_Result;
}

void VesselDtoEnvelope::setResult(const std::shared_ptr<VesselDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool VesselDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void VesselDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
