...
ItemPickListDtoEnvelope::ItemPickListDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemPickListDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPickListDtoEnvelope::toJson() const
{
...
bool ItemPickListDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPickListDto> refVal_setResult;
...
void ItemPickListDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPickListDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPickListDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPickListDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPickListDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPickListDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPickListDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPickListDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPickListDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPickListDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPickListDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPickListDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPickListDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPickListDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPickListDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPickListDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPickListDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPickListDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPickListDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPickListDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPickListDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPickListDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPickListDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPickListDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPickListDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPickListDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPickListDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPickListDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPickListDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPickListDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPickListDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPickListDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPickListDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPickListDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPickListDto> ItemPickListDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemPickListDtoEnvelope::setResult(const std::shared_ptr<ItemPickListDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPickListDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPickListDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
