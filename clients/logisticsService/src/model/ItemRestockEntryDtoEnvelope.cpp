...
ItemRestockEntryDtoEnvelope::ItemRestockEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemRestockEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemRestockEntryDtoEnvelope::toJson() const
{
...
bool ItemRestockEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemRestockEntryDto> refVal_setResult;
...
void ItemRestockEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemRestockEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemRestockEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemRestockEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemRestockEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemRestockEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemRestockEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemRestockEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemRestockEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemRestockEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemRestockEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemRestockEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemRestockEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemRestockEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemRestockEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemRestockEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemRestockEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemRestockEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemRestockEntryDto> ItemRestockEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemRestockEntryDtoEnvelope::setResult(const std::shared_ptr<ItemRestockEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemRestockEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemRestockEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
