...
SeawayBillDtoListEnvelope::SeawayBillDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SeawayBillDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SeawayBillDtoListEnvelope::toJson() const
{
...
bool SeawayBillDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SeawayBillDto>> refVal_setResult;
...
void SeawayBillDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SeawayBillDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SeawayBillDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SeawayBillDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SeawayBillDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SeawayBillDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SeawayBillDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SeawayBillDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SeawayBillDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SeawayBillDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SeawayBillDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SeawayBillDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SeawayBillDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SeawayBillDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SeawayBillDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SeawayBillDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SeawayBillDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SeawayBillDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SeawayBillDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SeawayBillDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SeawayBillDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SeawayBillDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SeawayBillDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SeawayBillDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SeawayBillDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SeawayBillDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SeawayBillDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SeawayBillDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SeawayBillDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SeawayBillDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SeawayBillDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SeawayBillDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SeawayBillDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SeawayBillDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SeawayBillDto>>& SeawayBillDtoListEnvelope::getResult()
{
    return m_Result;
}

void SeawayBillDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SeawayBillDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SeawayBillDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SeawayBillDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
