...
TruckDriverDtoEnvelope::TruckDriverDtoEnvelope()
{
    m_IsSuccess = false;
...
void TruckDriverDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TruckDriverDtoEnvelope::toJson() const
{
...
bool TruckDriverDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TruckDriverDto> refVal_setResult;
...
void TruckDriverDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TruckDriverDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TruckDriverDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TruckDriverDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TruckDriverDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TruckDriverDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TruckDriverDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TruckDriverDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TruckDriverDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TruckDriverDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TruckDriverDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TruckDriverDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TruckDriverDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TruckDriverDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TruckDriverDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TruckDriverDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TruckDriverDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TruckDriverDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TruckDriverDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TruckDriverDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TruckDriverDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TruckDriverDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TruckDriverDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TruckDriverDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TruckDriverDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TruckDriverDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TruckDriverDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TruckDriverDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TruckDriverDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TruckDriverDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TruckDriverDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TruckDriverDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TruckDriverDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TruckDriverDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TruckDriverDto> TruckDriverDtoEnvelope::getResult() const
{
    return m_Result;
}

void TruckDriverDtoEnvelope::setResult(const std::shared_ptr<TruckDriverDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TruckDriverDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TruckDriverDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
