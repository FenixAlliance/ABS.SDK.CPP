...
ItemPackingSlipEntryDtoEnvelope::ItemPackingSlipEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemPackingSlipEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPackingSlipEntryDtoEnvelope::toJson() const
{
...
bool ItemPackingSlipEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPackingSlipEntryDto> refVal_setResult;
...
void ItemPackingSlipEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPackingSlipEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPackingSlipEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPackingSlipEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPackingSlipEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPackingSlipEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPackingSlipEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPackingSlipEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPackingSlipEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPackingSlipEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPackingSlipEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPackingSlipEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPackingSlipEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPackingSlipEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPackingSlipEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPackingSlipEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPackingSlipEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPackingSlipEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPackingSlipEntryDto> ItemPackingSlipEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemPackingSlipEntryDtoEnvelope::setResult(const std::shared_ptr<ItemPackingSlipEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPackingSlipEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPackingSlipEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
