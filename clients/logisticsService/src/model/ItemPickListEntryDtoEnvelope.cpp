...
ItemPickListEntryDtoEnvelope::ItemPickListEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemPickListEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPickListEntryDtoEnvelope::toJson() const
{
...
bool ItemPickListEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPickListEntryDto> refVal_setResult;
...
void ItemPickListEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPickListEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPickListEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPickListEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPickListEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPickListEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPickListEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPickListEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPickListEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPickListEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPickListEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPickListEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPickListEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPickListEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPickListEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPickListEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPickListEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPickListEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPickListEntryDto> ItemPickListEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemPickListEntryDtoEnvelope::setResult(const std::shared_ptr<ItemPickListEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPickListEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPickListEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
