...
DeliveryNoteDtoEnvelope::DeliveryNoteDtoEnvelope()
{
    m_IsSuccess = false;
...
void DeliveryNoteDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DeliveryNoteDtoEnvelope::toJson() const
{
...
bool DeliveryNoteDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DeliveryNoteDto> refVal_setResult;
...
void DeliveryNoteDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeliveryNoteDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DeliveryNoteDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DeliveryNoteDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DeliveryNoteDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DeliveryNoteDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DeliveryNoteDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DeliveryNoteDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DeliveryNoteDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DeliveryNoteDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DeliveryNoteDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DeliveryNoteDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DeliveryNoteDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DeliveryNoteDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DeliveryNoteDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DeliveryNoteDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DeliveryNoteDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DeliveryNoteDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DeliveryNoteDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DeliveryNoteDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DeliveryNoteDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DeliveryNoteDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DeliveryNoteDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DeliveryNoteDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DeliveryNoteDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DeliveryNoteDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DeliveryNoteDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DeliveryNoteDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DeliveryNoteDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DeliveryNoteDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DeliveryNoteDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DeliveryNoteDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DeliveryNoteDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DeliveryNoteDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DeliveryNoteDto> DeliveryNoteDtoEnvelope::getResult() const
{
    return m_Result;
}

void DeliveryNoteDtoEnvelope::setResult(const std::shared_ptr<DeliveryNoteDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DeliveryNoteDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DeliveryNoteDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
