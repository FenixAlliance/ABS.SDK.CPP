...
ProofOfDeliveryDtoEnvelope::ProofOfDeliveryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ProofOfDeliveryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ProofOfDeliveryDtoEnvelope::toJson() const
{
...
bool ProofOfDeliveryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ProofOfDeliveryDto> refVal_setResult;
...
void ProofOfDeliveryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProofOfDeliveryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ProofOfDeliveryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ProofOfDeliveryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ProofOfDeliveryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ProofOfDeliveryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ProofOfDeliveryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ProofOfDeliveryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ProofOfDeliveryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ProofOfDeliveryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ProofOfDeliveryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ProofOfDeliveryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ProofOfDeliveryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ProofOfDeliveryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ProofOfDeliveryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ProofOfDeliveryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ProofOfDeliveryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ProofOfDeliveryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ProofOfDeliveryDto> ProofOfDeliveryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ProofOfDeliveryDtoEnvelope::setResult(const std::shared_ptr<ProofOfDeliveryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ProofOfDeliveryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ProofOfDeliveryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
