...
AirwayBillDtoEnvelope::AirwayBillDtoEnvelope()
{
    m_IsSuccess = false;
...
void AirwayBillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AirwayBillDtoEnvelope::toJson() const
{
...
bool AirwayBillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AirwayBillDto> refVal_setResult;
...
void AirwayBillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AirwayBillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AirwayBillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AirwayBillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AirwayBillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AirwayBillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AirwayBillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AirwayBillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AirwayBillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AirwayBillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AirwayBillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AirwayBillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AirwayBillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AirwayBillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AirwayBillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AirwayBillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AirwayBillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AirwayBillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AirwayBillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AirwayBillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AirwayBillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AirwayBillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AirwayBillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AirwayBillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AirwayBillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AirwayBillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AirwayBillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AirwayBillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AirwayBillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AirwayBillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AirwayBillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AirwayBillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AirwayBillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AirwayBillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AirwayBillDto> AirwayBillDtoEnvelope::getResult() const
{
    return m_Result;
}

void AirwayBillDtoEnvelope::setResult(const std::shared_ptr<AirwayBillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AirwayBillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AirwayBillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
