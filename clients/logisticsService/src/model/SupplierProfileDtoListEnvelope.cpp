...
SupplierProfileDtoListEnvelope::SupplierProfileDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SupplierProfileDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupplierProfileDtoListEnvelope::toJson() const
{
...
bool SupplierProfileDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SupplierProfileDto>> refVal_setResult;
...
void SupplierProfileDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupplierProfileDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupplierProfileDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupplierProfileDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupplierProfileDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupplierProfileDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupplierProfileDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupplierProfileDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupplierProfileDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupplierProfileDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupplierProfileDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupplierProfileDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupplierProfileDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupplierProfileDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupplierProfileDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupplierProfileDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupplierProfileDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupplierProfileDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupplierProfileDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupplierProfileDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupplierProfileDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupplierProfileDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupplierProfileDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupplierProfileDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupplierProfileDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupplierProfileDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupplierProfileDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupplierProfileDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupplierProfileDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupplierProfileDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupplierProfileDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupplierProfileDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupplierProfileDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupplierProfileDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SupplierProfileDto>>& SupplierProfileDtoListEnvelope::getResult()
{
    return m_Result;
}

void SupplierProfileDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SupplierProfileDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupplierProfileDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupplierProfileDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
