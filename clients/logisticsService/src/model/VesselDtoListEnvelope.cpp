...
VesselDtoListEnvelope::VesselDtoListEnvelope()
{
    m_IsSuccess = false;
...
void VesselDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value VesselDtoListEnvelope::toJson() const
{
...
bool VesselDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<VesselDto>> refVal_setResult;
...
void VesselDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VesselDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool VesselDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void VesselDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool VesselDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void VesselDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t VesselDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void VesselDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool VesselDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void VesselDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t VesselDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void VesselDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool VesselDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void VesselDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime VesselDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void VesselDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool VesselDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void VesselDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t VesselDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void VesselDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool VesselDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void VesselDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t VesselDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void VesselDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool VesselDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void VesselDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& VesselDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void VesselDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool VesselDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void VesselDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t VesselDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void VesselDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool VesselDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void VesselDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<VesselDto>>& VesselDtoListEnvelope::getResult()
{
    return m_Result;
}

void VesselDtoListEnvelope::setResult(const std::vector<std::shared_ptr<VesselDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool VesselDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void VesselDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
