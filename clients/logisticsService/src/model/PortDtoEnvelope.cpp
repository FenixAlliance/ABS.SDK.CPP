...
PortDtoEnvelope::PortDtoEnvelope()
{
    m_IsSuccess = false;
...
void PortDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PortDtoEnvelope::toJson() const
{
...
bool PortDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PortDto> refVal_setResult;
...
void PortDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PortDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PortDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PortDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PortDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PortDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PortDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PortDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PortDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PortDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PortDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PortDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PortDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PortDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PortDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PortDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PortDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PortDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PortDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PortDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PortDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PortDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PortDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PortDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PortDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PortDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PortDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PortDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PortDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PortDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PortDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PortDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PortDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PortDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PortDto> PortDtoEnvelope::getResult() const
{
    return m_Result;
}

void PortDtoEnvelope::setResult(const std::shared_ptr<PortDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PortDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PortDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
