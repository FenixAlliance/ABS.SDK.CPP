...
RoadWaybillDtoListEnvelope::RoadWaybillDtoListEnvelope()
{
    m_IsSuccess = false;
...
void RoadWaybillDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RoadWaybillDtoListEnvelope::toJson() const
{
...
bool RoadWaybillDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<RoadWaybillDto>> refVal_setResult;
...
void RoadWaybillDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RoadWaybillDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RoadWaybillDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RoadWaybillDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RoadWaybillDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RoadWaybillDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RoadWaybillDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RoadWaybillDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RoadWaybillDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RoadWaybillDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RoadWaybillDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RoadWaybillDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RoadWaybillDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RoadWaybillDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RoadWaybillDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RoadWaybillDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RoadWaybillDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RoadWaybillDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RoadWaybillDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RoadWaybillDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RoadWaybillDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RoadWaybillDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RoadWaybillDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RoadWaybillDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RoadWaybillDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RoadWaybillDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RoadWaybillDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RoadWaybillDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RoadWaybillDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RoadWaybillDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RoadWaybillDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RoadWaybillDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RoadWaybillDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RoadWaybillDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<RoadWaybillDto>>& RoadWaybillDtoListEnvelope::getResult()
{
    return m_Result;
}

void RoadWaybillDtoListEnvelope::setResult(const std::vector<std::shared_ptr<RoadWaybillDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RoadWaybillDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RoadWaybillDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
