...
SeawayBillDtoEnvelope::SeawayBillDtoEnvelope()
{
    m_IsSuccess = false;
...
void SeawayBillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SeawayBillDtoEnvelope::toJson() const
{
...
bool SeawayBillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SeawayBillDto> refVal_setResult;
...
void SeawayBillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SeawayBillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SeawayBillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SeawayBillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SeawayBillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SeawayBillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SeawayBillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SeawayBillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SeawayBillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SeawayBillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SeawayBillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SeawayBillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SeawayBillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SeawayBillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SeawayBillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SeawayBillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SeawayBillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SeawayBillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SeawayBillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SeawayBillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SeawayBillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SeawayBillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SeawayBillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SeawayBillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SeawayBillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SeawayBillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SeawayBillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SeawayBillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SeawayBillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SeawayBillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SeawayBillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SeawayBillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SeawayBillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SeawayBillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SeawayBillDto> SeawayBillDtoEnvelope::getResult() const
{
    return m_Result;
}

void SeawayBillDtoEnvelope::setResult(const std::shared_ptr<SeawayBillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SeawayBillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SeawayBillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
