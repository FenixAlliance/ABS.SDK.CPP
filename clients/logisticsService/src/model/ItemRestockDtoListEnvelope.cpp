...
ItemRestockDtoListEnvelope::ItemRestockDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemRestockDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemRestockDtoListEnvelope::toJson() const
{
...
bool ItemRestockDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemRestockDto>> refVal_setResult;
...
void ItemRestockDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemRestockDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemRestockDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemRestockDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemRestockDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemRestockDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemRestockDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemRestockDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemRestockDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemRestockDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemRestockDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemRestockDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemRestockDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemRestockDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemRestockDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemRestockDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemRestockDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemRestockDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemRestockDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemRestockDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemRestockDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemRestockDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemRestockDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemRestockDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemRestockDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemRestockDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemRestockDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemRestockDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemRestockDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemRestockDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemRestockDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemRestockDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemRestockDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemRestockDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemRestockDto>>& ItemRestockDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemRestockDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemRestockDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemRestockDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemRestockDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
