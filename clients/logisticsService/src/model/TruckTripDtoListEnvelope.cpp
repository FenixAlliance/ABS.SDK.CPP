...
TruckTripDtoListEnvelope::TruckTripDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TruckTripDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TruckTripDtoListEnvelope::toJson() const
{
...
bool TruckTripDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TruckTripDto>> refVal_setResult;
...
void TruckTripDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TruckTripDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TruckTripDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TruckTripDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TruckTripDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TruckTripDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TruckTripDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TruckTripDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TruckTripDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TruckTripDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TruckTripDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TruckTripDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TruckTripDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TruckTripDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TruckTripDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TruckTripDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TruckTripDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TruckTripDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TruckTripDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TruckTripDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TruckTripDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TruckTripDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TruckTripDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TruckTripDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TruckTripDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TruckTripDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TruckTripDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TruckTripDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TruckTripDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TruckTripDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TruckTripDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TruckTripDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TruckTripDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TruckTripDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TruckTripDto>>& TruckTripDtoListEnvelope::getResult()
{
    return m_Result;
}

void TruckTripDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TruckTripDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TruckTripDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TruckTripDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
