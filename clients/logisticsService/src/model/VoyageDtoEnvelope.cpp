...
VoyageDtoEnvelope::VoyageDtoEnvelope()
{
    m_IsSuccess = false;
...
void VoyageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value VoyageDtoEnvelope::toJson() const
{
...
bool VoyageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<VoyageDto> refVal_setResult;
...
void VoyageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VoyageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool VoyageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void VoyageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool VoyageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void VoyageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t VoyageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void VoyageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool VoyageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void VoyageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t VoyageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void VoyageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool VoyageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void VoyageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime VoyageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void VoyageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool VoyageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void VoyageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t VoyageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void VoyageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool VoyageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void VoyageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t VoyageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void VoyageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool VoyageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void VoyageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& VoyageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void VoyageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool VoyageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void VoyageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t VoyageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void VoyageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool VoyageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void VoyageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<VoyageDto> VoyageDtoEnvelope::getResult() const
{
    return m_Result;
}

void VoyageDtoEnvelope::setResult(const std::shared_ptr<VoyageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool VoyageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void VoyageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
