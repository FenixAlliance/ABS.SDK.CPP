...
RailWaybillDtoListEnvelope::RailWaybillDtoListEnvelope()
{
    m_IsSuccess = false;
...
void RailWaybillDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RailWaybillDtoListEnvelope::toJson() const
{
...
bool RailWaybillDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<RailWaybillDto>> refVal_setResult;
...
void RailWaybillDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RailWaybillDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RailWaybillDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RailWaybillDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RailWaybillDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RailWaybillDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RailWaybillDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RailWaybillDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RailWaybillDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RailWaybillDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RailWaybillDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RailWaybillDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RailWaybillDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RailWaybillDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RailWaybillDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RailWaybillDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RailWaybillDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RailWaybillDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RailWaybillDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RailWaybillDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RailWaybillDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RailWaybillDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RailWaybillDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RailWaybillDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RailWaybillDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RailWaybillDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RailWaybillDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RailWaybillDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RailWaybillDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RailWaybillDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RailWaybillDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RailWaybillDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RailWaybillDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RailWaybillDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<RailWaybillDto>>& RailWaybillDtoListEnvelope::getResult()
{
    return m_Result;
}

void RailWaybillDtoListEnvelope::setResult(const std::vector<std::shared_ptr<RailWaybillDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RailWaybillDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RailWaybillDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
