...
WaybillLineDtoListEnvelope::WaybillLineDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WaybillLineDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WaybillLineDtoListEnvelope::toJson() const
{
...
bool WaybillLineDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WaybillLineDto>> refVal_setResult;
...
void WaybillLineDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WaybillLineDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WaybillLineDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WaybillLineDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WaybillLineDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WaybillLineDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WaybillLineDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WaybillLineDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WaybillLineDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WaybillLineDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WaybillLineDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WaybillLineDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WaybillLineDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WaybillLineDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WaybillLineDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WaybillLineDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WaybillLineDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WaybillLineDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WaybillLineDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WaybillLineDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WaybillLineDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WaybillLineDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WaybillLineDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WaybillLineDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WaybillLineDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WaybillLineDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WaybillLineDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WaybillLineDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WaybillLineDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WaybillLineDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WaybillLineDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WaybillLineDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WaybillLineDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WaybillLineDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WaybillLineDto>>& WaybillLineDtoListEnvelope::getResult()
{
    return m_Result;
}

void WaybillLineDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WaybillLineDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WaybillLineDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WaybillLineDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
