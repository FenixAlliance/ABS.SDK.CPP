...
ItemPackingSlipDtoEnvelope::ItemPackingSlipDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemPackingSlipDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPackingSlipDtoEnvelope::toJson() const
{
...
bool ItemPackingSlipDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPackingSlipDto> refVal_setResult;
...
void ItemPackingSlipDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPackingSlipDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPackingSlipDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPackingSlipDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPackingSlipDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPackingSlipDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPackingSlipDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPackingSlipDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPackingSlipDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPackingSlipDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPackingSlipDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPackingSlipDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPackingSlipDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPackingSlipDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPackingSlipDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPackingSlipDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPackingSlipDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPackingSlipDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPackingSlipDto> ItemPackingSlipDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemPackingSlipDtoEnvelope::setResult(const std::shared_ptr<ItemPackingSlipDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPackingSlipDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPackingSlipDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
