...
PortDtoListEnvelope::PortDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PortDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PortDtoListEnvelope::toJson() const
{
...
bool PortDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PortDto>> refVal_setResult;
...
void PortDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PortDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PortDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PortDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PortDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PortDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PortDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PortDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PortDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PortDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PortDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PortDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PortDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PortDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PortDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PortDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PortDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PortDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PortDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PortDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PortDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PortDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PortDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PortDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PortDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PortDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PortDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PortDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PortDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PortDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PortDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PortDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PortDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PortDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PortDto>>& PortDtoListEnvelope::getResult()
{
    return m_Result;
}

void PortDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PortDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PortDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PortDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
