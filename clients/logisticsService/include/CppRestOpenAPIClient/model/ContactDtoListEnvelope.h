...
/*
 * ContactDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoListEnvelope_H_
...
public:
    ...
    virtual ~ContactDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ContactDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ContactDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ContactDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ContactDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoListEnvelope_H_ */
