...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_StockApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_StockApi_H_
...
public:
    ...
    explicit StockApi( std::shared_ptr<const ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_StockApi_H_ */
