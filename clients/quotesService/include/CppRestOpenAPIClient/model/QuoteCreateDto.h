...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_QuoteCreateDto_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_QuoteCreateDto_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<QuoteLineCreateDto>>& getQuoteLines();
    bool quoteLinesIsSet() const;
    void unsetQuoteLines();

    void setQuoteLines(const std::vector<std::shared_ptr<QuoteLineCreateDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<QuoteLineCreateDto>> m_QuoteLines;
    bool m_QuoteLinesIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_QuoteCreateDto_H_ */
