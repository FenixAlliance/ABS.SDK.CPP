...
QuoteDtoEnvelope::QuoteDtoEnvelope()
{
    m_IsSuccess = false;
...
void QuoteDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value QuoteDtoEnvelope::toJson() const
{
...
bool QuoteDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<QuoteDto> refVal_setResult;
...
void QuoteDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuoteDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool QuoteDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void QuoteDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool QuoteDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void QuoteDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t QuoteDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void QuoteDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool QuoteDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void QuoteDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t QuoteDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void QuoteDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool QuoteDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void QuoteDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime QuoteDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void QuoteDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool QuoteDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void QuoteDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t QuoteDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void QuoteDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool QuoteDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void QuoteDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t QuoteDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void QuoteDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool QuoteDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void QuoteDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& QuoteDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void QuoteDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool QuoteDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void QuoteDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t QuoteDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void QuoteDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool QuoteDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void QuoteDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<QuoteDto> QuoteDtoEnvelope::getResult() const
{
    return m_Result;
}

void QuoteDtoEnvelope::setResult(const std::shared_ptr<QuoteDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool QuoteDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void QuoteDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
