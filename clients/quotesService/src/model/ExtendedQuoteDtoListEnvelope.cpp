...
ExtendedQuoteDtoListEnvelope::ExtendedQuoteDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedQuoteDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedQuoteDtoListEnvelope::toJson() const
{
...
bool ExtendedQuoteDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ExtendedQuoteDto>> refVal_setResult;
...
void ExtendedQuoteDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedQuoteDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedQuoteDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedQuoteDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedQuoteDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedQuoteDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedQuoteDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedQuoteDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedQuoteDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedQuoteDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedQuoteDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedQuoteDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedQuoteDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedQuoteDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedQuoteDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedQuoteDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedQuoteDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedQuoteDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ExtendedQuoteDto>>& ExtendedQuoteDtoListEnvelope::getResult()
{
    return m_Result;
}

void ExtendedQuoteDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ExtendedQuoteDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedQuoteDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedQuoteDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
