...
EmployerProfileDtoEnvelope::EmployerProfileDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmployerProfileDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmployerProfileDtoEnvelope::toJson() const
{
...
bool EmployerProfileDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmployerProfileDto> refVal_setResult;
...
void EmployerProfileDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmployerProfileDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmployerProfileDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmployerProfileDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmployerProfileDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmployerProfileDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmployerProfileDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmployerProfileDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmployerProfileDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmployerProfileDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmployerProfileDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmployerProfileDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmployerProfileDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmployerProfileDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmployerProfileDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmployerProfileDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmployerProfileDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmployerProfileDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmployerProfileDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmployerProfileDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmployerProfileDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmployerProfileDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmployerProfileDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmployerProfileDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmployerProfileDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmployerProfileDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmployerProfileDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmployerProfileDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmployerProfileDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmployerProfileDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmployerProfileDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmployerProfileDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmployerProfileDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmployerProfileDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmployerProfileDto> EmployerProfileDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmployerProfileDtoEnvelope::setResult(const std::shared_ptr<EmployerProfileDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmployerProfileDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmployerProfileDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
