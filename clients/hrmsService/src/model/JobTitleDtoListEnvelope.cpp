...
JobTitleDtoListEnvelope::JobTitleDtoListEnvelope()
{
    m_IsSuccess = false;
...
void JobTitleDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobTitleDtoListEnvelope::toJson() const
{
...
bool JobTitleDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<JobTitleDto>> refVal_setResult;
...
void JobTitleDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobTitleDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobTitleDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobTitleDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobTitleDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobTitleDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobTitleDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobTitleDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobTitleDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobTitleDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobTitleDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobTitleDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobTitleDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobTitleDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobTitleDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobTitleDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobTitleDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobTitleDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobTitleDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobTitleDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobTitleDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobTitleDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobTitleDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobTitleDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobTitleDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobTitleDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobTitleDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobTitleDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobTitleDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobTitleDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobTitleDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobTitleDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobTitleDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobTitleDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<JobTitleDto>>& JobTitleDtoListEnvelope::getResult()
{
    return m_Result;
}

void JobTitleDtoListEnvelope::setResult(const std::vector<std::shared_ptr<JobTitleDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobTitleDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobTitleDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
