...
EmployeeTypeDtoEnvelope::EmployeeTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmployeeTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmployeeTypeDtoEnvelope::toJson() const
{
...
bool EmployeeTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmployeeTypeDto> refVal_setResult;
...
void EmployeeTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmployeeTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmployeeTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmployeeTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmployeeTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmployeeTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmployeeTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmployeeTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmployeeTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmployeeTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmployeeTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmployeeTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmployeeTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmployeeTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmployeeTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmployeeTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmployeeTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmployeeTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmployeeTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmployeeTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmployeeTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmployeeTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmployeeTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmployeeTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmployeeTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmployeeTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmployeeTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmployeeTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmployeeTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmployeeTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmployeeTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmployeeTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmployeeTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmployeeTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmployeeTypeDto> EmployeeTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmployeeTypeDtoEnvelope::setResult(const std::shared_ptr<EmployeeTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmployeeTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmployeeTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
