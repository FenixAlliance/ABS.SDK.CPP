...
EmployerProfileDtoListEnvelope::EmployerProfileDtoListEnvelope()
{
    m_IsSuccess = false;
...
void EmployerProfileDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmployerProfileDtoListEnvelope::toJson() const
{
...
bool EmployerProfileDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<EmployerProfileDto>> refVal_setResult;
...
void EmployerProfileDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmployerProfileDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmployerProfileDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmployerProfileDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmployerProfileDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmployerProfileDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmployerProfileDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmployerProfileDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmployerProfileDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmployerProfileDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmployerProfileDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmployerProfileDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmployerProfileDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmployerProfileDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmployerProfileDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmployerProfileDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmployerProfileDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmployerProfileDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmployerProfileDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmployerProfileDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmployerProfileDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmployerProfileDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmployerProfileDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmployerProfileDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmployerProfileDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmployerProfileDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmployerProfileDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmployerProfileDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmployerProfileDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmployerProfileDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmployerProfileDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmployerProfileDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmployerProfileDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmployerProfileDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<EmployerProfileDto>>& EmployerProfileDtoListEnvelope::getResult()
{
    return m_Result;
}

void EmployerProfileDtoListEnvelope::setResult(const std::vector<std::shared_ptr<EmployerProfileDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmployerProfileDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmployerProfileDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
