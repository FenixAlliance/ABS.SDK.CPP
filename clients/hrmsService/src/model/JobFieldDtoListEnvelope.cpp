...
JobFieldDtoListEnvelope::JobFieldDtoListEnvelope()
{
    m_IsSuccess = false;
...
void JobFieldDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobFieldDtoListEnvelope::toJson() const
{
...
bool JobFieldDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<JobFieldDto>> refVal_setResult;
...
void JobFieldDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobFieldDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobFieldDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobFieldDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobFieldDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobFieldDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobFieldDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobFieldDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobFieldDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobFieldDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobFieldDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobFieldDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobFieldDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobFieldDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobFieldDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobFieldDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobFieldDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobFieldDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobFieldDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobFieldDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobFieldDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobFieldDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobFieldDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobFieldDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobFieldDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobFieldDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobFieldDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobFieldDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobFieldDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobFieldDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobFieldDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobFieldDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobFieldDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobFieldDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<JobFieldDto>>& JobFieldDtoListEnvelope::getResult()
{
    return m_Result;
}

void JobFieldDtoListEnvelope::setResult(const std::vector<std::shared_ptr<JobFieldDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobFieldDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobFieldDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
