...
LeaveApplicationDtoEnvelope::LeaveApplicationDtoEnvelope()
{
    m_IsSuccess = false;
...
void LeaveApplicationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LeaveApplicationDtoEnvelope::toJson() const
{
...
bool LeaveApplicationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LeaveApplicationDto> refVal_setResult;
...
void LeaveApplicationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LeaveApplicationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LeaveApplicationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LeaveApplicationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LeaveApplicationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LeaveApplicationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LeaveApplicationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LeaveApplicationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LeaveApplicationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LeaveApplicationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LeaveApplicationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LeaveApplicationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LeaveApplicationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LeaveApplicationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LeaveApplicationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LeaveApplicationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LeaveApplicationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LeaveApplicationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LeaveApplicationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LeaveApplicationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LeaveApplicationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LeaveApplicationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LeaveApplicationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LeaveApplicationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LeaveApplicationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LeaveApplicationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LeaveApplicationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LeaveApplicationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LeaveApplicationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LeaveApplicationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LeaveApplicationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LeaveApplicationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LeaveApplicationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LeaveApplicationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LeaveApplicationDto> LeaveApplicationDtoEnvelope::getResult() const
{
    return m_Result;
}

void LeaveApplicationDtoEnvelope::setResult(const std::shared_ptr<LeaveApplicationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LeaveApplicationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LeaveApplicationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
