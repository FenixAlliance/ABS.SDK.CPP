...
PayrollDtoListEnvelope::PayrollDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PayrollDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PayrollDtoListEnvelope::toJson() const
{
...
bool PayrollDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PayrollDto>> refVal_setResult;
...
void PayrollDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PayrollDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PayrollDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PayrollDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PayrollDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PayrollDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PayrollDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PayrollDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PayrollDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PayrollDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PayrollDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PayrollDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PayrollDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PayrollDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PayrollDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PayrollDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PayrollDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PayrollDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PayrollDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PayrollDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PayrollDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PayrollDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PayrollDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PayrollDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PayrollDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PayrollDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PayrollDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PayrollDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PayrollDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PayrollDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PayrollDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PayrollDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PayrollDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PayrollDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PayrollDto>>& PayrollDtoListEnvelope::getResult()
{
    return m_Result;
}

void PayrollDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PayrollDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PayrollDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PayrollDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
