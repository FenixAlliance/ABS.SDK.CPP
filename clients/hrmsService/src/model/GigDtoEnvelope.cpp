...
void GigDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value GigDtoEnvelope::toJson() const
{
...
bool GigDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GigDto> refVal_setResult;
...
void GigDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GigDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool GigDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void GigDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool GigDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void GigDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t GigDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void GigDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool GigDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void GigDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t GigDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void GigDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool GigDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void GigDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime GigDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void GigDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GigDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GigDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t GigDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void GigDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool GigDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void GigDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t GigDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void GigDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool GigDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void GigDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& GigDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void GigDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool GigDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void GigDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t GigDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void GigDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool GigDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void GigDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<GigDto> GigDtoEnvelope::getResult() const
{
    return m_Result;
}

void GigDtoEnvelope::setResult(const std::shared_ptr<GigDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GigDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void GigDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
