...
RequiredSkillRecordDtoEnvelope::RequiredSkillRecordDtoEnvelope()
{
    m_IsSuccess = false;
...
void RequiredSkillRecordDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RequiredSkillRecordDtoEnvelope::toJson() const
{
...
bool RequiredSkillRecordDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<RequiredSkillRecordDto> refVal_setResult;
...
void RequiredSkillRecordDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RequiredSkillRecordDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RequiredSkillRecordDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RequiredSkillRecordDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RequiredSkillRecordDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RequiredSkillRecordDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RequiredSkillRecordDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RequiredSkillRecordDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RequiredSkillRecordDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RequiredSkillRecordDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RequiredSkillRecordDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RequiredSkillRecordDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RequiredSkillRecordDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RequiredSkillRecordDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RequiredSkillRecordDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RequiredSkillRecordDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RequiredSkillRecordDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RequiredSkillRecordDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<RequiredSkillRecordDto> RequiredSkillRecordDtoEnvelope::getResult() const
{
    return m_Result;
}

void RequiredSkillRecordDtoEnvelope::setResult(const std::shared_ptr<RequiredSkillRecordDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RequiredSkillRecordDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RequiredSkillRecordDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
