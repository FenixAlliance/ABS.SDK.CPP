...
GigDtoListEnvelope::GigDtoListEnvelope()
{
    m_IsSuccess = false;
...
void GigDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value GigDtoListEnvelope::toJson() const
{
...
bool GigDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<GigDto>> refVal_setResult;
...
void GigDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GigDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool GigDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void GigDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool GigDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void GigDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t GigDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void GigDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool GigDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void GigDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t GigDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void GigDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool GigDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void GigDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime GigDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void GigDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GigDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GigDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t GigDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void GigDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool GigDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void GigDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t GigDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void GigDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool GigDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void GigDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& GigDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void GigDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool GigDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void GigDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t GigDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void GigDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool GigDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void GigDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<GigDto>>& GigDtoListEnvelope::getResult()
{
    return m_Result;
}

void GigDtoListEnvelope::setResult(const std::vector<std::shared_ptr<GigDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GigDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void GigDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
