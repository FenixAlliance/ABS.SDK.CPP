...
PayrollDtoEnvelope::PayrollDtoEnvelope()
{
    m_IsSuccess = false;
...
void PayrollDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PayrollDtoEnvelope::toJson() const
{
...
bool PayrollDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PayrollDto> refVal_setResult;
...
void PayrollDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PayrollDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PayrollDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PayrollDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PayrollDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PayrollDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PayrollDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PayrollDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PayrollDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PayrollDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PayrollDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PayrollDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PayrollDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PayrollDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PayrollDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PayrollDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PayrollDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PayrollDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PayrollDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PayrollDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PayrollDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PayrollDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PayrollDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PayrollDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PayrollDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PayrollDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PayrollDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PayrollDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PayrollDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PayrollDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PayrollDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PayrollDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PayrollDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PayrollDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PayrollDto> PayrollDtoEnvelope::getResult() const
{
    return m_Result;
}

void PayrollDtoEnvelope::setResult(const std::shared_ptr<PayrollDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PayrollDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PayrollDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
