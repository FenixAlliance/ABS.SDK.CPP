...
EmployeeProfileDtoEnvelope::EmployeeProfileDtoEnvelope()
{
    m_IsSuccess = false;
...
void EmployeeProfileDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmployeeProfileDtoEnvelope::toJson() const
{
...
bool EmployeeProfileDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EmployeeProfileDto> refVal_setResult;
...
void EmployeeProfileDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmployeeProfileDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmployeeProfileDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmployeeProfileDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmployeeProfileDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmployeeProfileDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmployeeProfileDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmployeeProfileDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmployeeProfileDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmployeeProfileDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmployeeProfileDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmployeeProfileDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmployeeProfileDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmployeeProfileDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmployeeProfileDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmployeeProfileDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmployeeProfileDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmployeeProfileDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmployeeProfileDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmployeeProfileDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmployeeProfileDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmployeeProfileDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmployeeProfileDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmployeeProfileDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmployeeProfileDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmployeeProfileDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmployeeProfileDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmployeeProfileDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmployeeProfileDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmployeeProfileDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmployeeProfileDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmployeeProfileDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmployeeProfileDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmployeeProfileDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<EmployeeProfileDto> EmployeeProfileDtoEnvelope::getResult() const
{
    return m_Result;
}

void EmployeeProfileDtoEnvelope::setResult(const std::shared_ptr<EmployeeProfileDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmployeeProfileDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmployeeProfileDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
