...
ScheduleDtoEnvelope::ScheduleDtoEnvelope()
{
    m_IsSuccess = false;
...
void ScheduleDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ScheduleDtoEnvelope::toJson() const
{
...
bool ScheduleDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ScheduleDto> refVal_setResult;
...
void ScheduleDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScheduleDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ScheduleDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ScheduleDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ScheduleDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ScheduleDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ScheduleDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ScheduleDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ScheduleDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ScheduleDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ScheduleDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ScheduleDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ScheduleDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ScheduleDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ScheduleDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ScheduleDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ScheduleDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ScheduleDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ScheduleDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ScheduleDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ScheduleDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ScheduleDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ScheduleDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ScheduleDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ScheduleDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ScheduleDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ScheduleDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ScheduleDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ScheduleDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ScheduleDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ScheduleDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ScheduleDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ScheduleDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ScheduleDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ScheduleDto> ScheduleDtoEnvelope::getResult() const
{
    return m_Result;
}

void ScheduleDtoEnvelope::setResult(const std::shared_ptr<ScheduleDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ScheduleDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ScheduleDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
