...
TimeIntervalDtoEnvelope::TimeIntervalDtoEnvelope()
{
    m_IsSuccess = false;
...
void TimeIntervalDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TimeIntervalDtoEnvelope::toJson() const
{
...
bool TimeIntervalDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TimeIntervalDto> refVal_setResult;
...
void TimeIntervalDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TimeIntervalDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TimeIntervalDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TimeIntervalDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TimeIntervalDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TimeIntervalDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TimeIntervalDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TimeIntervalDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TimeIntervalDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TimeIntervalDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TimeIntervalDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TimeIntervalDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TimeIntervalDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TimeIntervalDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TimeIntervalDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TimeIntervalDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TimeIntervalDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TimeIntervalDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TimeIntervalDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TimeIntervalDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TimeIntervalDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TimeIntervalDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TimeIntervalDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TimeIntervalDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TimeIntervalDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TimeIntervalDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TimeIntervalDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TimeIntervalDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TimeIntervalDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TimeIntervalDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TimeIntervalDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TimeIntervalDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TimeIntervalDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TimeIntervalDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TimeIntervalDto> TimeIntervalDtoEnvelope::getResult() const
{
    return m_Result;
}

void TimeIntervalDtoEnvelope::setResult(const std::shared_ptr<TimeIntervalDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TimeIntervalDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TimeIntervalDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
