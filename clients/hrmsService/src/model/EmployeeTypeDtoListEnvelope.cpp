...
EmployeeTypeDtoListEnvelope::EmployeeTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void EmployeeTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value EmployeeTypeDtoListEnvelope::toJson() const
{
...
bool EmployeeTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<EmployeeTypeDto>> refVal_setResult;
...
void EmployeeTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmployeeTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool EmployeeTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void EmployeeTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t EmployeeTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void EmployeeTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t EmployeeTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void EmployeeTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime EmployeeTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void EmployeeTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t EmployeeTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmployeeTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmployeeTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmployeeTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmployeeTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmployeeTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t EmployeeTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void EmployeeTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<EmployeeTypeDto>>& EmployeeTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void EmployeeTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<EmployeeTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool EmployeeTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void EmployeeTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
