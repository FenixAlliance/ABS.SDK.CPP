...
SalaryDtoListEnvelope::SalaryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SalaryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SalaryDtoListEnvelope::toJson() const
{
...
bool SalaryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SalaryDto>> refVal_setResult;
...
void SalaryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SalaryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SalaryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SalaryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SalaryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SalaryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SalaryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SalaryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SalaryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SalaryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SalaryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SalaryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SalaryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SalaryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SalaryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SalaryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SalaryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SalaryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SalaryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SalaryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SalaryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SalaryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SalaryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SalaryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SalaryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SalaryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SalaryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SalaryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SalaryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SalaryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SalaryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SalaryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SalaryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SalaryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SalaryDto>>& SalaryDtoListEnvelope::getResult()
{
    return m_Result;
}

void SalaryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SalaryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SalaryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SalaryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
