...
JobOfferDtoEnvelope::JobOfferDtoEnvelope()
{
    m_IsSuccess = false;
...
void JobOfferDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobOfferDtoEnvelope::toJson() const
{
...
bool JobOfferDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JobOfferDto> refVal_setResult;
...
void JobOfferDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobOfferDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobOfferDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobOfferDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobOfferDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobOfferDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobOfferDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobOfferDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobOfferDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobOfferDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobOfferDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobOfferDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobOfferDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobOfferDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobOfferDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobOfferDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobOfferDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobOfferDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobOfferDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobOfferDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobOfferDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobOfferDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobOfferDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobOfferDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobOfferDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobOfferDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobOfferDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobOfferDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobOfferDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobOfferDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobOfferDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobOfferDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobOfferDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobOfferDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JobOfferDto> JobOfferDtoEnvelope::getResult() const
{
    return m_Result;
}

void JobOfferDtoEnvelope::setResult(const std::shared_ptr<JobOfferDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobOfferDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobOfferDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
