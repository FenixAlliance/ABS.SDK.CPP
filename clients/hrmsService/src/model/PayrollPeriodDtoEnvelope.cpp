...
PayrollPeriodDtoEnvelope::PayrollPeriodDtoEnvelope()
{
    m_IsSuccess = false;
...
void PayrollPeriodDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PayrollPeriodDtoEnvelope::toJson() const
{
...
bool PayrollPeriodDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PayrollPeriodDto> refVal_setResult;
...
void PayrollPeriodDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PayrollPeriodDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PayrollPeriodDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PayrollPeriodDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PayrollPeriodDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PayrollPeriodDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PayrollPeriodDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PayrollPeriodDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PayrollPeriodDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PayrollPeriodDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PayrollPeriodDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PayrollPeriodDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PayrollPeriodDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PayrollPeriodDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PayrollPeriodDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PayrollPeriodDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PayrollPeriodDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PayrollPeriodDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PayrollPeriodDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PayrollPeriodDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PayrollPeriodDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PayrollPeriodDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PayrollPeriodDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PayrollPeriodDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PayrollPeriodDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PayrollPeriodDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PayrollPeriodDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PayrollPeriodDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PayrollPeriodDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PayrollPeriodDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PayrollPeriodDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PayrollPeriodDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PayrollPeriodDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PayrollPeriodDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PayrollPeriodDto> PayrollPeriodDtoEnvelope::getResult() const
{
    return m_Result;
}

void PayrollPeriodDtoEnvelope::setResult(const std::shared_ptr<PayrollPeriodDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PayrollPeriodDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PayrollPeriodDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
