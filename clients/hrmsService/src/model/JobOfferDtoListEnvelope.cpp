...
JobOfferDtoListEnvelope::JobOfferDtoListEnvelope()
{
    m_IsSuccess = false;
...
void JobOfferDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobOfferDtoListEnvelope::toJson() const
{
...
bool JobOfferDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<JobOfferDto>> refVal_setResult;
...
void JobOfferDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobOfferDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobOfferDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobOfferDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobOfferDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobOfferDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobOfferDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobOfferDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobOfferDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobOfferDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobOfferDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobOfferDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobOfferDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobOfferDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobOfferDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobOfferDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobOfferDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobOfferDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobOfferDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobOfferDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobOfferDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobOfferDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobOfferDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobOfferDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobOfferDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobOfferDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobOfferDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobOfferDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobOfferDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobOfferDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobOfferDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobOfferDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobOfferDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobOfferDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<JobOfferDto>>& JobOfferDtoListEnvelope::getResult()
{
    return m_Result;
}

void JobOfferDtoListEnvelope::setResult(const std::vector<std::shared_ptr<JobOfferDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobOfferDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobOfferDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
