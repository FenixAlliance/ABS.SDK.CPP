...
JobTitleDtoEnvelope::JobTitleDtoEnvelope()
{
    m_IsSuccess = false;
...
void JobTitleDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobTitleDtoEnvelope::toJson() const
{
...
bool JobTitleDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JobTitleDto> refVal_setResult;
...
void JobTitleDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobTitleDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobTitleDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobTitleDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobTitleDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobTitleDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobTitleDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobTitleDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobTitleDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobTitleDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobTitleDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobTitleDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobTitleDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobTitleDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobTitleDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobTitleDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobTitleDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobTitleDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobTitleDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobTitleDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobTitleDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobTitleDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobTitleDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobTitleDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobTitleDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobTitleDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobTitleDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobTitleDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobTitleDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobTitleDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobTitleDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobTitleDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobTitleDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobTitleDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JobTitleDto> JobTitleDtoEnvelope::getResult() const
{
    return m_Result;
}

void JobTitleDtoEnvelope::setResult(const std::shared_ptr<JobTitleDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobTitleDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobTitleDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
