...
JobFieldDtoEnvelope::JobFieldDtoEnvelope()
{
    m_IsSuccess = false;
...
void JobFieldDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JobFieldDtoEnvelope::toJson() const
{
...
bool JobFieldDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JobFieldDto> refVal_setResult;
...
void JobFieldDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JobFieldDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JobFieldDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JobFieldDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JobFieldDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JobFieldDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JobFieldDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JobFieldDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JobFieldDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JobFieldDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JobFieldDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JobFieldDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JobFieldDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JobFieldDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JobFieldDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JobFieldDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JobFieldDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JobFieldDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JobFieldDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JobFieldDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JobFieldDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JobFieldDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JobFieldDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JobFieldDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JobFieldDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JobFieldDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JobFieldDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JobFieldDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JobFieldDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JobFieldDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JobFieldDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JobFieldDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JobFieldDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JobFieldDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JobFieldDto> JobFieldDtoEnvelope::getResult() const
{
    return m_Result;
}

void JobFieldDtoEnvelope::setResult(const std::shared_ptr<JobFieldDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JobFieldDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JobFieldDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
