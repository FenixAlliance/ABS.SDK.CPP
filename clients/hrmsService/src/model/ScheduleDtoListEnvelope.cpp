...
ScheduleDtoListEnvelope::ScheduleDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ScheduleDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ScheduleDtoListEnvelope::toJson() const
{
...
bool ScheduleDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ScheduleDto>> refVal_setResult;
...
void ScheduleDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScheduleDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ScheduleDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ScheduleDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ScheduleDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ScheduleDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ScheduleDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ScheduleDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ScheduleDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ScheduleDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ScheduleDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ScheduleDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ScheduleDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ScheduleDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ScheduleDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ScheduleDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ScheduleDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ScheduleDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ScheduleDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ScheduleDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ScheduleDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ScheduleDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ScheduleDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ScheduleDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ScheduleDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ScheduleDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ScheduleDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ScheduleDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ScheduleDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ScheduleDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ScheduleDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ScheduleDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ScheduleDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ScheduleDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ScheduleDto>>& ScheduleDtoListEnvelope::getResult()
{
    return m_Result;
}

void ScheduleDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ScheduleDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ScheduleDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ScheduleDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
