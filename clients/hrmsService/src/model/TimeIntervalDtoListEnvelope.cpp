...
TimeIntervalDtoListEnvelope::TimeIntervalDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TimeIntervalDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TimeIntervalDtoListEnvelope::toJson() const
{
...
bool TimeIntervalDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TimeIntervalDto>> refVal_setResult;
...
void TimeIntervalDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TimeIntervalDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TimeIntervalDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TimeIntervalDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TimeIntervalDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TimeIntervalDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TimeIntervalDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TimeIntervalDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TimeIntervalDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TimeIntervalDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TimeIntervalDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TimeIntervalDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TimeIntervalDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TimeIntervalDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TimeIntervalDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TimeIntervalDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TimeIntervalDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TimeIntervalDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TimeIntervalDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TimeIntervalDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TimeIntervalDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TimeIntervalDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TimeIntervalDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TimeIntervalDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TimeIntervalDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TimeIntervalDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TimeIntervalDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TimeIntervalDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TimeIntervalDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TimeIntervalDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TimeIntervalDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TimeIntervalDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TimeIntervalDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TimeIntervalDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TimeIntervalDto>>& TimeIntervalDtoListEnvelope::getResult()
{
    return m_Result;
}

void TimeIntervalDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TimeIntervalDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TimeIntervalDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TimeIntervalDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
