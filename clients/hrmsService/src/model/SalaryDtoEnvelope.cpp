...
SalaryDtoEnvelope::SalaryDtoEnvelope()
{
    m_IsSuccess = false;
...
void SalaryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SalaryDtoEnvelope::toJson() const
{
...
bool SalaryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SalaryDto> refVal_setResult;
...
void SalaryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SalaryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SalaryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SalaryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SalaryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SalaryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SalaryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SalaryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SalaryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SalaryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SalaryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SalaryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SalaryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SalaryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SalaryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SalaryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SalaryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SalaryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SalaryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SalaryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SalaryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SalaryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SalaryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SalaryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SalaryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SalaryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SalaryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SalaryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SalaryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SalaryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SalaryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SalaryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SalaryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SalaryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SalaryDto> SalaryDtoEnvelope::getResult() const
{
    return m_Result;
}

void SalaryDtoEnvelope::setResult(const std::shared_ptr<SalaryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SalaryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SalaryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
