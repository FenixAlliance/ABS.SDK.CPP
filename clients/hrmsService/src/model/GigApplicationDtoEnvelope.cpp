...
GigApplicationDtoEnvelope::GigApplicationDtoEnvelope()
{
    m_IsSuccess = false;
...
void GigApplicationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value GigApplicationDtoEnvelope::toJson() const
{
...
bool GigApplicationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GigApplicationDto> refVal_setResult;
...
void GigApplicationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GigApplicationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool GigApplicationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void GigApplicationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool GigApplicationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void GigApplicationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t GigApplicationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void GigApplicationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool GigApplicationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void GigApplicationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t GigApplicationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void GigApplicationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool GigApplicationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void GigApplicationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime GigApplicationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void GigApplicationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GigApplicationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GigApplicationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t GigApplicationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void GigApplicationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool GigApplicationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void GigApplicationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t GigApplicationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void GigApplicationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool GigApplicationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void GigApplicationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& GigApplicationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void GigApplicationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool GigApplicationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void GigApplicationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t GigApplicationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void GigApplicationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool GigApplicationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void GigApplicationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<GigApplicationDto> GigApplicationDtoEnvelope::getResult() const
{
    return m_Result;
}

void GigApplicationDtoEnvelope::setResult(const std::shared_ptr<GigApplicationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GigApplicationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void GigApplicationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
