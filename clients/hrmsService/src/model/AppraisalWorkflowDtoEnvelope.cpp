...
AppraisalWorkflowDtoEnvelope::AppraisalWorkflowDtoEnvelope()
{
    m_IsSuccess = false;
...
void AppraisalWorkflowDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AppraisalWorkflowDtoEnvelope::toJson() const
{
...
bool AppraisalWorkflowDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AppraisalWorkflowDto> refVal_setResult;
...
void AppraisalWorkflowDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AppraisalWorkflowDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AppraisalWorkflowDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AppraisalWorkflowDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AppraisalWorkflowDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AppraisalWorkflowDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AppraisalWorkflowDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AppraisalWorkflowDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AppraisalWorkflowDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AppraisalWorkflowDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AppraisalWorkflowDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AppraisalWorkflowDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AppraisalWorkflowDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AppraisalWorkflowDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AppraisalWorkflowDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AppraisalWorkflowDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AppraisalWorkflowDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AppraisalWorkflowDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AppraisalWorkflowDto> AppraisalWorkflowDtoEnvelope::getResult() const
{
    return m_Result;
}

void AppraisalWorkflowDtoEnvelope::setResult(const std::shared_ptr<AppraisalWorkflowDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AppraisalWorkflowDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AppraisalWorkflowDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
