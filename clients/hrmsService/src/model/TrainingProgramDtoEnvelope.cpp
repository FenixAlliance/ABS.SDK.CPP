...
TrainingProgramDtoEnvelope::TrainingProgramDtoEnvelope()
{
    m_IsSuccess = false;
...
void TrainingProgramDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TrainingProgramDtoEnvelope::toJson() const
{
...
bool TrainingProgramDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TrainingProgramDto> refVal_setResult;
...
void TrainingProgramDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TrainingProgramDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TrainingProgramDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TrainingProgramDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TrainingProgramDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TrainingProgramDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TrainingProgramDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TrainingProgramDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TrainingProgramDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TrainingProgramDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TrainingProgramDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TrainingProgramDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TrainingProgramDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TrainingProgramDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TrainingProgramDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TrainingProgramDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TrainingProgramDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TrainingProgramDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TrainingProgramDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TrainingProgramDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TrainingProgramDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TrainingProgramDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TrainingProgramDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TrainingProgramDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TrainingProgramDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TrainingProgramDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TrainingProgramDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TrainingProgramDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TrainingProgramDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TrainingProgramDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TrainingProgramDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TrainingProgramDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TrainingProgramDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TrainingProgramDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TrainingProgramDto> TrainingProgramDtoEnvelope::getResult() const
{
    return m_Result;
}

void TrainingProgramDtoEnvelope::setResult(const std::shared_ptr<TrainingProgramDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TrainingProgramDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TrainingProgramDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
