...
/*
 * JobApplicantProfileDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_JobApplicantProfileDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_JobApplicantProfileDtoListEnvelope_H_
...
public:
    ...
    virtual ~JobApplicantProfileDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// JobApplicantProfileDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<JobApplicantProfileDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<JobApplicantProfileDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<JobApplicantProfileDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_JobApplicantProfileDtoListEnvelope_H_ */
