...
/*
 * GigApplicationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoListEnvelope_H_
...
public:
    ...
    virtual ~GigApplicationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// GigApplicationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<GigApplicationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<GigApplicationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<GigApplicationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoListEnvelope_H_ */
