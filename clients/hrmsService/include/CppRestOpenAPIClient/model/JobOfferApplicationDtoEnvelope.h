...
/*
 * JobOfferApplicationDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoEnvelope_H_
...
public:
    ...
    virtual ~JobOfferApplicationDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// JobOfferApplicationDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<JobOfferApplicationDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<JobOfferApplicationDto>& value);
...
protected:
    ...
    std::shared_ptr<JobOfferApplicationDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoEnvelope_H_ */
