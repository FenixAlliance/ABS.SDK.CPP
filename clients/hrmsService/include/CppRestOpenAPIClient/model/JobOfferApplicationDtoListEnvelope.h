...
/*
 * JobOfferApplicationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoListEnvelope_H_
...
public:
    ...
    virtual ~JobOfferApplicationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// JobOfferApplicationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<JobOfferApplicationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<JobOfferApplicationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<JobOfferApplicationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_JobOfferApplicationDtoListEnvelope_H_ */
