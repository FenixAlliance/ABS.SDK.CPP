...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getSkillsRequired() const;
    bool skillsRequiredIsSet() const;
    void unsetSkillsRequired();

    void setSkillsRequired(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_SkillsRequired;
    bool m_SkillsRequiredIsSet;
};
