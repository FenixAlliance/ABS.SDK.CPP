...
/*
 * GigApplicationDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoEnvelope_H_
...
public:
    ...
    virtual ~GigApplicationDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// GigApplicationDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<GigApplicationDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<GigApplicationDto>& value);
...
protected:
    ...
    std::shared_ptr<GigApplicationDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GigApplicationDtoEnvelope_H_ */
