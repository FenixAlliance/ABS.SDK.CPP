...
/*
 * JobFieldDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_JobFieldDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_JobFieldDtoListEnvelope_H_
...
public:
    ...
    virtual ~JobFieldDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// JobFieldDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<JobFieldDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<JobFieldDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<JobFieldDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_JobFieldDtoListEnvelope_H_ */
