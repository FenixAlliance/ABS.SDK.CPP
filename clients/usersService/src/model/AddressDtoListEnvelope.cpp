...
AddressDtoListEnvelope::AddressDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AddressDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AddressDtoListEnvelope::toJson() const
{
...
bool AddressDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AddressDto>> refVal_setResult;
...
void AddressDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddressDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AddressDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AddressDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AddressDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AddressDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AddressDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AddressDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AddressDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AddressDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AddressDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AddressDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AddressDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AddressDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AddressDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AddressDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AddressDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AddressDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AddressDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AddressDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AddressDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AddressDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AddressDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AddressDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AddressDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AddressDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AddressDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AddressDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AddressDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AddressDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AddressDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AddressDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AddressDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AddressDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AddressDto>>& AddressDtoListEnvelope::getResult()
{
    return m_Result;
}

void AddressDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AddressDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AddressDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AddressDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
