...
ExtendedTenantDtoListEnvelope::ExtendedTenantDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedTenantDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedTenantDtoListEnvelope::toJson() const
{
...
bool ExtendedTenantDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ExtendedTenantDto>> refVal_setResult;
...
void ExtendedTenantDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedTenantDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedTenantDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedTenantDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedTenantDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedTenantDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedTenantDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedTenantDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedTenantDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedTenantDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedTenantDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedTenantDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedTenantDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedTenantDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedTenantDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedTenantDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedTenantDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedTenantDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ExtendedTenantDto>>& ExtendedTenantDtoListEnvelope::getResult()
{
    return m_Result;
}

void ExtendedTenantDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ExtendedTenantDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedTenantDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedTenantDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
