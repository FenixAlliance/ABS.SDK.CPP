...
FollowRecordDtoListEnvelope::FollowRecordDtoListEnvelope()
{
    m_IsSuccess = false;
...
void FollowRecordDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FollowRecordDtoListEnvelope::toJson() const
{
...
bool FollowRecordDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FollowRecordDto>> refVal_setResult;
...
void FollowRecordDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FollowRecordDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FollowRecordDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FollowRecordDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FollowRecordDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FollowRecordDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FollowRecordDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FollowRecordDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FollowRecordDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FollowRecordDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FollowRecordDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FollowRecordDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FollowRecordDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FollowRecordDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FollowRecordDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FollowRecordDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FollowRecordDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FollowRecordDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FollowRecordDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FollowRecordDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FollowRecordDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FollowRecordDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FollowRecordDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FollowRecordDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FollowRecordDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FollowRecordDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FollowRecordDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FollowRecordDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FollowRecordDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FollowRecordDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FollowRecordDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FollowRecordDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FollowRecordDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FollowRecordDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<FollowRecordDto>>& FollowRecordDtoListEnvelope::getResult()
{
    return m_Result;
}

void FollowRecordDtoListEnvelope::setResult(const std::vector<std::shared_ptr<FollowRecordDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FollowRecordDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FollowRecordDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
