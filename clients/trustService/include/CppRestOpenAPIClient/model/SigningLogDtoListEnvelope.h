...
/*
 * SigningLogDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SigningLogDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SigningLogDtoListEnvelope_H_
...
public:
    ...
    virtual ~SigningLogDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// SigningLogDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SigningLogDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<SigningLogDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SigningLogDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SigningLogDtoListEnvelope_H_ */
