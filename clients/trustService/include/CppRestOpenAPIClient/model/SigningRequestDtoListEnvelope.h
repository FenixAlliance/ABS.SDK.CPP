...
/*
 * SigningRequestDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SigningRequestDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SigningRequestDtoListEnvelope_H_
...
public:
    ...
    virtual ~SigningRequestDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// SigningRequestDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SigningRequestDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<SigningRequestDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SigningRequestDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SigningRequestDtoListEnvelope_H_ */
