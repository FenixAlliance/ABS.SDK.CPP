...
/*
 * TrustSigningReadinessDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningReadinessDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningReadinessDtoEnvelope_H_
...
public:
    ...
    virtual ~TrustSigningReadinessDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// TrustSigningReadinessDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<TrustSigningReadinessDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<TrustSigningReadinessDto>& value);
...
protected:
    ...
    std::shared_ptr<TrustSigningReadinessDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningReadinessDtoEnvelope_H_ */
