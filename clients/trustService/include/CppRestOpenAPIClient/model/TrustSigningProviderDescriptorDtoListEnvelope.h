...
/*
 * TrustSigningProviderDescriptorDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningProviderDescriptorDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningProviderDescriptorDtoListEnvelope_H_
...
public:
    ...
    virtual ~TrustSigningProviderDescriptorDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// TrustSigningProviderDescriptorDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TrustSigningProviderDescriptorDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<TrustSigningProviderDescriptorDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<TrustSigningProviderDescriptorDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TrustSigningProviderDescriptorDtoListEnvelope_H_ */
