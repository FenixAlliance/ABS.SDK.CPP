...
/*
 * SignatureDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SignatureDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SignatureDtoListEnvelope_H_
...
public:
    ...
    virtual ~SignatureDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// SignatureDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SignatureDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<SignatureDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SignatureDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SignatureDtoListEnvelope_H_ */
