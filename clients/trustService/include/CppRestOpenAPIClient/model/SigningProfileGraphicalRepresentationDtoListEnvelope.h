...
/*
 * SigningProfileGraphicalRepresentationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SigningProfileGraphicalRepresentationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SigningProfileGraphicalRepresentationDtoListEnvelope_H_
...
public:
    ...
    virtual ~SigningProfileGraphicalRepresentationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// SigningProfileGraphicalRepresentationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SigningProfileGraphicalRepresentationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<SigningProfileGraphicalRepresentationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SigningProfileGraphicalRepresentationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SigningProfileGraphicalRepresentationDtoListEnvelope_H_ */
