...
SignatureDtoListEnvelope::SignatureDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SignatureDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SignatureDtoListEnvelope::toJson() const
{
...
bool SignatureDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SignatureDto>> refVal_setResult;
...
void SignatureDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SignatureDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SignatureDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SignatureDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SignatureDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SignatureDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SignatureDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SignatureDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SignatureDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SignatureDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SignatureDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SignatureDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SignatureDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SignatureDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SignatureDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SignatureDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SignatureDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SignatureDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SignatureDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SignatureDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SignatureDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SignatureDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SignatureDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SignatureDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SignatureDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SignatureDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SignatureDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SignatureDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SignatureDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SignatureDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SignatureDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SignatureDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SignatureDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SignatureDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SignatureDto>>& SignatureDtoListEnvelope::getResult()
{
    return m_Result;
}

void SignatureDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SignatureDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SignatureDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SignatureDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
