...
SigningRequestDtoListEnvelope::SigningRequestDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SigningRequestDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SigningRequestDtoListEnvelope::toJson() const
{
...
bool SigningRequestDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SigningRequestDto>> refVal_setResult;
...
void SigningRequestDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SigningRequestDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SigningRequestDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SigningRequestDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SigningRequestDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SigningRequestDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SigningRequestDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SigningRequestDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SigningRequestDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SigningRequestDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SigningRequestDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SigningRequestDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SigningRequestDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SigningRequestDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SigningRequestDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SigningRequestDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SigningRequestDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SigningRequestDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SigningRequestDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SigningRequestDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SigningRequestDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SigningRequestDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SigningRequestDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SigningRequestDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SigningRequestDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SigningRequestDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SigningRequestDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SigningRequestDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SigningRequestDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SigningRequestDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SigningRequestDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SigningRequestDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SigningRequestDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SigningRequestDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SigningRequestDto>>& SigningRequestDtoListEnvelope::getResult()
{
    return m_Result;
}

void SigningRequestDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SigningRequestDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SigningRequestDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SigningRequestDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
