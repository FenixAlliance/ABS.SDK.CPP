...
PointOfSaleDtoListEnvelope::PointOfSaleDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PointOfSaleDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PointOfSaleDtoListEnvelope::toJson() const
{
...
bool PointOfSaleDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PointOfSaleDto>> refVal_setResult;
...
void PointOfSaleDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PointOfSaleDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PointOfSaleDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PointOfSaleDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PointOfSaleDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PointOfSaleDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PointOfSaleDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PointOfSaleDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PointOfSaleDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PointOfSaleDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PointOfSaleDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PointOfSaleDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PointOfSaleDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PointOfSaleDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PointOfSaleDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PointOfSaleDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PointOfSaleDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PointOfSaleDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PointOfSaleDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PointOfSaleDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PointOfSaleDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PointOfSaleDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PointOfSaleDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PointOfSaleDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PointOfSaleDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PointOfSaleDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PointOfSaleDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PointOfSaleDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PointOfSaleDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PointOfSaleDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PointOfSaleDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PointOfSaleDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PointOfSaleDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PointOfSaleDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PointOfSaleDto>>& PointOfSaleDtoListEnvelope::getResult()
{
    return m_Result;
}

void PointOfSaleDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PointOfSaleDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PointOfSaleDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PointOfSaleDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
