...
SalesLiteratureDtoEnvelope::SalesLiteratureDtoEnvelope()
{
    m_IsSuccess = false;
...
void SalesLiteratureDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SalesLiteratureDtoEnvelope::toJson() const
{
...
bool SalesLiteratureDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SalesLiteratureDto> refVal_setResult;
...
void SalesLiteratureDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SalesLiteratureDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SalesLiteratureDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SalesLiteratureDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SalesLiteratureDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SalesLiteratureDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SalesLiteratureDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SalesLiteratureDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SalesLiteratureDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SalesLiteratureDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SalesLiteratureDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SalesLiteratureDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SalesLiteratureDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SalesLiteratureDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SalesLiteratureDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SalesLiteratureDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SalesLiteratureDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SalesLiteratureDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SalesLiteratureDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SalesLiteratureDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SalesLiteratureDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SalesLiteratureDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SalesLiteratureDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SalesLiteratureDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SalesLiteratureDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SalesLiteratureDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SalesLiteratureDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SalesLiteratureDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SalesLiteratureDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SalesLiteratureDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SalesLiteratureDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SalesLiteratureDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SalesLiteratureDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SalesLiteratureDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SalesLiteratureDto> SalesLiteratureDtoEnvelope::getResult() const
{
    return m_Result;
}

void SalesLiteratureDtoEnvelope::setResult(const std::shared_ptr<SalesLiteratureDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SalesLiteratureDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SalesLiteratureDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
