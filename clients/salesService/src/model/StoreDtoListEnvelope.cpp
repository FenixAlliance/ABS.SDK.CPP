...
StoreDtoListEnvelope::StoreDtoListEnvelope()
{
    m_IsSuccess = false;
...
void StoreDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value StoreDtoListEnvelope::toJson() const
{
...
bool StoreDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<StoreDto>> refVal_setResult;
...
void StoreDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StoreDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool StoreDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void StoreDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool StoreDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void StoreDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t StoreDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void StoreDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool StoreDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void StoreDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t StoreDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void StoreDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool StoreDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void StoreDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime StoreDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void StoreDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool StoreDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void StoreDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t StoreDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void StoreDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool StoreDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void StoreDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t StoreDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void StoreDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool StoreDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void StoreDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& StoreDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void StoreDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool StoreDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void StoreDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t StoreDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void StoreDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool StoreDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void StoreDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<StoreDto>>& StoreDtoListEnvelope::getResult()
{
    return m_Result;
}

void StoreDtoListEnvelope::setResult(const std::vector<std::shared_ptr<StoreDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StoreDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void StoreDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
