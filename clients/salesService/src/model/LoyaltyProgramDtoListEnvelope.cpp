...
LoyaltyProgramDtoListEnvelope::LoyaltyProgramDtoListEnvelope()
{
    m_IsSuccess = false;
...
void LoyaltyProgramDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LoyaltyProgramDtoListEnvelope::toJson() const
{
...
bool LoyaltyProgramDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<LoyaltyProgramDto>> refVal_setResult;
...
void LoyaltyProgramDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LoyaltyProgramDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LoyaltyProgramDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LoyaltyProgramDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LoyaltyProgramDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LoyaltyProgramDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LoyaltyProgramDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LoyaltyProgramDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LoyaltyProgramDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LoyaltyProgramDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LoyaltyProgramDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LoyaltyProgramDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LoyaltyProgramDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LoyaltyProgramDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LoyaltyProgramDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LoyaltyProgramDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LoyaltyProgramDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LoyaltyProgramDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<LoyaltyProgramDto>>& LoyaltyProgramDtoListEnvelope::getResult()
{
    return m_Result;
}

void LoyaltyProgramDtoListEnvelope::setResult(const std::vector<std::shared_ptr<LoyaltyProgramDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LoyaltyProgramDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LoyaltyProgramDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
