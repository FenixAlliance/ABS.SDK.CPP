...
StoreDtoEnvelope::StoreDtoEnvelope()
{
    m_IsSuccess = false;
...
void StoreDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value StoreDtoEnvelope::toJson() const
{
...
bool StoreDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<StoreDto> refVal_setResult;
...
void StoreDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StoreDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool StoreDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void StoreDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool StoreDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void StoreDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t StoreDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void StoreDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool StoreDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void StoreDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t StoreDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void StoreDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool StoreDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void StoreDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime StoreDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void StoreDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool StoreDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void StoreDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t StoreDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void StoreDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool StoreDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void StoreDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t StoreDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void StoreDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool StoreDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void StoreDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& StoreDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void StoreDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool StoreDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void StoreDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t StoreDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void StoreDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool StoreDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void StoreDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<StoreDto> StoreDtoEnvelope::getResult() const
{
    return m_Result;
}

void StoreDtoEnvelope::setResult(const std::shared_ptr<StoreDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StoreDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void StoreDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
