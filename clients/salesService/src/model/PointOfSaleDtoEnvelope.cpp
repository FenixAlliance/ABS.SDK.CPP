...
PointOfSaleDtoEnvelope::PointOfSaleDtoEnvelope()
{
    m_IsSuccess = false;
...
void PointOfSaleDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PointOfSaleDtoEnvelope::toJson() const
{
...
bool PointOfSaleDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PointOfSaleDto> refVal_setResult;
...
void PointOfSaleDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PointOfSaleDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PointOfSaleDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PointOfSaleDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PointOfSaleDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PointOfSaleDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PointOfSaleDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PointOfSaleDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PointOfSaleDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PointOfSaleDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PointOfSaleDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PointOfSaleDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PointOfSaleDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PointOfSaleDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PointOfSaleDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PointOfSaleDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PointOfSaleDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PointOfSaleDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PointOfSaleDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PointOfSaleDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PointOfSaleDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PointOfSaleDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PointOfSaleDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PointOfSaleDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PointOfSaleDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PointOfSaleDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PointOfSaleDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PointOfSaleDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PointOfSaleDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PointOfSaleDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PointOfSaleDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PointOfSaleDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PointOfSaleDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PointOfSaleDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PointOfSaleDto> PointOfSaleDtoEnvelope::getResult() const
{
    return m_Result;
}

void PointOfSaleDtoEnvelope::setResult(const std::shared_ptr<PointOfSaleDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PointOfSaleDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PointOfSaleDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
