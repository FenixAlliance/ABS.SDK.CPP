...
LoyaltyProgramDtoEnvelope::LoyaltyProgramDtoEnvelope()
{
    m_IsSuccess = false;
...
void LoyaltyProgramDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LoyaltyProgramDtoEnvelope::toJson() const
{
...
bool LoyaltyProgramDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LoyaltyProgramDto> refVal_setResult;
...
void LoyaltyProgramDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LoyaltyProgramDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LoyaltyProgramDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LoyaltyProgramDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LoyaltyProgramDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LoyaltyProgramDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LoyaltyProgramDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LoyaltyProgramDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LoyaltyProgramDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LoyaltyProgramDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LoyaltyProgramDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LoyaltyProgramDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LoyaltyProgramDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LoyaltyProgramDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LoyaltyProgramDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LoyaltyProgramDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LoyaltyProgramDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LoyaltyProgramDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LoyaltyProgramDto> LoyaltyProgramDtoEnvelope::getResult() const
{
    return m_Result;
}

void LoyaltyProgramDtoEnvelope::setResult(const std::shared_ptr<LoyaltyProgramDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LoyaltyProgramDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LoyaltyProgramDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
