...
/*
 * PostingExecutionDtoIReadOnlyListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PostingExecutionDtoIReadOnlyListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PostingExecutionDtoIReadOnlyListEnvelope_H_
...
public:
    ...
    virtual ~PostingExecutionDtoIReadOnlyListEnvelope();
    ...
    /////////////////////////////////////////////
    /// PostingExecutionDtoIReadOnlyListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PostingExecutionDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<PostingExecutionDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<PostingExecutionDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PostingExecutionDtoIReadOnlyListEnvelope_H_ */
