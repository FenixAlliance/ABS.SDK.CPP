...
TaxClassDtoListEnvelope::TaxClassDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TaxClassDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxClassDtoListEnvelope::toJson() const
{
...
bool TaxClassDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TaxClassDto>> refVal_setResult;
...
void TaxClassDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxClassDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxClassDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxClassDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxClassDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxClassDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxClassDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxClassDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxClassDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxClassDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxClassDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxClassDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxClassDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxClassDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxClassDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxClassDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxClassDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxClassDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxClassDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxClassDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxClassDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxClassDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxClassDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxClassDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxClassDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxClassDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxClassDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxClassDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxClassDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxClassDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxClassDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxClassDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxClassDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxClassDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TaxClassDto>>& TaxClassDtoListEnvelope::getResult()
{
    return m_Result;
}

void TaxClassDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TaxClassDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxClassDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxClassDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
