...
AccountTypeDtoListEnvelope::AccountTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AccountTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountTypeDtoListEnvelope::toJson() const
{
...
bool AccountTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AccountTypeDto>> refVal_setResult;
...
void AccountTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AccountTypeDto>>& AccountTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void AccountTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AccountTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
