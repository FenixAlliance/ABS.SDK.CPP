...
TaxPolicyDtoEnvelope::TaxPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void TaxPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxPolicyDtoEnvelope::toJson() const
{
...
bool TaxPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaxPolicyDto> refVal_setResult;
...
void TaxPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TaxPolicyDto> TaxPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void TaxPolicyDtoEnvelope::setResult(const std::shared_ptr<TaxPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
