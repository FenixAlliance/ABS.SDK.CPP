...
AccountGroupDtoListEnvelope::AccountGroupDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AccountGroupDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountGroupDtoListEnvelope::toJson() const
{
...
bool AccountGroupDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AccountGroupDto>> refVal_setResult;
...
void AccountGroupDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountGroupDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountGroupDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountGroupDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountGroupDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountGroupDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountGroupDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountGroupDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountGroupDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountGroupDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountGroupDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountGroupDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountGroupDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountGroupDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountGroupDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountGroupDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountGroupDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountGroupDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountGroupDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountGroupDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountGroupDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountGroupDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountGroupDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountGroupDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountGroupDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountGroupDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountGroupDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountGroupDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountGroupDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountGroupDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountGroupDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountGroupDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountGroupDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountGroupDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AccountGroupDto>>& AccountGroupDtoListEnvelope::getResult()
{
    return m_Result;
}

void AccountGroupDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AccountGroupDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountGroupDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountGroupDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
