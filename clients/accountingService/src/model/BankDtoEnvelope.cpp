...
BankDtoEnvelope::BankDtoEnvelope()
{
    m_IsSuccess = false;
...
void BankDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankDtoEnvelope::toJson() const
{
...
bool BankDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BankDto> refVal_setResult;
...
void BankDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BankDto> BankDtoEnvelope::getResult() const
{
    return m_Result;
}

void BankDtoEnvelope::setResult(const std::shared_ptr<BankDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
