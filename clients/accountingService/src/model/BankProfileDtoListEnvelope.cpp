...
BankProfileDtoListEnvelope::BankProfileDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BankProfileDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankProfileDtoListEnvelope::toJson() const
{
...
bool BankProfileDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BankProfileDto>> refVal_setResult;
...
void BankProfileDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankProfileDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankProfileDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankProfileDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankProfileDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankProfileDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankProfileDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankProfileDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankProfileDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankProfileDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankProfileDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankProfileDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankProfileDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankProfileDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankProfileDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankProfileDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankProfileDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankProfileDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankProfileDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankProfileDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankProfileDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankProfileDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankProfileDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankProfileDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankProfileDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankProfileDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankProfileDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankProfileDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankProfileDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankProfileDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankProfileDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankProfileDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankProfileDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankProfileDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BankProfileDto>>& BankProfileDtoListEnvelope::getResult()
{
    return m_Result;
}

void BankProfileDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BankProfileDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankProfileDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankProfileDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
