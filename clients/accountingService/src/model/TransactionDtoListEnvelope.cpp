...
TransactionDtoListEnvelope::TransactionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TransactionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TransactionDtoListEnvelope::toJson() const
{
...
bool TransactionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TransactionDto>> refVal_setResult;
...
void TransactionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TransactionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TransactionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TransactionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TransactionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TransactionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TransactionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TransactionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TransactionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TransactionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TransactionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TransactionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TransactionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TransactionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TransactionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TransactionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TransactionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TransactionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TransactionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TransactionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TransactionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TransactionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TransactionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TransactionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TransactionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TransactionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TransactionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TransactionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TransactionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TransactionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TransactionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TransactionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TransactionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TransactionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TransactionDto>>& TransactionDtoListEnvelope::getResult()
{
    return m_Result;
}

void TransactionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TransactionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TransactionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TransactionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
