...
BankDtoListEnvelope::BankDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BankDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankDtoListEnvelope::toJson() const
{
...
bool BankDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BankDto>> refVal_setResult;
...
void BankDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BankDto>>& BankDtoListEnvelope::getResult()
{
    return m_Result;
}

void BankDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BankDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
