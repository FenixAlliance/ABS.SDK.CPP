...
FinancialBookDtoEnvelope::FinancialBookDtoEnvelope()
{
    m_IsSuccess = false;
...
void FinancialBookDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FinancialBookDtoEnvelope::toJson() const
{
...
bool FinancialBookDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FinancialBookDto> refVal_setResult;
...
void FinancialBookDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FinancialBookDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FinancialBookDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FinancialBookDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FinancialBookDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FinancialBookDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FinancialBookDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FinancialBookDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FinancialBookDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FinancialBookDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FinancialBookDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FinancialBookDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FinancialBookDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FinancialBookDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FinancialBookDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FinancialBookDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FinancialBookDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FinancialBookDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FinancialBookDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FinancialBookDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FinancialBookDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FinancialBookDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FinancialBookDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FinancialBookDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FinancialBookDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FinancialBookDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FinancialBookDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FinancialBookDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FinancialBookDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FinancialBookDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FinancialBookDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FinancialBookDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FinancialBookDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FinancialBookDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<FinancialBookDto> FinancialBookDtoEnvelope::getResult() const
{
    return m_Result;
}

void FinancialBookDtoEnvelope::setResult(const std::shared_ptr<FinancialBookDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FinancialBookDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FinancialBookDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
