...
LedgerDtoEnvelope::LedgerDtoEnvelope()
{
    m_IsSuccess = false;
...
void LedgerDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LedgerDtoEnvelope::toJson() const
{
...
bool LedgerDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LedgerDto> refVal_setResult;
...
void LedgerDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LedgerDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LedgerDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LedgerDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LedgerDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LedgerDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LedgerDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LedgerDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LedgerDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LedgerDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LedgerDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LedgerDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LedgerDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LedgerDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LedgerDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LedgerDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LedgerDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LedgerDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LedgerDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LedgerDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LedgerDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LedgerDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LedgerDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LedgerDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LedgerDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LedgerDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LedgerDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LedgerDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LedgerDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LedgerDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LedgerDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LedgerDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LedgerDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LedgerDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LedgerDto> LedgerDtoEnvelope::getResult() const
{
    return m_Result;
}

void LedgerDtoEnvelope::setResult(const std::shared_ptr<LedgerDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LedgerDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LedgerDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
