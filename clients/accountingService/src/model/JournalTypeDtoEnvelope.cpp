...
JournalTypeDtoEnvelope::JournalTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void JournalTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JournalTypeDtoEnvelope::toJson() const
{
...
bool JournalTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JournalTypeDto> refVal_setResult;
...
void JournalTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JournalTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JournalTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JournalTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JournalTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JournalTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JournalTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JournalTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JournalTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JournalTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JournalTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JournalTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JournalTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JournalTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JournalTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JournalTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JournalTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JournalTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JournalTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JournalTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JournalTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JournalTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JournalTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JournalTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JournalTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JournalTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JournalTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JournalTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JournalTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JournalTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JournalTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JournalTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JournalTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JournalTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JournalTypeDto> JournalTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void JournalTypeDtoEnvelope::setResult(const std::shared_ptr<JournalTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JournalTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JournalTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
