...
void FiscalRegimeCreateDto::validate()
{
    // TODO: implement validation
}

web::json::value FiscalRegimeCreateDto::toJson() const
{
...
bool FiscalRegimeCreateDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FiscalRegimeCreateDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalRegimeCreateDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t FiscalRegimeCreateDto::getId() const
{
    return m_Id;
}

void FiscalRegimeCreateDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool FiscalRegimeCreateDto::idIsSet() const
{
    return m_IdIsSet;
}

void FiscalRegimeCreateDto::unsetId()
{
    m_IdIsSet = false;
}
utility::datetime FiscalRegimeCreateDto::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalRegimeCreateDto::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalRegimeCreateDto::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalRegimeCreateDto::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t FiscalRegimeCreateDto::getCode() const
{
    return m_Code;
}

void FiscalRegimeCreateDto::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool FiscalRegimeCreateDto::codeIsSet() const
{
    return m_CodeIsSet;
}

void FiscalRegimeCreateDto::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t FiscalRegimeCreateDto::getName() const
{
    return m_Name;
}

void FiscalRegimeCreateDto::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool FiscalRegimeCreateDto::nameIsSet() const
{
    return m_NameIsSet;
}

void FiscalRegimeCreateDto::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t FiscalRegimeCreateDto::getFiscalAuthorityId() const
{
    return m_FiscalAuthorityId;
}

void FiscalRegimeCreateDto::setFiscalAuthorityId(const utility::string_t& value)
{
    m_FiscalAuthorityId = value;
    m_FiscalAuthorityIdIsSet = true;
}

bool FiscalRegimeCreateDto::fiscalAuthorityIdIsSet() const
{
    return m_FiscalAuthorityIdIsSet;
}

void FiscalRegimeCreateDto::unsetFiscalAuthorityId()
{
    m_FiscalAuthorityIdIsSet = false;
}
utility::string_t FiscalRegimeCreateDto::getTenantId() const
{
    return m_TenantId;
}

void FiscalRegimeCreateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool FiscalRegimeCreateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void FiscalRegimeCreateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t FiscalRegimeCreateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void FiscalRegimeCreateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool FiscalRegimeCreateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void FiscalRegimeCreateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
