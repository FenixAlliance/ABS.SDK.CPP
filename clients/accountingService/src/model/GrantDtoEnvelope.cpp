...
GrantDtoEnvelope::GrantDtoEnvelope()
{
    m_IsSuccess = false;
...
void GrantDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value GrantDtoEnvelope::toJson() const
{
...
bool GrantDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GrantDto> refVal_setResult;
...
void GrantDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrantDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool GrantDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void GrantDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool GrantDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void GrantDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t GrantDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void GrantDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool GrantDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void GrantDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t GrantDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void GrantDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool GrantDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void GrantDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime GrantDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void GrantDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GrantDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GrantDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t GrantDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void GrantDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool GrantDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void GrantDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t GrantDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void GrantDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool GrantDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void GrantDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& GrantDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void GrantDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool GrantDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void GrantDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t GrantDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void GrantDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool GrantDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void GrantDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<GrantDto> GrantDtoEnvelope::getResult() const
{
    return m_Result;
}

void GrantDtoEnvelope::setResult(const std::shared_ptr<GrantDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GrantDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void GrantDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
