...
TaxRateDtoEnvelope::TaxRateDtoEnvelope()
{
    m_IsSuccess = false;
...
void TaxRateDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxRateDtoEnvelope::toJson() const
{
...
bool TaxRateDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaxRateDto> refVal_setResult;
...
void TaxRateDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxRateDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxRateDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxRateDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxRateDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxRateDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxRateDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxRateDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxRateDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxRateDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxRateDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxRateDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxRateDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxRateDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxRateDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxRateDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxRateDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxRateDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxRateDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxRateDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxRateDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxRateDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxRateDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxRateDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxRateDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxRateDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxRateDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxRateDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxRateDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxRateDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxRateDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxRateDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxRateDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxRateDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TaxRateDto> TaxRateDtoEnvelope::getResult() const
{
    return m_Result;
}

void TaxRateDtoEnvelope::setResult(const std::shared_ptr<TaxRateDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxRateDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxRateDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
