...
TransactionCategoryDtoEnvelope::TransactionCategoryDtoEnvelope()
{
    m_IsSuccess = false;
...
void TransactionCategoryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TransactionCategoryDtoEnvelope::toJson() const
{
...
bool TransactionCategoryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TransactionCategoryDto> refVal_setResult;
...
void TransactionCategoryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TransactionCategoryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TransactionCategoryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TransactionCategoryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TransactionCategoryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TransactionCategoryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TransactionCategoryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TransactionCategoryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TransactionCategoryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TransactionCategoryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TransactionCategoryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TransactionCategoryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TransactionCategoryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TransactionCategoryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TransactionCategoryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TransactionCategoryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TransactionCategoryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TransactionCategoryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TransactionCategoryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TransactionCategoryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TransactionCategoryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TransactionCategoryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TransactionCategoryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TransactionCategoryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TransactionCategoryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TransactionCategoryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TransactionCategoryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TransactionCategoryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TransactionCategoryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TransactionCategoryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TransactionCategoryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TransactionCategoryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TransactionCategoryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TransactionCategoryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TransactionCategoryDto> TransactionCategoryDtoEnvelope::getResult() const
{
    return m_Result;
}

void TransactionCategoryDtoEnvelope::setResult(const std::shared_ptr<TransactionCategoryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TransactionCategoryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TransactionCategoryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
