...
utility::string_t AccountRelationDto::getType() const
{
    return m_Type;
}

void AccountRelationDto::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AccountRelationDto::typeIsSet() const
{
    return m_TypeIsSet;
}

void AccountRelationDto::unsetType()
{
    m_TypeIsSet = false;
}
