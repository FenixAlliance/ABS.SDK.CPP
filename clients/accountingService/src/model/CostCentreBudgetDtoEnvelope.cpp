...
CostCentreBudgetDtoEnvelope::CostCentreBudgetDtoEnvelope()
{
    m_IsSuccess = false;
...
void CostCentreBudgetDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CostCentreBudgetDtoEnvelope::toJson() const
{
...
bool CostCentreBudgetDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CostCentreBudgetDto> refVal_setResult;
...
void CostCentreBudgetDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CostCentreBudgetDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CostCentreBudgetDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CostCentreBudgetDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CostCentreBudgetDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CostCentreBudgetDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CostCentreBudgetDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CostCentreBudgetDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CostCentreBudgetDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CostCentreBudgetDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CostCentreBudgetDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CostCentreBudgetDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CostCentreBudgetDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CostCentreBudgetDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CostCentreBudgetDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CostCentreBudgetDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CostCentreBudgetDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CostCentreBudgetDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CostCentreBudgetDto> CostCentreBudgetDtoEnvelope::getResult() const
{
    return m_Result;
}

void CostCentreBudgetDtoEnvelope::setResult(const std::shared_ptr<CostCentreBudgetDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CostCentreBudgetDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CostCentreBudgetDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
