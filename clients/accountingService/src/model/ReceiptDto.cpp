...
utility::string_t ReceiptDto::getUserId() const
{
    return m_UserId;
}

void ReceiptDto::setUserId(const utility::string_t& value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}

bool ReceiptDto::userIdIsSet() const
{
    return m_UserIdIsSet;
}

void ReceiptDto::unsetUserId()
{
    m_UserIdIsSet = false;
}
