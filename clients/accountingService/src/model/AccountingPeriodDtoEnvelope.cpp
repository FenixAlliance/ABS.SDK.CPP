...
AccountingPeriodDtoEnvelope::AccountingPeriodDtoEnvelope()
{
    m_IsSuccess = false;
...
void AccountingPeriodDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountingPeriodDtoEnvelope::toJson() const
{
...
bool AccountingPeriodDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AccountingPeriodDto> refVal_setResult;
...
void AccountingPeriodDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountingPeriodDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountingPeriodDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountingPeriodDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountingPeriodDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountingPeriodDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountingPeriodDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountingPeriodDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountingPeriodDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountingPeriodDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountingPeriodDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountingPeriodDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountingPeriodDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountingPeriodDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountingPeriodDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountingPeriodDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountingPeriodDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountingPeriodDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountingPeriodDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountingPeriodDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountingPeriodDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountingPeriodDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountingPeriodDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountingPeriodDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountingPeriodDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountingPeriodDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountingPeriodDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountingPeriodDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountingPeriodDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountingPeriodDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountingPeriodDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountingPeriodDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountingPeriodDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountingPeriodDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AccountingPeriodDto> AccountingPeriodDtoEnvelope::getResult() const
{
    return m_Result;
}

void AccountingPeriodDtoEnvelope::setResult(const std::shared_ptr<AccountingPeriodDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountingPeriodDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountingPeriodDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
