...
BudgetAccountEntryDtoEnvelope::BudgetAccountEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void BudgetAccountEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BudgetAccountEntryDtoEnvelope::toJson() const
{
...
bool BudgetAccountEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BudgetAccountEntryDto> refVal_setResult;
...
void BudgetAccountEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BudgetAccountEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BudgetAccountEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BudgetAccountEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BudgetAccountEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BudgetAccountEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BudgetAccountEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BudgetAccountEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BudgetAccountEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BudgetAccountEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BudgetAccountEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BudgetAccountEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BudgetAccountEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BudgetAccountEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BudgetAccountEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BudgetAccountEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BudgetAccountEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BudgetAccountEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BudgetAccountEntryDto> BudgetAccountEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void BudgetAccountEntryDtoEnvelope::setResult(const std::shared_ptr<BudgetAccountEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BudgetAccountEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BudgetAccountEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
