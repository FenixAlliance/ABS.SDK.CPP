...
CostCentreDtoEnvelope::CostCentreDtoEnvelope()
{
    m_IsSuccess = false;
...
void CostCentreDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CostCentreDtoEnvelope::toJson() const
{
...
bool CostCentreDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CostCentreDto> refVal_setResult;
...
void CostCentreDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CostCentreDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CostCentreDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CostCentreDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CostCentreDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CostCentreDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CostCentreDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CostCentreDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CostCentreDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CostCentreDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CostCentreDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CostCentreDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CostCentreDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CostCentreDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CostCentreDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CostCentreDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CostCentreDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CostCentreDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CostCentreDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CostCentreDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CostCentreDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CostCentreDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CostCentreDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CostCentreDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CostCentreDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CostCentreDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CostCentreDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CostCentreDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CostCentreDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CostCentreDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CostCentreDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CostCentreDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CostCentreDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CostCentreDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CostCentreDto> CostCentreDtoEnvelope::getResult() const
{
    return m_Result;
}

void CostCentreDtoEnvelope::setResult(const std::shared_ptr<CostCentreDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CostCentreDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CostCentreDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
