...
CommissionDtoEnvelope::CommissionDtoEnvelope()
{
    m_IsSuccess = false;
...
void CommissionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CommissionDtoEnvelope::toJson() const
{
...
bool CommissionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CommissionDto> refVal_setResult;
...
void CommissionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CommissionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CommissionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CommissionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CommissionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CommissionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CommissionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CommissionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CommissionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CommissionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CommissionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CommissionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CommissionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CommissionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CommissionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CommissionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CommissionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CommissionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CommissionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CommissionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CommissionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CommissionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CommissionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CommissionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CommissionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CommissionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CommissionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CommissionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CommissionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CommissionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CommissionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CommissionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CommissionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CommissionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CommissionDto> CommissionDtoEnvelope::getResult() const
{
    return m_Result;
}

void CommissionDtoEnvelope::setResult(const std::shared_ptr<CommissionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CommissionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CommissionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
