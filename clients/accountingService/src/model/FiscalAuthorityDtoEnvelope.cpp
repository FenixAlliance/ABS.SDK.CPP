...
FiscalAuthorityDtoEnvelope::FiscalAuthorityDtoEnvelope()
{
    m_IsSuccess = false;
...
void FiscalAuthorityDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FiscalAuthorityDtoEnvelope::toJson() const
{
...
bool FiscalAuthorityDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FiscalAuthorityDto> refVal_setResult;
...
void FiscalAuthorityDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalAuthorityDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FiscalAuthorityDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FiscalAuthorityDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FiscalAuthorityDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FiscalAuthorityDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FiscalAuthorityDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FiscalAuthorityDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FiscalAuthorityDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalAuthorityDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FiscalAuthorityDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FiscalAuthorityDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FiscalAuthorityDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FiscalAuthorityDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FiscalAuthorityDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FiscalAuthorityDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FiscalAuthorityDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FiscalAuthorityDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<FiscalAuthorityDto> FiscalAuthorityDtoEnvelope::getResult() const
{
    return m_Result;
}

void FiscalAuthorityDtoEnvelope::setResult(const std::shared_ptr<FiscalAuthorityDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FiscalAuthorityDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FiscalAuthorityDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
