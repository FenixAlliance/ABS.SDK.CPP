...
ReceiptDtoEnvelope::ReceiptDtoEnvelope()
{
    m_IsSuccess = false;
...
void ReceiptDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ReceiptDtoEnvelope::toJson() const
{
...
bool ReceiptDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ReceiptDto> refVal_setResult;
...
void ReceiptDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReceiptDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ReceiptDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ReceiptDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ReceiptDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ReceiptDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ReceiptDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ReceiptDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ReceiptDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ReceiptDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ReceiptDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ReceiptDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ReceiptDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ReceiptDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ReceiptDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ReceiptDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ReceiptDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ReceiptDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ReceiptDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ReceiptDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ReceiptDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ReceiptDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ReceiptDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ReceiptDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ReceiptDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ReceiptDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ReceiptDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ReceiptDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ReceiptDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ReceiptDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ReceiptDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ReceiptDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ReceiptDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ReceiptDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ReceiptDto> ReceiptDtoEnvelope::getResult() const
{
    return m_Result;
}

void ReceiptDtoEnvelope::setResult(const std::shared_ptr<ReceiptDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ReceiptDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ReceiptDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
