...
BillingProfileDtoEnvelope::BillingProfileDtoEnvelope()
{
    m_IsSuccess = false;
...
void BillingProfileDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BillingProfileDtoEnvelope::toJson() const
{
...
bool BillingProfileDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BillingProfileDto> refVal_setResult;
...
void BillingProfileDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BillingProfileDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BillingProfileDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BillingProfileDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BillingProfileDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BillingProfileDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BillingProfileDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BillingProfileDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BillingProfileDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BillingProfileDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BillingProfileDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BillingProfileDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BillingProfileDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BillingProfileDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BillingProfileDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BillingProfileDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BillingProfileDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BillingProfileDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BillingProfileDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BillingProfileDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BillingProfileDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BillingProfileDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BillingProfileDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BillingProfileDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BillingProfileDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BillingProfileDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BillingProfileDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BillingProfileDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BillingProfileDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BillingProfileDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BillingProfileDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BillingProfileDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BillingProfileDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BillingProfileDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BillingProfileDto> BillingProfileDtoEnvelope::getResult() const
{
    return m_Result;
}

void BillingProfileDtoEnvelope::setResult(const std::shared_ptr<BillingProfileDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BillingProfileDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BillingProfileDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
