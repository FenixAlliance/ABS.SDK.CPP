...
#include "CppRestOpenAPIClient/model/ChartOfAccountsListEnvelope.h"
...
ChartOfAccountsListEnvelope::ChartOfAccountsListEnvelope()
{
    m_IsSuccess = false;
...
void ChartOfAccountsListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ChartOfAccountsListEnvelope::toJson() const
{
...
bool ChartOfAccountsListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ChartOfAccounts>> refVal_setResult;
...
void ChartOfAccountsListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChartOfAccountsListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ChartOfAccountsListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ChartOfAccountsListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ChartOfAccountsListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ChartOfAccountsListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ChartOfAccountsListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ChartOfAccountsListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ChartOfAccountsListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ChartOfAccountsListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ChartOfAccountsListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ChartOfAccountsListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ChartOfAccountsListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ChartOfAccountsListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ChartOfAccountsListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ChartOfAccountsListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ChartOfAccountsListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ChartOfAccountsListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ChartOfAccountsListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ChartOfAccountsListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ChartOfAccountsListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ChartOfAccountsListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ChartOfAccountsListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ChartOfAccountsListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ChartOfAccountsListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ChartOfAccountsListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ChartOfAccountsListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ChartOfAccountsListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ChartOfAccountsListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ChartOfAccountsListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ChartOfAccountsListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ChartOfAccountsListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ChartOfAccountsListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ChartOfAccountsListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ChartOfAccounts>>& ChartOfAccountsListEnvelope::getResult()
{
    return m_Result;
}

void ChartOfAccountsListEnvelope::setResult(const std::vector<std::shared_ptr<ChartOfAccounts>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ChartOfAccountsListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ChartOfAccountsListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
