...
ShareTransferDtoEnvelope::ShareTransferDtoEnvelope()
{
    m_IsSuccess = false;
...
void ShareTransferDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShareTransferDtoEnvelope::toJson() const
{
...
bool ShareTransferDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ShareTransferDto> refVal_setResult;
...
void ShareTransferDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShareTransferDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShareTransferDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShareTransferDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShareTransferDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShareTransferDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShareTransferDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShareTransferDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShareTransferDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShareTransferDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShareTransferDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShareTransferDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShareTransferDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShareTransferDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShareTransferDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShareTransferDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShareTransferDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShareTransferDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShareTransferDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShareTransferDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShareTransferDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShareTransferDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShareTransferDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShareTransferDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShareTransferDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShareTransferDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShareTransferDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShareTransferDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShareTransferDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShareTransferDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShareTransferDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShareTransferDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShareTransferDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShareTransferDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ShareTransferDto> ShareTransferDtoEnvelope::getResult() const
{
    return m_Result;
}

void ShareTransferDtoEnvelope::setResult(const std::shared_ptr<ShareTransferDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShareTransferDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShareTransferDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
