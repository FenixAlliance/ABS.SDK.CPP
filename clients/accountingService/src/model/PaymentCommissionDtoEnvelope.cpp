...
PaymentCommissionDtoEnvelope::PaymentCommissionDtoEnvelope()
{
    m_IsSuccess = false;
...
void PaymentCommissionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentCommissionDtoEnvelope::toJson() const
{
...
bool PaymentCommissionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PaymentCommissionDto> refVal_setResult;
...
void PaymentCommissionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentCommissionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentCommissionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentCommissionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentCommissionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentCommissionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentCommissionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentCommissionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentCommissionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentCommissionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentCommissionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentCommissionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentCommissionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentCommissionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentCommissionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentCommissionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentCommissionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentCommissionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentCommissionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentCommissionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentCommissionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentCommissionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentCommissionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentCommissionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentCommissionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentCommissionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentCommissionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentCommissionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentCommissionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentCommissionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentCommissionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentCommissionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentCommissionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentCommissionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PaymentCommissionDto> PaymentCommissionDtoEnvelope::getResult() const
{
    return m_Result;
}

void PaymentCommissionDtoEnvelope::setResult(const std::shared_ptr<PaymentCommissionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentCommissionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentCommissionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
