...
BankTransactionDtoEnvelope::BankTransactionDtoEnvelope()
{
    m_IsSuccess = false;
...
void BankTransactionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankTransactionDtoEnvelope::toJson() const
{
...
bool BankTransactionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BankTransactionDto> refVal_setResult;
...
void BankTransactionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankTransactionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankTransactionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankTransactionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankTransactionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankTransactionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankTransactionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankTransactionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankTransactionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankTransactionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankTransactionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankTransactionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankTransactionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankTransactionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankTransactionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankTransactionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankTransactionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankTransactionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankTransactionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankTransactionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankTransactionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankTransactionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankTransactionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankTransactionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankTransactionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankTransactionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankTransactionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankTransactionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankTransactionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankTransactionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankTransactionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankTransactionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankTransactionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankTransactionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BankTransactionDto> BankTransactionDtoEnvelope::getResult() const
{
    return m_Result;
}

void BankTransactionDtoEnvelope::setResult(const std::shared_ptr<BankTransactionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankTransactionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankTransactionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
