...
AccountingEntryDtoEnvelope::AccountingEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void AccountingEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountingEntryDtoEnvelope::toJson() const
{
...
bool AccountingEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AccountingEntryDto> refVal_setResult;
...
void AccountingEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountingEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountingEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountingEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountingEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountingEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountingEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountingEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountingEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountingEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountingEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountingEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountingEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountingEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountingEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountingEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountingEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountingEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountingEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountingEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountingEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountingEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountingEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountingEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountingEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountingEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountingEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountingEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountingEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountingEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountingEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountingEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountingEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountingEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AccountingEntryDto> AccountingEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void AccountingEntryDtoEnvelope::setResult(const std::shared_ptr<AccountingEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountingEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountingEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
