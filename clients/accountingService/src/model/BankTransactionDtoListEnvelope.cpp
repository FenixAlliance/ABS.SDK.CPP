...
BankTransactionDtoListEnvelope::BankTransactionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BankTransactionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankTransactionDtoListEnvelope::toJson() const
{
...
bool BankTransactionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BankTransactionDto>> refVal_setResult;
...
void BankTransactionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankTransactionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankTransactionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankTransactionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankTransactionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankTransactionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankTransactionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankTransactionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankTransactionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankTransactionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankTransactionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankTransactionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankTransactionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankTransactionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankTransactionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankTransactionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankTransactionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankTransactionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankTransactionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankTransactionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankTransactionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankTransactionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankTransactionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankTransactionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankTransactionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankTransactionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankTransactionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankTransactionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankTransactionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankTransactionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankTransactionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankTransactionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankTransactionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankTransactionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BankTransactionDto>>& BankTransactionDtoListEnvelope::getResult()
{
    return m_Result;
}

void BankTransactionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BankTransactionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankTransactionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankTransactionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
