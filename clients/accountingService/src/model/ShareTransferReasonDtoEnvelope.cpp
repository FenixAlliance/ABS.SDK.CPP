...
ShareTransferReasonDtoEnvelope::ShareTransferReasonDtoEnvelope()
{
    m_IsSuccess = false;
...
void ShareTransferReasonDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShareTransferReasonDtoEnvelope::toJson() const
{
...
bool ShareTransferReasonDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ShareTransferReasonDto> refVal_setResult;
...
void ShareTransferReasonDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShareTransferReasonDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShareTransferReasonDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShareTransferReasonDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShareTransferReasonDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShareTransferReasonDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShareTransferReasonDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShareTransferReasonDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShareTransferReasonDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShareTransferReasonDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShareTransferReasonDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShareTransferReasonDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShareTransferReasonDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShareTransferReasonDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShareTransferReasonDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShareTransferReasonDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShareTransferReasonDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShareTransferReasonDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ShareTransferReasonDto> ShareTransferReasonDtoEnvelope::getResult() const
{
    return m_Result;
}

void ShareTransferReasonDtoEnvelope::setResult(const std::shared_ptr<ShareTransferReasonDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShareTransferReasonDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShareTransferReasonDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
