...
utility::string_t AccountingEntryCreateDto::getTenantId() const
{
    return m_TenantId;
}

void AccountingEntryCreateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool AccountingEntryCreateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void AccountingEntryCreateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t AccountingEntryCreateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void AccountingEntryCreateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool AccountingEntryCreateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void AccountingEntryCreateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
