...
LedgerTypeDtoEnvelope::LedgerTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void LedgerTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LedgerTypeDtoEnvelope::toJson() const
{
...
bool LedgerTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LedgerTypeDto> refVal_setResult;
...
void LedgerTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LedgerTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LedgerTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LedgerTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LedgerTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LedgerTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LedgerTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LedgerTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LedgerTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LedgerTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LedgerTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LedgerTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LedgerTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LedgerTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LedgerTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LedgerTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LedgerTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LedgerTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LedgerTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LedgerTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LedgerTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LedgerTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LedgerTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LedgerTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LedgerTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LedgerTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LedgerTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LedgerTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LedgerTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LedgerTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LedgerTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LedgerTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LedgerTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LedgerTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LedgerTypeDto> LedgerTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void LedgerTypeDtoEnvelope::setResult(const std::shared_ptr<LedgerTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LedgerTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LedgerTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
