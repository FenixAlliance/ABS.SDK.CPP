...
FiscalResponsibilityDtoEnvelope::FiscalResponsibilityDtoEnvelope()
{
    m_IsSuccess = false;
...
void FiscalResponsibilityDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FiscalResponsibilityDtoEnvelope::toJson() const
{
...
bool FiscalResponsibilityDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FiscalResponsibilityDto> refVal_setResult;
...
void FiscalResponsibilityDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalResponsibilityDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FiscalResponsibilityDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FiscalResponsibilityDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FiscalResponsibilityDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FiscalResponsibilityDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FiscalResponsibilityDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FiscalResponsibilityDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FiscalResponsibilityDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalResponsibilityDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FiscalResponsibilityDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FiscalResponsibilityDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FiscalResponsibilityDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FiscalResponsibilityDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FiscalResponsibilityDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FiscalResponsibilityDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FiscalResponsibilityDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FiscalResponsibilityDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<FiscalResponsibilityDto> FiscalResponsibilityDtoEnvelope::getResult() const
{
    return m_Result;
}

void FiscalResponsibilityDtoEnvelope::setResult(const std::shared_ptr<FiscalResponsibilityDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FiscalResponsibilityDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FiscalResponsibilityDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
