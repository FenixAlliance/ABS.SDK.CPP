...
ItemTaxPolicyRecordDtoEnvelope::ItemTaxPolicyRecordDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemTaxPolicyRecordDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemTaxPolicyRecordDtoEnvelope::toJson() const
{
...
bool ItemTaxPolicyRecordDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemTaxPolicyRecordDto> refVal_setResult;
...
void ItemTaxPolicyRecordDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemTaxPolicyRecordDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemTaxPolicyRecordDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemTaxPolicyRecordDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemTaxPolicyRecordDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemTaxPolicyRecordDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemTaxPolicyRecordDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemTaxPolicyRecordDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemTaxPolicyRecordDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemTaxPolicyRecordDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemTaxPolicyRecordDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemTaxPolicyRecordDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemTaxPolicyRecordDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemTaxPolicyRecordDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemTaxPolicyRecordDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemTaxPolicyRecordDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemTaxPolicyRecordDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemTaxPolicyRecordDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemTaxPolicyRecordDto> ItemTaxPolicyRecordDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemTaxPolicyRecordDtoEnvelope::setResult(const std::shared_ptr<ItemTaxPolicyRecordDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemTaxPolicyRecordDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemTaxPolicyRecordDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
