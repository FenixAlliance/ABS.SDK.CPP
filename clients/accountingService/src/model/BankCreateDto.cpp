...
void BankCreateDto::validate()
{
    // TODO: implement validation
}

web::json::value BankCreateDto::toJson() const
{
...
bool BankCreateDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BankCreateDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankCreateDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t BankCreateDto::getId() const
{
    return m_Id;
}

void BankCreateDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool BankCreateDto::idIsSet() const
{
    return m_IdIsSet;
}

void BankCreateDto::unsetId()
{
    m_IdIsSet = false;
}
utility::datetime BankCreateDto::getTimestamp() const
{
    return m_Timestamp;
}

void BankCreateDto::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankCreateDto::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankCreateDto::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t BankCreateDto::getName() const
{
    return m_Name;
}

void BankCreateDto::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BankCreateDto::nameIsSet() const
{
    return m_NameIsSet;
}

void BankCreateDto::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t BankCreateDto::getImage() const
{
    return m_Image;
}

void BankCreateDto::setImage(const utility::string_t& value)
{
    m_Image = value;
    m_ImageIsSet = true;
}

bool BankCreateDto::imageIsSet() const
{
    return m_ImageIsSet;
}

void BankCreateDto::unsetImage()
{
    m_ImageIsSet = false;
}
utility::string_t BankCreateDto::getCountryId() const
{
    return m_CountryId;
}

void BankCreateDto::setCountryId(const utility::string_t& value)
{
    m_CountryId = value;
    m_CountryIdIsSet = true;
}

bool BankCreateDto::countryIdIsSet() const
{
    return m_CountryIdIsSet;
}

void BankCreateDto::unsetCountryId()
{
    m_CountryIdIsSet = false;
}
}
