...
utility::string_t ShareIssuanceCreateDto::getTenantId() const
{
    return m_TenantId;
}

void ShareIssuanceCreateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool ShareIssuanceCreateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void ShareIssuanceCreateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t ShareIssuanceCreateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void ShareIssuanceCreateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool ShareIssuanceCreateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void ShareIssuanceCreateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
