...
ExpenseTypeDtoListEnvelope::ExpenseTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ExpenseTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExpenseTypeDtoListEnvelope::toJson() const
{
...
bool ExpenseTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ExpenseTypeDto>> refVal_setResult;
...
void ExpenseTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExpenseTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExpenseTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExpenseTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExpenseTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExpenseTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExpenseTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExpenseTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExpenseTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExpenseTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExpenseTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExpenseTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExpenseTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExpenseTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExpenseTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExpenseTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExpenseTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExpenseTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ExpenseTypeDto>>& ExpenseTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void ExpenseTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ExpenseTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExpenseTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExpenseTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
