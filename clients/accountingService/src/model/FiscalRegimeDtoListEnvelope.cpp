...
FiscalRegimeDtoListEnvelope::FiscalRegimeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void FiscalRegimeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FiscalRegimeDtoListEnvelope::toJson() const
{
...
bool FiscalRegimeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FiscalRegimeDto>> refVal_setResult;
...
void FiscalRegimeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalRegimeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FiscalRegimeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FiscalRegimeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FiscalRegimeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FiscalRegimeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FiscalRegimeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FiscalRegimeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FiscalRegimeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalRegimeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FiscalRegimeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FiscalRegimeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FiscalRegimeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FiscalRegimeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FiscalRegimeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FiscalRegimeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FiscalRegimeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FiscalRegimeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<FiscalRegimeDto>>& FiscalRegimeDtoListEnvelope::getResult()
{
    return m_Result;
}

void FiscalRegimeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<FiscalRegimeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FiscalRegimeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FiscalRegimeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
