...
AccountGroupDtoEnvelope::AccountGroupDtoEnvelope()
{
    m_IsSuccess = false;
...
void AccountGroupDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountGroupDtoEnvelope::toJson() const
{
...
bool AccountGroupDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AccountGroupDto> refVal_setResult;
...
void AccountGroupDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountGroupDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountGroupDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountGroupDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountGroupDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountGroupDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountGroupDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountGroupDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountGroupDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountGroupDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountGroupDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountGroupDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountGroupDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountGroupDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountGroupDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountGroupDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountGroupDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountGroupDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountGroupDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountGroupDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountGroupDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountGroupDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountGroupDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountGroupDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountGroupDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountGroupDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountGroupDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountGroupDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountGroupDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountGroupDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountGroupDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountGroupDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountGroupDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountGroupDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AccountGroupDto> AccountGroupDtoEnvelope::getResult() const
{
    return m_Result;
}

void AccountGroupDtoEnvelope::setResult(const std::shared_ptr<AccountGroupDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountGroupDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountGroupDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
