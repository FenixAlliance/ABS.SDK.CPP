...
AccountDtoListEnvelope::AccountDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AccountDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountDtoListEnvelope::toJson() const
{
...
bool AccountDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AccountDto>> refVal_setResult;
...
void AccountDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AccountDto>>& AccountDtoListEnvelope::getResult()
{
    return m_Result;
}

void AccountDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AccountDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
