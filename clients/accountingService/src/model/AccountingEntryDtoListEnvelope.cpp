...
int32_t AccountingEntryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountingEntryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountingEntryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountingEntryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountingEntryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountingEntryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountingEntryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountingEntryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountingEntryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountingEntryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountingEntryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountingEntryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
