...
FiscalRegimeDtoEnvelope::FiscalRegimeDtoEnvelope()
{
    m_IsSuccess = false;
...
void FiscalRegimeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FiscalRegimeDtoEnvelope::toJson() const
{
...
bool FiscalRegimeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FiscalRegimeDto> refVal_setResult;
...
void FiscalRegimeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalRegimeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FiscalRegimeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FiscalRegimeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FiscalRegimeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FiscalRegimeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FiscalRegimeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FiscalRegimeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FiscalRegimeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FiscalRegimeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FiscalRegimeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FiscalRegimeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FiscalRegimeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FiscalRegimeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FiscalRegimeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalRegimeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalRegimeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalRegimeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FiscalRegimeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FiscalRegimeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FiscalRegimeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FiscalRegimeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FiscalRegimeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FiscalRegimeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FiscalRegimeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FiscalRegimeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FiscalRegimeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FiscalRegimeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FiscalRegimeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FiscalRegimeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FiscalRegimeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FiscalRegimeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FiscalRegimeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FiscalRegimeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<FiscalRegimeDto> FiscalRegimeDtoEnvelope::getResult() const
{
    return m_Result;
}

void FiscalRegimeDtoEnvelope::setResult(const std::shared_ptr<FiscalRegimeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FiscalRegimeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FiscalRegimeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
