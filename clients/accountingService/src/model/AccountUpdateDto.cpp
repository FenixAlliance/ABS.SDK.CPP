...
utility::string_t AccountUpdateDto::getContactId() const
{
    return m_ContactId;
}

void AccountUpdateDto::setContactId(const utility::string_t& value)
{
    m_ContactId = value;
    m_ContactIdIsSet = true;
}

bool AccountUpdateDto::contactIdIsSet() const
{
    return m_ContactIdIsSet;
}

void AccountUpdateDto::unsetContactId()
{
    m_ContactIdIsSet = false;
}
