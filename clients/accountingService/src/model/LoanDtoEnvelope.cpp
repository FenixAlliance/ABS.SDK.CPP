...
LoanDtoEnvelope::LoanDtoEnvelope()
{
    m_IsSuccess = false;
...
void LoanDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LoanDtoEnvelope::toJson() const
{
...
bool LoanDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LoanDto> refVal_setResult;
...
void LoanDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LoanDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LoanDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LoanDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LoanDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LoanDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LoanDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LoanDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LoanDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LoanDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LoanDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LoanDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LoanDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LoanDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LoanDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LoanDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LoanDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LoanDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LoanDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LoanDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LoanDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LoanDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LoanDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LoanDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LoanDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LoanDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LoanDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LoanDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LoanDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LoanDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LoanDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LoanDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LoanDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LoanDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LoanDto> LoanDtoEnvelope::getResult() const
{
    return m_Result;
}

void LoanDtoEnvelope::setResult(const std::shared_ptr<LoanDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LoanDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LoanDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
