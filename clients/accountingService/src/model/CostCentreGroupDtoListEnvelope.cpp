...
CostCentreGroupDtoListEnvelope::CostCentreGroupDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CostCentreGroupDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CostCentreGroupDtoListEnvelope::toJson() const
{
...
bool CostCentreGroupDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CostCentreGroupDto>> refVal_setResult;
...
void CostCentreGroupDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CostCentreGroupDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CostCentreGroupDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CostCentreGroupDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CostCentreGroupDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CostCentreGroupDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CostCentreGroupDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CostCentreGroupDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CostCentreGroupDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CostCentreGroupDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CostCentreGroupDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CostCentreGroupDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CostCentreGroupDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CostCentreGroupDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CostCentreGroupDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CostCentreGroupDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CostCentreGroupDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CostCentreGroupDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CostCentreGroupDto>>& CostCentreGroupDtoListEnvelope::getResult()
{
    return m_Result;
}

void CostCentreGroupDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CostCentreGroupDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CostCentreGroupDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CostCentreGroupDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
