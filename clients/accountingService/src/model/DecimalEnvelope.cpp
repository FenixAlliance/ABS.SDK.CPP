...
DecimalEnvelope::DecimalEnvelope()
{
    m_IsSuccess = false;
...
void DecimalEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DecimalEnvelope::toJson() const
{
...
bool DecimalEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DecimalEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DecimalEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DecimalEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DecimalEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DecimalEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DecimalEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DecimalEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DecimalEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DecimalEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DecimalEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DecimalEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DecimalEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DecimalEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DecimalEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DecimalEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DecimalEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DecimalEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DecimalEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DecimalEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DecimalEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DecimalEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DecimalEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DecimalEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DecimalEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DecimalEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DecimalEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DecimalEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DecimalEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DecimalEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DecimalEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DecimalEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DecimalEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DecimalEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DecimalEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
double DecimalEnvelope::getResult() const
{
    return m_Result;
}

void DecimalEnvelope::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DecimalEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DecimalEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
