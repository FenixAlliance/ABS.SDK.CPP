...
LoanApplicationDtoEnvelope::LoanApplicationDtoEnvelope()
{
    m_IsSuccess = false;
...
void LoanApplicationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LoanApplicationDtoEnvelope::toJson() const
{
...
bool LoanApplicationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LoanApplicationDto> refVal_setResult;
...
void LoanApplicationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LoanApplicationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LoanApplicationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LoanApplicationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LoanApplicationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LoanApplicationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LoanApplicationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LoanApplicationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LoanApplicationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LoanApplicationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LoanApplicationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LoanApplicationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LoanApplicationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LoanApplicationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LoanApplicationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LoanApplicationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LoanApplicationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LoanApplicationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LoanApplicationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LoanApplicationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LoanApplicationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LoanApplicationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LoanApplicationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LoanApplicationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LoanApplicationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LoanApplicationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LoanApplicationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LoanApplicationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LoanApplicationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LoanApplicationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LoanApplicationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LoanApplicationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LoanApplicationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LoanApplicationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LoanApplicationDto> LoanApplicationDtoEnvelope::getResult() const
{
    return m_Result;
}

void LoanApplicationDtoEnvelope::setResult(const std::shared_ptr<LoanApplicationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LoanApplicationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LoanApplicationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
