...
AccountRelationDtoListEnvelope::AccountRelationDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AccountRelationDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountRelationDtoListEnvelope::toJson() const
{
...
bool AccountRelationDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AccountRelationDto>> refVal_setResult;
...
void AccountRelationDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountRelationDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountRelationDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountRelationDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountRelationDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountRelationDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountRelationDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountRelationDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountRelationDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountRelationDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountRelationDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountRelationDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountRelationDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountRelationDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountRelationDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountRelationDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountRelationDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountRelationDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountRelationDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountRelationDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountRelationDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountRelationDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountRelationDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountRelationDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountRelationDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountRelationDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountRelationDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountRelationDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountRelationDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountRelationDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountRelationDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountRelationDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountRelationDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountRelationDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AccountRelationDto>>& AccountRelationDtoListEnvelope::getResult()
{
    return m_Result;
}

void AccountRelationDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AccountRelationDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountRelationDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountRelationDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
