...
ShareTransferDtoListEnvelope::ShareTransferDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ShareTransferDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShareTransferDtoListEnvelope::toJson() const
{
...
bool ShareTransferDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ShareTransferDto>> refVal_setResult;
...
void ShareTransferDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShareTransferDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShareTransferDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShareTransferDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShareTransferDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShareTransferDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShareTransferDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShareTransferDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShareTransferDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShareTransferDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShareTransferDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShareTransferDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShareTransferDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShareTransferDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShareTransferDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShareTransferDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShareTransferDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShareTransferDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShareTransferDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShareTransferDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShareTransferDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShareTransferDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShareTransferDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShareTransferDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShareTransferDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShareTransferDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShareTransferDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShareTransferDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShareTransferDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShareTransferDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShareTransferDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShareTransferDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShareTransferDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShareTransferDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ShareTransferDto>>& ShareTransferDtoListEnvelope::getResult()
{
    return m_Result;
}

void ShareTransferDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ShareTransferDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShareTransferDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShareTransferDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
