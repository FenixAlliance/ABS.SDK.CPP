...
AccountTypeDtoEnvelope::AccountTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void AccountTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountTypeDtoEnvelope::toJson() const
{
...
bool AccountTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AccountTypeDto> refVal_setResult;
...
void AccountTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AccountTypeDto> AccountTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void AccountTypeDtoEnvelope::setResult(const std::shared_ptr<AccountTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
