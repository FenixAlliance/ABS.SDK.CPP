...
CommissionDtoListEnvelope::CommissionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CommissionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CommissionDtoListEnvelope::toJson() const
{
...
bool CommissionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CommissionDto>> refVal_setResult;
...
void CommissionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CommissionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CommissionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CommissionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CommissionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CommissionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CommissionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CommissionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CommissionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CommissionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CommissionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CommissionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CommissionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CommissionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CommissionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CommissionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CommissionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CommissionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CommissionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CommissionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CommissionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CommissionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CommissionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CommissionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CommissionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CommissionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CommissionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CommissionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CommissionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CommissionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CommissionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CommissionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CommissionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CommissionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CommissionDto>>& CommissionDtoListEnvelope::getResult()
{
    return m_Result;
}

void CommissionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CommissionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CommissionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CommissionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
