...
BudgetDtoIReadOnlyListEnvelope::BudgetDtoIReadOnlyListEnvelope()
{
    m_IsSuccess = false;
...
void BudgetDtoIReadOnlyListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BudgetDtoIReadOnlyListEnvelope::toJson() const
{
...
bool BudgetDtoIReadOnlyListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BudgetDto>> refVal_setResult;
...
void BudgetDtoIReadOnlyListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BudgetDtoIReadOnlyListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BudgetDtoIReadOnlyListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BudgetDtoIReadOnlyListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BudgetDtoIReadOnlyListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BudgetDtoIReadOnlyListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BudgetDtoIReadOnlyListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BudgetDtoIReadOnlyListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BudgetDtoIReadOnlyListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BudgetDtoIReadOnlyListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BudgetDtoIReadOnlyListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BudgetDtoIReadOnlyListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BudgetDtoIReadOnlyListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BudgetDtoIReadOnlyListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BudgetDtoIReadOnlyListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BudgetDtoIReadOnlyListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BudgetDtoIReadOnlyListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BudgetDtoIReadOnlyListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BudgetDto>>& BudgetDtoIReadOnlyListEnvelope::getResult()
{
    return m_Result;
}

void BudgetDtoIReadOnlyListEnvelope::setResult(const std::vector<std::shared_ptr<BudgetDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BudgetDtoIReadOnlyListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BudgetDtoIReadOnlyListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
