...
JournalDtoIReadOnlyListEnvelope::JournalDtoIReadOnlyListEnvelope()
{
    m_IsSuccess = false;
...
void JournalDtoIReadOnlyListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JournalDtoIReadOnlyListEnvelope::toJson() const
{
...
bool JournalDtoIReadOnlyListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<JournalDto>> refVal_setResult;
...
void JournalDtoIReadOnlyListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JournalDtoIReadOnlyListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JournalDtoIReadOnlyListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JournalDtoIReadOnlyListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JournalDtoIReadOnlyListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JournalDtoIReadOnlyListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JournalDtoIReadOnlyListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JournalDtoIReadOnlyListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JournalDtoIReadOnlyListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JournalDtoIReadOnlyListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JournalDtoIReadOnlyListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JournalDtoIReadOnlyListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JournalDtoIReadOnlyListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JournalDtoIReadOnlyListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JournalDtoIReadOnlyListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JournalDtoIReadOnlyListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JournalDtoIReadOnlyListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JournalDtoIReadOnlyListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<JournalDto>>& JournalDtoIReadOnlyListEnvelope::getResult()
{
    return m_Result;
}

void JournalDtoIReadOnlyListEnvelope::setResult(const std::vector<std::shared_ptr<JournalDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JournalDtoIReadOnlyListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JournalDtoIReadOnlyListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
