...
TransactionDtoEnvelope::TransactionDtoEnvelope()
{
    m_IsSuccess = false;
...
void TransactionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TransactionDtoEnvelope::toJson() const
{
...
bool TransactionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TransactionDto> refVal_setResult;
...
void TransactionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TransactionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TransactionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TransactionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TransactionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TransactionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TransactionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TransactionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TransactionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TransactionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TransactionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TransactionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TransactionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TransactionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TransactionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TransactionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TransactionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TransactionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TransactionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TransactionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TransactionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TransactionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TransactionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TransactionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TransactionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TransactionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TransactionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TransactionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TransactionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TransactionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TransactionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TransactionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TransactionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TransactionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TransactionDto> TransactionDtoEnvelope::getResult() const
{
    return m_Result;
}

void TransactionDtoEnvelope::setResult(const std::shared_ptr<TransactionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TransactionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TransactionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
