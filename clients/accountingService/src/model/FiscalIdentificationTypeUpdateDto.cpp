...
utility::string_t FiscalIdentificationTypeUpdateDto::getTenantId() const
{
    return m_TenantId;
}

void FiscalIdentificationTypeUpdateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool FiscalIdentificationTypeUpdateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void FiscalIdentificationTypeUpdateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t FiscalIdentificationTypeUpdateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void FiscalIdentificationTypeUpdateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool FiscalIdentificationTypeUpdateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void FiscalIdentificationTypeUpdateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
