...
FiscalPeriodDtoListEnvelope::FiscalPeriodDtoListEnvelope()
{
    m_IsSuccess = false;
...
void FiscalPeriodDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value FiscalPeriodDtoListEnvelope::toJson() const
{
...
bool FiscalPeriodDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FiscalPeriodDto>> refVal_setResult;
...
void FiscalPeriodDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FiscalPeriodDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool FiscalPeriodDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void FiscalPeriodDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t FiscalPeriodDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void FiscalPeriodDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t FiscalPeriodDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void FiscalPeriodDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime FiscalPeriodDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void FiscalPeriodDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t FiscalPeriodDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void FiscalPeriodDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t FiscalPeriodDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void FiscalPeriodDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& FiscalPeriodDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void FiscalPeriodDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t FiscalPeriodDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void FiscalPeriodDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<FiscalPeriodDto>>& FiscalPeriodDtoListEnvelope::getResult()
{
    return m_Result;
}

void FiscalPeriodDtoListEnvelope::setResult(const std::vector<std::shared_ptr<FiscalPeriodDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool FiscalPeriodDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void FiscalPeriodDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
