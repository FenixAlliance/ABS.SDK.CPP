...
ExpenseClaimDtoListEnvelope::ExpenseClaimDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ExpenseClaimDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExpenseClaimDtoListEnvelope::toJson() const
{
...
bool ExpenseClaimDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ExpenseClaimDto>> refVal_setResult;
...
void ExpenseClaimDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExpenseClaimDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExpenseClaimDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExpenseClaimDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExpenseClaimDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExpenseClaimDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExpenseClaimDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExpenseClaimDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExpenseClaimDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExpenseClaimDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExpenseClaimDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExpenseClaimDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExpenseClaimDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExpenseClaimDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExpenseClaimDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExpenseClaimDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExpenseClaimDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExpenseClaimDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ExpenseClaimDto>>& ExpenseClaimDtoListEnvelope::getResult()
{
    return m_Result;
}

void ExpenseClaimDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ExpenseClaimDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExpenseClaimDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExpenseClaimDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
