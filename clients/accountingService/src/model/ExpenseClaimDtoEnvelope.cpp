...
ExpenseClaimDtoEnvelope::ExpenseClaimDtoEnvelope()
{
    m_IsSuccess = false;
...
void ExpenseClaimDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExpenseClaimDtoEnvelope::toJson() const
{
...
bool ExpenseClaimDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExpenseClaimDto> refVal_setResult;
...
void ExpenseClaimDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExpenseClaimDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExpenseClaimDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExpenseClaimDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExpenseClaimDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExpenseClaimDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExpenseClaimDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExpenseClaimDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExpenseClaimDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExpenseClaimDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExpenseClaimDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExpenseClaimDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExpenseClaimDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExpenseClaimDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExpenseClaimDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExpenseClaimDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExpenseClaimDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExpenseClaimDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExpenseClaimDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExpenseClaimDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExpenseClaimDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExpenseClaimDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExpenseClaimDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExpenseClaimDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExpenseClaimDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExpenseClaimDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExpenseClaimDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExpenseClaimDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExpenseClaimDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExpenseClaimDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExpenseClaimDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExpenseClaimDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExpenseClaimDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExpenseClaimDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExpenseClaimDto> ExpenseClaimDtoEnvelope::getResult() const
{
    return m_Result;
}

void ExpenseClaimDtoEnvelope::setResult(const std::shared_ptr<ExpenseClaimDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExpenseClaimDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExpenseClaimDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
