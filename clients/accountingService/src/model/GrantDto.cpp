...
#include "CppRestOpenAPIClient/model/GrantDto.h"
...
void GrantDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrantDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t GrantDto::getId() const
{
    return m_Id;
}

void GrantDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
utility::datetime GrantDto::getTimestamp() const
{
    return m_Timestamp;
}

void GrantDto::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GrantDto::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GrantDto::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t GrantDto::getTenantId() const
{
    return m_TenantId;
}

void GrantDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool GrantDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void GrantDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t GrantDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void GrantDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool GrantDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void GrantDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
