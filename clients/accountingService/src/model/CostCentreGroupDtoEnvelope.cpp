...
CostCentreGroupDtoEnvelope::CostCentreGroupDtoEnvelope()
{
    m_IsSuccess = false;
...
void CostCentreGroupDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CostCentreGroupDtoEnvelope::toJson() const
{
...
bool CostCentreGroupDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CostCentreGroupDto> refVal_setResult;
...
void CostCentreGroupDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CostCentreGroupDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CostCentreGroupDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CostCentreGroupDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CostCentreGroupDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CostCentreGroupDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CostCentreGroupDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CostCentreGroupDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CostCentreGroupDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CostCentreGroupDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CostCentreGroupDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CostCentreGroupDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CostCentreGroupDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CostCentreGroupDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CostCentreGroupDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CostCentreGroupDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CostCentreGroupDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CostCentreGroupDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CostCentreGroupDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CostCentreGroupDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CostCentreGroupDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CostCentreGroupDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CostCentreGroupDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CostCentreGroupDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CostCentreGroupDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CostCentreGroupDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CostCentreGroupDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CostCentreGroupDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CostCentreGroupDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CostCentreGroupDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CostCentreGroupDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CostCentreGroupDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CostCentreGroupDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CostCentreGroupDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CostCentreGroupDto> CostCentreGroupDtoEnvelope::getResult() const
{
    return m_Result;
}

void CostCentreGroupDtoEnvelope::setResult(const std::shared_ptr<CostCentreGroupDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CostCentreGroupDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CostCentreGroupDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
