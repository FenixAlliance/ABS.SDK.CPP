...
AccountDtoEnvelope::AccountDtoEnvelope()
{
    m_IsSuccess = false;
...
void AccountDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AccountDtoEnvelope::toJson() const
{
...
bool AccountDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AccountDto> refVal_setResult;
...
void AccountDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AccountDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AccountDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AccountDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AccountDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AccountDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AccountDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AccountDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AccountDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AccountDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AccountDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AccountDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AccountDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AccountDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AccountDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AccountDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AccountDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AccountDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AccountDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AccountDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AccountDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AccountDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AccountDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AccountDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AccountDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AccountDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AccountDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AccountDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AccountDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AccountDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AccountDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AccountDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AccountDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AccountDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AccountDto> AccountDtoEnvelope::getResult() const
{
    return m_Result;
}

void AccountDtoEnvelope::setResult(const std::shared_ptr<AccountDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AccountDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
