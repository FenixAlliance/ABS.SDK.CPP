...
JournalEntryDtoEnvelope::JournalEntryDtoEnvelope()
{
    m_IsSuccess = false;
...
void JournalEntryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JournalEntryDtoEnvelope::toJson() const
{
...
bool JournalEntryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JournalEntryDto> refVal_setResult;
...
void JournalEntryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JournalEntryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JournalEntryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JournalEntryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JournalEntryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JournalEntryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JournalEntryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JournalEntryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JournalEntryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JournalEntryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JournalEntryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JournalEntryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JournalEntryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JournalEntryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JournalEntryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JournalEntryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JournalEntryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JournalEntryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JournalEntryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JournalEntryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JournalEntryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JournalEntryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JournalEntryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JournalEntryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JournalEntryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JournalEntryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JournalEntryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JournalEntryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JournalEntryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JournalEntryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JournalEntryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JournalEntryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JournalEntryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JournalEntryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JournalEntryDto> JournalEntryDtoEnvelope::getResult() const
{
    return m_Result;
}

void JournalEntryDtoEnvelope::setResult(const std::shared_ptr<JournalEntryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JournalEntryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JournalEntryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
