...
CostCentreDtoListEnvelope::CostCentreDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CostCentreDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CostCentreDtoListEnvelope::toJson() const
{
...
bool CostCentreDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CostCentreDto>> refVal_setResult;
...
void CostCentreDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CostCentreDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CostCentreDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CostCentreDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CostCentreDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CostCentreDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CostCentreDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CostCentreDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CostCentreDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CostCentreDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CostCentreDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CostCentreDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CostCentreDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CostCentreDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CostCentreDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CostCentreDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CostCentreDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CostCentreDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CostCentreDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CostCentreDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CostCentreDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CostCentreDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CostCentreDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CostCentreDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CostCentreDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CostCentreDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CostCentreDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CostCentreDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CostCentreDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CostCentreDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CostCentreDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CostCentreDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CostCentreDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CostCentreDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CostCentreDto>>& CostCentreDtoListEnvelope::getResult()
{
    return m_Result;
}

void CostCentreDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CostCentreDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CostCentreDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CostCentreDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
