...
TaxRateDtoListEnvelope::TaxRateDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TaxRateDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxRateDtoListEnvelope::toJson() const
{
...
bool TaxRateDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TaxRateDto>> refVal_setResult;
...
void TaxRateDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxRateDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxRateDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxRateDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxRateDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxRateDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxRateDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxRateDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxRateDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxRateDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxRateDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxRateDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxRateDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxRateDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxRateDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxRateDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxRateDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxRateDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxRateDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxRateDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxRateDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxRateDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxRateDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxRateDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxRateDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxRateDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxRateDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxRateDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxRateDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxRateDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxRateDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxRateDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxRateDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxRateDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TaxRateDto>>& TaxRateDtoListEnvelope::getResult()
{
    return m_Result;
}

void TaxRateDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TaxRateDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxRateDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxRateDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
