...
utility::string_t FiscalRegimeUpdateDto::getTenantId() const
{
    return m_TenantId;
}

void FiscalRegimeUpdateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool FiscalRegimeUpdateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void FiscalRegimeUpdateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t FiscalRegimeUpdateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void FiscalRegimeUpdateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool FiscalRegimeUpdateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void FiscalRegimeUpdateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
