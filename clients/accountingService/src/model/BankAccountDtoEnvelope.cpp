...
BankAccountDtoEnvelope::BankAccountDtoEnvelope()
{
    m_IsSuccess = false;
...
void BankAccountDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankAccountDtoEnvelope::toJson() const
{
...
bool BankAccountDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BankAccountDto> refVal_setResult;
...
void BankAccountDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankAccountDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankAccountDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankAccountDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankAccountDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankAccountDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankAccountDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankAccountDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankAccountDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankAccountDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankAccountDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankAccountDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankAccountDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankAccountDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankAccountDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankAccountDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankAccountDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankAccountDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankAccountDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankAccountDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankAccountDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankAccountDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankAccountDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankAccountDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankAccountDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankAccountDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankAccountDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankAccountDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankAccountDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankAccountDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankAccountDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankAccountDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankAccountDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankAccountDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BankAccountDto> BankAccountDtoEnvelope::getResult() const
{
    return m_Result;
}

void BankAccountDtoEnvelope::setResult(const std::shared_ptr<BankAccountDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankAccountDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankAccountDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
