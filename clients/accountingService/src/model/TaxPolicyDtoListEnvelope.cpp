...
TaxPolicyDtoListEnvelope::TaxPolicyDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TaxPolicyDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxPolicyDtoListEnvelope::toJson() const
{
...
bool TaxPolicyDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TaxPolicyDto>> refVal_setResult;
...
void TaxPolicyDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxPolicyDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxPolicyDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxPolicyDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxPolicyDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxPolicyDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxPolicyDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxPolicyDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxPolicyDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxPolicyDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxPolicyDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxPolicyDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxPolicyDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxPolicyDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxPolicyDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxPolicyDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxPolicyDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxPolicyDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxPolicyDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxPolicyDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxPolicyDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxPolicyDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxPolicyDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxPolicyDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxPolicyDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxPolicyDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxPolicyDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxPolicyDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxPolicyDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxPolicyDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxPolicyDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxPolicyDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxPolicyDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxPolicyDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TaxPolicyDto>>& TaxPolicyDtoListEnvelope::getResult()
{
    return m_Result;
}

void TaxPolicyDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TaxPolicyDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxPolicyDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxPolicyDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
