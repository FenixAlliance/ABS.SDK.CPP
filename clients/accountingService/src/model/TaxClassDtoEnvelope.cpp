...
TaxClassDtoEnvelope::TaxClassDtoEnvelope()
{
    m_IsSuccess = false;
...
void TaxClassDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TaxClassDtoEnvelope::toJson() const
{
...
bool TaxClassDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TaxClassDto> refVal_setResult;
...
void TaxClassDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TaxClassDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TaxClassDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TaxClassDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TaxClassDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TaxClassDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TaxClassDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TaxClassDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TaxClassDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TaxClassDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TaxClassDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TaxClassDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TaxClassDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TaxClassDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TaxClassDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TaxClassDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TaxClassDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TaxClassDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TaxClassDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TaxClassDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TaxClassDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TaxClassDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TaxClassDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TaxClassDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TaxClassDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TaxClassDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TaxClassDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TaxClassDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TaxClassDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TaxClassDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TaxClassDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TaxClassDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TaxClassDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TaxClassDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TaxClassDto> TaxClassDtoEnvelope::getResult() const
{
    return m_Result;
}

void TaxClassDtoEnvelope::setResult(const std::shared_ptr<TaxClassDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TaxClassDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TaxClassDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
