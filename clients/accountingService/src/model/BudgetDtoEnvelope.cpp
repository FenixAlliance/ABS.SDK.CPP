...
BudgetDtoEnvelope::BudgetDtoEnvelope()
{
    m_IsSuccess = false;
...
void BudgetDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BudgetDtoEnvelope::toJson() const
{
...
bool BudgetDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BudgetDto> refVal_setResult;
...
void BudgetDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BudgetDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BudgetDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BudgetDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BudgetDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BudgetDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BudgetDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BudgetDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BudgetDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BudgetDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BudgetDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BudgetDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BudgetDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BudgetDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BudgetDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BudgetDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BudgetDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BudgetDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BudgetDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BudgetDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BudgetDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BudgetDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BudgetDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BudgetDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BudgetDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BudgetDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BudgetDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BudgetDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BudgetDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BudgetDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BudgetDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BudgetDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BudgetDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BudgetDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BudgetDto> BudgetDtoEnvelope::getResult() const
{
    return m_Result;
}

void BudgetDtoEnvelope::setResult(const std::shared_ptr<BudgetDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BudgetDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BudgetDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
