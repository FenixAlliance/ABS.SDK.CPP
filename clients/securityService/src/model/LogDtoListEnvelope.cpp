...
LogDtoListEnvelope::LogDtoListEnvelope()
{
    m_IsSuccess = false;
...
void LogDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LogDtoListEnvelope::toJson() const
{
...
bool LogDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<LogDto>> refVal_setResult;
...
void LogDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LogDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LogDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LogDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LogDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LogDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LogDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LogDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LogDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LogDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LogDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LogDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LogDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LogDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LogDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LogDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LogDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LogDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LogDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LogDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LogDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LogDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LogDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LogDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LogDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LogDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LogDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LogDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LogDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LogDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LogDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LogDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LogDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LogDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<LogDto>>& LogDtoListEnvelope::getResult()
{
    return m_Result;
}

void LogDtoListEnvelope::setResult(const std::vector<std::shared_ptr<LogDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LogDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LogDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
