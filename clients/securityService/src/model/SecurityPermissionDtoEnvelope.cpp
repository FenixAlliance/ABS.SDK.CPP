...
SecurityPermissionDtoEnvelope::SecurityPermissionDtoEnvelope()
{
    m_IsSuccess = false;
...
void SecurityPermissionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SecurityPermissionDtoEnvelope::toJson() const
{
...
bool SecurityPermissionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SecurityPermissionDto> refVal_setResult;
...
void SecurityPermissionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SecurityPermissionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SecurityPermissionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SecurityPermissionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SecurityPermissionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SecurityPermissionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SecurityPermissionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SecurityPermissionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SecurityPermissionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SecurityPermissionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SecurityPermissionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SecurityPermissionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SecurityPermissionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SecurityPermissionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SecurityPermissionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SecurityPermissionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SecurityPermissionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SecurityPermissionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SecurityPermissionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SecurityPermissionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SecurityPermissionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SecurityPermissionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SecurityPermissionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SecurityPermissionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SecurityPermissionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SecurityPermissionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SecurityPermissionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SecurityPermissionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SecurityPermissionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SecurityPermissionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SecurityPermissionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SecurityPermissionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SecurityPermissionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SecurityPermissionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SecurityPermissionDto> SecurityPermissionDtoEnvelope::getResult() const
{
    return m_Result;
}

void SecurityPermissionDtoEnvelope::setResult(const std::shared_ptr<SecurityPermissionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SecurityPermissionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SecurityPermissionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
