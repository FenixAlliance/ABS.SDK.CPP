...
SecurityRoleDtoListEnvelope::SecurityRoleDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SecurityRoleDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SecurityRoleDtoListEnvelope::toJson() const
{
...
bool SecurityRoleDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SecurityRoleDto>> refVal_setResult;
...
void SecurityRoleDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SecurityRoleDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SecurityRoleDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SecurityRoleDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SecurityRoleDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SecurityRoleDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SecurityRoleDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SecurityRoleDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SecurityRoleDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SecurityRoleDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SecurityRoleDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SecurityRoleDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SecurityRoleDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SecurityRoleDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SecurityRoleDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SecurityRoleDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SecurityRoleDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SecurityRoleDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SecurityRoleDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SecurityRoleDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SecurityRoleDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SecurityRoleDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SecurityRoleDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SecurityRoleDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SecurityRoleDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SecurityRoleDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SecurityRoleDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SecurityRoleDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SecurityRoleDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SecurityRoleDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SecurityRoleDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SecurityRoleDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SecurityRoleDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SecurityRoleDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SecurityRoleDto>>& SecurityRoleDtoListEnvelope::getResult()
{
    return m_Result;
}

void SecurityRoleDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SecurityRoleDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SecurityRoleDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SecurityRoleDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
