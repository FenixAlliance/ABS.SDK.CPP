...
OAuthAuthorizationDtoEnvelope::OAuthAuthorizationDtoEnvelope()
{
    m_IsSuccess = false;
...
void OAuthAuthorizationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OAuthAuthorizationDtoEnvelope::toJson() const
{
...
bool OAuthAuthorizationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OAuthAuthorizationDto> refVal_setResult;
...
void OAuthAuthorizationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OAuthAuthorizationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OAuthAuthorizationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OAuthAuthorizationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OAuthAuthorizationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OAuthAuthorizationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OAuthAuthorizationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OAuthAuthorizationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OAuthAuthorizationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OAuthAuthorizationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OAuthAuthorizationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OAuthAuthorizationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OAuthAuthorizationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OAuthAuthorizationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OAuthAuthorizationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OAuthAuthorizationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OAuthAuthorizationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OAuthAuthorizationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<OAuthAuthorizationDto> OAuthAuthorizationDtoEnvelope::getResult() const
{
    return m_Result;
}

void OAuthAuthorizationDtoEnvelope::setResult(const std::shared_ptr<OAuthAuthorizationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OAuthAuthorizationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OAuthAuthorizationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
