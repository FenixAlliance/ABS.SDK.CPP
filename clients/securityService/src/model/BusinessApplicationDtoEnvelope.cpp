...
BusinessApplicationDtoEnvelope::BusinessApplicationDtoEnvelope()
{
    m_IsSuccess = false;
...
void BusinessApplicationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BusinessApplicationDtoEnvelope::toJson() const
{
...
bool BusinessApplicationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BusinessApplicationDto> refVal_setResult;
...
void BusinessApplicationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BusinessApplicationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BusinessApplicationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BusinessApplicationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BusinessApplicationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BusinessApplicationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BusinessApplicationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BusinessApplicationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BusinessApplicationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BusinessApplicationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BusinessApplicationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BusinessApplicationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BusinessApplicationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BusinessApplicationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BusinessApplicationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BusinessApplicationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BusinessApplicationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BusinessApplicationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BusinessApplicationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BusinessApplicationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BusinessApplicationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BusinessApplicationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BusinessApplicationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BusinessApplicationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BusinessApplicationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BusinessApplicationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BusinessApplicationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BusinessApplicationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BusinessApplicationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BusinessApplicationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BusinessApplicationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BusinessApplicationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BusinessApplicationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BusinessApplicationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BusinessApplicationDto> BusinessApplicationDtoEnvelope::getResult() const
{
    return m_Result;
}

void BusinessApplicationDtoEnvelope::setResult(const std::shared_ptr<BusinessApplicationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BusinessApplicationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BusinessApplicationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
