...
ServiceCaseDtoEnvelope::ServiceCaseDtoEnvelope()
{
    m_IsSuccess = false;
...
void ServiceCaseDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ServiceCaseDtoEnvelope::toJson() const
{
...
bool ServiceCaseDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ServiceCaseDto> refVal_setResult;
...
void ServiceCaseDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceCaseDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ServiceCaseDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ServiceCaseDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ServiceCaseDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ServiceCaseDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ServiceCaseDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ServiceCaseDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ServiceCaseDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ServiceCaseDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ServiceCaseDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ServiceCaseDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ServiceCaseDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ServiceCaseDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ServiceCaseDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ServiceCaseDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ServiceCaseDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ServiceCaseDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ServiceCaseDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ServiceCaseDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ServiceCaseDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ServiceCaseDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ServiceCaseDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ServiceCaseDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ServiceCaseDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ServiceCaseDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ServiceCaseDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ServiceCaseDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ServiceCaseDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ServiceCaseDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ServiceCaseDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ServiceCaseDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ServiceCaseDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ServiceCaseDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ServiceCaseDto> ServiceCaseDtoEnvelope::getResult() const
{
    return m_Result;
}

void ServiceCaseDtoEnvelope::setResult(const std::shared_ptr<ServiceCaseDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ServiceCaseDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServiceCaseDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
