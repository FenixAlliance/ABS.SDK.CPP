...
ServiceDtoEnvelope::ServiceDtoEnvelope()
{
    m_IsSuccess = false;
...
void ServiceDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ServiceDtoEnvelope::toJson() const
{
...
bool ServiceDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ServiceDto> refVal_setResult;
...
void ServiceDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ServiceDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ServiceDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ServiceDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ServiceDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ServiceDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ServiceDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ServiceDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ServiceDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ServiceDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ServiceDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ServiceDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ServiceDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ServiceDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ServiceDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ServiceDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ServiceDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ServiceDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ServiceDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ServiceDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ServiceDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ServiceDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ServiceDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ServiceDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ServiceDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ServiceDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ServiceDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ServiceDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ServiceDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ServiceDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ServiceDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ServiceDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ServiceDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ServiceDto> ServiceDtoEnvelope::getResult() const
{
    return m_Result;
}

void ServiceDtoEnvelope::setResult(const std::shared_ptr<ServiceDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ServiceDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServiceDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
