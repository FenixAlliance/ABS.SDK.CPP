...
ServiceQueueDtoEnvelope::ServiceQueueDtoEnvelope()
{
    m_IsSuccess = false;
...
void ServiceQueueDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ServiceQueueDtoEnvelope::toJson() const
{
...
bool ServiceQueueDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ServiceQueueDto> refVal_setResult;
...
void ServiceQueueDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceQueueDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ServiceQueueDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ServiceQueueDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ServiceQueueDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ServiceQueueDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ServiceQueueDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ServiceQueueDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ServiceQueueDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ServiceQueueDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ServiceQueueDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ServiceQueueDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ServiceQueueDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ServiceQueueDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ServiceQueueDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ServiceQueueDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ServiceQueueDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ServiceQueueDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ServiceQueueDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ServiceQueueDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ServiceQueueDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ServiceQueueDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ServiceQueueDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ServiceQueueDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ServiceQueueDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ServiceQueueDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ServiceQueueDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ServiceQueueDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ServiceQueueDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ServiceQueueDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ServiceQueueDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ServiceQueueDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ServiceQueueDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ServiceQueueDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ServiceQueueDto> ServiceQueueDtoEnvelope::getResult() const
{
    return m_Result;
}

void ServiceQueueDtoEnvelope::setResult(const std::shared_ptr<ServiceQueueDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ServiceQueueDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServiceQueueDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
