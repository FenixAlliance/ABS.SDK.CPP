...
ServiceLevelDtoEnvelope::ServiceLevelDtoEnvelope()
{
    m_IsSuccess = false;
...
void ServiceLevelDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ServiceLevelDtoEnvelope::toJson() const
{
...
bool ServiceLevelDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ServiceLevelDto> refVal_setResult;
...
void ServiceLevelDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceLevelDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ServiceLevelDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ServiceLevelDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ServiceLevelDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ServiceLevelDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ServiceLevelDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ServiceLevelDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ServiceLevelDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ServiceLevelDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ServiceLevelDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ServiceLevelDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ServiceLevelDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ServiceLevelDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ServiceLevelDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ServiceLevelDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ServiceLevelDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ServiceLevelDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ServiceLevelDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ServiceLevelDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ServiceLevelDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ServiceLevelDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ServiceLevelDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ServiceLevelDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ServiceLevelDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ServiceLevelDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ServiceLevelDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ServiceLevelDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ServiceLevelDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ServiceLevelDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ServiceLevelDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ServiceLevelDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ServiceLevelDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ServiceLevelDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ServiceLevelDto> ServiceLevelDtoEnvelope::getResult() const
{
    return m_Result;
}

void ServiceLevelDtoEnvelope::setResult(const std::shared_ptr<ServiceLevelDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ServiceLevelDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServiceLevelDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
