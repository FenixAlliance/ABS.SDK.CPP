...
ServiceCaseTypeDtoEnvelope::ServiceCaseTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void ServiceCaseTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ServiceCaseTypeDtoEnvelope::toJson() const
{
...
bool ServiceCaseTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ServiceCaseTypeDto> refVal_setResult;
...
void ServiceCaseTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServiceCaseTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ServiceCaseTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ServiceCaseTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ServiceCaseTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ServiceCaseTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ServiceCaseTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ServiceCaseTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ServiceCaseTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ServiceCaseTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ServiceCaseTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ServiceCaseTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ServiceCaseTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ServiceCaseTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ServiceCaseTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ServiceCaseTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ServiceCaseTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ServiceCaseTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ServiceCaseTypeDto> ServiceCaseTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void ServiceCaseTypeDtoEnvelope::setResult(const std::shared_ptr<ServiceCaseTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ServiceCaseTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServiceCaseTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
