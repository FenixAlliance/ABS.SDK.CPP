...
InvoiceAdjustmentDtoEnvelope::InvoiceAdjustmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void InvoiceAdjustmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InvoiceAdjustmentDtoEnvelope::toJson() const
{
...
bool InvoiceAdjustmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InvoiceAdjustmentDto> refVal_setResult;
...
void InvoiceAdjustmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoiceAdjustmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InvoiceAdjustmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InvoiceAdjustmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InvoiceAdjustmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InvoiceAdjustmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InvoiceAdjustmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InvoiceAdjustmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InvoiceAdjustmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InvoiceAdjustmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InvoiceAdjustmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InvoiceAdjustmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InvoiceAdjustmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InvoiceAdjustmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InvoiceAdjustmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InvoiceAdjustmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InvoiceAdjustmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InvoiceAdjustmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InvoiceAdjustmentDto> InvoiceAdjustmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void InvoiceAdjustmentDtoEnvelope::setResult(const std::shared_ptr<InvoiceAdjustmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InvoiceAdjustmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InvoiceAdjustmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
