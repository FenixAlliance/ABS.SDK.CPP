...
PaymentDtoIReadOnlyListEnvelope::PaymentDtoIReadOnlyListEnvelope()
{
    m_IsSuccess = false;
...
void PaymentDtoIReadOnlyListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentDtoIReadOnlyListEnvelope::toJson() const
{
...
bool PaymentDtoIReadOnlyListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PaymentDto>> refVal_setResult;
...
void PaymentDtoIReadOnlyListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentDtoIReadOnlyListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentDtoIReadOnlyListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentDtoIReadOnlyListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentDtoIReadOnlyListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentDtoIReadOnlyListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentDtoIReadOnlyListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentDtoIReadOnlyListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentDtoIReadOnlyListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentDtoIReadOnlyListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentDtoIReadOnlyListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentDtoIReadOnlyListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentDtoIReadOnlyListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentDtoIReadOnlyListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentDtoIReadOnlyListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentDtoIReadOnlyListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentDtoIReadOnlyListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentDtoIReadOnlyListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PaymentDto>>& PaymentDtoIReadOnlyListEnvelope::getResult()
{
    return m_Result;
}

void PaymentDtoIReadOnlyListEnvelope::setResult(const std::vector<std::shared_ptr<PaymentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentDtoIReadOnlyListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentDtoIReadOnlyListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
