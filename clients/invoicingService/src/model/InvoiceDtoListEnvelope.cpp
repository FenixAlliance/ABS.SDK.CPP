...
InvoiceDtoListEnvelope::InvoiceDtoListEnvelope()
{
    m_IsSuccess = false;
...
void InvoiceDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InvoiceDtoListEnvelope::toJson() const
{
...
bool InvoiceDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<InvoiceDto>> refVal_setResult;
...
void InvoiceDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoiceDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InvoiceDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InvoiceDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InvoiceDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InvoiceDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InvoiceDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InvoiceDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InvoiceDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InvoiceDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InvoiceDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InvoiceDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InvoiceDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InvoiceDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InvoiceDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InvoiceDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InvoiceDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InvoiceDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InvoiceDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InvoiceDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InvoiceDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InvoiceDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InvoiceDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InvoiceDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InvoiceDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InvoiceDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InvoiceDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InvoiceDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InvoiceDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InvoiceDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InvoiceDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InvoiceDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InvoiceDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InvoiceDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<InvoiceDto>>& InvoiceDtoListEnvelope::getResult()
{
    return m_Result;
}

void InvoiceDtoListEnvelope::setResult(const std::vector<std::shared_ptr<InvoiceDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InvoiceDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InvoiceDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
