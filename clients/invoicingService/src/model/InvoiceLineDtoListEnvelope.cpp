...
InvoiceLineDtoListEnvelope::InvoiceLineDtoListEnvelope()
{
    m_IsSuccess = false;
...
void InvoiceLineDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InvoiceLineDtoListEnvelope::toJson() const
{
...
bool InvoiceLineDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InvoiceLineDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoiceLineDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InvoiceLineDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InvoiceLineDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InvoiceLineDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InvoiceLineDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InvoiceLineDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InvoiceLineDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InvoiceLineDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InvoiceLineDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InvoiceLineDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InvoiceLineDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InvoiceLineDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InvoiceLineDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InvoiceLineDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InvoiceLineDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InvoiceLineDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InvoiceLineDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InvoiceLineDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InvoiceLineDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InvoiceLineDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InvoiceLineDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InvoiceLineDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InvoiceLineDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InvoiceLineDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InvoiceLineDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InvoiceLineDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InvoiceLineDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InvoiceLineDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InvoiceLineDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InvoiceLineDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InvoiceLineDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InvoiceLineDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InvoiceLineDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<InvoiceLineDto>>& InvoiceLineDtoListEnvelope::getResult()
{
    return m_Result;
}

void InvoiceLineDtoListEnvelope::setResult(const std::vector<std::shared_ptr<InvoiceLineDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InvoiceLineDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InvoiceLineDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
