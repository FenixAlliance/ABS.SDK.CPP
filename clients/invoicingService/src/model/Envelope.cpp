...
bool Envelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void Envelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool Envelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void Envelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t Envelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void Envelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool Envelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void Envelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t Envelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void Envelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool Envelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void Envelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime Envelope::getTimestamp() const
{
    return m_Timestamp;
}

void Envelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool Envelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void Envelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t Envelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void Envelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool Envelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void Envelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t Envelope::getErrorCode() const
{
    return m_ErrorCode;
}

void Envelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool Envelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void Envelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& Envelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void Envelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool Envelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void Envelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t Envelope::getActivityId() const
{
    return m_ActivityId;
}

void Envelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool Envelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void Envelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
utility::string_t Envelope::getResult() const
{
    return m_Result;
}

void Envelope::setResult(const utility::string_t& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Envelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void Envelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
