...
InvoiceReferenceDtoEnvelope::InvoiceReferenceDtoEnvelope()
{
    m_IsSuccess = false;
...
void InvoiceReferenceDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InvoiceReferenceDtoEnvelope::toJson() const
{
...
bool InvoiceReferenceDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InvoiceReferenceDto> refVal_setResult;
...
void InvoiceReferenceDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoiceReferenceDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InvoiceReferenceDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InvoiceReferenceDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InvoiceReferenceDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InvoiceReferenceDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InvoiceReferenceDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InvoiceReferenceDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InvoiceReferenceDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InvoiceReferenceDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InvoiceReferenceDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InvoiceReferenceDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InvoiceReferenceDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InvoiceReferenceDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InvoiceReferenceDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InvoiceReferenceDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InvoiceReferenceDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InvoiceReferenceDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InvoiceReferenceDto> InvoiceReferenceDtoEnvelope::getResult() const
{
    return m_Result;
}

void InvoiceReferenceDtoEnvelope::setResult(const std::shared_ptr<InvoiceReferenceDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InvoiceReferenceDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InvoiceReferenceDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
