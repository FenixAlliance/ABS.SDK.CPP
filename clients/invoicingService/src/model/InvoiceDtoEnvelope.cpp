...
InvoiceDtoEnvelope::InvoiceDtoEnvelope()
{
    m_IsSuccess = false;
...
void InvoiceDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InvoiceDtoEnvelope::toJson() const
{
...
bool InvoiceDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InvoiceDto> refVal_setResult;
...
void InvoiceDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InvoiceDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InvoiceDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InvoiceDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InvoiceDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InvoiceDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InvoiceDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InvoiceDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InvoiceDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InvoiceDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InvoiceDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InvoiceDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InvoiceDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InvoiceDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InvoiceDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InvoiceDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InvoiceDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InvoiceDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InvoiceDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InvoiceDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InvoiceDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InvoiceDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InvoiceDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InvoiceDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InvoiceDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InvoiceDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InvoiceDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InvoiceDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InvoiceDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InvoiceDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InvoiceDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InvoiceDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InvoiceDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InvoiceDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InvoiceDto> InvoiceDtoEnvelope::getResult() const
{
    return m_Result;
}

void InvoiceDtoEnvelope::setResult(const std::shared_ptr<InvoiceDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InvoiceDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InvoiceDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
