...
ItemShippingPolicyDtoEnvelope::ItemShippingPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemShippingPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemShippingPolicyDtoEnvelope::toJson() const
{
...
bool ItemShippingPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemShippingPolicyDto> refVal_setResult;
...
void ItemShippingPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemShippingPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemShippingPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemShippingPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemShippingPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemShippingPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemShippingPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemShippingPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemShippingPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemShippingPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemShippingPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemShippingPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemShippingPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemShippingPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemShippingPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemShippingPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemShippingPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemShippingPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemShippingPolicyDto> ItemShippingPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemShippingPolicyDtoEnvelope::setResult(const std::shared_ptr<ItemShippingPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemShippingPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemShippingPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
