...
utility::string_t ShippingCourierCreateDto::getBusinessProfileRecordID() const
{
    return m_BusinessProfileRecordID;
}

void ShippingCourierCreateDto::setBusinessProfileRecordID(const utility::string_t& value)
{
    m_BusinessProfileRecordID = value;
    m_BusinessProfileRecordIDIsSet = true;
}

bool ShippingCourierCreateDto::businessProfileRecordIDIsSet() const
{
    return m_BusinessProfileRecordIDIsSet;
}

void ShippingCourierCreateDto::unsetBusinessProfileRecordID()
{
    m_BusinessProfileRecordIDIsSet = false;
}
}
