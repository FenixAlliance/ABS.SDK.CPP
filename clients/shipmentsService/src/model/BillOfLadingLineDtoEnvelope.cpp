...
BillOfLadingLineDtoEnvelope::BillOfLadingLineDtoEnvelope()
{
    m_IsSuccess = false;
...
void BillOfLadingLineDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BillOfLadingLineDtoEnvelope::toJson() const
{
...
bool BillOfLadingLineDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BillOfLadingLineDto> refVal_setResult;
...
void BillOfLadingLineDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BillOfLadingLineDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BillOfLadingLineDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BillOfLadingLineDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BillOfLadingLineDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BillOfLadingLineDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BillOfLadingLineDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BillOfLadingLineDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BillOfLadingLineDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BillOfLadingLineDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BillOfLadingLineDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BillOfLadingLineDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BillOfLadingLineDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BillOfLadingLineDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BillOfLadingLineDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BillOfLadingLineDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BillOfLadingLineDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BillOfLadingLineDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BillOfLadingLineDto> BillOfLadingLineDtoEnvelope::getResult() const
{
    return m_Result;
}

void BillOfLadingLineDtoEnvelope::setResult(const std::shared_ptr<BillOfLadingLineDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BillOfLadingLineDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BillOfLadingLineDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
