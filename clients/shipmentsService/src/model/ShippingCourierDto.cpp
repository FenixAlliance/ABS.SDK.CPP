...
utility::string_t ShippingCourierDto::getTenantId() const
{
    return m_TenantId;
}

void ShippingCourierDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool ShippingCourierDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void ShippingCourierDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t ShippingCourierDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void ShippingCourierDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool ShippingCourierDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void ShippingCourierDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
