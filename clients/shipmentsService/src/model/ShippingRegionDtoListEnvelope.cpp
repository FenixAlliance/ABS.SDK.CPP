...
ShippingRegionDtoListEnvelope::ShippingRegionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ShippingRegionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShippingRegionDtoListEnvelope::toJson() const
{
...
bool ShippingRegionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ShippingRegionDto>> refVal_setResult;
...
void ShippingRegionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShippingRegionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShippingRegionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShippingRegionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShippingRegionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShippingRegionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShippingRegionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShippingRegionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShippingRegionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShippingRegionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShippingRegionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShippingRegionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShippingRegionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShippingRegionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShippingRegionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShippingRegionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShippingRegionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShippingRegionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShippingRegionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShippingRegionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShippingRegionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShippingRegionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShippingRegionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShippingRegionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShippingRegionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShippingRegionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShippingRegionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShippingRegionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShippingRegionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShippingRegionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShippingRegionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShippingRegionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShippingRegionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShippingRegionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ShippingRegionDto>>& ShippingRegionDtoListEnvelope::getResult()
{
    return m_Result;
}

void ShippingRegionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ShippingRegionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShippingRegionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShippingRegionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
