...
BillOfLadingDtoEnvelope::BillOfLadingDtoEnvelope()
{
    m_IsSuccess = false;
...
void BillOfLadingDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BillOfLadingDtoEnvelope::toJson() const
{
...
bool BillOfLadingDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BillOfLadingDto> refVal_setResult;
...
void BillOfLadingDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BillOfLadingDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BillOfLadingDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BillOfLadingDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BillOfLadingDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BillOfLadingDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BillOfLadingDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BillOfLadingDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BillOfLadingDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BillOfLadingDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BillOfLadingDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BillOfLadingDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BillOfLadingDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BillOfLadingDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BillOfLadingDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BillOfLadingDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BillOfLadingDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BillOfLadingDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BillOfLadingDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BillOfLadingDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BillOfLadingDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BillOfLadingDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BillOfLadingDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BillOfLadingDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BillOfLadingDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BillOfLadingDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BillOfLadingDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BillOfLadingDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BillOfLadingDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BillOfLadingDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BillOfLadingDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BillOfLadingDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BillOfLadingDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BillOfLadingDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BillOfLadingDto> BillOfLadingDtoEnvelope::getResult() const
{
    return m_Result;
}

void BillOfLadingDtoEnvelope::setResult(const std::shared_ptr<BillOfLadingDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BillOfLadingDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BillOfLadingDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
