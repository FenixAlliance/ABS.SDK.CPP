...
BillOfLadingDtoListEnvelope::BillOfLadingDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BillOfLadingDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BillOfLadingDtoListEnvelope::toJson() const
{
...
bool BillOfLadingDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BillOfLadingDto>> refVal_setResult;
...
void BillOfLadingDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BillOfLadingDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BillOfLadingDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BillOfLadingDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BillOfLadingDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BillOfLadingDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BillOfLadingDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BillOfLadingDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BillOfLadingDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BillOfLadingDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BillOfLadingDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BillOfLadingDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BillOfLadingDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BillOfLadingDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BillOfLadingDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BillOfLadingDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BillOfLadingDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BillOfLadingDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BillOfLadingDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BillOfLadingDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BillOfLadingDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BillOfLadingDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BillOfLadingDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BillOfLadingDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BillOfLadingDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BillOfLadingDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BillOfLadingDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BillOfLadingDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BillOfLadingDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BillOfLadingDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BillOfLadingDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BillOfLadingDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BillOfLadingDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BillOfLadingDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BillOfLadingDto>>& BillOfLadingDtoListEnvelope::getResult()
{
    return m_Result;
}

void BillOfLadingDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BillOfLadingDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BillOfLadingDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BillOfLadingDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
