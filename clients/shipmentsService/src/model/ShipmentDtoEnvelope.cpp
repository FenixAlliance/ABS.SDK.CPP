...
ShipmentDtoEnvelope::ShipmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void ShipmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShipmentDtoEnvelope::toJson() const
{
...
bool ShipmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ShipmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShipmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShipmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShipmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShipmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShipmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShipmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShipmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShipmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShipmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShipmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShipmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShipmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShipmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShipmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShipmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShipmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShipmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShipmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShipmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShipmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShipmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShipmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShipmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShipmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShipmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShipmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShipmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShipmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShipmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShipmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShipmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShipmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShipmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ShipmentDto> ShipmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void ShipmentDtoEnvelope::setResult(const std::shared_ptr<ShipmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShipmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShipmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
