...
ShipmentDtoListEnvelope::ShipmentDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ShipmentDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShipmentDtoListEnvelope::toJson() const
{
...
bool ShipmentDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ShipmentDto>> refVal_setResult;
...
void ShipmentDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShipmentDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShipmentDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShipmentDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShipmentDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShipmentDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShipmentDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShipmentDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShipmentDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShipmentDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShipmentDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShipmentDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShipmentDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShipmentDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShipmentDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShipmentDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShipmentDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShipmentDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShipmentDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShipmentDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShipmentDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShipmentDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShipmentDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShipmentDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShipmentDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShipmentDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShipmentDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShipmentDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShipmentDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShipmentDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShipmentDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShipmentDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShipmentDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShipmentDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ShipmentDto>>& ShipmentDtoListEnvelope::getResult()
{
    return m_Result;
}

void ShipmentDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ShipmentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShipmentDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShipmentDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
