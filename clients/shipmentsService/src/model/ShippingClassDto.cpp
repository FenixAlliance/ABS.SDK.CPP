...
utility::string_t ShippingClassDto::getBusinessID() const
{
    return m_BusinessID;
}

void ShippingClassDto::setBusinessID(const utility::string_t& value)
{
    m_BusinessID = value;
    m_BusinessIDIsSet = true;
}

bool ShippingClassDto::businessIDIsSet() const
{
    return m_BusinessIDIsSet;
}

void ShippingClassDto::unsetBusinessID()
{
    m_BusinessIDIsSet = false;
}
}
