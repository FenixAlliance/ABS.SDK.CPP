...
ShippingRegionDtoEnvelope::ShippingRegionDtoEnvelope()
{
    m_IsSuccess = false;
...
void ShippingRegionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShippingRegionDtoEnvelope::toJson() const
{
...
bool ShippingRegionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ShippingRegionDto> refVal_setResult;
...
void ShippingRegionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShippingRegionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShippingRegionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShippingRegionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShippingRegionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShippingRegionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShippingRegionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShippingRegionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShippingRegionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShippingRegionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShippingRegionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShippingRegionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShippingRegionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShippingRegionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShippingRegionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShippingRegionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShippingRegionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShippingRegionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShippingRegionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShippingRegionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShippingRegionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShippingRegionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShippingRegionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShippingRegionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShippingRegionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShippingRegionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShippingRegionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShippingRegionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShippingRegionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShippingRegionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShippingRegionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShippingRegionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShippingRegionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShippingRegionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ShippingRegionDto> ShippingRegionDtoEnvelope::getResult() const
{
    return m_Result;
}

void ShippingRegionDtoEnvelope::setResult(const std::shared_ptr<ShippingRegionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShippingRegionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShippingRegionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
