...
ShippingCourierDtoEnvelope::ShippingCourierDtoEnvelope()
{
    m_IsSuccess = false;
...
void ShippingCourierDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ShippingCourierDtoEnvelope::toJson() const
{
...
bool ShippingCourierDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ShippingCourierDto> refVal_setResult;
...
void ShippingCourierDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ShippingCourierDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ShippingCourierDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ShippingCourierDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ShippingCourierDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ShippingCourierDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ShippingCourierDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ShippingCourierDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ShippingCourierDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ShippingCourierDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ShippingCourierDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ShippingCourierDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ShippingCourierDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ShippingCourierDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ShippingCourierDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ShippingCourierDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ShippingCourierDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ShippingCourierDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ShippingCourierDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ShippingCourierDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ShippingCourierDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ShippingCourierDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ShippingCourierDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ShippingCourierDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ShippingCourierDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ShippingCourierDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ShippingCourierDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ShippingCourierDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ShippingCourierDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ShippingCourierDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ShippingCourierDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ShippingCourierDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ShippingCourierDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ShippingCourierDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ShippingCourierDto> ShippingCourierDtoEnvelope::getResult() const
{
    return m_Result;
}

void ShippingCourierDtoEnvelope::setResult(const std::shared_ptr<ShippingCourierDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ShippingCourierDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ShippingCourierDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
