...
ExtendedOrderDtoListEnvelope::ExtendedOrderDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedOrderDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedOrderDtoListEnvelope::toJson() const
{
...
bool ExtendedOrderDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ExtendedOrderDto>> refVal_setResult;
...
void ExtendedOrderDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedOrderDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedOrderDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedOrderDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedOrderDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedOrderDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedOrderDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedOrderDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedOrderDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedOrderDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedOrderDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedOrderDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedOrderDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedOrderDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedOrderDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedOrderDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedOrderDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedOrderDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ExtendedOrderDto>>& ExtendedOrderDtoListEnvelope::getResult()
{
    return m_Result;
}

void ExtendedOrderDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ExtendedOrderDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedOrderDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedOrderDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
