...
WalletDtoEnvelope::WalletDtoEnvelope()
{
    m_IsSuccess = false;
...
void WalletDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WalletDtoEnvelope::toJson() const
{
...
bool WalletDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WalletDto> refVal_setResult;
...
void WalletDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WalletDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WalletDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WalletDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WalletDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WalletDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WalletDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WalletDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WalletDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WalletDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WalletDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WalletDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WalletDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WalletDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WalletDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WalletDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WalletDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WalletDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WalletDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WalletDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WalletDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WalletDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WalletDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WalletDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WalletDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WalletDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WalletDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WalletDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WalletDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WalletDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WalletDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WalletDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WalletDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WalletDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WalletDto> WalletDtoEnvelope::getResult() const
{
    return m_Result;
}

void WalletDtoEnvelope::setResult(const std::shared_ptr<WalletDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WalletDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WalletDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
