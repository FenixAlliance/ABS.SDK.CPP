...
PaymentTokenDtoListEnvelope::PaymentTokenDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PaymentTokenDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentTokenDtoListEnvelope::toJson() const
{
...
bool PaymentTokenDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PaymentTokenDto>> refVal_setResult;
...
void PaymentTokenDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentTokenDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentTokenDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentTokenDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentTokenDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentTokenDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentTokenDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentTokenDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentTokenDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentTokenDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentTokenDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentTokenDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentTokenDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentTokenDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentTokenDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentTokenDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentTokenDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentTokenDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentTokenDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentTokenDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentTokenDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentTokenDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentTokenDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentTokenDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentTokenDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentTokenDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentTokenDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentTokenDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentTokenDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentTokenDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentTokenDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentTokenDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentTokenDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentTokenDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PaymentTokenDto>>& PaymentTokenDtoListEnvelope::getResult()
{
    return m_Result;
}

void PaymentTokenDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PaymentTokenDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentTokenDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentTokenDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
