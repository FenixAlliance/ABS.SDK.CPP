...
QuoteDtoListEnvelope::QuoteDtoListEnvelope()
{
    m_IsSuccess = false;
...
void QuoteDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value QuoteDtoListEnvelope::toJson() const
{
...
bool QuoteDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<QuoteDto>> refVal_setResult;
...
void QuoteDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuoteDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool QuoteDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void QuoteDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool QuoteDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void QuoteDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t QuoteDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void QuoteDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool QuoteDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void QuoteDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t QuoteDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void QuoteDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool QuoteDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void QuoteDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime QuoteDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void QuoteDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool QuoteDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void QuoteDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t QuoteDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void QuoteDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool QuoteDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void QuoteDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t QuoteDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void QuoteDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool QuoteDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void QuoteDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& QuoteDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void QuoteDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool QuoteDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void QuoteDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t QuoteDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void QuoteDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool QuoteDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void QuoteDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<QuoteDto>>& QuoteDtoListEnvelope::getResult()
{
    return m_Result;
}

void QuoteDtoListEnvelope::setResult(const std::vector<std::shared_ptr<QuoteDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool QuoteDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void QuoteDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
