...
BankAccountDtoListEnvelope::BankAccountDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BankAccountDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BankAccountDtoListEnvelope::toJson() const
{
...
bool BankAccountDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BankAccountDto>> refVal_setResult;
...
void BankAccountDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BankAccountDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BankAccountDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BankAccountDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BankAccountDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BankAccountDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BankAccountDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BankAccountDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BankAccountDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BankAccountDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BankAccountDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BankAccountDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BankAccountDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BankAccountDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BankAccountDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BankAccountDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BankAccountDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BankAccountDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BankAccountDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BankAccountDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BankAccountDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BankAccountDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BankAccountDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BankAccountDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BankAccountDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BankAccountDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BankAccountDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BankAccountDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BankAccountDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BankAccountDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BankAccountDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BankAccountDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BankAccountDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BankAccountDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BankAccountDto>>& BankAccountDtoListEnvelope::getResult()
{
    return m_Result;
}

void BankAccountDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BankAccountDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BankAccountDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BankAccountDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
