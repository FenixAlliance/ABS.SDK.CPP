...
LocationDtoEnvelope::LocationDtoEnvelope()
{
    m_IsSuccess = false;
...
void LocationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LocationDtoEnvelope::toJson() const
{
...
bool LocationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LocationDto> refVal_setResult;
...
void LocationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LocationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LocationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LocationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LocationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LocationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LocationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LocationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LocationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LocationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LocationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LocationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LocationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LocationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LocationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LocationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LocationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LocationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LocationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LocationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LocationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LocationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LocationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LocationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LocationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LocationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LocationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LocationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LocationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LocationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LocationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LocationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LocationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LocationDto> LocationDtoEnvelope::getResult() const
{
    return m_Result;
}

void LocationDtoEnvelope::setResult(const std::shared_ptr<LocationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LocationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LocationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
