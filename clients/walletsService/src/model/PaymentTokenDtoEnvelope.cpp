...
PaymentTokenDtoEnvelope::PaymentTokenDtoEnvelope()
{
    m_IsSuccess = false;
...
void PaymentTokenDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentTokenDtoEnvelope::toJson() const
{
...
bool PaymentTokenDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PaymentTokenDto> refVal_setResult;
...
void PaymentTokenDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentTokenDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentTokenDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentTokenDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentTokenDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentTokenDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentTokenDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentTokenDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentTokenDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentTokenDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentTokenDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentTokenDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentTokenDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentTokenDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentTokenDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentTokenDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentTokenDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentTokenDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentTokenDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentTokenDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentTokenDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentTokenDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentTokenDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentTokenDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentTokenDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentTokenDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentTokenDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentTokenDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentTokenDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentTokenDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentTokenDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentTokenDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentTokenDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentTokenDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PaymentTokenDto> PaymentTokenDtoEnvelope::getResult() const
{
    return m_Result;
}

void PaymentTokenDtoEnvelope::setResult(const std::shared_ptr<PaymentTokenDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentTokenDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentTokenDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
