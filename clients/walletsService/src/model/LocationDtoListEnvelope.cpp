...
LocationDtoListEnvelope::LocationDtoListEnvelope()
{
    m_IsSuccess = false;
...
void LocationDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LocationDtoListEnvelope::toJson() const
{
...
bool LocationDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LocationDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LocationDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LocationDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LocationDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LocationDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LocationDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LocationDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LocationDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LocationDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LocationDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LocationDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LocationDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LocationDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LocationDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LocationDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LocationDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LocationDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LocationDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LocationDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LocationDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LocationDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LocationDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LocationDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LocationDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LocationDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LocationDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LocationDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LocationDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LocationDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LocationDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LocationDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LocationDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LocationDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<LocationDto>>& LocationDtoListEnvelope::getResult()
{
    return m_Result;
}

void LocationDtoListEnvelope::setResult(const std::vector<std::shared_ptr<LocationDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LocationDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LocationDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
