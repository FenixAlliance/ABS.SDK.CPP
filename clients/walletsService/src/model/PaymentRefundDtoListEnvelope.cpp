...
PaymentRefundDtoListEnvelope::PaymentRefundDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PaymentRefundDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentRefundDtoListEnvelope::toJson() const
{
...
bool PaymentRefundDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PaymentRefundDto>> refVal_setResult;
...
void PaymentRefundDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentRefundDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentRefundDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentRefundDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentRefundDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentRefundDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentRefundDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentRefundDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentRefundDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentRefundDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentRefundDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentRefundDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentRefundDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentRefundDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentRefundDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentRefundDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentRefundDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentRefundDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentRefundDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentRefundDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentRefundDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentRefundDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentRefundDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentRefundDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentRefundDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentRefundDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentRefundDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentRefundDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentRefundDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentRefundDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentRefundDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentRefundDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentRefundDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentRefundDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PaymentRefundDto>>& PaymentRefundDtoListEnvelope::getResult()
{
    return m_Result;
}

void PaymentRefundDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PaymentRefundDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentRefundDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentRefundDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
