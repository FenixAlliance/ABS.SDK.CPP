...
RoundingPolicyDtoEnvelope::RoundingPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void RoundingPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RoundingPolicyDtoEnvelope::toJson() const
{
...
bool RoundingPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<RoundingPolicyDto> refVal_setResult;
...
void RoundingPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RoundingPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RoundingPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RoundingPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RoundingPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RoundingPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RoundingPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RoundingPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RoundingPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RoundingPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RoundingPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RoundingPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RoundingPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RoundingPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RoundingPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RoundingPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RoundingPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RoundingPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RoundingPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RoundingPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RoundingPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RoundingPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RoundingPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RoundingPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RoundingPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RoundingPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RoundingPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RoundingPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RoundingPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RoundingPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RoundingPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RoundingPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RoundingPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RoundingPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<RoundingPolicyDto> RoundingPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void RoundingPolicyDtoEnvelope::setResult(const std::shared_ptr<RoundingPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RoundingPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RoundingPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
