...
utility::string_t DiscountListCreateDto::getTenantId() const
{
    return m_TenantId;
}

void DiscountListCreateDto::setTenantId(const utility::string_t& value)
{
    m_TenantId = value;
    m_TenantIdIsSet = true;
}

bool DiscountListCreateDto::tenantIdIsSet() const
{
    return m_TenantIdIsSet;
}

void DiscountListCreateDto::unsetTenantId()
{
    m_TenantIdIsSet = false;
}
utility::string_t DiscountListCreateDto::getEnrollmentId() const
{
    return m_EnrollmentId;
}

void DiscountListCreateDto::setEnrollmentId(const utility::string_t& value)
{
    m_EnrollmentId = value;
    m_EnrollmentIdIsSet = true;
}

bool DiscountListCreateDto::enrollmentIdIsSet() const
{
    return m_EnrollmentIdIsSet;
}

void DiscountListCreateDto::unsetEnrollmentId()
{
    m_EnrollmentIdIsSet = false;
}
}
