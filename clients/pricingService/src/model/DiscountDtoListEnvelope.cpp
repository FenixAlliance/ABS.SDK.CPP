...
DiscountDtoListEnvelope::DiscountDtoListEnvelope()
{
    m_IsSuccess = false;
...
void DiscountDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DiscountDtoListEnvelope::toJson() const
{
...
bool DiscountDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<DiscountDto>> refVal_setResult;
...
void DiscountDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DiscountDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DiscountDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DiscountDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DiscountDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DiscountDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DiscountDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DiscountDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DiscountDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DiscountDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DiscountDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DiscountDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DiscountDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DiscountDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DiscountDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DiscountDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DiscountDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DiscountDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DiscountDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DiscountDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DiscountDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DiscountDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DiscountDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DiscountDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DiscountDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DiscountDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DiscountDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DiscountDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DiscountDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DiscountDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DiscountDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DiscountDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DiscountDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DiscountDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<DiscountDto>>& DiscountDtoListEnvelope::getResult()
{
    return m_Result;
}

void DiscountDtoListEnvelope::setResult(const std::vector<std::shared_ptr<DiscountDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DiscountDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DiscountDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
