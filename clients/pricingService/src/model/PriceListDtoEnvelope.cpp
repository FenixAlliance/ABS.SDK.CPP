...
PriceListDtoEnvelope::PriceListDtoEnvelope()
{
    m_IsSuccess = false;
...
void PriceListDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PriceListDtoEnvelope::toJson() const
{
...
bool PriceListDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PriceListDto> refVal_setResult;
...
void PriceListDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PriceListDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PriceListDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PriceListDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PriceListDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PriceListDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PriceListDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PriceListDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PriceListDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PriceListDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PriceListDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PriceListDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PriceListDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PriceListDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PriceListDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PriceListDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PriceListDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PriceListDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PriceListDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PriceListDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PriceListDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PriceListDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PriceListDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PriceListDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PriceListDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PriceListDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PriceListDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PriceListDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PriceListDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PriceListDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PriceListDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PriceListDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PriceListDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PriceListDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PriceListDto> PriceListDtoEnvelope::getResult() const
{
    return m_Result;
}

void PriceListDtoEnvelope::setResult(const std::shared_ptr<PriceListDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PriceListDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PriceListDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
