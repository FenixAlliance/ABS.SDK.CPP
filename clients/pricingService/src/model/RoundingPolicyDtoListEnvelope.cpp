...
RoundingPolicyDtoListEnvelope::RoundingPolicyDtoListEnvelope()
{
    m_IsSuccess = false;
...
void RoundingPolicyDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RoundingPolicyDtoListEnvelope::toJson() const
{
...
bool RoundingPolicyDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<RoundingPolicyDto>> refVal_setResult;
...
void RoundingPolicyDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RoundingPolicyDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RoundingPolicyDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RoundingPolicyDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RoundingPolicyDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RoundingPolicyDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RoundingPolicyDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RoundingPolicyDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RoundingPolicyDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RoundingPolicyDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RoundingPolicyDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RoundingPolicyDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RoundingPolicyDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RoundingPolicyDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RoundingPolicyDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RoundingPolicyDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RoundingPolicyDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RoundingPolicyDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<RoundingPolicyDto>>& RoundingPolicyDtoListEnvelope::getResult()
{
    return m_Result;
}

void RoundingPolicyDtoListEnvelope::setResult(const std::vector<std::shared_ptr<RoundingPolicyDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RoundingPolicyDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RoundingPolicyDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
