...
ItemPriceCalculationEnvelope::ItemPriceCalculationEnvelope()
{
    m_IsSuccess = false;
...
void ItemPriceCalculationEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPriceCalculationEnvelope::toJson() const
{
...
bool ItemPriceCalculationEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPriceCalculation> refVal_setResult;
...
void ItemPriceCalculationEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPriceCalculationEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPriceCalculationEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPriceCalculationEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPriceCalculationEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPriceCalculationEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPriceCalculationEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPriceCalculationEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPriceCalculationEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPriceCalculationEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPriceCalculationEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPriceCalculationEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPriceCalculationEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPriceCalculationEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPriceCalculationEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPriceCalculationEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPriceCalculationEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPriceCalculationEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPriceCalculationEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPriceCalculationEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPriceCalculationEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPriceCalculationEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPriceCalculationEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPriceCalculationEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPriceCalculationEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPriceCalculationEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPriceCalculationEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPriceCalculationEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPriceCalculationEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPriceCalculationEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPriceCalculationEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPriceCalculationEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPriceCalculationEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPriceCalculationEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPriceCalculation> ItemPriceCalculationEnvelope::getResult() const
{
    return m_Result;
}

void ItemPriceCalculationEnvelope::setResult(const std::shared_ptr<ItemPriceCalculation>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPriceCalculationEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPriceCalculationEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
