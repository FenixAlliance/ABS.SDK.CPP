...
DiscountListDtoEnvelope::DiscountListDtoEnvelope()
{
    m_IsSuccess = false;
...
void DiscountListDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value DiscountListDtoEnvelope::toJson() const
{
...
bool DiscountListDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<DiscountListDto> refVal_setResult;
...
void DiscountListDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DiscountListDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool DiscountListDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void DiscountListDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool DiscountListDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void DiscountListDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t DiscountListDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void DiscountListDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool DiscountListDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void DiscountListDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t DiscountListDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void DiscountListDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool DiscountListDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void DiscountListDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime DiscountListDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void DiscountListDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool DiscountListDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void DiscountListDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t DiscountListDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void DiscountListDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool DiscountListDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void DiscountListDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t DiscountListDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void DiscountListDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool DiscountListDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void DiscountListDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& DiscountListDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void DiscountListDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool DiscountListDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void DiscountListDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t DiscountListDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void DiscountListDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool DiscountListDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void DiscountListDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<DiscountListDto> DiscountListDtoEnvelope::getResult() const
{
    return m_Result;
}

void DiscountListDtoEnvelope::setResult(const std::shared_ptr<DiscountListDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool DiscountListDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void DiscountListDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
