...
ItemPriceDtoEnvelope::ItemPriceDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemPriceDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemPriceDtoEnvelope::toJson() const
{
...
bool ItemPriceDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemPriceDto> refVal_setResult;
...
void ItemPriceDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPriceDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemPriceDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemPriceDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemPriceDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemPriceDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemPriceDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemPriceDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemPriceDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemPriceDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemPriceDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemPriceDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemPriceDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemPriceDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemPriceDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemPriceDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemPriceDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemPriceDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemPriceDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemPriceDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemPriceDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemPriceDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemPriceDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemPriceDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemPriceDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemPriceDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemPriceDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemPriceDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemPriceDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemPriceDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemPriceDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemPriceDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemPriceDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemPriceDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemPriceDto> ItemPriceDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemPriceDtoEnvelope::setResult(const std::shared_ptr<ItemPriceDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemPriceDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemPriceDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
