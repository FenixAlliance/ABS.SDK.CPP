...
PriceListDtoListEnvelope::PriceListDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PriceListDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PriceListDtoListEnvelope::toJson() const
{
...
bool PriceListDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<PriceListDto>> refVal_setResult;
...
void PriceListDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PriceListDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PriceListDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PriceListDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PriceListDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PriceListDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PriceListDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PriceListDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PriceListDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PriceListDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PriceListDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PriceListDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PriceListDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PriceListDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PriceListDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PriceListDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PriceListDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PriceListDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PriceListDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PriceListDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PriceListDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PriceListDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PriceListDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PriceListDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PriceListDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PriceListDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PriceListDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PriceListDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PriceListDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PriceListDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PriceListDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PriceListDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PriceListDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PriceListDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PriceListDto>>& PriceListDtoListEnvelope::getResult()
{
    return m_Result;
}

void PriceListDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PriceListDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PriceListDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PriceListDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
