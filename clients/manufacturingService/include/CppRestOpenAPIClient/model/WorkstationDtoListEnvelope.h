...
/*
 * WorkstationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_WorkstationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_WorkstationDtoListEnvelope_H_
...
public:
    ...
    virtual ~WorkstationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// WorkstationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WorkstationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<WorkstationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<WorkstationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_WorkstationDtoListEnvelope_H_ */
