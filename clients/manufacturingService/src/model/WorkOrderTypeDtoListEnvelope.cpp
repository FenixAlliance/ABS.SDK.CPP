...
WorkOrderTypeDtoListEnvelope::WorkOrderTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WorkOrderTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WorkOrderTypeDtoListEnvelope::toJson() const
{
...
bool WorkOrderTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WorkOrderTypeDto>> refVal_setResult;
...
void WorkOrderTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WorkOrderTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WorkOrderTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WorkOrderTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WorkOrderTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WorkOrderTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WorkOrderTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WorkOrderTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WorkOrderTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WorkOrderTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WorkOrderTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WorkOrderTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WorkOrderTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WorkOrderTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WorkOrderTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WorkOrderTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WorkOrderTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WorkOrderTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WorkOrderTypeDto>>& WorkOrderTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void WorkOrderTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WorkOrderTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WorkOrderTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WorkOrderTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
