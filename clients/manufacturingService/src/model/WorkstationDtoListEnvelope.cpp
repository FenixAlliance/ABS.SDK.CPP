...
WorkstationDtoListEnvelope::WorkstationDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WorkstationDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WorkstationDtoListEnvelope::toJson() const
{
...
bool WorkstationDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WorkstationDto>> refVal_setResult;
...
void WorkstationDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WorkstationDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WorkstationDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WorkstationDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WorkstationDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WorkstationDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WorkstationDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WorkstationDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WorkstationDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WorkstationDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WorkstationDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WorkstationDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WorkstationDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WorkstationDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WorkstationDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WorkstationDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WorkstationDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WorkstationDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WorkstationDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WorkstationDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WorkstationDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WorkstationDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WorkstationDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WorkstationDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WorkstationDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WorkstationDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WorkstationDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WorkstationDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WorkstationDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WorkstationDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WorkstationDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WorkstationDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WorkstationDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WorkstationDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WorkstationDto>>& WorkstationDtoListEnvelope::getResult()
{
    return m_Result;
}

void WorkstationDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WorkstationDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WorkstationDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WorkstationDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
