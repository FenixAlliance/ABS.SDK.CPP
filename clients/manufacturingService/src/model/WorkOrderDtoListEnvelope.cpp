...
int32_t WorkOrderDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WorkOrderDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WorkOrderDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WorkOrderDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WorkOrderDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WorkOrderDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WorkOrderDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WorkOrderDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WorkOrderDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WorkOrderDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WorkOrderDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WorkOrderDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
