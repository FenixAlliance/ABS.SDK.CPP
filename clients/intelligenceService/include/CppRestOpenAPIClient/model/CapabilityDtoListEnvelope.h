...
/*
 * CapabilityDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoListEnvelope_H_
...
public:
    ...
    virtual ~CapabilityDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CapabilityDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CapabilityDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CapabilityDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CapabilityDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoListEnvelope_H_ */
