...
/*
 * CognitiveAgentDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<CognitiveAgentDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<CognitiveAgentDto>& value);
...
protected:
    ...
    std::shared_ptr<CognitiveAgentDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoEnvelope_H_ */
