...
/*
 * CapabilityDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoEnvelope_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<CapabilityDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<CapabilityDto>& value);
...
protected:
    ...
    std::shared_ptr<CapabilityDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CapabilityDtoEnvelope_H_ */
