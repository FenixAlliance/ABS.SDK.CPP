...
/*
 * AiProviderDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AiProviderDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AiProviderDtoListEnvelope_H_
...
public:
    ...
    virtual ~AiProviderDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// AiProviderDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AiProviderDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<AiProviderDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<AiProviderDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AiProviderDtoListEnvelope_H_ */
