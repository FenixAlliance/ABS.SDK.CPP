...
/*
 * CognitiveAgentConversationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentConversationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentConversationDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentConversationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentConversationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveAgentConversationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveAgentConversationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveAgentConversationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentConversationDtoListEnvelope_H_ */
