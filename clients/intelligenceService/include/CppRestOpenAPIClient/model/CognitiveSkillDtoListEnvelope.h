...
/*
 * CognitiveSkillDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveSkillDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveSkillDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveSkillDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveSkillDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveSkillDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoListEnvelope_H_ */
