...
/*
 * CognitiveAgentSkillDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentSkillDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentSkillDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentSkillDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentSkillDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveAgentSkillDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveAgentSkillDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveAgentSkillDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentSkillDtoListEnvelope_H_ */
