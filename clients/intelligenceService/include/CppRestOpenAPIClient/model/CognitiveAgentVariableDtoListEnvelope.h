...
/*
 * CognitiveAgentVariableDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentVariableDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentVariableDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentVariableDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentVariableDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveAgentVariableDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveAgentVariableDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveAgentVariableDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentVariableDtoListEnvelope_H_ */
