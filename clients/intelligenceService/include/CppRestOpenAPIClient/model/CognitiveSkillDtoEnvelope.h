...
/*
 * CognitiveSkillDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoEnvelope_H_
...
public:
    ...
    virtual ~CognitiveSkillDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveSkillDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<CognitiveSkillDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<CognitiveSkillDto>& value);
...
protected:
    ...
    std::shared_ptr<CognitiveSkillDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveSkillDtoEnvelope_H_ */
