...
/*
 * CognitiveAgentDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveAgentDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveAgentDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveAgentDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentDtoListEnvelope_H_ */
