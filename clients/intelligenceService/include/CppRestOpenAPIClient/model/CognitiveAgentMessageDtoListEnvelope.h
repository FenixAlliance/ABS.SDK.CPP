...
/*
 * CognitiveAgentMessageDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentMessageDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentMessageDtoListEnvelope_H_
...
public:
    ...
    virtual ~CognitiveAgentMessageDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// CognitiveAgentMessageDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CognitiveAgentMessageDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<CognitiveAgentMessageDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CognitiveAgentMessageDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CognitiveAgentMessageDtoListEnvelope_H_ */
