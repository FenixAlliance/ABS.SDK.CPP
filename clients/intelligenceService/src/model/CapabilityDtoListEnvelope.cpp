...
CapabilityDtoListEnvelope::CapabilityDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CapabilityDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CapabilityDtoListEnvelope::toJson() const
{
...
bool CapabilityDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CapabilityDto>> refVal_setResult;
...
void CapabilityDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CapabilityDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CapabilityDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CapabilityDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CapabilityDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CapabilityDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CapabilityDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CapabilityDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CapabilityDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CapabilityDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CapabilityDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CapabilityDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CapabilityDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CapabilityDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CapabilityDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CapabilityDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CapabilityDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CapabilityDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CapabilityDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CapabilityDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CapabilityDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CapabilityDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CapabilityDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CapabilityDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CapabilityDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CapabilityDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CapabilityDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CapabilityDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CapabilityDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CapabilityDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CapabilityDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CapabilityDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CapabilityDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CapabilityDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CapabilityDto>>& CapabilityDtoListEnvelope::getResult()
{
    return m_Result;
}

void CapabilityDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CapabilityDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CapabilityDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CapabilityDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
