...
CognitiveAgentDtoEnvelope::CognitiveAgentDtoEnvelope()
{
    m_IsSuccess = false;
...
void CognitiveAgentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CognitiveAgentDtoEnvelope::toJson() const
{
...
bool CognitiveAgentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CognitiveAgentDto> refVal_setResult;
...
void CognitiveAgentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CognitiveAgentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CognitiveAgentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CognitiveAgentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CognitiveAgentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CognitiveAgentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CognitiveAgentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CognitiveAgentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CognitiveAgentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CognitiveAgentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CognitiveAgentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CognitiveAgentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CognitiveAgentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CognitiveAgentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CognitiveAgentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CognitiveAgentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CognitiveAgentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CognitiveAgentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CognitiveAgentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CognitiveAgentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CognitiveAgentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CognitiveAgentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CognitiveAgentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CognitiveAgentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CognitiveAgentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CognitiveAgentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CognitiveAgentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CognitiveAgentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CognitiveAgentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CognitiveAgentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CognitiveAgentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CognitiveAgentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CognitiveAgentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CognitiveAgentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CognitiveAgentDto> CognitiveAgentDtoEnvelope::getResult() const
{
    return m_Result;
}

void CognitiveAgentDtoEnvelope::setResult(const std::shared_ptr<CognitiveAgentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CognitiveAgentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CognitiveAgentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
