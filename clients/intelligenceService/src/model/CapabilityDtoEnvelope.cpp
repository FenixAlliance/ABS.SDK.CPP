...
CapabilityDtoEnvelope::CapabilityDtoEnvelope()
{
    m_IsSuccess = false;
...
void CapabilityDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CapabilityDtoEnvelope::toJson() const
{
...
bool CapabilityDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CapabilityDto> refVal_setResult;
...
void CapabilityDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CapabilityDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CapabilityDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CapabilityDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CapabilityDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CapabilityDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CapabilityDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CapabilityDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CapabilityDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CapabilityDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CapabilityDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CapabilityDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CapabilityDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CapabilityDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CapabilityDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CapabilityDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CapabilityDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CapabilityDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CapabilityDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CapabilityDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CapabilityDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CapabilityDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CapabilityDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CapabilityDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CapabilityDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CapabilityDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CapabilityDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CapabilityDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CapabilityDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CapabilityDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CapabilityDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CapabilityDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CapabilityDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CapabilityDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CapabilityDto> CapabilityDtoEnvelope::getResult() const
{
    return m_Result;
}

void CapabilityDtoEnvelope::setResult(const std::shared_ptr<CapabilityDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CapabilityDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CapabilityDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
