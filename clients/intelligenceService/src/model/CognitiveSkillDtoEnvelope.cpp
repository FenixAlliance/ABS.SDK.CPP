...
CognitiveSkillDtoEnvelope::CognitiveSkillDtoEnvelope()
{
    m_IsSuccess = false;
...
void CognitiveSkillDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CognitiveSkillDtoEnvelope::toJson() const
{
...
bool CognitiveSkillDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CognitiveSkillDto> refVal_setResult;
...
void CognitiveSkillDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CognitiveSkillDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CognitiveSkillDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CognitiveSkillDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CognitiveSkillDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CognitiveSkillDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CognitiveSkillDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CognitiveSkillDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CognitiveSkillDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CognitiveSkillDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CognitiveSkillDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CognitiveSkillDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CognitiveSkillDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CognitiveSkillDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CognitiveSkillDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CognitiveSkillDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CognitiveSkillDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CognitiveSkillDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CognitiveSkillDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CognitiveSkillDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CognitiveSkillDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CognitiveSkillDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CognitiveSkillDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CognitiveSkillDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CognitiveSkillDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CognitiveSkillDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CognitiveSkillDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CognitiveSkillDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CognitiveSkillDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CognitiveSkillDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CognitiveSkillDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CognitiveSkillDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CognitiveSkillDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CognitiveSkillDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CognitiveSkillDto> CognitiveSkillDtoEnvelope::getResult() const
{
    return m_Result;
}

void CognitiveSkillDtoEnvelope::setResult(const std::shared_ptr<CognitiveSkillDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CognitiveSkillDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CognitiveSkillDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
