...
PortalSettingsEnvelope::PortalSettingsEnvelope()
{
    m_IsSuccess = false;
...
void PortalSettingsEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PortalSettingsEnvelope::toJson() const
{
...
bool PortalSettingsEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PortalSettings> refVal_setResult;
...
void PortalSettingsEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PortalSettingsEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PortalSettingsEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PortalSettingsEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PortalSettingsEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PortalSettingsEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PortalSettingsEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PortalSettingsEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PortalSettingsEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PortalSettingsEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PortalSettingsEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PortalSettingsEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PortalSettingsEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PortalSettingsEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PortalSettingsEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PortalSettingsEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PortalSettingsEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PortalSettingsEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PortalSettingsEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PortalSettingsEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PortalSettingsEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PortalSettingsEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PortalSettingsEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PortalSettingsEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PortalSettingsEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PortalSettingsEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PortalSettingsEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PortalSettingsEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PortalSettingsEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PortalSettingsEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PortalSettingsEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PortalSettingsEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PortalSettingsEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PortalSettingsEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PortalSettings> PortalSettingsEnvelope::getResult() const
{
    return m_Result;
}

void PortalSettingsEnvelope::setResult(const std::shared_ptr<PortalSettings>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PortalSettingsEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PortalSettingsEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
