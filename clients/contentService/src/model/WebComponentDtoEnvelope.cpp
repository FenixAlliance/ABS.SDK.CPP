...
WebComponentDtoEnvelope::WebComponentDtoEnvelope()
{
    m_IsSuccess = false;
...
void WebComponentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WebComponentDtoEnvelope::toJson() const
{
...
bool WebComponentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WebComponentDto> refVal_setResult;
...
void WebComponentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebComponentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WebComponentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WebComponentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WebComponentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WebComponentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WebComponentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WebComponentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WebComponentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WebComponentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WebComponentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WebComponentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WebComponentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WebComponentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WebComponentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WebComponentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WebComponentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WebComponentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WebComponentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WebComponentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WebComponentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WebComponentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WebComponentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WebComponentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WebComponentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WebComponentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WebComponentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WebComponentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WebComponentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WebComponentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WebComponentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WebComponentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WebComponentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WebComponentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WebComponentDto> WebComponentDtoEnvelope::getResult() const
{
    return m_Result;
}

void WebComponentDtoEnvelope::setResult(const std::shared_ptr<WebComponentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WebComponentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WebComponentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
