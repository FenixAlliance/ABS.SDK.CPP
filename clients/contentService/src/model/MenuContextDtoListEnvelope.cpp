...
MenuContextDtoListEnvelope::MenuContextDtoListEnvelope()
{
    m_IsSuccess = false;
...
void MenuContextDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value MenuContextDtoListEnvelope::toJson() const
{
...
bool MenuContextDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<MenuContextDto>> refVal_setResult;
...
void MenuContextDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MenuContextDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool MenuContextDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void MenuContextDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool MenuContextDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void MenuContextDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t MenuContextDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void MenuContextDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool MenuContextDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void MenuContextDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t MenuContextDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void MenuContextDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool MenuContextDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void MenuContextDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime MenuContextDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void MenuContextDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool MenuContextDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void MenuContextDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t MenuContextDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void MenuContextDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool MenuContextDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void MenuContextDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t MenuContextDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void MenuContextDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool MenuContextDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void MenuContextDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& MenuContextDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void MenuContextDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool MenuContextDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void MenuContextDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t MenuContextDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void MenuContextDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool MenuContextDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void MenuContextDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<MenuContextDto>>& MenuContextDtoListEnvelope::getResult()
{
    return m_Result;
}

void MenuContextDtoListEnvelope::setResult(const std::vector<std::shared_ptr<MenuContextDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool MenuContextDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void MenuContextDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
