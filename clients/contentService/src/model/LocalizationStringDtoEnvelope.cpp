...
LocalizationStringDtoEnvelope::LocalizationStringDtoEnvelope()
{
    m_IsSuccess = false;
...
void LocalizationStringDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value LocalizationStringDtoEnvelope::toJson() const
{
...
bool LocalizationStringDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LocalizationStringDto> refVal_setResult;
...
void LocalizationStringDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocalizationStringDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool LocalizationStringDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void LocalizationStringDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool LocalizationStringDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void LocalizationStringDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t LocalizationStringDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void LocalizationStringDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool LocalizationStringDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void LocalizationStringDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t LocalizationStringDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void LocalizationStringDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool LocalizationStringDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void LocalizationStringDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime LocalizationStringDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void LocalizationStringDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool LocalizationStringDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void LocalizationStringDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t LocalizationStringDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void LocalizationStringDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool LocalizationStringDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void LocalizationStringDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t LocalizationStringDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void LocalizationStringDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool LocalizationStringDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void LocalizationStringDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& LocalizationStringDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void LocalizationStringDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool LocalizationStringDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void LocalizationStringDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t LocalizationStringDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void LocalizationStringDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool LocalizationStringDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void LocalizationStringDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<LocalizationStringDto> LocalizationStringDtoEnvelope::getResult() const
{
    return m_Result;
}

void LocalizationStringDtoEnvelope::setResult(const std::shared_ptr<LocalizationStringDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool LocalizationStringDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void LocalizationStringDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
