...
BlogPostTagDtoEnvelope::BlogPostTagDtoEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostTagDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostTagDtoEnvelope::toJson() const
{
...
bool BlogPostTagDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BlogPostTagDto> refVal_setResult;
...
void BlogPostTagDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostTagDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostTagDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostTagDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostTagDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostTagDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostTagDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostTagDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostTagDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostTagDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostTagDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostTagDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostTagDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostTagDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostTagDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostTagDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostTagDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostTagDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostTagDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostTagDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostTagDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostTagDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostTagDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostTagDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostTagDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostTagDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostTagDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostTagDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostTagDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostTagDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostTagDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostTagDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostTagDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostTagDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BlogPostTagDto> BlogPostTagDtoEnvelope::getResult() const
{
    return m_Result;
}

void BlogPostTagDtoEnvelope::setResult(const std::shared_ptr<BlogPostTagDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostTagDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostTagDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
