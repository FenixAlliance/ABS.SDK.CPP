...
WebContentDtoListEnvelope::WebContentDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WebContentDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WebContentDtoListEnvelope::toJson() const
{
...
bool WebContentDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WebContentDto>> refVal_setResult;
...
void WebContentDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebContentDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WebContentDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WebContentDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WebContentDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WebContentDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WebContentDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WebContentDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WebContentDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WebContentDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WebContentDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WebContentDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WebContentDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WebContentDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WebContentDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WebContentDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WebContentDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WebContentDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WebContentDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WebContentDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WebContentDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WebContentDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WebContentDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WebContentDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WebContentDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WebContentDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WebContentDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WebContentDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WebContentDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WebContentDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WebContentDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WebContentDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WebContentDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WebContentDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WebContentDto>>& WebContentDtoListEnvelope::getResult()
{
    return m_Result;
}

void WebContentDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WebContentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WebContentDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WebContentDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
