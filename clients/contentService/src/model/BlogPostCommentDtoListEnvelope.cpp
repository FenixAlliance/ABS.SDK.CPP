...
BlogPostCommentDtoListEnvelope::BlogPostCommentDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostCommentDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostCommentDtoListEnvelope::toJson() const
{
...
bool BlogPostCommentDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BlogPostCommentDto>> refVal_setResult;
...
void BlogPostCommentDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostCommentDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostCommentDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostCommentDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostCommentDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostCommentDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostCommentDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostCommentDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostCommentDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostCommentDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostCommentDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostCommentDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostCommentDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostCommentDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostCommentDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostCommentDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostCommentDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostCommentDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BlogPostCommentDto>>& BlogPostCommentDtoListEnvelope::getResult()
{
    return m_Result;
}

void BlogPostCommentDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BlogPostCommentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostCommentDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostCommentDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
