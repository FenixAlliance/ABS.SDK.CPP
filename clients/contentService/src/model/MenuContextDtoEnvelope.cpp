...
MenuContextDtoEnvelope::MenuContextDtoEnvelope()
{
    m_IsSuccess = false;
...
void MenuContextDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value MenuContextDtoEnvelope::toJson() const
{
...
bool MenuContextDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MenuContextDto> refVal_setResult;
...
void MenuContextDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MenuContextDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool MenuContextDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void MenuContextDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool MenuContextDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void MenuContextDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t MenuContextDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void MenuContextDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool MenuContextDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void MenuContextDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t MenuContextDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void MenuContextDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool MenuContextDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void MenuContextDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime MenuContextDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void MenuContextDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool MenuContextDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void MenuContextDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t MenuContextDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void MenuContextDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool MenuContextDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void MenuContextDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t MenuContextDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void MenuContextDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool MenuContextDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void MenuContextDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& MenuContextDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void MenuContextDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool MenuContextDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void MenuContextDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t MenuContextDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void MenuContextDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool MenuContextDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void MenuContextDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<MenuContextDto> MenuContextDtoEnvelope::getResult() const
{
    return m_Result;
}

void MenuContextDtoEnvelope::setResult(const std::shared_ptr<MenuContextDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool MenuContextDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void MenuContextDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
