...
BlogPostDtoListEnvelope::BlogPostDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostDtoListEnvelope::toJson() const
{
...
bool BlogPostDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BlogPostDto>> refVal_setResult;
...
void BlogPostDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BlogPostDto>>& BlogPostDtoListEnvelope::getResult()
{
    return m_Result;
}

void BlogPostDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BlogPostDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
