...
BlogPostDtoEnvelope::BlogPostDtoEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostDtoEnvelope::toJson() const
{
...
bool BlogPostDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BlogPostDto> refVal_setResult;
...
void BlogPostDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BlogPostDto> BlogPostDtoEnvelope::getResult() const
{
    return m_Result;
}

void BlogPostDtoEnvelope::setResult(const std::shared_ptr<BlogPostDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
