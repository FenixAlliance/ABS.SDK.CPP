...
ExecutionContextEnvelope::ExecutionContextEnvelope()
{
    m_IsSuccess = false;
...
void ExecutionContextEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExecutionContextEnvelope::toJson() const
{
...
bool ExecutionContextEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExecutionContext> refVal_setResult;
...
void ExecutionContextEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExecutionContextEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExecutionContextEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExecutionContextEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExecutionContextEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExecutionContextEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExecutionContextEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExecutionContextEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExecutionContextEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExecutionContextEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExecutionContextEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExecutionContextEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExecutionContextEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExecutionContextEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExecutionContextEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExecutionContextEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExecutionContextEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExecutionContextEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExecutionContextEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExecutionContextEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExecutionContextEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExecutionContextEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExecutionContextEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExecutionContextEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExecutionContextEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExecutionContextEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExecutionContextEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExecutionContextEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExecutionContextEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExecutionContextEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExecutionContextEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExecutionContextEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExecutionContextEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExecutionContextEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExecutionContext> ExecutionContextEnvelope::getResult() const
{
    return m_Result;
}

void ExecutionContextEnvelope::setResult(const std::shared_ptr<ExecutionContext>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExecutionContextEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExecutionContextEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
