...
WebPageCategoryDtoListEnvelope::WebPageCategoryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void WebPageCategoryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WebPageCategoryDtoListEnvelope::toJson() const
{
...
bool WebPageCategoryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WebPageCategoryDto>> refVal_setResult;
...
void WebPageCategoryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebPageCategoryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WebPageCategoryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WebPageCategoryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WebPageCategoryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WebPageCategoryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WebPageCategoryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WebPageCategoryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WebPageCategoryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WebPageCategoryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WebPageCategoryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WebPageCategoryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WebPageCategoryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WebPageCategoryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WebPageCategoryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WebPageCategoryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WebPageCategoryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WebPageCategoryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<WebPageCategoryDto>>& WebPageCategoryDtoListEnvelope::getResult()
{
    return m_Result;
}

void WebPageCategoryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<WebPageCategoryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WebPageCategoryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WebPageCategoryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
