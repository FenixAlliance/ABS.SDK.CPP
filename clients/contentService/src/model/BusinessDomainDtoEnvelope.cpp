...
BusinessDomainDtoEnvelope::BusinessDomainDtoEnvelope()
{
    m_IsSuccess = false;
...
void BusinessDomainDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BusinessDomainDtoEnvelope::toJson() const
{
...
bool BusinessDomainDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BusinessDomainDto> refVal_setResult;
...
void BusinessDomainDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BusinessDomainDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BusinessDomainDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BusinessDomainDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BusinessDomainDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BusinessDomainDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BusinessDomainDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BusinessDomainDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BusinessDomainDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BusinessDomainDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BusinessDomainDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BusinessDomainDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BusinessDomainDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BusinessDomainDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BusinessDomainDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BusinessDomainDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BusinessDomainDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BusinessDomainDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BusinessDomainDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BusinessDomainDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BusinessDomainDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BusinessDomainDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BusinessDomainDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BusinessDomainDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BusinessDomainDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BusinessDomainDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BusinessDomainDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BusinessDomainDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BusinessDomainDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BusinessDomainDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BusinessDomainDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BusinessDomainDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BusinessDomainDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BusinessDomainDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BusinessDomainDto> BusinessDomainDtoEnvelope::getResult() const
{
    return m_Result;
}

void BusinessDomainDtoEnvelope::setResult(const std::shared_ptr<BusinessDomainDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BusinessDomainDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BusinessDomainDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
