...
utility::string_t BlogPostCreateDto::getSlug() const
{
    return m_Slug;
}

void BlogPostCreateDto::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool BlogPostCreateDto::slugIsSet() const
{
    return m_SlugIsSet;
}

void BlogPostCreateDto::unsetSlug()
{
    m_SlugIsSet = false;
}
