...
WebPageCategoryDtoEnvelope::WebPageCategoryDtoEnvelope()
{
    m_IsSuccess = false;
...
void WebPageCategoryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WebPageCategoryDtoEnvelope::toJson() const
{
...
bool WebPageCategoryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WebPageCategoryDto> refVal_setResult;
...
void WebPageCategoryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WebPageCategoryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WebPageCategoryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WebPageCategoryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WebPageCategoryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WebPageCategoryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WebPageCategoryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WebPageCategoryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WebPageCategoryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WebPageCategoryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WebPageCategoryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WebPageCategoryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WebPageCategoryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WebPageCategoryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WebPageCategoryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WebPageCategoryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WebPageCategoryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WebPageCategoryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WebPageCategoryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WebPageCategoryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WebPageCategoryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WebPageCategoryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WebPageCategoryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WebPageCategoryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WebPageCategoryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WebPageCategoryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WebPageCategoryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WebPageCategoryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WebPageCategoryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WebPageCategoryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WebPageCategoryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WebPageCategoryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WebPageCategoryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WebPageCategoryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WebPageCategoryDto> WebPageCategoryDtoEnvelope::getResult() const
{
    return m_Result;
}

void WebPageCategoryDtoEnvelope::setResult(const std::shared_ptr<WebPageCategoryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WebPageCategoryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WebPageCategoryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
