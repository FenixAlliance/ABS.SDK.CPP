...
BlogPostCategoryDtoEnvelope::BlogPostCategoryDtoEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostCategoryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostCategoryDtoEnvelope::toJson() const
{
...
bool BlogPostCategoryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BlogPostCategoryDto> refVal_setResult;
...
void BlogPostCategoryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostCategoryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostCategoryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostCategoryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostCategoryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostCategoryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostCategoryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostCategoryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostCategoryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostCategoryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostCategoryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostCategoryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostCategoryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostCategoryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostCategoryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostCategoryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostCategoryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostCategoryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BlogPostCategoryDto> BlogPostCategoryDtoEnvelope::getResult() const
{
    return m_Result;
}

void BlogPostCategoryDtoEnvelope::setResult(const std::shared_ptr<BlogPostCategoryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostCategoryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostCategoryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
