...
BlogPostTagDtoListEnvelope::BlogPostTagDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BlogPostTagDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BlogPostTagDtoListEnvelope::toJson() const
{
...
bool BlogPostTagDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BlogPostTagDto>> refVal_setResult;
...
void BlogPostTagDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlogPostTagDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BlogPostTagDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BlogPostTagDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BlogPostTagDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BlogPostTagDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BlogPostTagDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BlogPostTagDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BlogPostTagDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BlogPostTagDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BlogPostTagDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BlogPostTagDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BlogPostTagDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BlogPostTagDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BlogPostTagDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BlogPostTagDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BlogPostTagDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BlogPostTagDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BlogPostTagDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BlogPostTagDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BlogPostTagDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BlogPostTagDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BlogPostTagDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BlogPostTagDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BlogPostTagDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BlogPostTagDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BlogPostTagDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BlogPostTagDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BlogPostTagDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BlogPostTagDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BlogPostTagDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BlogPostTagDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BlogPostTagDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BlogPostTagDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BlogPostTagDto>>& BlogPostTagDtoListEnvelope::getResult()
{
    return m_Result;
}

void BlogPostTagDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BlogPostTagDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BlogPostTagDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BlogPostTagDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
