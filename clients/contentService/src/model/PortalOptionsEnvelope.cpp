...
PortalOptionsEnvelope::PortalOptionsEnvelope()
{
    m_IsSuccess = false;
...
void PortalOptionsEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PortalOptionsEnvelope::toJson() const
{
...
bool PortalOptionsEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PortalOptions> refVal_setResult;
...
void PortalOptionsEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PortalOptionsEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PortalOptionsEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PortalOptionsEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PortalOptionsEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PortalOptionsEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PortalOptionsEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PortalOptionsEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PortalOptionsEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PortalOptionsEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PortalOptionsEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PortalOptionsEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PortalOptionsEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PortalOptionsEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PortalOptionsEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PortalOptionsEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PortalOptionsEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PortalOptionsEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PortalOptionsEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PortalOptionsEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PortalOptionsEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PortalOptionsEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PortalOptionsEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PortalOptionsEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PortalOptionsEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PortalOptionsEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PortalOptionsEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PortalOptionsEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PortalOptionsEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PortalOptionsEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PortalOptionsEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PortalOptionsEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PortalOptionsEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PortalOptionsEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PortalOptions> PortalOptionsEnvelope::getResult() const
{
    return m_Result;
}

void PortalOptionsEnvelope::setResult(const std::shared_ptr<PortalOptions>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PortalOptionsEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PortalOptionsEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
