...
#include "CppRestOpenAPIClient/api/ThemesApi.h"
...
ThemesApi::ThemesApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<void> ThemesApi::getLatestCurrencyRatesModelAsync(boost::optional<utility::string_t> apiVersion, boost::optional<utility::string_t> xApiVersion) const
{
    ...
    utility::string_t localVarPath = utility::conversions::to_string_t("/api/v2/ContentService/Themes/Update");
