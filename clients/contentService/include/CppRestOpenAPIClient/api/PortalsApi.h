...
public:
    ...
    pplx::task<std::shared_ptr<EmptyEnvelope>> bindWebPortalDomainAsync(
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<BusinessDomainDtoListEnvelope>> getWebPortalDomainBindingsAsync(
        utility::string_t tenantId,
        utility::string_t portalId,
        boost::optional<utility::string_t> apiVersion,
        boost::optional<utility::string_t> xApiVersion
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<EmptyEnvelope>> unbindWebPortalDomainAsync(
        utility::string_t tenantId,
        utility::string_t portalId,
        utility::string_t businessDomainId,
        boost::optional<utility::string_t> apiVersion,
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="portalSettings"> (optional)</param>
    pplx::task<std::shared_ptr<EmptyEnvelope>> updateWebPortalSettingsAsync(
        utility::string_t tenantId,
        utility::string_t portalId,
        boost::optional<utility::string_t> apiVersion,
        boost::optional<utility::string_t> xApiVersion,
        boost::optional<std::shared_ptr<PortalSettings>> portalSettings
    ) const;
