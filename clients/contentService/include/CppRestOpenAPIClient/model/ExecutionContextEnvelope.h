...
/*
 * ExecutionContextEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ExecutionContextEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ExecutionContextEnvelope_H_
...
public:
    ...
    virtual ~ExecutionContextEnvelope();
    ...
    /////////////////////////////////////////////
    /// ExecutionContextEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<ExecutionContext> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<ExecutionContext>& value);
...
protected:
    ...
    std::shared_ptr<ExecutionContext> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ExecutionContextEnvelope_H_ */
