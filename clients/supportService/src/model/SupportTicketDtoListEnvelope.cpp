...
SupportTicketDtoListEnvelope::SupportTicketDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SupportTicketDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupportTicketDtoListEnvelope::toJson() const
{
...
bool SupportTicketDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SupportTicketDto>> refVal_setResult;
...
void SupportTicketDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupportTicketDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupportTicketDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupportTicketDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupportTicketDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupportTicketDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupportTicketDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupportTicketDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupportTicketDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupportTicketDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupportTicketDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupportTicketDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupportTicketDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupportTicketDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupportTicketDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupportTicketDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupportTicketDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupportTicketDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupportTicketDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupportTicketDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupportTicketDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupportTicketDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupportTicketDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupportTicketDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupportTicketDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupportTicketDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupportTicketDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupportTicketDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupportTicketDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupportTicketDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupportTicketDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupportTicketDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupportTicketDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupportTicketDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SupportTicketDto>>& SupportTicketDtoListEnvelope::getResult()
{
    return m_Result;
}

void SupportTicketDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SupportTicketDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupportTicketDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupportTicketDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
