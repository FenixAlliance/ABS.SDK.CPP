...
WarrantyRequestDtoEnvelope::WarrantyRequestDtoEnvelope()
{
    m_IsSuccess = false;
...
void WarrantyRequestDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WarrantyRequestDtoEnvelope::toJson() const
{
...
bool WarrantyRequestDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WarrantyRequestDto> refVal_setResult;
...
void WarrantyRequestDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WarrantyRequestDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WarrantyRequestDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WarrantyRequestDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WarrantyRequestDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WarrantyRequestDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WarrantyRequestDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WarrantyRequestDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WarrantyRequestDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WarrantyRequestDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WarrantyRequestDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WarrantyRequestDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WarrantyRequestDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WarrantyRequestDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WarrantyRequestDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WarrantyRequestDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WarrantyRequestDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WarrantyRequestDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WarrantyRequestDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WarrantyRequestDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WarrantyRequestDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WarrantyRequestDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WarrantyRequestDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WarrantyRequestDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WarrantyRequestDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WarrantyRequestDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WarrantyRequestDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WarrantyRequestDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WarrantyRequestDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WarrantyRequestDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WarrantyRequestDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WarrantyRequestDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WarrantyRequestDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WarrantyRequestDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WarrantyRequestDto> WarrantyRequestDtoEnvelope::getResult() const
{
    return m_Result;
}

void WarrantyRequestDtoEnvelope::setResult(const std::shared_ptr<WarrantyRequestDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WarrantyRequestDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WarrantyRequestDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
