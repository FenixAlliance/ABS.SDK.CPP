...
MaintenanceVisitDtoEnvelope::MaintenanceVisitDtoEnvelope()
{
    m_IsSuccess = false;
...
void MaintenanceVisitDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value MaintenanceVisitDtoEnvelope::toJson() const
{
...
bool MaintenanceVisitDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MaintenanceVisitDto> refVal_setResult;
...
void MaintenanceVisitDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MaintenanceVisitDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool MaintenanceVisitDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void MaintenanceVisitDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t MaintenanceVisitDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void MaintenanceVisitDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t MaintenanceVisitDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void MaintenanceVisitDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime MaintenanceVisitDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void MaintenanceVisitDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t MaintenanceVisitDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void MaintenanceVisitDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t MaintenanceVisitDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void MaintenanceVisitDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& MaintenanceVisitDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void MaintenanceVisitDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t MaintenanceVisitDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void MaintenanceVisitDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<MaintenanceVisitDto> MaintenanceVisitDtoEnvelope::getResult() const
{
    return m_Result;
}

void MaintenanceVisitDtoEnvelope::setResult(const std::shared_ptr<MaintenanceVisitDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool MaintenanceVisitDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void MaintenanceVisitDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
