...
SupportTicketDtoEnvelope::SupportTicketDtoEnvelope()
{
    m_IsSuccess = false;
...
void SupportTicketDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupportTicketDtoEnvelope::toJson() const
{
...
bool SupportTicketDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SupportTicketDto> refVal_setResult;
...
void SupportTicketDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupportTicketDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupportTicketDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupportTicketDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupportTicketDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupportTicketDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupportTicketDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupportTicketDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupportTicketDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupportTicketDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupportTicketDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupportTicketDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupportTicketDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupportTicketDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupportTicketDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupportTicketDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupportTicketDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupportTicketDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupportTicketDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupportTicketDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupportTicketDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupportTicketDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupportTicketDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupportTicketDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupportTicketDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupportTicketDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupportTicketDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupportTicketDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupportTicketDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupportTicketDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupportTicketDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupportTicketDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupportTicketDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupportTicketDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SupportTicketDto> SupportTicketDtoEnvelope::getResult() const
{
    return m_Result;
}

void SupportTicketDtoEnvelope::setResult(const std::shared_ptr<SupportTicketDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupportTicketDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupportTicketDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
