...
ReturnRequestDtoEnvelope::ReturnRequestDtoEnvelope()
{
    m_IsSuccess = false;
...
void ReturnRequestDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ReturnRequestDtoEnvelope::toJson() const
{
...
bool ReturnRequestDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ReturnRequestDto> refVal_setResult;
...
void ReturnRequestDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReturnRequestDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ReturnRequestDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ReturnRequestDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ReturnRequestDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ReturnRequestDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ReturnRequestDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ReturnRequestDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ReturnRequestDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ReturnRequestDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ReturnRequestDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ReturnRequestDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ReturnRequestDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ReturnRequestDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ReturnRequestDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ReturnRequestDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ReturnRequestDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ReturnRequestDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ReturnRequestDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ReturnRequestDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ReturnRequestDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ReturnRequestDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ReturnRequestDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ReturnRequestDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ReturnRequestDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ReturnRequestDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ReturnRequestDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ReturnRequestDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ReturnRequestDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ReturnRequestDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ReturnRequestDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ReturnRequestDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ReturnRequestDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ReturnRequestDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ReturnRequestDto> ReturnRequestDtoEnvelope::getResult() const
{
    return m_Result;
}

void ReturnRequestDtoEnvelope::setResult(const std::shared_ptr<ReturnRequestDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ReturnRequestDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ReturnRequestDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
