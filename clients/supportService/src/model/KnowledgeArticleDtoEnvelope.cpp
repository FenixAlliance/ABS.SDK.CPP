...
KnowledgeArticleDtoEnvelope::KnowledgeArticleDtoEnvelope()
{
    m_IsSuccess = false;
...
void KnowledgeArticleDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value KnowledgeArticleDtoEnvelope::toJson() const
{
...
bool KnowledgeArticleDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<KnowledgeArticleDto> refVal_setResult;
...
void KnowledgeArticleDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool KnowledgeArticleDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool KnowledgeArticleDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void KnowledgeArticleDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t KnowledgeArticleDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void KnowledgeArticleDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t KnowledgeArticleDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void KnowledgeArticleDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime KnowledgeArticleDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void KnowledgeArticleDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t KnowledgeArticleDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void KnowledgeArticleDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t KnowledgeArticleDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void KnowledgeArticleDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& KnowledgeArticleDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void KnowledgeArticleDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t KnowledgeArticleDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void KnowledgeArticleDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<KnowledgeArticleDto> KnowledgeArticleDtoEnvelope::getResult() const
{
    return m_Result;
}

void KnowledgeArticleDtoEnvelope::setResult(const std::shared_ptr<KnowledgeArticleDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool KnowledgeArticleDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void KnowledgeArticleDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
