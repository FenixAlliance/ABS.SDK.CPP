...
SupportRequestDtoListEnvelope::SupportRequestDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SupportRequestDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupportRequestDtoListEnvelope::toJson() const
{
...
bool SupportRequestDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SupportRequestDto>> refVal_setResult;
...
void SupportRequestDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupportRequestDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupportRequestDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupportRequestDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupportRequestDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupportRequestDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupportRequestDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupportRequestDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupportRequestDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupportRequestDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupportRequestDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupportRequestDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupportRequestDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupportRequestDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupportRequestDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupportRequestDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupportRequestDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupportRequestDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupportRequestDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupportRequestDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupportRequestDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupportRequestDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupportRequestDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupportRequestDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupportRequestDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupportRequestDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupportRequestDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupportRequestDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupportRequestDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupportRequestDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupportRequestDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupportRequestDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupportRequestDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupportRequestDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SupportRequestDto>>& SupportRequestDtoListEnvelope::getResult()
{
    return m_Result;
}

void SupportRequestDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SupportRequestDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupportRequestDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupportRequestDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
