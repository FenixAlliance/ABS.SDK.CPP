...
SupportRequestDtoEnvelope::SupportRequestDtoEnvelope()
{
    m_IsSuccess = false;
...
void SupportRequestDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupportRequestDtoEnvelope::toJson() const
{
...
bool SupportRequestDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SupportRequestDto> refVal_setResult;
...
void SupportRequestDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupportRequestDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupportRequestDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupportRequestDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupportRequestDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupportRequestDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupportRequestDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupportRequestDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupportRequestDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupportRequestDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupportRequestDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupportRequestDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupportRequestDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupportRequestDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupportRequestDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupportRequestDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupportRequestDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupportRequestDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupportRequestDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupportRequestDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupportRequestDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupportRequestDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupportRequestDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupportRequestDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupportRequestDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupportRequestDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupportRequestDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupportRequestDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupportRequestDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupportRequestDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupportRequestDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupportRequestDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupportRequestDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupportRequestDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SupportRequestDto> SupportRequestDtoEnvelope::getResult() const
{
    return m_Result;
}

void SupportRequestDtoEnvelope::setResult(const std::shared_ptr<SupportRequestDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupportRequestDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupportRequestDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
