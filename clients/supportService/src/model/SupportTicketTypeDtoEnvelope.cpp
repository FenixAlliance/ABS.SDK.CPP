...
SupportTicketTypeDtoEnvelope::SupportTicketTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void SupportTicketTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SupportTicketTypeDtoEnvelope::toJson() const
{
...
bool SupportTicketTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SupportTicketTypeDto> refVal_setResult;
...
void SupportTicketTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SupportTicketTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SupportTicketTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SupportTicketTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SupportTicketTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SupportTicketTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SupportTicketTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SupportTicketTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SupportTicketTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SupportTicketTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SupportTicketTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SupportTicketTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SupportTicketTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SupportTicketTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SupportTicketTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SupportTicketTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SupportTicketTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SupportTicketTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SupportTicketTypeDto> SupportTicketTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void SupportTicketTypeDtoEnvelope::setResult(const std::shared_ptr<SupportTicketTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SupportTicketTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SupportTicketTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
