...
RefundRequestDtoEnvelope::RefundRequestDtoEnvelope()
{
    m_IsSuccess = false;
...
void RefundRequestDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value RefundRequestDtoEnvelope::toJson() const
{
...
bool RefundRequestDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<RefundRequestDto> refVal_setResult;
...
void RefundRequestDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RefundRequestDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool RefundRequestDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void RefundRequestDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool RefundRequestDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void RefundRequestDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t RefundRequestDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void RefundRequestDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool RefundRequestDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void RefundRequestDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t RefundRequestDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void RefundRequestDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool RefundRequestDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void RefundRequestDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime RefundRequestDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void RefundRequestDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool RefundRequestDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void RefundRequestDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t RefundRequestDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void RefundRequestDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool RefundRequestDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void RefundRequestDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t RefundRequestDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void RefundRequestDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool RefundRequestDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void RefundRequestDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& RefundRequestDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void RefundRequestDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool RefundRequestDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void RefundRequestDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t RefundRequestDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void RefundRequestDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool RefundRequestDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void RefundRequestDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<RefundRequestDto> RefundRequestDtoEnvelope::getResult() const
{
    return m_Result;
}

void RefundRequestDtoEnvelope::setResult(const std::shared_ptr<RefundRequestDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool RefundRequestDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void RefundRequestDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
