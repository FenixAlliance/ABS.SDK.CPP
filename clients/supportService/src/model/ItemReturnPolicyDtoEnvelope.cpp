...
ItemReturnPolicyDtoEnvelope::ItemReturnPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemReturnPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemReturnPolicyDtoEnvelope::toJson() const
{
...
bool ItemReturnPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemReturnPolicyDto> refVal_setResult;
...
void ItemReturnPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemReturnPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemReturnPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemReturnPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemReturnPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemReturnPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemReturnPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemReturnPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemReturnPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemReturnPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemReturnPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemReturnPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemReturnPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemReturnPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemReturnPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemReturnPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemReturnPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemReturnPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemReturnPolicyDto> ItemReturnPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemReturnPolicyDtoEnvelope::setResult(const std::shared_ptr<ItemReturnPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemReturnPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemReturnPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
