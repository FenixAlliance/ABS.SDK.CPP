...
AssetCategoryDtoListEnvelope::AssetCategoryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetCategoryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetCategoryDtoListEnvelope::toJson() const
{
...
bool AssetCategoryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetCategoryDto>> refVal_setResult;
...
void AssetCategoryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetCategoryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetCategoryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetCategoryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetCategoryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetCategoryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetCategoryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetCategoryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetCategoryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetCategoryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetCategoryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetCategoryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetCategoryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetCategoryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetCategoryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetCategoryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetCategoryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetCategoryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetCategoryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetCategoryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetCategoryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetCategoryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetCategoryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetCategoryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetCategoryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetCategoryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetCategoryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetCategoryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetCategoryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetCategoryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetCategoryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetCategoryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetCategoryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetCategoryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetCategoryDto>>& AssetCategoryDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetCategoryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetCategoryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetCategoryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetCategoryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
