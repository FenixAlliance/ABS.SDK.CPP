...
AssetRepairDtoEnvelope::AssetRepairDtoEnvelope()
{
    m_IsSuccess = false;
...
void AssetRepairDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetRepairDtoEnvelope::toJson() const
{
...
bool AssetRepairDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AssetRepairDto> refVal_setResult;
...
void AssetRepairDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetRepairDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetRepairDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetRepairDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetRepairDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetRepairDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetRepairDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetRepairDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetRepairDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetRepairDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetRepairDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetRepairDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetRepairDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetRepairDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetRepairDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetRepairDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetRepairDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetRepairDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetRepairDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetRepairDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetRepairDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetRepairDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetRepairDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetRepairDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetRepairDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetRepairDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetRepairDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetRepairDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetRepairDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetRepairDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetRepairDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetRepairDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetRepairDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetRepairDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AssetRepairDto> AssetRepairDtoEnvelope::getResult() const
{
    return m_Result;
}

void AssetRepairDtoEnvelope::setResult(const std::shared_ptr<AssetRepairDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetRepairDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetRepairDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
