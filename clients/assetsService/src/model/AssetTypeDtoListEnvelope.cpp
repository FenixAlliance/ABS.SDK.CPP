...
AssetTypeDtoListEnvelope::AssetTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetTypeDtoListEnvelope::toJson() const
{
...
bool AssetTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetTypeDto>> refVal_setResult;
...
void AssetTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetTypeDto>>& AssetTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
