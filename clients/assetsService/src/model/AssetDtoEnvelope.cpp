...
AssetDtoEnvelope::AssetDtoEnvelope()
{
    m_IsSuccess = false;
...
void AssetDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetDtoEnvelope::toJson() const
{
...
bool AssetDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AssetDto> refVal_setResult;
...
void AssetDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AssetDto> AssetDtoEnvelope::getResult() const
{
    return m_Result;
}

void AssetDtoEnvelope::setResult(const std::shared_ptr<AssetDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
