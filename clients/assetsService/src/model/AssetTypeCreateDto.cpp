...
void AssetTypeCreateDto::validate()
{
    // TODO: implement validation
}

web::json::value AssetTypeCreateDto::toJson() const
{
...
bool AssetTypeCreateDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AssetTypeCreateDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetTypeCreateDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AssetTypeCreateDto::getId() const
{
    return m_Id;
}

void AssetTypeCreateDto::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool AssetTypeCreateDto::idIsSet() const
{
    return m_IdIsSet;
}

void AssetTypeCreateDto::unsetId()
{
    m_IdIsSet = false;
}
utility::datetime AssetTypeCreateDto::getTimestamp() const
{
    return m_Timestamp;
}

void AssetTypeCreateDto::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetTypeCreateDto::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetTypeCreateDto::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t AssetTypeCreateDto::getBusinessId() const
{
    return m_BusinessId;
}

void AssetTypeCreateDto::setBusinessId(const utility::string_t& value)
{
    m_BusinessId = value;
    m_BusinessIdIsSet = true;
}

bool AssetTypeCreateDto::businessIdIsSet() const
{
    return m_BusinessIdIsSet;
}

void AssetTypeCreateDto::unsetBusinessId()
{
    m_BusinessIdIsSet = false;
}
utility::string_t AssetTypeCreateDto::getBusinessProfileRecordId() const
{
    return m_BusinessProfileRecordId;
}

void AssetTypeCreateDto::setBusinessProfileRecordId(const utility::string_t& value)
{
    m_BusinessProfileRecordId = value;
    m_BusinessProfileRecordIdIsSet = true;
}

bool AssetTypeCreateDto::businessProfileRecordIdIsSet() const
{
    return m_BusinessProfileRecordIdIsSet;
}

void AssetTypeCreateDto::unsetBusinessProfileRecordId()
{
    m_BusinessProfileRecordIdIsSet = false;
}
utility::string_t AssetTypeCreateDto::getName() const
{
    return m_Name;
}

void AssetTypeCreateDto::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AssetTypeCreateDto::nameIsSet() const
{
    return m_NameIsSet;
}

void AssetTypeCreateDto::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t AssetTypeCreateDto::getDescription() const
{
    return m_Description;
}

void AssetTypeCreateDto::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool AssetTypeCreateDto::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void AssetTypeCreateDto::unsetDescription()
{
    m_DescriptionIsSet = false;
}
}
