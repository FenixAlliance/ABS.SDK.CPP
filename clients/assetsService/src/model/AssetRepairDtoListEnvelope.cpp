...
AssetRepairDtoListEnvelope::AssetRepairDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetRepairDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetRepairDtoListEnvelope::toJson() const
{
...
bool AssetRepairDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetRepairDto>> refVal_setResult;
...
void AssetRepairDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetRepairDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetRepairDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetRepairDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetRepairDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetRepairDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetRepairDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetRepairDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetRepairDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetRepairDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetRepairDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetRepairDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetRepairDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetRepairDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetRepairDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetRepairDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetRepairDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetRepairDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetRepairDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetRepairDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetRepairDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetRepairDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetRepairDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetRepairDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetRepairDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetRepairDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetRepairDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetRepairDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetRepairDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetRepairDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetRepairDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetRepairDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetRepairDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetRepairDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetRepairDto>>& AssetRepairDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetRepairDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetRepairDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetRepairDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetRepairDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
