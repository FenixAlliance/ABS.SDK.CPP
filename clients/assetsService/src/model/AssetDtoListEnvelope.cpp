...
AssetDtoListEnvelope::AssetDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetDtoListEnvelope::toJson() const
{
...
bool AssetDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetDto>> refVal_setResult;
...
void AssetDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetDto>>& AssetDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
