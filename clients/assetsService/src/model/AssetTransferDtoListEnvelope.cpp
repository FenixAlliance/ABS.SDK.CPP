...
AssetTransferDtoListEnvelope::AssetTransferDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetTransferDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetTransferDtoListEnvelope::toJson() const
{
...
bool AssetTransferDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetTransferDto>> refVal_setResult;
...
void AssetTransferDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetTransferDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetTransferDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetTransferDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetTransferDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetTransferDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetTransferDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetTransferDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetTransferDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetTransferDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetTransferDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetTransferDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetTransferDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetTransferDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetTransferDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetTransferDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetTransferDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetTransferDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetTransferDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetTransferDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetTransferDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetTransferDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetTransferDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetTransferDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetTransferDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetTransferDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetTransferDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetTransferDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetTransferDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetTransferDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetTransferDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetTransferDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetTransferDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetTransferDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetTransferDto>>& AssetTransferDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetTransferDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetTransferDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetTransferDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetTransferDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
