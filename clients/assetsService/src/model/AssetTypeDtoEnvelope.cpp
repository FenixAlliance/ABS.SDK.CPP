...
AssetTypeDtoEnvelope::AssetTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void AssetTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetTypeDtoEnvelope::toJson() const
{
...
bool AssetTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AssetTypeDto> refVal_setResult;
...
void AssetTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AssetTypeDto> AssetTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void AssetTypeDtoEnvelope::setResult(const std::shared_ptr<AssetTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
