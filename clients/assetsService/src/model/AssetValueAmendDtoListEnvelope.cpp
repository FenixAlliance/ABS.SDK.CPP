...
AssetValueAmendDtoListEnvelope::AssetValueAmendDtoListEnvelope()
{
    m_IsSuccess = false;
...
void AssetValueAmendDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetValueAmendDtoListEnvelope::toJson() const
{
...
bool AssetValueAmendDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<AssetValueAmendDto>> refVal_setResult;
...
void AssetValueAmendDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetValueAmendDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetValueAmendDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetValueAmendDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetValueAmendDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetValueAmendDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetValueAmendDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetValueAmendDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetValueAmendDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetValueAmendDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetValueAmendDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetValueAmendDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetValueAmendDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetValueAmendDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetValueAmendDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetValueAmendDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetValueAmendDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetValueAmendDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<AssetValueAmendDto>>& AssetValueAmendDtoListEnvelope::getResult()
{
    return m_Result;
}

void AssetValueAmendDtoListEnvelope::setResult(const std::vector<std::shared_ptr<AssetValueAmendDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetValueAmendDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetValueAmendDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
