...
AssetTransferDtoEnvelope::AssetTransferDtoEnvelope()
{
    m_IsSuccess = false;
...
void AssetTransferDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AssetTransferDtoEnvelope::toJson() const
{
...
bool AssetTransferDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AssetTransferDto> refVal_setResult;
...
void AssetTransferDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssetTransferDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AssetTransferDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AssetTransferDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AssetTransferDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AssetTransferDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AssetTransferDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AssetTransferDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AssetTransferDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AssetTransferDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AssetTransferDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AssetTransferDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AssetTransferDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AssetTransferDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AssetTransferDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AssetTransferDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AssetTransferDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AssetTransferDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AssetTransferDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AssetTransferDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AssetTransferDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AssetTransferDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AssetTransferDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AssetTransferDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AssetTransferDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AssetTransferDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AssetTransferDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AssetTransferDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AssetTransferDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AssetTransferDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AssetTransferDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AssetTransferDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AssetTransferDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AssetTransferDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AssetTransferDto> AssetTransferDtoEnvelope::getResult() const
{
    return m_Result;
}

void AssetTransferDtoEnvelope::setResult(const std::shared_ptr<AssetTransferDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AssetTransferDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AssetTransferDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
