...
JsonWebKeySetEnvelope::JsonWebKeySetEnvelope()
{
    m_IsSuccess = false;
...
void JsonWebKeySetEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JsonWebKeySetEnvelope::toJson() const
{
...
bool JsonWebKeySetEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JsonWebKeySet> refVal_setResult;
...
void JsonWebKeySetEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JsonWebKeySetEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JsonWebKeySetEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JsonWebKeySetEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JsonWebKeySetEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JsonWebKeySetEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JsonWebKeySetEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JsonWebKeySetEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JsonWebKeySetEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JsonWebKeySetEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JsonWebKeySetEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JsonWebKeySetEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JsonWebKeySetEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JsonWebKeySetEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JsonWebKeySetEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JsonWebKeySetEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JsonWebKeySetEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JsonWebKeySetEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JsonWebKeySetEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JsonWebKeySetEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JsonWebKeySetEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JsonWebKeySetEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JsonWebKeySetEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JsonWebKeySetEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JsonWebKeySetEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JsonWebKeySetEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JsonWebKeySetEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JsonWebKeySetEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JsonWebKeySetEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JsonWebKeySetEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JsonWebKeySetEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JsonWebKeySetEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JsonWebKeySetEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JsonWebKeySetEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JsonWebKeySet> JsonWebKeySetEnvelope::getResult() const
{
    return m_Result;
}

void JsonWebKeySetEnvelope::setResult(const std::shared_ptr<JsonWebKeySet>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JsonWebKeySetEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JsonWebKeySetEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
