...
UserCreateDtoEnvelope::UserCreateDtoEnvelope()
{
    m_IsSuccess = false;
...
void UserCreateDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UserCreateDtoEnvelope::toJson() const
{
...
bool UserCreateDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UserCreateDto> refVal_setResult;
...
void UserCreateDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserCreateDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UserCreateDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UserCreateDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UserCreateDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UserCreateDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UserCreateDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UserCreateDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UserCreateDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UserCreateDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UserCreateDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UserCreateDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UserCreateDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UserCreateDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UserCreateDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UserCreateDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UserCreateDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UserCreateDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UserCreateDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UserCreateDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UserCreateDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UserCreateDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UserCreateDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UserCreateDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UserCreateDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UserCreateDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UserCreateDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UserCreateDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UserCreateDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UserCreateDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UserCreateDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UserCreateDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UserCreateDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UserCreateDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<UserCreateDto> UserCreateDtoEnvelope::getResult() const
{
    return m_Result;
}

void UserCreateDtoEnvelope::setResult(const std::shared_ptr<UserCreateDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UserCreateDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UserCreateDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
