...
JsonWebTokenEnvelope::JsonWebTokenEnvelope()
{
    m_IsSuccess = false;
...
void JsonWebTokenEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value JsonWebTokenEnvelope::toJson() const
{
...
bool JsonWebTokenEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<JsonWebToken> refVal_setResult;
...
void JsonWebTokenEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool JsonWebTokenEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool JsonWebTokenEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void JsonWebTokenEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool JsonWebTokenEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void JsonWebTokenEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t JsonWebTokenEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void JsonWebTokenEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool JsonWebTokenEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void JsonWebTokenEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t JsonWebTokenEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void JsonWebTokenEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool JsonWebTokenEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void JsonWebTokenEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime JsonWebTokenEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void JsonWebTokenEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool JsonWebTokenEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void JsonWebTokenEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t JsonWebTokenEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void JsonWebTokenEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool JsonWebTokenEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void JsonWebTokenEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t JsonWebTokenEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void JsonWebTokenEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool JsonWebTokenEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void JsonWebTokenEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& JsonWebTokenEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void JsonWebTokenEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool JsonWebTokenEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void JsonWebTokenEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t JsonWebTokenEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void JsonWebTokenEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool JsonWebTokenEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void JsonWebTokenEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<JsonWebToken> JsonWebTokenEnvelope::getResult() const
{
    return m_Result;
}

void JsonWebTokenEnvelope::setResult(const std::shared_ptr<JsonWebToken>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool JsonWebTokenEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void JsonWebTokenEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
