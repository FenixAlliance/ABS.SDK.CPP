...
void ErrorEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ErrorEnvelope::toJson() const
{
...
bool ErrorEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ErrorEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ErrorEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ErrorEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ErrorEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ErrorEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ErrorEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ErrorEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ErrorEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ErrorEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ErrorEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ErrorEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ErrorEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ErrorEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ErrorEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ErrorEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ErrorEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ErrorEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ErrorEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ErrorEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ErrorEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ErrorEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ErrorEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ErrorEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ErrorEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ErrorEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ErrorEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ErrorEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ErrorEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ErrorEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ErrorEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ErrorEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ErrorEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ErrorEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ErrorEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
}
