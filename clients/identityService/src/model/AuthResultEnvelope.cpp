...
AuthResultEnvelope::AuthResultEnvelope()
{
    m_IsSuccess = false;
...
void AuthResultEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value AuthResultEnvelope::toJson() const
{
...
bool AuthResultEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AuthResultEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AuthResultEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool AuthResultEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void AuthResultEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool AuthResultEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void AuthResultEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t AuthResultEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void AuthResultEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool AuthResultEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void AuthResultEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t AuthResultEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void AuthResultEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool AuthResultEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void AuthResultEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime AuthResultEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void AuthResultEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool AuthResultEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void AuthResultEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t AuthResultEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void AuthResultEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool AuthResultEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void AuthResultEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t AuthResultEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void AuthResultEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool AuthResultEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void AuthResultEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& AuthResultEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void AuthResultEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool AuthResultEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void AuthResultEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t AuthResultEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void AuthResultEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool AuthResultEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void AuthResultEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<AuthResult> AuthResultEnvelope::getResult() const
{
    return m_Result;
}

void AuthResultEnvelope::setResult(const std::shared_ptr<AuthResult>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool AuthResultEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void AuthResultEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
