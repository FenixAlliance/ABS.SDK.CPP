...
OrderDtoListEnvelope::OrderDtoListEnvelope()
{
    m_IsSuccess = false;
...
void OrderDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OrderDtoListEnvelope::toJson() const
{
...
bool OrderDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OrderDto>> refVal_setResult;
...
void OrderDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OrderDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OrderDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OrderDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OrderDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OrderDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OrderDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OrderDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OrderDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OrderDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OrderDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OrderDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OrderDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OrderDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OrderDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OrderDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OrderDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OrderDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OrderDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OrderDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OrderDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OrderDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OrderDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OrderDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OrderDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OrderDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OrderDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OrderDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OrderDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OrderDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OrderDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OrderDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OrderDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<OrderDto>>& OrderDtoListEnvelope::getResult()
{
    return m_Result;
}

void OrderDtoListEnvelope::setResult(const std::vector<std::shared_ptr<OrderDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OrderDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
