...
OrderLineDtoEnvelope::OrderLineDtoEnvelope()
{
    m_IsSuccess = false;
...
void OrderLineDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OrderLineDtoEnvelope::toJson() const
{
...
bool OrderLineDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OrderLineDto> refVal_setResult;
...
void OrderLineDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderLineDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OrderLineDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OrderLineDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OrderLineDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OrderLineDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OrderLineDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OrderLineDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OrderLineDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OrderLineDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OrderLineDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OrderLineDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OrderLineDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OrderLineDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OrderLineDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OrderLineDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OrderLineDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OrderLineDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OrderLineDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OrderLineDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OrderLineDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OrderLineDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OrderLineDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OrderLineDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OrderLineDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OrderLineDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OrderLineDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OrderLineDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OrderLineDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OrderLineDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OrderLineDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OrderLineDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OrderLineDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OrderLineDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<OrderLineDto> OrderLineDtoEnvelope::getResult() const
{
    return m_Result;
}

void OrderLineDtoEnvelope::setResult(const std::shared_ptr<OrderLineDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OrderLineDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderLineDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
