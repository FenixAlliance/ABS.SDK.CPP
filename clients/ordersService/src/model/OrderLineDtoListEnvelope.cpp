...
OrderLineDtoListEnvelope::OrderLineDtoListEnvelope()
{
    m_IsSuccess = false;
...
void OrderLineDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OrderLineDtoListEnvelope::toJson() const
{
...
bool OrderLineDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OrderLineDto>> refVal_setResult;
...
void OrderLineDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OrderLineDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OrderLineDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OrderLineDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OrderLineDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OrderLineDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OrderLineDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OrderLineDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OrderLineDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OrderLineDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OrderLineDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OrderLineDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OrderLineDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OrderLineDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OrderLineDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OrderLineDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OrderLineDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OrderLineDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OrderLineDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OrderLineDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OrderLineDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OrderLineDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OrderLineDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OrderLineDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OrderLineDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OrderLineDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OrderLineDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OrderLineDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OrderLineDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OrderLineDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OrderLineDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OrderLineDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OrderLineDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OrderLineDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<OrderLineDto>>& OrderLineDtoListEnvelope::getResult()
{
    return m_Result;
}

void OrderLineDtoListEnvelope::setResult(const std::vector<std::shared_ptr<OrderLineDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OrderLineDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderLineDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
