...
ForexRatesDtoEnvelope::ForexRatesDtoEnvelope()
{
    m_IsSuccess = false;
...
void ForexRatesDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ForexRatesDtoEnvelope::toJson() const
{
...
bool ForexRatesDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ForexRatesDto> refVal_setResult;
...
void ForexRatesDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ForexRatesDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ForexRatesDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ForexRatesDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ForexRatesDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ForexRatesDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ForexRatesDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ForexRatesDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ForexRatesDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ForexRatesDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ForexRatesDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ForexRatesDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ForexRatesDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ForexRatesDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ForexRatesDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ForexRatesDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ForexRatesDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ForexRatesDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ForexRatesDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ForexRatesDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ForexRatesDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ForexRatesDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ForexRatesDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ForexRatesDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ForexRatesDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ForexRatesDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ForexRatesDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ForexRatesDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ForexRatesDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ForexRatesDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ForexRatesDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ForexRatesDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ForexRatesDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ForexRatesDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ForexRatesDto> ForexRatesDtoEnvelope::getResult() const
{
    return m_Result;
}

void ForexRatesDtoEnvelope::setResult(const std::shared_ptr<ForexRatesDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ForexRatesDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ForexRatesDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
