...
ExchangeRateEnvelope::ExchangeRateEnvelope()
{
    m_IsSuccess = false;
...
void ExchangeRateEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExchangeRateEnvelope::toJson() const
{
...
bool ExchangeRateEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExchangeRate> refVal_setResult;
...
void ExchangeRateEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExchangeRateEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExchangeRateEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExchangeRateEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExchangeRateEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExchangeRateEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExchangeRateEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExchangeRateEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExchangeRateEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExchangeRateEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExchangeRateEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExchangeRateEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExchangeRateEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExchangeRateEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExchangeRateEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExchangeRateEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExchangeRateEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExchangeRateEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExchangeRateEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExchangeRateEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExchangeRateEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExchangeRateEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExchangeRateEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExchangeRateEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExchangeRateEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExchangeRateEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExchangeRateEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExchangeRateEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExchangeRateEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExchangeRateEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExchangeRateEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExchangeRateEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExchangeRateEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExchangeRateEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExchangeRate> ExchangeRateEnvelope::getResult() const
{
    return m_Result;
}

void ExchangeRateEnvelope::setResult(const std::shared_ptr<ExchangeRate>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExchangeRateEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExchangeRateEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
