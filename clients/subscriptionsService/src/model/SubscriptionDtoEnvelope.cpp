...
SubscriptionDtoEnvelope::SubscriptionDtoEnvelope()
{
    m_IsSuccess = false;
...
void SubscriptionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionDtoEnvelope::toJson() const
{
...
bool SubscriptionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionDto> refVal_setResult;
...
void SubscriptionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SubscriptionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SubscriptionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SubscriptionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SubscriptionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SubscriptionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SubscriptionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SubscriptionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SubscriptionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SubscriptionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SubscriptionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SubscriptionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SubscriptionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SubscriptionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SubscriptionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SubscriptionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SubscriptionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SubscriptionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SubscriptionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SubscriptionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SubscriptionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SubscriptionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SubscriptionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SubscriptionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SubscriptionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SubscriptionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SubscriptionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SubscriptionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SubscriptionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SubscriptionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SubscriptionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SubscriptionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SubscriptionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SubscriptionDto> SubscriptionDtoEnvelope::getResult() const
{
    return m_Result;
}

void SubscriptionDtoEnvelope::setResult(const std::shared_ptr<SubscriptionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SubscriptionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SubscriptionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
