...
SubscriptionPlanDtoEnvelope::SubscriptionPlanDtoEnvelope()
{
    m_IsSuccess = false;
...
void SubscriptionPlanDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SubscriptionPlanDtoEnvelope::toJson() const
{
...
bool SubscriptionPlanDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SubscriptionPlanDto> refVal_setResult;
...
void SubscriptionPlanDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SubscriptionPlanDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SubscriptionPlanDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SubscriptionPlanDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SubscriptionPlanDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SubscriptionPlanDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SubscriptionPlanDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SubscriptionPlanDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SubscriptionPlanDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SubscriptionPlanDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SubscriptionPlanDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SubscriptionPlanDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SubscriptionPlanDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SubscriptionPlanDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SubscriptionPlanDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SubscriptionPlanDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SubscriptionPlanDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SubscriptionPlanDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SubscriptionPlanDto> SubscriptionPlanDtoEnvelope::getResult() const
{
    return m_Result;
}

void SubscriptionPlanDtoEnvelope::setResult(const std::shared_ptr<SubscriptionPlanDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SubscriptionPlanDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SubscriptionPlanDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
