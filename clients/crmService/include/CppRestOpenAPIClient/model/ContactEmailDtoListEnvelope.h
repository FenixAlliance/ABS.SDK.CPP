...
/*
 * ContactEmailDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactEmailDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactEmailDtoListEnvelope_H_
...
public:
    ...
    virtual ~ContactEmailDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ContactEmailDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ContactEmailDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ContactEmailDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ContactEmailDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactEmailDtoListEnvelope_H_ */
