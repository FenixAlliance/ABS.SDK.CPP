...
/*
 * ContactSourceDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactSourceDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactSourceDtoListEnvelope_H_
...
public:
    ...
    virtual ~ContactSourceDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ContactSourceDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ContactSourceDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ContactSourceDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ContactSourceDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactSourceDtoListEnvelope_H_ */
