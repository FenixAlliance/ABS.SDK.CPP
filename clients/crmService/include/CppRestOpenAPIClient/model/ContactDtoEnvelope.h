...
/*
 * ContactDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoEnvelope_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<ContactDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<ContactDto>& value);
...
protected:
    ...
    std::shared_ptr<ContactDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactDtoEnvelope_H_ */
