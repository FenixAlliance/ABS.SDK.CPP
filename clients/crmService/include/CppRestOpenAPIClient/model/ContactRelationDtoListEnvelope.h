...
/*
 * ContactRelationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ContactRelationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ContactRelationDtoListEnvelope_H_
...
public:
    ...
    virtual ~ContactRelationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ContactRelationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ContactRelationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ContactRelationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ContactRelationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ContactRelationDtoListEnvelope_H_ */
