...
OptionDtoListEnvelope::OptionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void OptionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OptionDtoListEnvelope::toJson() const
{
...
bool OptionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<OptionDto>> refVal_setResult;
...
void OptionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OptionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OptionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OptionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OptionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OptionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OptionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OptionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OptionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OptionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OptionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OptionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OptionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OptionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OptionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OptionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OptionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OptionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OptionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OptionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OptionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OptionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OptionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OptionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OptionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OptionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OptionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OptionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OptionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OptionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OptionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OptionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OptionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OptionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<OptionDto>>& OptionDtoListEnvelope::getResult()
{
    return m_Result;
}

void OptionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<OptionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OptionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OptionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
