...
ContactProfileDtoListEnvelope::ContactProfileDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ContactProfileDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ContactProfileDtoListEnvelope::toJson() const
{
...
bool ContactProfileDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ContactProfileDto>> refVal_setResult;
...
void ContactProfileDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ContactProfileDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ContactProfileDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ContactProfileDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ContactProfileDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ContactProfileDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ContactProfileDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ContactProfileDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ContactProfileDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ContactProfileDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ContactProfileDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ContactProfileDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ContactProfileDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ContactProfileDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ContactProfileDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ContactProfileDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ContactProfileDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ContactProfileDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ContactProfileDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ContactProfileDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ContactProfileDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ContactProfileDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ContactProfileDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ContactProfileDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ContactProfileDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ContactProfileDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ContactProfileDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ContactProfileDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ContactProfileDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ContactProfileDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ContactProfileDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ContactProfileDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ContactProfileDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ContactProfileDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ContactProfileDto>>& ContactProfileDtoListEnvelope::getResult()
{
    return m_Result;
}

void ContactProfileDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ContactProfileDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ContactProfileDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ContactProfileDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
