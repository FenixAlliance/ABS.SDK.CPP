...
ContactEmailDtoListEnvelope::ContactEmailDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ContactEmailDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ContactEmailDtoListEnvelope::toJson() const
{
...
bool ContactEmailDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ContactEmailDto>> refVal_setResult;
...
void ContactEmailDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ContactEmailDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ContactEmailDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ContactEmailDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ContactEmailDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ContactEmailDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ContactEmailDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ContactEmailDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ContactEmailDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ContactEmailDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ContactEmailDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ContactEmailDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ContactEmailDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ContactEmailDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ContactEmailDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ContactEmailDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ContactEmailDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ContactEmailDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ContactEmailDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ContactEmailDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ContactEmailDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ContactEmailDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ContactEmailDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ContactEmailDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ContactEmailDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ContactEmailDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ContactEmailDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ContactEmailDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ContactEmailDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ContactEmailDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ContactEmailDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ContactEmailDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ContactEmailDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ContactEmailDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ContactEmailDto>>& ContactEmailDtoListEnvelope::getResult()
{
    return m_Result;
}

void ContactEmailDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ContactEmailDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ContactEmailDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ContactEmailDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
