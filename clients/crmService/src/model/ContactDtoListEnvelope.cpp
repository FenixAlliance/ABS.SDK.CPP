...
ContactDtoListEnvelope::ContactDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ContactDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ContactDtoListEnvelope::toJson() const
{
...
bool ContactDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ContactDto>> refVal_setResult;
...
void ContactDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ContactDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ContactDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ContactDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ContactDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ContactDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ContactDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ContactDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ContactDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ContactDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ContactDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ContactDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ContactDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ContactDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ContactDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ContactDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ContactDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ContactDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ContactDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ContactDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ContactDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ContactDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ContactDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ContactDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ContactDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ContactDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ContactDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ContactDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ContactDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ContactDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ContactDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ContactDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ContactDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ContactDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ContactDto>>& ContactDtoListEnvelope::getResult()
{
    return m_Result;
}

void ContactDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ContactDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ContactDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ContactDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
