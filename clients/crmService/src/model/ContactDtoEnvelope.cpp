...
ContactDtoEnvelope::ContactDtoEnvelope()
{
    m_IsSuccess = false;
...
void ContactDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ContactDtoEnvelope::toJson() const
{
...
bool ContactDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ContactDto> refVal_setResult;
...
void ContactDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ContactDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ContactDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ContactDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ContactDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ContactDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ContactDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ContactDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ContactDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ContactDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ContactDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ContactDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ContactDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ContactDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ContactDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ContactDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ContactDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ContactDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ContactDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ContactDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ContactDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ContactDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ContactDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ContactDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ContactDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ContactDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ContactDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ContactDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ContactDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ContactDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ContactDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ContactDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ContactDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ContactDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ContactDto> ContactDtoEnvelope::getResult() const
{
    return m_Result;
}

void ContactDtoEnvelope::setResult(const std::shared_ptr<ContactDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ContactDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ContactDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
