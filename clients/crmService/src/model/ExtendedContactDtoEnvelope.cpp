...
ExtendedContactDtoEnvelope::ExtendedContactDtoEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedContactDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedContactDtoEnvelope::toJson() const
{
...
bool ExtendedContactDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExtendedContactDto> refVal_setResult;
...
void ExtendedContactDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedContactDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedContactDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedContactDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedContactDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedContactDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedContactDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedContactDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedContactDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedContactDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedContactDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedContactDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedContactDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedContactDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedContactDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedContactDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedContactDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedContactDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedContactDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedContactDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedContactDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedContactDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedContactDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedContactDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedContactDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedContactDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedContactDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedContactDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedContactDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedContactDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedContactDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedContactDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedContactDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedContactDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExtendedContactDto> ExtendedContactDtoEnvelope::getResult() const
{
    return m_Result;
}

void ExtendedContactDtoEnvelope::setResult(const std::shared_ptr<ExtendedContactDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedContactDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedContactDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
