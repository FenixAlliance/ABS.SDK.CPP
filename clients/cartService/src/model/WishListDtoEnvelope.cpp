...
WishListDtoEnvelope::WishListDtoEnvelope()
{
    m_IsSuccess = false;
...
void WishListDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value WishListDtoEnvelope::toJson() const
{
...
bool WishListDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<WishListDto> refVal_setResult;
...
void WishListDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WishListDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool WishListDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void WishListDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool WishListDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void WishListDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t WishListDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void WishListDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool WishListDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void WishListDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t WishListDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void WishListDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool WishListDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void WishListDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime WishListDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void WishListDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool WishListDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void WishListDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t WishListDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void WishListDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool WishListDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void WishListDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t WishListDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void WishListDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool WishListDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void WishListDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& WishListDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void WishListDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool WishListDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void WishListDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t WishListDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void WishListDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool WishListDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void WishListDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<WishListDto> WishListDtoEnvelope::getResult() const
{
    return m_Result;
}

void WishListDtoEnvelope::setResult(const std::shared_ptr<WishListDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool WishListDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void WishListDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
