...
CountryDtoEnvelope::CountryDtoEnvelope()
{
    m_IsSuccess = false;
...
void CountryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CountryDtoEnvelope::toJson() const
{
...
bool CountryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<CountryDto> refVal_setResult;
...
void CountryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CountryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CountryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CountryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CountryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CountryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CountryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CountryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CountryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CountryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CountryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CountryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CountryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CountryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CountryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CountryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CountryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CountryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CountryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CountryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CountryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CountryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CountryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CountryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CountryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CountryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CountryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CountryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CountryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CountryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CountryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CountryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CountryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CountryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<CountryDto> CountryDtoEnvelope::getResult() const
{
    return m_Result;
}

void CountryDtoEnvelope::setResult(const std::shared_ptr<CountryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CountryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CountryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
