...
ItemCartRecordDtoEnvelope::ItemCartRecordDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemCartRecordDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemCartRecordDtoEnvelope::toJson() const
{
...
bool ItemCartRecordDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemCartRecordDto> refVal_setResult;
...
void ItemCartRecordDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemCartRecordDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemCartRecordDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemCartRecordDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemCartRecordDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemCartRecordDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemCartRecordDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemCartRecordDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemCartRecordDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemCartRecordDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemCartRecordDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemCartRecordDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemCartRecordDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemCartRecordDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemCartRecordDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemCartRecordDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemCartRecordDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemCartRecordDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemCartRecordDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemCartRecordDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemCartRecordDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemCartRecordDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemCartRecordDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemCartRecordDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemCartRecordDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemCartRecordDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemCartRecordDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemCartRecordDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemCartRecordDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemCartRecordDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemCartRecordDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemCartRecordDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemCartRecordDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemCartRecordDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemCartRecordDto> ItemCartRecordDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemCartRecordDtoEnvelope::setResult(const std::shared_ptr<ItemCartRecordDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemCartRecordDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemCartRecordDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
