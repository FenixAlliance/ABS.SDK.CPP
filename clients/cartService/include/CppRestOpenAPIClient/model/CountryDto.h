...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CountryDto_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CountryDto_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getNativeName() const;
    bool nativeNameIsSet() const;
    void unsetNativeName();

    void setNativeName(const utility::string_t& value);
...
protected:
    ...
    bool m_NameIsSet;
    utility::string_t m_NativeName;
    bool m_NativeNameIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CountryDto_H_ */
