...
ItemGoogleCategoryDtoEnvelope::ItemGoogleCategoryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemGoogleCategoryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemGoogleCategoryDtoEnvelope::toJson() const
{
...
bool ItemGoogleCategoryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemGoogleCategoryDto> refVal_setResult;
...
void ItemGoogleCategoryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemGoogleCategoryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemGoogleCategoryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemGoogleCategoryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemGoogleCategoryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemGoogleCategoryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemGoogleCategoryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemGoogleCategoryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemGoogleCategoryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemGoogleCategoryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemGoogleCategoryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemGoogleCategoryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemGoogleCategoryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemGoogleCategoryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemGoogleCategoryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemGoogleCategoryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemGoogleCategoryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemGoogleCategoryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemGoogleCategoryDto> ItemGoogleCategoryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemGoogleCategoryDtoEnvelope::setResult(const std::shared_ptr<ItemGoogleCategoryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemGoogleCategoryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemGoogleCategoryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
