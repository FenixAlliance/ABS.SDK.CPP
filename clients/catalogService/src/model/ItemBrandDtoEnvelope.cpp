...
ItemBrandDtoEnvelope::ItemBrandDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemBrandDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemBrandDtoEnvelope::toJson() const
{
...
bool ItemBrandDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemBrandDto> refVal_setResult;
...
void ItemBrandDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemBrandDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemBrandDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemBrandDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemBrandDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemBrandDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemBrandDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemBrandDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemBrandDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemBrandDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemBrandDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemBrandDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemBrandDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemBrandDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemBrandDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemBrandDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemBrandDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemBrandDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemBrandDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemBrandDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemBrandDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemBrandDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemBrandDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemBrandDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemBrandDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemBrandDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemBrandDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemBrandDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemBrandDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemBrandDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemBrandDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemBrandDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemBrandDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemBrandDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemBrandDto> ItemBrandDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemBrandDtoEnvelope::setResult(const std::shared_ptr<ItemBrandDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemBrandDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemBrandDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
