...
MerchantDtoListEnvelope::MerchantDtoListEnvelope()
{
    m_IsSuccess = false;
...
void MerchantDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value MerchantDtoListEnvelope::toJson() const
{
...
bool MerchantDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<MerchantDto>> refVal_setResult;
...
void MerchantDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MerchantDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool MerchantDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void MerchantDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool MerchantDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void MerchantDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t MerchantDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void MerchantDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool MerchantDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void MerchantDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t MerchantDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void MerchantDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool MerchantDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void MerchantDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime MerchantDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void MerchantDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool MerchantDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void MerchantDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t MerchantDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void MerchantDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool MerchantDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void MerchantDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t MerchantDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void MerchantDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool MerchantDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void MerchantDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& MerchantDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void MerchantDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool MerchantDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void MerchantDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t MerchantDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void MerchantDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool MerchantDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void MerchantDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<MerchantDto>>& MerchantDtoListEnvelope::getResult()
{
    return m_Result;
}

void MerchantDtoListEnvelope::setResult(const std::vector<std::shared_ptr<MerchantDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool MerchantDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void MerchantDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
