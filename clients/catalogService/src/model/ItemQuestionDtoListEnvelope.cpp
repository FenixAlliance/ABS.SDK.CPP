...
ItemQuestionDtoListEnvelope::ItemQuestionDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemQuestionDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemQuestionDtoListEnvelope::toJson() const
{
...
bool ItemQuestionDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemQuestionDto>> refVal_setResult;
...
void ItemQuestionDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemQuestionDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemQuestionDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemQuestionDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemQuestionDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemQuestionDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemQuestionDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemQuestionDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemQuestionDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemQuestionDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemQuestionDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemQuestionDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemQuestionDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemQuestionDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemQuestionDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemQuestionDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemQuestionDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemQuestionDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemQuestionDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemQuestionDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemQuestionDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemQuestionDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemQuestionDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemQuestionDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemQuestionDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemQuestionDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemQuestionDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemQuestionDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemQuestionDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemQuestionDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemQuestionDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemQuestionDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemQuestionDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemQuestionDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemQuestionDto>>& ItemQuestionDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemQuestionDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemQuestionDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemQuestionDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemQuestionDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
