...
ItemAttachmentDtoListEnvelope::ItemAttachmentDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemAttachmentDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttachmentDtoListEnvelope::toJson() const
{
...
bool ItemAttachmentDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemAttachmentDto>> refVal_setResult;
...
void ItemAttachmentDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttachmentDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemAttachmentDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemAttachmentDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemAttachmentDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemAttachmentDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemAttachmentDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemAttachmentDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemAttachmentDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemAttachmentDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemAttachmentDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemAttachmentDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemAttachmentDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemAttachmentDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemAttachmentDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemAttachmentDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemAttachmentDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemAttachmentDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemAttachmentDto>>& ItemAttachmentDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemAttachmentDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemAttachmentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemAttachmentDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemAttachmentDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
