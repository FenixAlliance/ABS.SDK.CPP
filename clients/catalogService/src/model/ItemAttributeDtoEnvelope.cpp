...
ItemAttributeDtoEnvelope::ItemAttributeDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemAttributeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeDtoEnvelope::toJson() const
{
...
bool ItemAttributeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemAttributeDto> refVal_setResult;
...
void ItemAttributeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemAttributeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemAttributeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemAttributeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemAttributeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemAttributeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemAttributeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemAttributeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemAttributeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemAttributeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemAttributeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemAttributeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemAttributeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemAttributeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemAttributeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemAttributeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemAttributeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemAttributeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemAttributeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemAttributeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemAttributeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemAttributeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemAttributeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemAttributeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemAttributeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemAttributeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemAttributeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemAttributeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemAttributeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemAttributeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemAttributeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemAttributeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemAttributeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemAttributeDto> ItemAttributeDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemAttributeDtoEnvelope::setResult(const std::shared_ptr<ItemAttributeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemAttributeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemAttributeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
