...
ItemTaxPolicyDtoListEnvelope::ItemTaxPolicyDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemTaxPolicyDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemTaxPolicyDtoListEnvelope::toJson() const
{
...
bool ItemTaxPolicyDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemTaxPolicyDto>> refVal_setResult;
...
void ItemTaxPolicyDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemTaxPolicyDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemTaxPolicyDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemTaxPolicyDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemTaxPolicyDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemTaxPolicyDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemTaxPolicyDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemTaxPolicyDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemTaxPolicyDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemTaxPolicyDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemTaxPolicyDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemTaxPolicyDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemTaxPolicyDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemTaxPolicyDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemTaxPolicyDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemTaxPolicyDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemTaxPolicyDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemTaxPolicyDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemTaxPolicyDto>>& ItemTaxPolicyDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemTaxPolicyDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemTaxPolicyDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemTaxPolicyDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemTaxPolicyDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
