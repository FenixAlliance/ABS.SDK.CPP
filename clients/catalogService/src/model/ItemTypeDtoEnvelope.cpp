...
ItemTypeDtoEnvelope::ItemTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemTypeDtoEnvelope::toJson() const
{
...
bool ItemTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemTypeDto> refVal_setResult;
...
void ItemTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemTypeDto> ItemTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemTypeDtoEnvelope::setResult(const std::shared_ptr<ItemTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
