...
ItemTaxPolicyDtoEnvelope::ItemTaxPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemTaxPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemTaxPolicyDtoEnvelope::toJson() const
{
...
bool ItemTaxPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemTaxPolicyDto> refVal_setResult;
...
void ItemTaxPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemTaxPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemTaxPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemTaxPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemTaxPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemTaxPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemTaxPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemTaxPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemTaxPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemTaxPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemTaxPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemTaxPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemTaxPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemTaxPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemTaxPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemTaxPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemTaxPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemTaxPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemTaxPolicyDto> ItemTaxPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemTaxPolicyDtoEnvelope::setResult(const std::shared_ptr<ItemTaxPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemTaxPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemTaxPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
