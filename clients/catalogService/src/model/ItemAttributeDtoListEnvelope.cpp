...
ItemAttributeDtoListEnvelope::ItemAttributeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemAttributeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeDtoListEnvelope::toJson() const
{
...
bool ItemAttributeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemAttributeDto>> refVal_setResult;
...
void ItemAttributeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemAttributeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemAttributeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemAttributeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemAttributeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemAttributeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemAttributeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemAttributeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemAttributeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemAttributeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemAttributeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemAttributeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemAttributeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemAttributeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemAttributeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemAttributeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemAttributeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemAttributeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemAttributeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemAttributeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemAttributeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemAttributeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemAttributeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemAttributeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemAttributeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemAttributeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemAttributeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemAttributeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemAttributeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemAttributeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemAttributeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemAttributeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemAttributeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemAttributeDto>>& ItemAttributeDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemAttributeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemAttributeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemAttributeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemAttributeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
