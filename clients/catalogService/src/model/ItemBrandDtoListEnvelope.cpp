...
ItemBrandDtoListEnvelope::ItemBrandDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemBrandDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemBrandDtoListEnvelope::toJson() const
{
...
bool ItemBrandDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemBrandDto>> refVal_setResult;
...
void ItemBrandDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemBrandDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemBrandDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemBrandDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemBrandDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemBrandDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemBrandDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemBrandDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemBrandDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemBrandDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemBrandDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemBrandDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemBrandDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemBrandDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemBrandDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemBrandDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemBrandDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemBrandDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemBrandDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemBrandDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemBrandDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemBrandDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemBrandDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemBrandDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemBrandDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemBrandDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemBrandDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemBrandDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemBrandDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemBrandDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemBrandDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemBrandDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemBrandDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemBrandDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemBrandDto>>& ItemBrandDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemBrandDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemBrandDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemBrandDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemBrandDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
