...
ItemReviewDtoListEnvelope::ItemReviewDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemReviewDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemReviewDtoListEnvelope::toJson() const
{
...
bool ItemReviewDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemReviewDto>> refVal_setResult;
...
void ItemReviewDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemReviewDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemReviewDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemReviewDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemReviewDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemReviewDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemReviewDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemReviewDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemReviewDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemReviewDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemReviewDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemReviewDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemReviewDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemReviewDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemReviewDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemReviewDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemReviewDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemReviewDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemReviewDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemReviewDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemReviewDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemReviewDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemReviewDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemReviewDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemReviewDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemReviewDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemReviewDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemReviewDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemReviewDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemReviewDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemReviewDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemReviewDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemReviewDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemReviewDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemReviewDto>>& ItemReviewDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemReviewDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemReviewDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemReviewDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemReviewDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
