...
utility::string_t ItemBrandDto::getBusinessID() const
{
    return m_BusinessID;
}

void ItemBrandDto::setBusinessID(const utility::string_t& value)
{
    m_BusinessID = value;
    m_BusinessIDIsSet = true;
}

bool ItemBrandDto::businessIDIsSet() const
{
    return m_BusinessIDIsSet;
}

void ItemBrandDto::unsetBusinessID()
{
    m_BusinessIDIsSet = false;
}
}
