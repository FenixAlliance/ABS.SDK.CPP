...
ItemWarrantyPolicyDtoEnvelope::ItemWarrantyPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemWarrantyPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemWarrantyPolicyDtoEnvelope::toJson() const
{
...
bool ItemWarrantyPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemWarrantyPolicyDto> refVal_setResult;
...
void ItemWarrantyPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemWarrantyPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemWarrantyPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemWarrantyPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemWarrantyPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemWarrantyPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemWarrantyPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemWarrantyPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemWarrantyPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemWarrantyPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemWarrantyPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemWarrantyPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemWarrantyPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemWarrantyPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemWarrantyPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemWarrantyPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemWarrantyPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemWarrantyPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemWarrantyPolicyDto> ItemWarrantyPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemWarrantyPolicyDtoEnvelope::setResult(const std::shared_ptr<ItemWarrantyPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemWarrantyPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemWarrantyPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
