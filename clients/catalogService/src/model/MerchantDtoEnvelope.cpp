...
MerchantDtoEnvelope::MerchantDtoEnvelope()
{
    m_IsSuccess = false;
...
void MerchantDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value MerchantDtoEnvelope::toJson() const
{
...
bool MerchantDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<MerchantDto> refVal_setResult;
...
void MerchantDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MerchantDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool MerchantDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void MerchantDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool MerchantDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void MerchantDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t MerchantDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void MerchantDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool MerchantDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void MerchantDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t MerchantDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void MerchantDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool MerchantDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void MerchantDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime MerchantDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void MerchantDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool MerchantDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void MerchantDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t MerchantDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void MerchantDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool MerchantDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void MerchantDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t MerchantDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void MerchantDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool MerchantDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void MerchantDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& MerchantDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void MerchantDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool MerchantDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void MerchantDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t MerchantDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void MerchantDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool MerchantDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void MerchantDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<MerchantDto> MerchantDtoEnvelope::getResult() const
{
    return m_Result;
}

void MerchantDtoEnvelope::setResult(const std::shared_ptr<MerchantDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool MerchantDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void MerchantDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
