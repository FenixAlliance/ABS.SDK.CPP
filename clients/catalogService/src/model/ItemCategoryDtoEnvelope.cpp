...
ItemCategoryDtoEnvelope::ItemCategoryDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemCategoryDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemCategoryDtoEnvelope::toJson() const
{
...
bool ItemCategoryDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemCategoryDto> refVal_setResult;
...
void ItemCategoryDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemCategoryDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemCategoryDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemCategoryDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemCategoryDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemCategoryDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemCategoryDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemCategoryDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemCategoryDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemCategoryDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemCategoryDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemCategoryDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemCategoryDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemCategoryDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemCategoryDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemCategoryDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemCategoryDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemCategoryDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemCategoryDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemCategoryDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemCategoryDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemCategoryDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemCategoryDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemCategoryDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemCategoryDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemCategoryDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemCategoryDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemCategoryDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemCategoryDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemCategoryDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemCategoryDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemCategoryDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemCategoryDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemCategoryDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemCategoryDto> ItemCategoryDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemCategoryDtoEnvelope::setResult(const std::shared_ptr<ItemCategoryDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemCategoryDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemCategoryDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
