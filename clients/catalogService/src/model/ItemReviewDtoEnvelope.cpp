...
ItemReviewDtoEnvelope::ItemReviewDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemReviewDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemReviewDtoEnvelope::toJson() const
{
...
bool ItemReviewDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemReviewDto> refVal_setResult;
...
void ItemReviewDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemReviewDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemReviewDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemReviewDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemReviewDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemReviewDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemReviewDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemReviewDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemReviewDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemReviewDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemReviewDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemReviewDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemReviewDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemReviewDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemReviewDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemReviewDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemReviewDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemReviewDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemReviewDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemReviewDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemReviewDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemReviewDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemReviewDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemReviewDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemReviewDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemReviewDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemReviewDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemReviewDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemReviewDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemReviewDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemReviewDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemReviewDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemReviewDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemReviewDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemReviewDto> ItemReviewDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemReviewDtoEnvelope::setResult(const std::shared_ptr<ItemReviewDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemReviewDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemReviewDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
