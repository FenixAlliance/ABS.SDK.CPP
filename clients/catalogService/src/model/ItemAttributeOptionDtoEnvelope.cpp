...
ItemAttributeOptionDtoEnvelope::ItemAttributeOptionDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemAttributeOptionDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeOptionDtoEnvelope::toJson() const
{
...
bool ItemAttributeOptionDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemAttributeOptionDto> refVal_setResult;
...
void ItemAttributeOptionDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeOptionDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemAttributeOptionDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemAttributeOptionDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemAttributeOptionDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemAttributeOptionDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemAttributeOptionDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemAttributeOptionDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemAttributeOptionDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemAttributeOptionDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemAttributeOptionDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemAttributeOptionDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemAttributeOptionDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemAttributeOptionDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemAttributeOptionDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemAttributeOptionDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemAttributeOptionDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemAttributeOptionDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemAttributeOptionDto> ItemAttributeOptionDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemAttributeOptionDtoEnvelope::setResult(const std::shared_ptr<ItemAttributeOptionDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemAttributeOptionDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemAttributeOptionDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
