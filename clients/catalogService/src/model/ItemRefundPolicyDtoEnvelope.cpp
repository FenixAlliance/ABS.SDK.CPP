...
ItemRefundPolicyDtoEnvelope::ItemRefundPolicyDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemRefundPolicyDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemRefundPolicyDtoEnvelope::toJson() const
{
...
bool ItemRefundPolicyDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemRefundPolicyDto> refVal_setResult;
...
void ItemRefundPolicyDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemRefundPolicyDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemRefundPolicyDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemRefundPolicyDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemRefundPolicyDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemRefundPolicyDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemRefundPolicyDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemRefundPolicyDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemRefundPolicyDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemRefundPolicyDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemRefundPolicyDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemRefundPolicyDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemRefundPolicyDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemRefundPolicyDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemRefundPolicyDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemRefundPolicyDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemRefundPolicyDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemRefundPolicyDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemRefundPolicyDto> ItemRefundPolicyDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemRefundPolicyDtoEnvelope::setResult(const std::shared_ptr<ItemRefundPolicyDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemRefundPolicyDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemRefundPolicyDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
