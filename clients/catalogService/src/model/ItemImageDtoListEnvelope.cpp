...
ItemImageDtoListEnvelope::ItemImageDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ItemImageDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemImageDtoListEnvelope::toJson() const
{
...
bool ItemImageDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ItemImageDto>> refVal_setResult;
...
void ItemImageDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemImageDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemImageDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemImageDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemImageDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemImageDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemImageDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemImageDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemImageDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemImageDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemImageDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemImageDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemImageDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemImageDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemImageDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemImageDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemImageDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemImageDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemImageDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemImageDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemImageDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemImageDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemImageDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemImageDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemImageDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemImageDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemImageDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemImageDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemImageDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemImageDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemImageDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemImageDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemImageDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemImageDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ItemImageDto>>& ItemImageDtoListEnvelope::getResult()
{
    return m_Result;
}

void ItemImageDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ItemImageDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemImageDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemImageDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
