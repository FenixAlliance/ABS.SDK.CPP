...
ItemAttachmentDtoEnvelope::ItemAttachmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void ItemAttachmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttachmentDtoEnvelope::toJson() const
{
...
bool ItemAttachmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ItemAttachmentDto> refVal_setResult;
...
void ItemAttachmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttachmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ItemAttachmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ItemAttachmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ItemAttachmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ItemAttachmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ItemAttachmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ItemAttachmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ItemAttachmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ItemAttachmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ItemAttachmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ItemAttachmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ItemAttachmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ItemAttachmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ItemAttachmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ItemAttachmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ItemAttachmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ItemAttachmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ItemAttachmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ItemAttachmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ItemAttachmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ItemAttachmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ItemAttachmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ItemAttachmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ItemAttachmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ItemAttachmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ItemAttachmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ItemAttachmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ItemAttachmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ItemAttachmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ItemAttachmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ItemAttachmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ItemAttachmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ItemAttachmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ItemAttachmentDto> ItemAttachmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void ItemAttachmentDtoEnvelope::setResult(const std::shared_ptr<ItemAttachmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ItemAttachmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ItemAttachmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
