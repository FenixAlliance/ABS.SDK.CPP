...
/*
 * ItemTaxPoliciesApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_ItemTaxPoliciesApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_ItemTaxPoliciesApi_H_
...
public:
    ...
    explicit ItemTaxPoliciesApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~ItemTaxPoliciesApi();
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ItemTaxPolicyDtoEnvelope>> getItemTaxPolicyByIdAsync(
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> relateItemToTaxPolicyAsync(
    ...
    /// <param name="apiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="xApiVersion"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<void> removeTaxPolicyFromItemAsync(
        utility::string_t tenantId,
        utility::string_t itemId,
        utility::string_t itemTaxPolicyId,
        boost::optional<utility::string_t> apiVersion,
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_ItemTaxPoliciesApi_H_ */
