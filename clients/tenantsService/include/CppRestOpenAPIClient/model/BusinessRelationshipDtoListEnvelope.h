...
/*
 * BusinessRelationshipDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_BusinessRelationshipDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_BusinessRelationshipDtoListEnvelope_H_
...
public:
    ...
    virtual ~BusinessRelationshipDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// BusinessRelationshipDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BusinessRelationshipDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<BusinessRelationshipDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<BusinessRelationshipDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_BusinessRelationshipDtoListEnvelope_H_ */
