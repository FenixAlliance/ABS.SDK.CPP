...
StringListEnvelope::StringListEnvelope()
{
    m_IsSuccess = false;
...
void StringListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value StringListEnvelope::toJson() const
{
...
bool StringListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setResult;
...
void StringListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StringListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool StringListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void StringListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool StringListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void StringListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t StringListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void StringListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool StringListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void StringListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t StringListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void StringListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool StringListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void StringListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime StringListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void StringListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool StringListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void StringListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t StringListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void StringListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool StringListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void StringListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t StringListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void StringListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool StringListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void StringListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& StringListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void StringListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool StringListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void StringListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t StringListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void StringListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool StringListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void StringListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<utility::string_t>& StringListEnvelope::getResult()
{
    return m_Result;
}

void StringListEnvelope::setResult(const std::vector<utility::string_t>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StringListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void StringListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
