...
BusinessRelationshipDtoEnvelope::BusinessRelationshipDtoEnvelope()
{
    m_IsSuccess = false;
...
void BusinessRelationshipDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BusinessRelationshipDtoEnvelope::toJson() const
{
...
bool BusinessRelationshipDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<BusinessRelationshipDto> refVal_setResult;
...
void BusinessRelationshipDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BusinessRelationshipDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BusinessRelationshipDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BusinessRelationshipDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BusinessRelationshipDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BusinessRelationshipDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BusinessRelationshipDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BusinessRelationshipDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BusinessRelationshipDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BusinessRelationshipDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BusinessRelationshipDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BusinessRelationshipDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BusinessRelationshipDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BusinessRelationshipDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BusinessRelationshipDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BusinessRelationshipDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BusinessRelationshipDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BusinessRelationshipDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<BusinessRelationshipDto> BusinessRelationshipDtoEnvelope::getResult() const
{
    return m_Result;
}

void BusinessRelationshipDtoEnvelope::setResult(const std::shared_ptr<BusinessRelationshipDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BusinessRelationshipDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BusinessRelationshipDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
