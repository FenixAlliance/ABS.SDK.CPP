...
TenantInvitationDtoEnvelope::TenantInvitationDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantInvitationDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantInvitationDtoEnvelope::toJson() const
{
...
bool TenantInvitationDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantInvitationDto> refVal_setResult;
...
void TenantInvitationDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantInvitationDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantInvitationDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantInvitationDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantInvitationDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantInvitationDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantInvitationDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantInvitationDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantInvitationDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantInvitationDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantInvitationDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantInvitationDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantInvitationDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantInvitationDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantInvitationDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantInvitationDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantInvitationDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantInvitationDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantInvitationDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantInvitationDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantInvitationDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantInvitationDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantInvitationDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantInvitationDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantInvitationDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantInvitationDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantInvitationDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantInvitationDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantInvitationDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantInvitationDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantInvitationDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantInvitationDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantInvitationDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantInvitationDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantInvitationDto> TenantInvitationDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantInvitationDtoEnvelope::setResult(const std::shared_ptr<TenantInvitationDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantInvitationDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantInvitationDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
