...
NotificationDtoListEnvelope::NotificationDtoListEnvelope()
{
    m_IsSuccess = false;
...
void NotificationDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value NotificationDtoListEnvelope::toJson() const
{
...
bool NotificationDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<NotificationDto>> refVal_setResult;
...
void NotificationDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NotificationDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool NotificationDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void NotificationDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool NotificationDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void NotificationDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t NotificationDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void NotificationDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool NotificationDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void NotificationDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t NotificationDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void NotificationDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool NotificationDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void NotificationDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime NotificationDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void NotificationDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool NotificationDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void NotificationDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t NotificationDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void NotificationDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool NotificationDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void NotificationDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t NotificationDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void NotificationDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool NotificationDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void NotificationDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& NotificationDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void NotificationDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool NotificationDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void NotificationDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t NotificationDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void NotificationDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool NotificationDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void NotificationDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<NotificationDto>>& NotificationDtoListEnvelope::getResult()
{
    return m_Result;
}

void NotificationDtoListEnvelope::setResult(const std::vector<std::shared_ptr<NotificationDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool NotificationDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void NotificationDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
