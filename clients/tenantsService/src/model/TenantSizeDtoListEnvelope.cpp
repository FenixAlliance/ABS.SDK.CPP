...
TenantSizeDtoListEnvelope::TenantSizeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantSizeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantSizeDtoListEnvelope::toJson() const
{
...
bool TenantSizeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantSizeDto>> refVal_setResult;
...
void TenantSizeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantSizeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantSizeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantSizeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantSizeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantSizeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantSizeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantSizeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantSizeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantSizeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantSizeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantSizeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantSizeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantSizeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantSizeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantSizeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantSizeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantSizeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantSizeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantSizeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantSizeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantSizeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantSizeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantSizeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantSizeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantSizeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantSizeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantSizeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantSizeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantSizeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantSizeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantSizeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantSizeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantSizeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantSizeDto>>& TenantSizeDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantSizeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantSizeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantSizeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantSizeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
