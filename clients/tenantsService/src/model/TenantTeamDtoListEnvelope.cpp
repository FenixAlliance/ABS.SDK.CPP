...
TenantTeamDtoListEnvelope::TenantTeamDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantTeamDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantTeamDtoListEnvelope::toJson() const
{
...
bool TenantTeamDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantTeamDto>> refVal_setResult;
...
void TenantTeamDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantTeamDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantTeamDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantTeamDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantTeamDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantTeamDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantTeamDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantTeamDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantTeamDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantTeamDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantTeamDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantTeamDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantTeamDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantTeamDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantTeamDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantTeamDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantTeamDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantTeamDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantTeamDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantTeamDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantTeamDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantTeamDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantTeamDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantTeamDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantTeamDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantTeamDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantTeamDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantTeamDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantTeamDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantTeamDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantTeamDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantTeamDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantTeamDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantTeamDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantTeamDto>>& TenantTeamDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantTeamDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantTeamDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantTeamDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantTeamDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
