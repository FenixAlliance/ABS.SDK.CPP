...
TenantIndustryDtoListEnvelope::TenantIndustryDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantIndustryDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantIndustryDtoListEnvelope::toJson() const
{
...
bool TenantIndustryDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantIndustryDto>> refVal_setResult;
...
void TenantIndustryDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantIndustryDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantIndustryDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantIndustryDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantIndustryDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantIndustryDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantIndustryDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantIndustryDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantIndustryDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantIndustryDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantIndustryDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantIndustryDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantIndustryDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantIndustryDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantIndustryDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantIndustryDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantIndustryDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantIndustryDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantIndustryDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantIndustryDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantIndustryDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantIndustryDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantIndustryDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantIndustryDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantIndustryDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantIndustryDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantIndustryDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantIndustryDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantIndustryDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantIndustryDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantIndustryDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantIndustryDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantIndustryDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantIndustryDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantIndustryDto>>& TenantIndustryDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantIndustryDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantIndustryDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantIndustryDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantIndustryDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
