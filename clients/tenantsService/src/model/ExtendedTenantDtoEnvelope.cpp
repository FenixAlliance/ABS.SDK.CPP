...
ExtendedTenantDtoEnvelope::ExtendedTenantDtoEnvelope()
{
    m_IsSuccess = false;
...
void ExtendedTenantDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ExtendedTenantDtoEnvelope::toJson() const
{
...
bool ExtendedTenantDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ExtendedTenantDto> refVal_setResult;
...
void ExtendedTenantDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtendedTenantDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ExtendedTenantDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ExtendedTenantDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ExtendedTenantDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ExtendedTenantDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ExtendedTenantDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ExtendedTenantDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ExtendedTenantDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ExtendedTenantDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ExtendedTenantDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ExtendedTenantDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ExtendedTenantDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ExtendedTenantDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ExtendedTenantDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ExtendedTenantDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ExtendedTenantDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ExtendedTenantDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ExtendedTenantDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ExtendedTenantDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ExtendedTenantDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ExtendedTenantDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ExtendedTenantDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ExtendedTenantDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ExtendedTenantDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ExtendedTenantDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ExtendedTenantDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ExtendedTenantDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ExtendedTenantDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ExtendedTenantDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ExtendedTenantDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ExtendedTenantDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ExtendedTenantDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ExtendedTenantDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ExtendedTenantDto> ExtendedTenantDtoEnvelope::getResult() const
{
    return m_Result;
}

void ExtendedTenantDtoEnvelope::setResult(const std::shared_ptr<ExtendedTenantDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ExtendedTenantDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExtendedTenantDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
