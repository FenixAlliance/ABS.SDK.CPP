...
UnitDtoListEnvelope::UnitDtoListEnvelope()
{
    m_IsSuccess = false;
...
void UnitDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UnitDtoListEnvelope::toJson() const
{
...
bool UnitDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<UnitDto>> refVal_setResult;
...
void UnitDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UnitDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UnitDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UnitDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UnitDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UnitDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UnitDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UnitDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UnitDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UnitDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UnitDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UnitDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UnitDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UnitDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UnitDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UnitDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UnitDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UnitDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UnitDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UnitDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UnitDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UnitDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UnitDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UnitDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UnitDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UnitDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UnitDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UnitDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UnitDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UnitDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UnitDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UnitDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UnitDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UnitDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<UnitDto>>& UnitDtoListEnvelope::getResult()
{
    return m_Result;
}

void UnitDtoListEnvelope::setResult(const std::vector<std::shared_ptr<UnitDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UnitDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UnitDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
