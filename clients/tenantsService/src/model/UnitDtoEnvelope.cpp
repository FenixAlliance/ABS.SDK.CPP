...
UnitDtoEnvelope::UnitDtoEnvelope()
{
    m_IsSuccess = false;
...
void UnitDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UnitDtoEnvelope::toJson() const
{
...
bool UnitDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UnitDto> refVal_setResult;
...
void UnitDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UnitDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UnitDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UnitDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UnitDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UnitDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UnitDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UnitDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UnitDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UnitDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UnitDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UnitDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UnitDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UnitDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UnitDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UnitDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UnitDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UnitDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UnitDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UnitDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UnitDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UnitDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UnitDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UnitDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UnitDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UnitDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UnitDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UnitDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UnitDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UnitDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UnitDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UnitDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UnitDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UnitDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<UnitDto> UnitDtoEnvelope::getResult() const
{
    return m_Result;
}

void UnitDtoEnvelope::setResult(const std::shared_ptr<UnitDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UnitDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UnitDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
