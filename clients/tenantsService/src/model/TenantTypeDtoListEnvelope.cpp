...
TenantTypeDtoListEnvelope::TenantTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantTypeDtoListEnvelope::toJson() const
{
...
bool TenantTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantTypeDto>> refVal_setResult;
...
void TenantTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantTypeDto>>& TenantTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
