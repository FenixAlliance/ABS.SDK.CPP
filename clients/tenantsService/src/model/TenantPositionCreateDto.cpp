...
utility::string_t TenantPositionCreateDto::getBusinessID() const
{
    return m_BusinessID;
}

void TenantPositionCreateDto::setBusinessID(const utility::string_t& value)
{
    m_BusinessID = value;
    m_BusinessIDIsSet = true;
}

bool TenantPositionCreateDto::businessIDIsSet() const
{
    return m_BusinessIDIsSet;
}

void TenantPositionCreateDto::unsetBusinessID()
{
    m_BusinessIDIsSet = false;
}
utility::string_t TenantPositionCreateDto::getBusinessProfileRecordID() const
{
    return m_BusinessProfileRecordID;
}

void TenantPositionCreateDto::setBusinessProfileRecordID(const utility::string_t& value)
{
    m_BusinessProfileRecordID = value;
    m_BusinessProfileRecordIDIsSet = true;
}

bool TenantPositionCreateDto::businessProfileRecordIDIsSet() const
{
    return m_BusinessProfileRecordIDIsSet;
}

void TenantPositionCreateDto::unsetBusinessProfileRecordID()
{
    m_BusinessProfileRecordIDIsSet = false;
}
