...
TenantEnrollmentDtoEnvelope::TenantEnrollmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantEnrollmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantEnrollmentDtoEnvelope::toJson() const
{
...
bool TenantEnrollmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantEnrollmentDto> refVal_setResult;
...
void TenantEnrollmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantEnrollmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantEnrollmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantEnrollmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantEnrollmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantEnrollmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantEnrollmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantEnrollmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantEnrollmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantEnrollmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantEnrollmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantEnrollmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantEnrollmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantEnrollmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantEnrollmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantEnrollmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantEnrollmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantEnrollmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantEnrollmentDto> TenantEnrollmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantEnrollmentDtoEnvelope::setResult(const std::shared_ptr<TenantEnrollmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantEnrollmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantEnrollmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
