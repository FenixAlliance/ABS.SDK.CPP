...
TenantSegmentDtoEnvelope::TenantSegmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantSegmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantSegmentDtoEnvelope::toJson() const
{
...
bool TenantSegmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantSegmentDto> refVal_setResult;
...
void TenantSegmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantSegmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantSegmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantSegmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantSegmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantSegmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantSegmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantSegmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantSegmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantSegmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantSegmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantSegmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantSegmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantSegmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantSegmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantSegmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantSegmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantSegmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantSegmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantSegmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantSegmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantSegmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantSegmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantSegmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantSegmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantSegmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantSegmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantSegmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantSegmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantSegmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantSegmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantSegmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantSegmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantSegmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantSegmentDto> TenantSegmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantSegmentDtoEnvelope::setResult(const std::shared_ptr<TenantSegmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantSegmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantSegmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
