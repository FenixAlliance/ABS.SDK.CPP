...
TenantDepartmentDtoEnvelope::TenantDepartmentDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantDepartmentDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantDepartmentDtoEnvelope::toJson() const
{
...
bool TenantDepartmentDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantDepartmentDto> refVal_setResult;
...
void TenantDepartmentDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantDepartmentDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantDepartmentDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantDepartmentDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantDepartmentDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantDepartmentDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantDepartmentDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantDepartmentDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantDepartmentDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantDepartmentDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantDepartmentDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantDepartmentDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantDepartmentDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantDepartmentDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantDepartmentDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantDepartmentDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantDepartmentDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantDepartmentDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantDepartmentDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantDepartmentDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantDepartmentDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantDepartmentDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantDepartmentDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantDepartmentDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantDepartmentDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantDepartmentDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantDepartmentDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantDepartmentDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantDepartmentDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantDepartmentDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantDepartmentDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantDepartmentDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantDepartmentDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantDepartmentDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantDepartmentDto> TenantDepartmentDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantDepartmentDtoEnvelope::setResult(const std::shared_ptr<TenantDepartmentDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantDepartmentDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantDepartmentDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
