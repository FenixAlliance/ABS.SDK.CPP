...
TenantTypeDtoEnvelope::TenantTypeDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantTypeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantTypeDtoEnvelope::toJson() const
{
...
bool TenantTypeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantTypeDto> refVal_setResult;
...
void TenantTypeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantTypeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantTypeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantTypeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantTypeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantTypeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantTypeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantTypeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantTypeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantTypeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantTypeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantTypeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantTypeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantTypeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantTypeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantTypeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantTypeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantTypeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantTypeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantTypeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantTypeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantTypeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantTypeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantTypeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantTypeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantTypeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantTypeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantTypeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantTypeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantTypeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantTypeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantTypeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantTypeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantTypeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantTypeDto> TenantTypeDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantTypeDtoEnvelope::setResult(const std::shared_ptr<TenantTypeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantTypeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantTypeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
