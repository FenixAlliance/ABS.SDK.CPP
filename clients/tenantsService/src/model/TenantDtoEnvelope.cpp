...
TenantDtoEnvelope::TenantDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantDtoEnvelope::toJson() const
{
...
bool TenantDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantDto> refVal_setResult;
...
void TenantDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantDto> TenantDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantDtoEnvelope::setResult(const std::shared_ptr<TenantDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
