...
TenantTeamRecordDtoEnvelope::TenantTeamRecordDtoEnvelope()
{
    m_IsSuccess = false;
...
void TenantTeamRecordDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantTeamRecordDtoEnvelope::toJson() const
{
...
bool TenantTeamRecordDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<TenantTeamRecordDto> refVal_setResult;
...
void TenantTeamRecordDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantTeamRecordDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantTeamRecordDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantTeamRecordDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantTeamRecordDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantTeamRecordDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantTeamRecordDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantTeamRecordDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantTeamRecordDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantTeamRecordDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantTeamRecordDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantTeamRecordDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantTeamRecordDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantTeamRecordDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantTeamRecordDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantTeamRecordDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantTeamRecordDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantTeamRecordDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<TenantTeamRecordDto> TenantTeamRecordDtoEnvelope::getResult() const
{
    return m_Result;
}

void TenantTeamRecordDtoEnvelope::setResult(const std::shared_ptr<TenantTeamRecordDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantTeamRecordDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantTeamRecordDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
