...
TenantUnitDtoListEnvelope::TenantUnitDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantUnitDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantUnitDtoListEnvelope::toJson() const
{
...
bool TenantUnitDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantUnitDto>> refVal_setResult;
...
void TenantUnitDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantUnitDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantUnitDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantUnitDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantUnitDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantUnitDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantUnitDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantUnitDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantUnitDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantUnitDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantUnitDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantUnitDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantUnitDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantUnitDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantUnitDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantUnitDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantUnitDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantUnitDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantUnitDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantUnitDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantUnitDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantUnitDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantUnitDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantUnitDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantUnitDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantUnitDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantUnitDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantUnitDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantUnitDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantUnitDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantUnitDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantUnitDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantUnitDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantUnitDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantUnitDto>>& TenantUnitDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantUnitDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantUnitDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantUnitDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantUnitDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
