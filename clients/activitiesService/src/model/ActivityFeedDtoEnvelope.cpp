...
ActivityFeedDtoEnvelope::ActivityFeedDtoEnvelope()
{
    m_IsSuccess = false;
...
void ActivityFeedDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ActivityFeedDtoEnvelope::toJson() const
{
...
bool ActivityFeedDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ActivityFeedDto> refVal_setResult;
...
void ActivityFeedDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActivityFeedDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ActivityFeedDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ActivityFeedDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ActivityFeedDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ActivityFeedDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ActivityFeedDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ActivityFeedDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ActivityFeedDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ActivityFeedDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ActivityFeedDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ActivityFeedDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ActivityFeedDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ActivityFeedDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ActivityFeedDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ActivityFeedDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ActivityFeedDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ActivityFeedDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ActivityFeedDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ActivityFeedDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ActivityFeedDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ActivityFeedDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ActivityFeedDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ActivityFeedDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ActivityFeedDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ActivityFeedDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ActivityFeedDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ActivityFeedDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ActivityFeedDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ActivityFeedDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ActivityFeedDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ActivityFeedDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ActivityFeedDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ActivityFeedDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ActivityFeedDto> ActivityFeedDtoEnvelope::getResult() const
{
    return m_Result;
}

void ActivityFeedDtoEnvelope::setResult(const std::shared_ptr<ActivityFeedDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ActivityFeedDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ActivityFeedDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
