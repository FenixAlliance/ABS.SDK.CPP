...
ActivityFeedDtoListEnvelope::ActivityFeedDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ActivityFeedDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ActivityFeedDtoListEnvelope::toJson() const
{
...
bool ActivityFeedDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ActivityFeedDto>> refVal_setResult;
...
void ActivityFeedDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActivityFeedDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ActivityFeedDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ActivityFeedDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ActivityFeedDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ActivityFeedDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ActivityFeedDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ActivityFeedDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ActivityFeedDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ActivityFeedDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ActivityFeedDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ActivityFeedDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ActivityFeedDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ActivityFeedDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ActivityFeedDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ActivityFeedDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ActivityFeedDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ActivityFeedDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ActivityFeedDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ActivityFeedDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ActivityFeedDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ActivityFeedDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ActivityFeedDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ActivityFeedDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ActivityFeedDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ActivityFeedDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ActivityFeedDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ActivityFeedDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ActivityFeedDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ActivityFeedDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ActivityFeedDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ActivityFeedDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ActivityFeedDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ActivityFeedDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ActivityFeedDto>>& ActivityFeedDtoListEnvelope::getResult()
{
    return m_Result;
}

void ActivityFeedDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ActivityFeedDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ActivityFeedDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ActivityFeedDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
