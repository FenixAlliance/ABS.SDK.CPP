...
ActivityTypeDtoListEnvelope::ActivityTypeDtoListEnvelope()
{
    m_IsSuccess = false;
...
void ActivityTypeDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ActivityTypeDtoListEnvelope::toJson() const
{
...
bool ActivityTypeDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<ActivityTypeDto>> refVal_setResult;
...
void ActivityTypeDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActivityTypeDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ActivityTypeDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ActivityTypeDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ActivityTypeDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ActivityTypeDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ActivityTypeDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ActivityTypeDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ActivityTypeDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ActivityTypeDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ActivityTypeDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ActivityTypeDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ActivityTypeDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ActivityTypeDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ActivityTypeDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ActivityTypeDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ActivityTypeDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ActivityTypeDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ActivityTypeDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ActivityTypeDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ActivityTypeDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ActivityTypeDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ActivityTypeDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ActivityTypeDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ActivityTypeDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ActivityTypeDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ActivityTypeDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ActivityTypeDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ActivityTypeDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ActivityTypeDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ActivityTypeDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ActivityTypeDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ActivityTypeDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ActivityTypeDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<ActivityTypeDto>>& ActivityTypeDtoListEnvelope::getResult()
{
    return m_Result;
}

void ActivityTypeDtoListEnvelope::setResult(const std::vector<std::shared_ptr<ActivityTypeDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ActivityTypeDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ActivityTypeDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
