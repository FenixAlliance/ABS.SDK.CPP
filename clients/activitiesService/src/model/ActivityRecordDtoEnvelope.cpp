...
ActivityRecordDtoEnvelope::ActivityRecordDtoEnvelope()
{
    m_IsSuccess = false;
...
void ActivityRecordDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value ActivityRecordDtoEnvelope::toJson() const
{
...
bool ActivityRecordDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ActivityRecordDto> refVal_setResult;
...
void ActivityRecordDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ActivityRecordDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool ActivityRecordDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void ActivityRecordDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool ActivityRecordDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void ActivityRecordDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t ActivityRecordDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void ActivityRecordDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool ActivityRecordDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void ActivityRecordDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t ActivityRecordDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void ActivityRecordDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool ActivityRecordDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void ActivityRecordDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime ActivityRecordDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void ActivityRecordDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ActivityRecordDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ActivityRecordDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t ActivityRecordDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void ActivityRecordDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool ActivityRecordDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void ActivityRecordDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t ActivityRecordDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void ActivityRecordDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool ActivityRecordDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void ActivityRecordDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& ActivityRecordDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void ActivityRecordDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool ActivityRecordDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void ActivityRecordDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t ActivityRecordDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void ActivityRecordDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool ActivityRecordDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void ActivityRecordDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<ActivityRecordDto> ActivityRecordDtoEnvelope::getResult() const
{
    return m_Result;
}

void ActivityRecordDtoEnvelope::setResult(const std::shared_ptr<ActivityRecordDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool ActivityRecordDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void ActivityRecordDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
