...
StudioModuleListEnvelope::StudioModuleListEnvelope()
{
    m_IsSuccess = false;
...
void StudioModuleListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value StudioModuleListEnvelope::toJson() const
{
...
bool StudioModuleListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<StudioModule>> refVal_setResult;
...
void StudioModuleListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StudioModuleListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool StudioModuleListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void StudioModuleListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool StudioModuleListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void StudioModuleListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t StudioModuleListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void StudioModuleListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool StudioModuleListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void StudioModuleListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t StudioModuleListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void StudioModuleListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool StudioModuleListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void StudioModuleListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime StudioModuleListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void StudioModuleListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool StudioModuleListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void StudioModuleListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t StudioModuleListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void StudioModuleListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool StudioModuleListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void StudioModuleListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t StudioModuleListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void StudioModuleListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool StudioModuleListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void StudioModuleListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& StudioModuleListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void StudioModuleListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool StudioModuleListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void StudioModuleListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t StudioModuleListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void StudioModuleListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool StudioModuleListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void StudioModuleListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<StudioModule>>& StudioModuleListEnvelope::getResult()
{
    return m_Result;
}

void StudioModuleListEnvelope::setResult(const std::vector<std::shared_ptr<StudioModule>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool StudioModuleListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void StudioModuleListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
