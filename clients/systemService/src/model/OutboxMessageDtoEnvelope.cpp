...
OutboxMessageDtoEnvelope::OutboxMessageDtoEnvelope()
{
    m_IsSuccess = false;
...
void OutboxMessageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OutboxMessageDtoEnvelope::toJson() const
{
...
bool OutboxMessageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OutboxMessageDto> refVal_setResult;
...
void OutboxMessageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OutboxMessageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OutboxMessageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OutboxMessageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OutboxMessageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OutboxMessageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OutboxMessageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OutboxMessageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OutboxMessageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OutboxMessageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OutboxMessageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OutboxMessageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OutboxMessageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OutboxMessageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OutboxMessageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OutboxMessageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OutboxMessageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OutboxMessageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OutboxMessageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OutboxMessageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OutboxMessageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OutboxMessageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OutboxMessageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OutboxMessageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OutboxMessageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OutboxMessageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OutboxMessageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OutboxMessageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OutboxMessageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OutboxMessageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OutboxMessageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OutboxMessageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OutboxMessageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OutboxMessageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<OutboxMessageDto> OutboxMessageDtoEnvelope::getResult() const
{
    return m_Result;
}

void OutboxMessageDtoEnvelope::setResult(const std::shared_ptr<OutboxMessageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OutboxMessageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OutboxMessageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
