...
void OutboxAdminReasonDto::validate()
{
    // TODO: implement validation
}

web::json::value OutboxAdminReasonDto::toJson() const
{
...
bool OutboxAdminReasonDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void OutboxAdminReasonDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OutboxAdminReasonDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t OutboxAdminReasonDto::getReason() const
{
    return m_Reason;
}

void OutboxAdminReasonDto::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool OutboxAdminReasonDto::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void OutboxAdminReasonDto::unsetReason()
{
    m_ReasonIsSet = false;
}
}
