...
SuiteLicenseDtoListEnvelope::SuiteLicenseDtoListEnvelope()
{
    m_IsSuccess = false;
...
void SuiteLicenseDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SuiteLicenseDtoListEnvelope::toJson() const
{
...
bool SuiteLicenseDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SuiteLicenseDto>> refVal_setResult;
...
void SuiteLicenseDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SuiteLicenseDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SuiteLicenseDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SuiteLicenseDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SuiteLicenseDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SuiteLicenseDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SuiteLicenseDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SuiteLicenseDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SuiteLicenseDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SuiteLicenseDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SuiteLicenseDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SuiteLicenseDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SuiteLicenseDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SuiteLicenseDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SuiteLicenseDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SuiteLicenseDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SuiteLicenseDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SuiteLicenseDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<SuiteLicenseDto>>& SuiteLicenseDtoListEnvelope::getResult()
{
    return m_Result;
}

void SuiteLicenseDtoListEnvelope::setResult(const std::vector<std::shared_ptr<SuiteLicenseDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SuiteLicenseDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SuiteLicenseDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
