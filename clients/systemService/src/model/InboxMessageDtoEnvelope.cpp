...
InboxMessageDtoEnvelope::InboxMessageDtoEnvelope()
{
    m_IsSuccess = false;
...
void InboxMessageDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InboxMessageDtoEnvelope::toJson() const
{
...
bool InboxMessageDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InboxMessageDto> refVal_setResult;
...
void InboxMessageDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxMessageDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InboxMessageDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InboxMessageDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InboxMessageDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InboxMessageDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InboxMessageDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InboxMessageDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InboxMessageDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InboxMessageDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InboxMessageDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InboxMessageDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InboxMessageDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InboxMessageDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InboxMessageDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InboxMessageDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InboxMessageDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InboxMessageDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InboxMessageDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InboxMessageDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InboxMessageDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InboxMessageDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InboxMessageDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InboxMessageDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InboxMessageDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InboxMessageDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InboxMessageDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InboxMessageDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InboxMessageDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InboxMessageDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InboxMessageDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InboxMessageDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InboxMessageDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InboxMessageDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InboxMessageDto> InboxMessageDtoEnvelope::getResult() const
{
    return m_Result;
}

void InboxMessageDtoEnvelope::setResult(const std::shared_ptr<InboxMessageDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InboxMessageDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InboxMessageDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
