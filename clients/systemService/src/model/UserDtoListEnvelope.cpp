...
UserDtoListEnvelope::UserDtoListEnvelope()
{
    m_IsSuccess = false;
...
void UserDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UserDtoListEnvelope::toJson() const
{
...
bool UserDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<UserDto>> refVal_setResult;
...
void UserDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UserDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UserDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UserDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UserDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UserDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UserDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UserDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UserDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UserDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UserDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UserDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UserDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UserDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UserDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UserDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UserDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UserDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UserDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UserDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UserDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UserDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UserDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UserDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UserDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UserDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UserDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UserDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UserDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UserDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UserDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UserDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UserDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<UserDto>>& UserDtoListEnvelope::getResult()
{
    return m_Result;
}

void UserDtoListEnvelope::setResult(const std::vector<std::shared_ptr<UserDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UserDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UserDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
