...
CartDtoListEnvelope::CartDtoListEnvelope()
{
    m_IsSuccess = false;
...
void CartDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value CartDtoListEnvelope::toJson() const
{
...
bool CartDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<CartDto>> refVal_setResult;
...
void CartDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CartDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool CartDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void CartDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool CartDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void CartDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t CartDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void CartDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool CartDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void CartDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t CartDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void CartDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool CartDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void CartDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime CartDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void CartDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool CartDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void CartDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t CartDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void CartDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool CartDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void CartDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t CartDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void CartDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool CartDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void CartDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& CartDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void CartDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool CartDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void CartDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t CartDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void CartDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool CartDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void CartDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<CartDto>>& CartDtoListEnvelope::getResult()
{
    return m_Result;
}

void CartDtoListEnvelope::setResult(const std::vector<std::shared_ptr<CartDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool CartDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void CartDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
