...
IPLookupDtoListEnvelope::IPLookupDtoListEnvelope()
{
    m_IsSuccess = false;
...
void IPLookupDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value IPLookupDtoListEnvelope::toJson() const
{
...
bool IPLookupDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<IPLookupDto>> refVal_setResult;
...
void IPLookupDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IPLookupDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool IPLookupDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void IPLookupDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool IPLookupDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void IPLookupDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t IPLookupDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void IPLookupDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool IPLookupDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void IPLookupDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t IPLookupDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void IPLookupDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool IPLookupDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void IPLookupDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime IPLookupDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void IPLookupDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool IPLookupDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void IPLookupDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t IPLookupDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void IPLookupDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool IPLookupDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void IPLookupDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t IPLookupDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void IPLookupDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool IPLookupDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void IPLookupDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& IPLookupDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void IPLookupDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool IPLookupDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void IPLookupDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t IPLookupDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void IPLookupDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool IPLookupDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void IPLookupDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<IPLookupDto>>& IPLookupDtoListEnvelope::getResult()
{
    return m_Result;
}

void IPLookupDtoListEnvelope::setResult(const std::vector<std::shared_ptr<IPLookupDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool IPLookupDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void IPLookupDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
