...
TenantDtoListEnvelope::TenantDtoListEnvelope()
{
    m_IsSuccess = false;
...
void TenantDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value TenantDtoListEnvelope::toJson() const
{
...
bool TenantDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<TenantDto>> refVal_setResult;
...
void TenantDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TenantDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool TenantDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void TenantDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool TenantDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void TenantDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t TenantDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void TenantDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool TenantDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void TenantDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t TenantDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void TenantDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool TenantDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void TenantDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime TenantDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void TenantDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool TenantDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void TenantDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t TenantDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void TenantDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool TenantDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void TenantDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t TenantDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void TenantDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool TenantDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void TenantDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& TenantDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void TenantDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool TenantDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void TenantDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t TenantDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void TenantDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool TenantDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void TenantDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<TenantDto>>& TenantDtoListEnvelope::getResult()
{
    return m_Result;
}

void TenantDtoListEnvelope::setResult(const std::vector<std::shared_ptr<TenantDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool TenantDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void TenantDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
