...
void InboxAdminReasonDto::validate()
{
    // TODO: implement validation
}

web::json::value InboxAdminReasonDto::toJson() const
{
...
bool InboxAdminReasonDto::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InboxAdminReasonDto::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxAdminReasonDto::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t InboxAdminReasonDto::getReason() const
{
    return m_Reason;
}

void InboxAdminReasonDto::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool InboxAdminReasonDto::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void InboxAdminReasonDto::unsetReason()
{
    m_ReasonIsSet = false;
}
}
