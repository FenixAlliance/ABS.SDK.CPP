...
BusinessDomainDtoListEnvelope::BusinessDomainDtoListEnvelope()
{
    m_IsSuccess = false;
...
void BusinessDomainDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value BusinessDomainDtoListEnvelope::toJson() const
{
...
bool BusinessDomainDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BusinessDomainDto>> refVal_setResult;
...
void BusinessDomainDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BusinessDomainDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool BusinessDomainDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void BusinessDomainDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool BusinessDomainDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void BusinessDomainDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t BusinessDomainDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void BusinessDomainDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool BusinessDomainDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void BusinessDomainDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t BusinessDomainDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void BusinessDomainDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool BusinessDomainDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void BusinessDomainDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime BusinessDomainDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void BusinessDomainDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool BusinessDomainDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void BusinessDomainDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t BusinessDomainDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void BusinessDomainDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool BusinessDomainDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void BusinessDomainDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t BusinessDomainDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void BusinessDomainDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool BusinessDomainDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void BusinessDomainDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& BusinessDomainDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void BusinessDomainDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool BusinessDomainDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void BusinessDomainDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t BusinessDomainDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void BusinessDomainDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool BusinessDomainDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void BusinessDomainDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<BusinessDomainDto>>& BusinessDomainDtoListEnvelope::getResult()
{
    return m_Result;
}

void BusinessDomainDtoListEnvelope::setResult(const std::vector<std::shared_ptr<BusinessDomainDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool BusinessDomainDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void BusinessDomainDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
