...
GuestCartPurgeResultDtoEnvelope::GuestCartPurgeResultDtoEnvelope()
{
    m_IsSuccess = false;
...
void GuestCartPurgeResultDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value GuestCartPurgeResultDtoEnvelope::toJson() const
{
...
bool GuestCartPurgeResultDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GuestCartPurgeResultDto> refVal_setResult;
...
void GuestCartPurgeResultDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GuestCartPurgeResultDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool GuestCartPurgeResultDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void GuestCartPurgeResultDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t GuestCartPurgeResultDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void GuestCartPurgeResultDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t GuestCartPurgeResultDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void GuestCartPurgeResultDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime GuestCartPurgeResultDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void GuestCartPurgeResultDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t GuestCartPurgeResultDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void GuestCartPurgeResultDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t GuestCartPurgeResultDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void GuestCartPurgeResultDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& GuestCartPurgeResultDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void GuestCartPurgeResultDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t GuestCartPurgeResultDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void GuestCartPurgeResultDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<GuestCartPurgeResultDto> GuestCartPurgeResultDtoEnvelope::getResult() const
{
    return m_Result;
}

void GuestCartPurgeResultDtoEnvelope::setResult(const std::shared_ptr<GuestCartPurgeResultDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool GuestCartPurgeResultDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void GuestCartPurgeResultDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
