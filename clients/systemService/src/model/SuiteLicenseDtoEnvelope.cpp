...
SuiteLicenseDtoEnvelope::SuiteLicenseDtoEnvelope()
{
    m_IsSuccess = false;
...
void SuiteLicenseDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value SuiteLicenseDtoEnvelope::toJson() const
{
...
bool SuiteLicenseDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<SuiteLicenseDto> refVal_setResult;
...
void SuiteLicenseDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SuiteLicenseDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool SuiteLicenseDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void SuiteLicenseDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool SuiteLicenseDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void SuiteLicenseDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t SuiteLicenseDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void SuiteLicenseDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool SuiteLicenseDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void SuiteLicenseDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t SuiteLicenseDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void SuiteLicenseDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool SuiteLicenseDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void SuiteLicenseDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime SuiteLicenseDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void SuiteLicenseDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SuiteLicenseDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SuiteLicenseDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t SuiteLicenseDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void SuiteLicenseDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool SuiteLicenseDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void SuiteLicenseDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t SuiteLicenseDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void SuiteLicenseDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool SuiteLicenseDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void SuiteLicenseDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& SuiteLicenseDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void SuiteLicenseDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool SuiteLicenseDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void SuiteLicenseDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t SuiteLicenseDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void SuiteLicenseDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool SuiteLicenseDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void SuiteLicenseDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<SuiteLicenseDto> SuiteLicenseDtoEnvelope::getResult() const
{
    return m_Result;
}

void SuiteLicenseDtoEnvelope::setResult(const std::shared_ptr<SuiteLicenseDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool SuiteLicenseDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void SuiteLicenseDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
