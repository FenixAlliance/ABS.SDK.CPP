...
InboxReplayResultDtoEnvelope::InboxReplayResultDtoEnvelope()
{
    m_IsSuccess = false;
...
void InboxReplayResultDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InboxReplayResultDtoEnvelope::toJson() const
{
...
bool InboxReplayResultDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InboxReplayResultDto> refVal_setResult;
...
void InboxReplayResultDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxReplayResultDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InboxReplayResultDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InboxReplayResultDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InboxReplayResultDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InboxReplayResultDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InboxReplayResultDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InboxReplayResultDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InboxReplayResultDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InboxReplayResultDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InboxReplayResultDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InboxReplayResultDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InboxReplayResultDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InboxReplayResultDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InboxReplayResultDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InboxReplayResultDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InboxReplayResultDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InboxReplayResultDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InboxReplayResultDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InboxReplayResultDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InboxReplayResultDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InboxReplayResultDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InboxReplayResultDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InboxReplayResultDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InboxReplayResultDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InboxReplayResultDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InboxReplayResultDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InboxReplayResultDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InboxReplayResultDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InboxReplayResultDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InboxReplayResultDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InboxReplayResultDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InboxReplayResultDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InboxReplayResultDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InboxReplayResultDto> InboxReplayResultDtoEnvelope::getResult() const
{
    return m_Result;
}

void InboxReplayResultDtoEnvelope::setResult(const std::shared_ptr<InboxReplayResultDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InboxReplayResultDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InboxReplayResultDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
