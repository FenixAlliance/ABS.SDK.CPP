...
UserDtoEnvelope::UserDtoEnvelope()
{
    m_IsSuccess = false;
...
void UserDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UserDtoEnvelope::toJson() const
{
...
bool UserDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UserDto> refVal_setResult;
...
void UserDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UserDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UserDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UserDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UserDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UserDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UserDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UserDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UserDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UserDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UserDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UserDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UserDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UserDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UserDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UserDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UserDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UserDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UserDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UserDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UserDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UserDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UserDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UserDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UserDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UserDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UserDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UserDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UserDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UserDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UserDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UserDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UserDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<UserDto> UserDtoEnvelope::getResult() const
{
    return m_Result;
}

void UserDtoEnvelope::setResult(const std::shared_ptr<UserDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UserDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UserDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
