...
OutboxHealthDtoEnvelope::OutboxHealthDtoEnvelope()
{
    m_IsSuccess = false;
...
void OutboxHealthDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value OutboxHealthDtoEnvelope::toJson() const
{
...
bool OutboxHealthDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<OutboxHealthDto> refVal_setResult;
...
void OutboxHealthDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool OutboxHealthDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool OutboxHealthDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void OutboxHealthDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool OutboxHealthDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void OutboxHealthDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t OutboxHealthDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void OutboxHealthDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool OutboxHealthDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void OutboxHealthDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t OutboxHealthDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void OutboxHealthDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool OutboxHealthDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void OutboxHealthDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime OutboxHealthDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void OutboxHealthDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool OutboxHealthDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void OutboxHealthDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t OutboxHealthDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void OutboxHealthDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool OutboxHealthDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void OutboxHealthDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t OutboxHealthDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void OutboxHealthDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool OutboxHealthDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void OutboxHealthDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& OutboxHealthDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void OutboxHealthDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool OutboxHealthDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void OutboxHealthDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t OutboxHealthDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void OutboxHealthDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool OutboxHealthDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void OutboxHealthDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<OutboxHealthDto> OutboxHealthDtoEnvelope::getResult() const
{
    return m_Result;
}

void OutboxHealthDtoEnvelope::setResult(const std::shared_ptr<OutboxHealthDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool OutboxHealthDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void OutboxHealthDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
