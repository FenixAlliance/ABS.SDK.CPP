...
IPLookupDtoEnvelope::IPLookupDtoEnvelope()
{
    m_IsSuccess = false;
...
void IPLookupDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value IPLookupDtoEnvelope::toJson() const
{
...
bool IPLookupDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<IPLookupDto> refVal_setResult;
...
void IPLookupDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IPLookupDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool IPLookupDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void IPLookupDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool IPLookupDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void IPLookupDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t IPLookupDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void IPLookupDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool IPLookupDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void IPLookupDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t IPLookupDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void IPLookupDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool IPLookupDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void IPLookupDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime IPLookupDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void IPLookupDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool IPLookupDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void IPLookupDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t IPLookupDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void IPLookupDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool IPLookupDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void IPLookupDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t IPLookupDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void IPLookupDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool IPLookupDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void IPLookupDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& IPLookupDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void IPLookupDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool IPLookupDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void IPLookupDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t IPLookupDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void IPLookupDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool IPLookupDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void IPLookupDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<IPLookupDto> IPLookupDtoEnvelope::getResult() const
{
    return m_Result;
}

void IPLookupDtoEnvelope::setResult(const std::shared_ptr<IPLookupDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool IPLookupDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void IPLookupDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
