...
UserAdminDetailDtoEnvelope::UserAdminDetailDtoEnvelope()
{
    m_IsSuccess = false;
...
void UserAdminDetailDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value UserAdminDetailDtoEnvelope::toJson() const
{
...
bool UserAdminDetailDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UserAdminDetailDto> refVal_setResult;
...
void UserAdminDetailDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UserAdminDetailDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool UserAdminDetailDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void UserAdminDetailDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool UserAdminDetailDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void UserAdminDetailDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t UserAdminDetailDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void UserAdminDetailDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool UserAdminDetailDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void UserAdminDetailDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t UserAdminDetailDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void UserAdminDetailDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool UserAdminDetailDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void UserAdminDetailDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime UserAdminDetailDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void UserAdminDetailDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UserAdminDetailDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UserAdminDetailDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t UserAdminDetailDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void UserAdminDetailDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool UserAdminDetailDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void UserAdminDetailDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t UserAdminDetailDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void UserAdminDetailDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool UserAdminDetailDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void UserAdminDetailDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& UserAdminDetailDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void UserAdminDetailDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool UserAdminDetailDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void UserAdminDetailDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t UserAdminDetailDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void UserAdminDetailDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool UserAdminDetailDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void UserAdminDetailDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<UserAdminDetailDto> UserAdminDetailDtoEnvelope::getResult() const
{
    return m_Result;
}

void UserAdminDetailDtoEnvelope::setResult(const std::shared_ptr<UserAdminDetailDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool UserAdminDetailDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void UserAdminDetailDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
