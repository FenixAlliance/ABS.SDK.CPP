...
InboxHealthDtoEnvelope::InboxHealthDtoEnvelope()
{
    m_IsSuccess = false;
...
void InboxHealthDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value InboxHealthDtoEnvelope::toJson() const
{
...
bool InboxHealthDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<InboxHealthDto> refVal_setResult;
...
void InboxHealthDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InboxHealthDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool InboxHealthDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void InboxHealthDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool InboxHealthDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void InboxHealthDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t InboxHealthDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void InboxHealthDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool InboxHealthDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void InboxHealthDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t InboxHealthDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void InboxHealthDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool InboxHealthDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void InboxHealthDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime InboxHealthDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void InboxHealthDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InboxHealthDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InboxHealthDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t InboxHealthDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void InboxHealthDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool InboxHealthDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void InboxHealthDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t InboxHealthDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void InboxHealthDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool InboxHealthDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void InboxHealthDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& InboxHealthDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void InboxHealthDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool InboxHealthDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void InboxHealthDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t InboxHealthDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void InboxHealthDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool InboxHealthDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void InboxHealthDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<InboxHealthDto> InboxHealthDtoEnvelope::getResult() const
{
    return m_Result;
}

void InboxHealthDtoEnvelope::setResult(const std::shared_ptr<InboxHealthDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool InboxHealthDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void InboxHealthDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
