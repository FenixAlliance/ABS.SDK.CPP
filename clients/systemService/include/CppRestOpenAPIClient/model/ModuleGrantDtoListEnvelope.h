...
/*
 * ModuleGrantDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ModuleGrantDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ModuleGrantDtoListEnvelope_H_
...
public:
    ...
    virtual ~ModuleGrantDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ModuleGrantDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ModuleGrantDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ModuleGrantDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ModuleGrantDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ModuleGrantDtoListEnvelope_H_ */
