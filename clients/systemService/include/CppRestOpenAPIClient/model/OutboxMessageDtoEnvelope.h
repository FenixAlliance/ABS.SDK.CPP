...
/*
 * OutboxMessageDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoEnvelope_H_
...
public:
    ...
    virtual ~OutboxMessageDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// OutboxMessageDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<OutboxMessageDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<OutboxMessageDto>& value);
...
protected:
    ...
    std::shared_ptr<OutboxMessageDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoEnvelope_H_ */
