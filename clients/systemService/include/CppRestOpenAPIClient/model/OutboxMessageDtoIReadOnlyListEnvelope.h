...
/*
 * OutboxMessageDtoIReadOnlyListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoIReadOnlyListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoIReadOnlyListEnvelope_H_
...
public:
    ...
    virtual ~OutboxMessageDtoIReadOnlyListEnvelope();
    ...
    /////////////////////////////////////////////
    /// OutboxMessageDtoIReadOnlyListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<OutboxMessageDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<OutboxMessageDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<OutboxMessageDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_OutboxMessageDtoIReadOnlyListEnvelope_H_ */
