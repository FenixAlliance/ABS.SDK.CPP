...
/*
 * ApplicationPrincipalDtoIReadOnlyListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ApplicationPrincipalDtoIReadOnlyListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ApplicationPrincipalDtoIReadOnlyListEnvelope_H_
...
public:
    ...
    virtual ~ApplicationPrincipalDtoIReadOnlyListEnvelope();
    ...
    /////////////////////////////////////////////
    /// ApplicationPrincipalDtoIReadOnlyListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ApplicationPrincipalDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<ApplicationPrincipalDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ApplicationPrincipalDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ApplicationPrincipalDtoIReadOnlyListEnvelope_H_ */
