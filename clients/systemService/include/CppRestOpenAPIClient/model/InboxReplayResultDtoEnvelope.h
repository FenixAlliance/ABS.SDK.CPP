...
/*
 * InboxReplayResultDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_InboxReplayResultDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_InboxReplayResultDtoEnvelope_H_
...
public:
    ...
    virtual ~InboxReplayResultDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// InboxReplayResultDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<InboxReplayResultDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<InboxReplayResultDto>& value);
...
protected:
    ...
    std::shared_ptr<InboxReplayResultDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_InboxReplayResultDtoEnvelope_H_ */
