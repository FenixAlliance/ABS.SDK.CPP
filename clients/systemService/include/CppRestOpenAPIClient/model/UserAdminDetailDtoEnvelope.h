...
/*
 * UserAdminDetailDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UserAdminDetailDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UserAdminDetailDtoEnvelope_H_
...
public:
    ...
    virtual ~UserAdminDetailDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// UserAdminDetailDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<UserAdminDetailDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<UserAdminDetailDto>& value);
...
protected:
    ...
    std::shared_ptr<UserAdminDetailDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UserAdminDetailDtoEnvelope_H_ */
