...
/*
 * InboxMessageDtoIReadOnlyListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_InboxMessageDtoIReadOnlyListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_InboxMessageDtoIReadOnlyListEnvelope_H_
...
public:
    ...
    virtual ~InboxMessageDtoIReadOnlyListEnvelope();
    ...
    /////////////////////////////////////////////
    /// InboxMessageDtoIReadOnlyListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<InboxMessageDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<InboxMessageDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<InboxMessageDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_InboxMessageDtoIReadOnlyListEnvelope_H_ */
