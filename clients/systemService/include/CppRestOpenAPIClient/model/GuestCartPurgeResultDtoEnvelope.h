...
/*
 * GuestCartPurgeResultDtoEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GuestCartPurgeResultDtoEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GuestCartPurgeResultDtoEnvelope_H_
...
public:
    ...
    virtual ~GuestCartPurgeResultDtoEnvelope();
    ...
    /////////////////////////////////////////////
    /// GuestCartPurgeResultDtoEnvelope members
    ...
    /// 
    /// </summary>
    std::shared_ptr<GuestCartPurgeResultDto> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<GuestCartPurgeResultDto>& value);
...
protected:
    ...
    std::shared_ptr<GuestCartPurgeResultDto> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GuestCartPurgeResultDtoEnvelope_H_ */
