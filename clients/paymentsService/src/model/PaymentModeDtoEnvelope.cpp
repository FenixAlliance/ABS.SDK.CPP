...
PaymentModeDtoEnvelope::PaymentModeDtoEnvelope()
{
    m_IsSuccess = false;
...
void PaymentModeDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentModeDtoEnvelope::toJson() const
{
...
bool PaymentModeDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PaymentModeDto> refVal_setResult;
...
void PaymentModeDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentModeDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentModeDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentModeDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentModeDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentModeDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentModeDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentModeDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentModeDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentModeDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentModeDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentModeDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentModeDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentModeDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentModeDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentModeDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentModeDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentModeDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentModeDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentModeDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentModeDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentModeDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentModeDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentModeDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentModeDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentModeDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentModeDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentModeDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentModeDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentModeDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentModeDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentModeDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentModeDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentModeDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PaymentModeDto> PaymentModeDtoEnvelope::getResult() const
{
    return m_Result;
}

void PaymentModeDtoEnvelope::setResult(const std::shared_ptr<PaymentModeDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentModeDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentModeDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
