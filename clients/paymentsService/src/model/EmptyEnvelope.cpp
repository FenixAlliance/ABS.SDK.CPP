...
int32_t EmptyEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void EmptyEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool EmptyEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void EmptyEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t EmptyEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void EmptyEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool EmptyEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void EmptyEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& EmptyEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void EmptyEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool EmptyEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void EmptyEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
