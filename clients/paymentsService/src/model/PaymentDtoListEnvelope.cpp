...
PaymentDtoListEnvelope::PaymentDtoListEnvelope()
{
    m_IsSuccess = false;
...
void PaymentDtoListEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentDtoListEnvelope::toJson() const
{
...
bool PaymentDtoListEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PaymentDtoListEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentDtoListEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentDtoListEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentDtoListEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentDtoListEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentDtoListEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentDtoListEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentDtoListEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentDtoListEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentDtoListEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentDtoListEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentDtoListEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentDtoListEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentDtoListEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentDtoListEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentDtoListEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentDtoListEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentDtoListEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentDtoListEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentDtoListEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentDtoListEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentDtoListEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentDtoListEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentDtoListEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentDtoListEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentDtoListEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentDtoListEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentDtoListEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentDtoListEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentDtoListEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentDtoListEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentDtoListEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentDtoListEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentDtoListEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::vector<std::shared_ptr<PaymentDto>>& PaymentDtoListEnvelope::getResult()
{
    return m_Result;
}

void PaymentDtoListEnvelope::setResult(const std::vector<std::shared_ptr<PaymentDto>>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentDtoListEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentDtoListEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
