...
PaymentTermDtoEnvelope::PaymentTermDtoEnvelope()
{
    m_IsSuccess = false;
...
void PaymentTermDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentTermDtoEnvelope::toJson() const
{
...
bool PaymentTermDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PaymentTermDto> refVal_setResult;
...
void PaymentTermDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentTermDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentTermDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentTermDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentTermDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentTermDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentTermDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentTermDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentTermDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentTermDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentTermDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentTermDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentTermDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentTermDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentTermDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentTermDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentTermDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentTermDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentTermDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentTermDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentTermDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentTermDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentTermDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentTermDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentTermDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentTermDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentTermDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentTermDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentTermDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentTermDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentTermDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentTermDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentTermDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentTermDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PaymentTermDto> PaymentTermDtoEnvelope::getResult() const
{
    return m_Result;
}

void PaymentTermDtoEnvelope::setResult(const std::shared_ptr<PaymentTermDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentTermDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentTermDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
