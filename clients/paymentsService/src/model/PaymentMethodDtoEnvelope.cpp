...
PaymentMethodDtoEnvelope::PaymentMethodDtoEnvelope()
{
    m_IsSuccess = false;
...
void PaymentMethodDtoEnvelope::validate()
{
    // TODO: implement validation
}

web::json::value PaymentMethodDtoEnvelope::toJson() const
{
...
bool PaymentMethodDtoEnvelope::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("result"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<PaymentMethodDto> refVal_setResult;
...
void PaymentMethodDtoEnvelope::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PaymentMethodDtoEnvelope::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool PaymentMethodDtoEnvelope::isIsSuccess() const
{
    return m_IsSuccess;
}

void PaymentMethodDtoEnvelope::setIsSuccess(bool value)
{
    m_IsSuccess = value;
    m_IsSuccessIsSet = true;
}

bool PaymentMethodDtoEnvelope::isSuccessIsSet() const
{
    return m_IsSuccessIsSet;
}

void PaymentMethodDtoEnvelope::unsetIsSuccess()
{
    m_IsSuccessIsSet = false;
}
utility::string_t PaymentMethodDtoEnvelope::getErrorMessage() const
{
    return m_ErrorMessage;
}

void PaymentMethodDtoEnvelope::setErrorMessage(const utility::string_t& value)
{
    m_ErrorMessage = value;
    m_ErrorMessageIsSet = true;
}

bool PaymentMethodDtoEnvelope::errorMessageIsSet() const
{
    return m_ErrorMessageIsSet;
}

void PaymentMethodDtoEnvelope::unsetErrorMessage()
{
    m_ErrorMessageIsSet = false;
}
utility::string_t PaymentMethodDtoEnvelope::getCorrelationId() const
{
    return m_CorrelationId;
}

void PaymentMethodDtoEnvelope::setCorrelationId(const utility::string_t& value)
{
    m_CorrelationId = value;
    m_CorrelationIdIsSet = true;
}

bool PaymentMethodDtoEnvelope::correlationIdIsSet() const
{
    return m_CorrelationIdIsSet;
}

void PaymentMethodDtoEnvelope::unsetCorrelationId()
{
    m_CorrelationIdIsSet = false;
}
utility::datetime PaymentMethodDtoEnvelope::getTimestamp() const
{
    return m_Timestamp;
}

void PaymentMethodDtoEnvelope::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool PaymentMethodDtoEnvelope::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void PaymentMethodDtoEnvelope::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
int32_t PaymentMethodDtoEnvelope::getHttpStatus() const
{
    return m_HttpStatus;
}

void PaymentMethodDtoEnvelope::setHttpStatus(int32_t value)
{
    m_HttpStatus = value;
    m_HttpStatusIsSet = true;
}

bool PaymentMethodDtoEnvelope::httpStatusIsSet() const
{
    return m_HttpStatusIsSet;
}

void PaymentMethodDtoEnvelope::unsetHttpStatus()
{
    m_HttpStatusIsSet = false;
}
utility::string_t PaymentMethodDtoEnvelope::getErrorCode() const
{
    return m_ErrorCode;
}

void PaymentMethodDtoEnvelope::setErrorCode(const utility::string_t& value)
{
    m_ErrorCode = value;
    m_ErrorCodeIsSet = true;
}

bool PaymentMethodDtoEnvelope::errorCodeIsSet() const
{
    return m_ErrorCodeIsSet;
}

void PaymentMethodDtoEnvelope::unsetErrorCode()
{
    m_ErrorCodeIsSet = false;
}
std::map<utility::string_t, std::vector<utility::string_t>>& PaymentMethodDtoEnvelope::getValidationDetails()
{
    return m_ValidationDetails;
}

void PaymentMethodDtoEnvelope::setValidationDetails(const std::map<utility::string_t, std::vector<utility::string_t>>& value)
{
    m_ValidationDetails = value;
    m_ValidationDetailsIsSet = true;
}

bool PaymentMethodDtoEnvelope::validationDetailsIsSet() const
{
    return m_ValidationDetailsIsSet;
}

void PaymentMethodDtoEnvelope::unsetValidationDetails()
{
    m_ValidationDetailsIsSet = false;
}
utility::string_t PaymentMethodDtoEnvelope::getActivityId() const
{
    return m_ActivityId;
}

void PaymentMethodDtoEnvelope::setActivityId(const utility::string_t& value)
{
    m_ActivityId = value;
    m_ActivityIdIsSet = true;
}

bool PaymentMethodDtoEnvelope::activityIdIsSet() const
{
    return m_ActivityIdIsSet;
}

void PaymentMethodDtoEnvelope::unsetActivityId()
{
    m_ActivityIdIsSet = false;
}
std::shared_ptr<PaymentMethodDto> PaymentMethodDtoEnvelope::getResult() const
{
    return m_Result;
}

void PaymentMethodDtoEnvelope::setResult(const std::shared_ptr<PaymentMethodDto>& value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool PaymentMethodDtoEnvelope::resultIsSet() const
{
    return m_ResultIsSet;
}

void PaymentMethodDtoEnvelope::unsetResult()
{
    m_ResultIsSet = false;
}
}
