...
/*
 * PaymentProviderRegistrationDtoListEnvelope.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PaymentProviderRegistrationDtoListEnvelope_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PaymentProviderRegistrationDtoListEnvelope_H_
...
public:
    ...
    virtual ~PaymentProviderRegistrationDtoListEnvelope();
    ...
    /////////////////////////////////////////////
    /// PaymentProviderRegistrationDtoListEnvelope members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PaymentProviderRegistrationDto>>& getResult();
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::vector<std::shared_ptr<PaymentProviderRegistrationDto>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<PaymentProviderRegistrationDto>> m_Result;
    bool m_ResultIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PaymentProviderRegistrationDtoListEnvelope_H_ */
